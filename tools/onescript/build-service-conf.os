...
Процедура ОбработатьФайлConfiguration_xml(ИмяФайла,Версия)
	...
	ИначеЕсли Версия = "8.3.10" Тогда
		ЗначениеВерсия = "VERSION" + СтрЗаменить(Версия,".","_");
	ИначеЕсли Версия = "8.3.11" Тогда
		ЗначениеВерсия = "VERSION" + СтрЗаменить(Версия,".","_");
	ИначеЕсли Версия = "8.3.12" Тогда
		ЗначениеВерсия = "VERSION" + СтрЗаменить(Версия,".","_");
	ИначеЕсли Версия = "8.3.13" Тогда
		ЗначениеВерсия = "VERSION" + СтрЗаменить("8.3.12",".","_");
	КонецЕсли;	 
...
массивСервисныхБаз.Добавить(Новый Структура("ПутьКИсходникам,СоздаваемаяБаза, Версия",
	".\lib\CF\83NoSync\",".\tools\ServiceBases\v83NoSyncServiceBase", "8.3.10"));
