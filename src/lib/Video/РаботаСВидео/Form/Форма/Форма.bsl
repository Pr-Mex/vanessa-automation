...
Процедура СобратьФинальноеВидеоИзЧастей(ПараметрыВидео,МассивЧастей)
	...
	ПараметрыВидео.Ванесса.ПереместитьФайлКомандаСистемы(ПараметрыВидео.ЗаписьВидеоКаталогДляВременныхФайлов + "\" + СобранноеВидео5,ФинальноеИмя);	
