...
Функция СоздатьЗаголовокСценария(ПараметрыВидео,ИмяСценария,НомерСценария)
	...
	СценарийMP3 = ПолучитьФайлMP3ИзТекста(ПараметрыВидео,"Сценарий. " + Текст,"scen_" + ДобавитьНулей(НомерСценария,3) + "_begin");
...
Процедура ДобавитьСубтитрыКВидео(ПараметрыВидео,ИмяФайлаШага,Шаг,ДлительностьMP3)
	...
	ЗТ.ЗаписатьСтроку(ПодготовитьСтрокуДляСубтитров(Шаг.Имя)); 
	ЗТ.Закрыть();
