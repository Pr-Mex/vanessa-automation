...
Процедура ЗаполнитьТекстШаговПоАктивномуЭлементу()
	...
	Если ТипЗнч(ЭлементФормы) = Тип("ТестируемоеПолеФормы") Тогда
		...
		ИначеЕсли Вид = ВидПоляФормы.ПолеТабличногоДокумента Тогда
			МассивШагов.Добавить("Дано Табличный документ """ + ЭлементФормы.Имя + """ стал равен макету ""ИмяМакета""");
			МассивШагов.Добавить("");
		...
		ИначеЕсли Вид = ВидПоляФормы.ПолеПереключателя Тогда
			...
			Попытка
				ТекстРедактирования = ЭлементФормы.ПолучитьОтображаемыйТекст();
			Исключение
			КонецПопытки;
			...
			КонецЕсли;	 
			МассивШагов.Добавить("");
			МассивШагов.Добавить("И я меняю значение переключателя """ + ЭлементФормы.ТекстЗаголовка + """ на '" + ТекстРедактирования + "'");
			МассивШагов.Добавить("И я меняю значение переключателя с именем """ + ЭлементФормы.Имя + """ на '" + ТекстРедактирования + "'");
