...
&НаСервере
Процедура ДобавитьШаги(Дерево,Тип,ПредставлениеТеста,ОписаниеШага,ИмяФайла,ТаблицаПеревода)
	...
	Если ТаблицаПеревода <> Неопределено Тогда
		...
		СтрокаТаблицаПеревода = ТаблицаПеревода.Найти(НРег(СтрокаПоиска),"ОригиналРусскийШагНРег");
		Если СтрокаТаблицаПеревода <> Неопределено Тогда
