...
Функция НайтиСледующуюСтрокаКогдаУсловиеИстинно(СтрокаУсловия)
	...
	Пока Истина Цикл
		...
		Иначе
			Если (РодительСтроки.ДопТип = "Условие") или (РодительСтроки.ДопТип = "УсловиеИначеЕсли") или (РодительСтроки.ДопТип = "УсловиеИначе") Тогда
...
Функция СформироватьОписаниеОшибки(Знач Стр, ИмяФайла, ИмяПроцедуры,ИнфоОбОшибке)
	...
	Стр = Стр + Символы.ПС + ПолучитьТекстСообщенияПользователю("$ТехническиеДанные$") + ":"
