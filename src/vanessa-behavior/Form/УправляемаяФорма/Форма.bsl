...
&НаКлиенте
Функция ПолучитьТабДокИзTestClient(ЭлементФормы,ДопПараметры = Неопределено) Экспорт
	СистемнаяИнформация = Новый СистемнаяИнформация;
				...
				Если Было = Неопределено Тогда
					...
					Если ЭлемСтало.Свойство("ТекстРедактирования") Тогда
						Если ЭлемСтало.ТекстРедактирования <> ПредставлениеДанных Тогда
							//Сообщить("ЭлемСтало.ТекстРедактирования="+ЭлемСтало.ТекстРедактирования + ", ПредставлениеДанных="+ПредставлениеДанных);
						КонецЕсли;	 
					КонецЕсли;	 
