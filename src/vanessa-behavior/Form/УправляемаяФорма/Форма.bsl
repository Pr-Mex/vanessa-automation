	...
	Для каждого КаталогФичи Из КаталогиФич Цикл
		...
		Для каждого Каталог Из МассивКаталогов Цикл
			...
			Для каждого СтрСнипет Из ТабРезультат_ Цикл
				...
				Снипет.Вставить("ОписаниеШага", СтрСнипет.ОписаниеШага);
				Снипет.Вставить("ТипШага",      СтрСнипет.ТипШага);
...
Процедура ДобавитьСнипетВДеревоШаговНаСервере(тДерево, Снипет, ИмяФайла)
	...
	Если ЗначениеЗаполнено(Снипет.ТипШага) Тогда
		тИмяСнипета = тШаг.Строки.Добавить();
		тИмяСнипета.Наименование = "Тип шага";
		тИмяСнипета.Значение     = Снипет.ТипШага;
		тИмяСнипета.ТипКартинки  = 100;
	КонецЕсли;	
	
	Если ЗначениеЗаполнено(Снипет.ОписаниеШага) Тогда
		тИмяСнипета = тШаг.Строки.Добавить();
		тИмяСнипета.Наименование = "Описание шага";
		тИмяСнипета.Значение     = Снипет.ОписаниеШага;
		тИмяСнипета.ТипКартинки  = 100;
	КонецЕсли;
