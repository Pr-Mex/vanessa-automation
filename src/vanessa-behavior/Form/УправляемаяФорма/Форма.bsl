...
Процедура ВосстановитьНастройки(ЭтоLinux)
	...
	Если ТипЗнч(Настройки) = Тип("Структура") Тогда
		...
		Настройки.Свойство("ОсновнойЯзык", Объект.ОсновнойЯзык);
		
		Если Не ЗначениеЗаполнено(Объект.ОсновнойЯзык) Тогда
			Объект.ОсновнойЯзык = "ru";
		КонецЕсли;	 
...
Процедура СохранитьНастройки()
	...
	Настройки.Вставить("ОсновнойЯзык", Объект.ОсновнойЯзык);
