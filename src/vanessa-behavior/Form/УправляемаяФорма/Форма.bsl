...
Процедура ВыполнитьКомандуОбработатьСценарийВидео(ИД_СценарияВМассиве,НадоПрерватьСценарийДляВставки,ШагВставки)
	...
	МассивЧастейВидео.Добавить(Новый Структура("Тип,ИмяЧастиВидео,ИмяЧастиСубтитры,КоличествоШаговВДаннойЧастиВидео,ИмяВставки","ЧастьВидео",ИмяЧастиВидео,ИмяЧастиСубтитры,КоличествоШаговВДаннойЧастиВидео,"-"));
	
	Если НадоПрерватьСценарийДляВставки Тогда
		МассивЧастейВидео.Добавить(Новый Структура("Тип,ИмяЧастиВидео,ИмяЧастиСубтитры,КоличествоШаговВДаннойЧастиВидео,ИмяВставки","Вставка","-","-",1,ШагВставки.ЗначенияПараметров[0].Значение.Значение));
	КонецЕсли;	 
