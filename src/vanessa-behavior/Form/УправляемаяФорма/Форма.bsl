...
&НаКлиенте
Процедура ПодсветитьАктивноеОкно(Длительность,ЖатьЗавершения = Истина) Экспорт
...
&НаКлиенте
Процедура ПереместитьКурсорМышиКАктивномуОкну(Скорость,ЖатьЗавершения = Истина) Экспорт
