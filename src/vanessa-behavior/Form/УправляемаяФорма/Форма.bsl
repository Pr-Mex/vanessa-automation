...
Процедура ВосстановитьНастройки(ЭтоLinux)
	...
	Если ТипЗнч(Настройки) = Тип("Структура") Тогда
		...
		Настройки.Свойство("ЗаписьВидеоПутьКBalabolka_console", Объект.ЗаписьВидеоПутьКBalabolka_console);
...
Процедура СохранитьНастройки()
	...
	Настройки.Вставить("ЗаписьВидеоПутьКBalabolka_console", Объект.ЗаписьВидеоПутьКBalabolka_console);
...
Функция ПолучитьПараметрыЗаписиВидео()
	...
	ПараметрыВидео.Вставить("ЗаписьВидеоПутьКBalabolka_console",Объект.ЗаписьВидеоПутьКBalabolka_console);
