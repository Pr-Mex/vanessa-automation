...
Функция ПодключитьУжеЗапущенныйTestClient(ДанныеЗапускаКлиентаТестирования)
	...
	Если НЕ ОбъектКонтекстСохраняемый.Свойство("ТестовоеПриложение") Тогда
		Попытка
			ТестовоеПриложение = СоздатьТестовоеПриложение("localhost", ДанныеЗапускаКлиентаТестирования);
...
&НаКлиенте
Функция СоздатьТестовоеПриложение(ИмяКомпьютера = "localhost", ДанныеЗапускаКлиентаТестирования)
	...
	Если ДанныеЗапускаКлиентаТестирования.ТипКлиента = "Web" Тогда
		ВтораяЧастьСтроки = ",""" + ДанныеЗапускаКлиентаТестирования.Имя + """)";
	Иначе	
		ВтораяЧастьСтроки = ")";
	КонецЕсли;	 
...
Функция ПолучитьСтрокуЗапускаWebКлиент(ДанныеЗапускаКлиентаТестирования)
	...
	ДобавитьПараметрКWeb(СтрокаЗапуска, "TESTCLIENTID", ДанныеЗапускаКлиентаТестирования.Имя);
