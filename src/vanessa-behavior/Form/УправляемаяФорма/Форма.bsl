...
Процедура ДобавитьСнипет(Знач Снипет,Знач ИмяФайла,ВерсияФайла,БылиОшибки,ТзнТаблицаИзвестныхStepDefinition)
	...
	Если Не Снипет.Свойство("ОписаниеШага") Тогда
		СтрТаблицаИзвестныхStepDefinition.ОписаниеШага        = "";
	Иначе	
		СтрТаблицаИзвестныхStepDefinition.ОписаниеШага        = Снипет.ОписаниеШага;
	КонецЕсли;	 
	Если Не Снипет.Свойство("ТипШага") Тогда
		СтрТаблицаИзвестныхStepDefinition.ТипШага             = "";
	Иначе	
		СтрТаблицаИзвестныхStepDefinition.ТипШага             = Снипет.ТипШага;
	КонецЕсли;	 
...
&НаКлиенте
Функция ПодключитьКонтекстОбработкиКлиент(Файл)
	Попытка
...
Процедура ПодключитьСнипетыИзОбработкиКлиент(Файл,ВерсияФайла,БылиОшибки)
	...
	Если ИД = Неопределено Тогда
		...
		Если НЕ ПодключитьКонтекстОбработкиКлиент(Файл) Тогда
			Возврат;
		КонецЕсли;	 
