...
Процедура ВывестиСтатистикуНаСервере()
	...
	Элементы.Статистика.Подсказка = "Всего фич: " + ВсегоФич + Символы.ПС +
									...
									"Всего шагов: " + ВсегоШаговОбщее + Символы.ПС +
									?(НеРеализованыхСпипетовВсего > 0, "Не реализовано шагов: " + НеРеализованыхСпипетовВсего, "") + 
									?(ВсегоШаговSuccess+ВсегоШаговPending+ВсегоШаговFailed > 0, 
										Символы.ПС +
										"Результат выполнения шагов (Success, Failed, Pending): " + 
