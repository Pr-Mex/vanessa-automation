...
Функция ПолучитьСписокТестов(КонтекстФреймворкаBDD) Экспорт
	...
	Ванесса.ДобавитьШагВМассивТестов(ВсеТесты,"ВТечениеСекундЯВыполняю(Парам01)","ВТечениеСекундЯВыполняю","И в течение 10 секунд я выполняю","Цикл. Выполняет действия в цикле в течение заданного числа секунд. По истчение времени вызывает исключение.","Прочее","Цикл");
