...
Функция ПолучитьСписокТестов(КонтекстФреймворкаBDD) Экспорт
	...
	Ванесса.ДобавитьШагВМассивТестов(ВсеТесты,"ВТаблицеЕстьСтрокиТогда(Парам01,ТабПарам)","ВТаблицеЕстьСтрокиТогда","Если в таблице ""ИмяТаблицы"" есть строки Тогда" + Символы.ПС + Символы.Таб + "| 'Реквизит строка' |" + Символы.ПС + Символы.Таб + "| '2'               |","Условие. Истинно, если в таблице есть нужная строка/строки. Поиск строк производится через получение всех строк таблицы , а затем нужные строки будут искаться в полученных строках таблицы.","UI.Таблицы.Проверка значения таблицы.Таблица Gherkin.Условие","Условие");
	Ванесса.ДобавитьШагВМассивТестов(ВсеТесты,"ВТаблицеЕстьСтрокаТогда(Парам01,ТабПарам)","ВТаблицеЕстьСтрокаТогда","Если в таблице ""ИмяТаблицы"" есть строка Тогда" + Символы.ПС + Символы.Таб + "| 'Реквизит строка' |" + Символы.ПС + Символы.Таб + "| '2'               |","Условие. Истинно, если в таблице есть нужная строка. Допускается передвать только одну строку для поиска. Шаг пытается сделать переход к строке и возвращает Истина если это получилось сделать.","UI.Таблицы.Проверка значения таблицы.Таблица Gherkin.Условие","Условие");
	...
	Ванесса.ДобавитьШагВМассивТестов(ВсеТесты,"ПолеИмеетЗначениеВТечениеСекундТогда(Парам01,Парам02,Парам03)","ПолеИмеетЗначениеВТечениеСекундТогда","Если поле ""ИмяПоля"" имеет значение ""ЗначениеПоля"" в течение 10 секунд Тогда","Условие. Проверяет значение поля формы в течение нужного числа секунд.","UI.Формы.Поля.Проверка значения поля","Условие");
	Ванесса.ДобавитьШагВМассивТестов(ВсеТесты,"ПолеСИменемИмеетЗначениеВТечениеСекундТогда(Парам01,Парам02,Парам03)","ПолеСИменемИмеетЗначениеВТечениеСекундТогда","Если поле с именем ""ИмяПоля"" имеет значение ""ЗначениеПоля2"" в течение 10 секунд Тогда","Условие. Проверяет значение поля формы в течение нужного числа секунд. Поиск поля производится по имени.","UI.Формы.Поля.Проверка значения поля","Условие");
...
&НаКлиенте
Процедура ОбработичкОжиданияПолеИмеетЗначениеВТечениеСекундТогда()
	ИмяОбработчикаОжидания = "ОбработичкОжиданияПолеИмеетЗначениеВТечениеСекундТогда";
...
&НаКлиенте
//Если поле "Наименование" имеет значение "Тестовый Элемент 2" в течение 10 секунд Тогда
//@ПолеИмеетЗначениеВТечениеСекундТогда(Парам01,Парам02,Парам03)
Процедура ПолеИмеетЗначениеВТечениеСекундТогда(ИмяПоля,Значение,КоличествоСекунд,ИскатьПоИмени = Ложь) Экспорт
	...
	ПодключитьОбработчикОжидания("ОбработичкОжиданияПолеИмеетЗначениеВТечениеСекундТогда",1,Ложь);
КонецПроцедуры



&НаКлиенте
//Если поле с именем "Наименование" имеет значение "Тестовый Элемент 2" в течение 10 секунд Тогда
//@ПолеСИменемИмеетЗначениеВТечениеСекундТогда(Парам01,Парам02,Парам03)
Процедура ПолеСИменемИмеетЗначениеВТечениеСекундТогда(ИмяПоля,ЗначениеПоля,КоличествоСекунд) Экспорт
	ПолеИмеетЗначениеВТечениеСекундТогда(ИмяПоля,ЗначениеПоля,КоличествоСекунд,Истина);
КонецПроцедуры
