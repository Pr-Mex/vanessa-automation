...
Функция ПолучитьСписокТестов(КонтекстФреймворкаBDD) Экспорт
	...
	Ванесса.ДобавитьШагВМассивТестов(ВсеТесты,"ВТаблицеПолеИмеетЗначениеТогда(Парам01,Парам02,Парам03)","ВТаблицеПолеИмеетЗначениеТогда","Если в таблице ""ИмяТаблицы"" поле ""ИмяПоля"" имеет значение ""ЗначениеПоля"" тогда","Условие. Проверяет значение ячейки таблицы. Имя ячейки указывается как оно задано в конфигураторе.","UI.Таблицы.Значение ячейки таблицы","Условие");
...
Процедура ВТаблицеПолеИмеетЗначениеТогда(ИмяТЧ,ИмяПоля,ОжидаемоеЗначение) Экспорт
	ТЧ                  = Ванесса.НайтиТЧПоИмени(ИмяТЧ);
