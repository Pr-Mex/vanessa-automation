...
Функция ПолучитьСписокТестов(КонтекстФреймворкаBDD) Экспорт
	...
	Ванесса.ДобавитьШагВМассивТестов(ВсеТесты,"ЭлементНеПрисутствуетНаФормеТогда(Парам01)","ЭлементНеПрисутствуетНаФормеТогда","Если элемент ""СтраницаТекущаяПечатнаяФорма"" не присутствует на форме Тогда","Условие. Проверяет видимость элемента Неопределено форме","UI.Формы.Поля","Условие");
...
Процедура ИмяТекущейФормыТогда(ИмяФормы) Экспорт
	...
	Сообщить("ТекФорма.ИмяФормы="+ТекФорма.ИмяФормы);
