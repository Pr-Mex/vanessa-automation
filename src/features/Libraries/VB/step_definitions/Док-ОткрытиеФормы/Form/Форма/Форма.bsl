...
Функция ПолучитьСписокТестов(КонтекстФреймворкаBDD) Экспорт
	...
	ДобавитьШагВМассивТестов(ВсеТесты,"ОткрыласьФормаVanessa_behaviorepf()","ОткрыласьФормаVanessa_behaviorepf","Тогда открылась форма vanessa-behavior.epf");
...
Процедура ЯНажимаюНаКнопкуДиалогаВыбораФайлов() Экспорт
	Ванесса.ВыполнитьSikuliСкрипт(Ванесса.Объект.КаталогИнструментов + "\tools\Sikuli\OpenDialog.sikuli");
	
	Ванесса.СделатьДействияПриЗаписиИнструкции("толькоскриншот");
	
	Ванесса.Шаг("И я набираю текст ""#enter""");
	//Ванесса.sleep(2);
	Ванесса.ВыполнитьSikuliСкрипт(Ванесса.Объект.КаталогИнструментов + "\tools\Sikuli\OpenDialogClick.sikuli");
КонецПроцедуры
...
&НаКлиенте
//Тогда открылась форма vanessa-behavior.epf
//@ОткрыласьФормаVanessa_behaviorepf()
Процедура ОткрыласьФормаVanessa_behaviorepf() Экспорт
...
Процедура ЯНабираюТекст(Текст) Экспорт
	...
	Ванесса.ВыполнитьSikuliСкрипт(Ванесса.Объект.КаталогИнструментов + "\tools\Sikuli\TypeText.sikuli " + ВременыйФайл);
КонецПроцедуры
