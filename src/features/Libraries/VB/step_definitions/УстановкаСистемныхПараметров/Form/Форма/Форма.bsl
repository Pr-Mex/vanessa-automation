...
Функция ПолучитьСписокТестов(КонтекстФреймворкаBDD) Экспорт
	...
	Ванесса.ДобавитьШагВМассивТестов(ВсеТесты,"ЯЗадаюСистемныеПараметрыСчитыванияМакетаНачСтрНачКолКолСтрКолКол(Парам01,Парам02,Парам03,Парам04)","ЯЗадаюСистемныеПараметрыСчитыванияМакетаНачСтрНачКолКолСтрКолКол","Когда Я задаю системные параметры считывания макета НачСтр 1 НачКол 1 КолСтр 100 КолКол 20","Указывает область чтения макета, когда он считывается по одной ячейке из данных TestClient","UI.Табличный документ.Область чтения");
