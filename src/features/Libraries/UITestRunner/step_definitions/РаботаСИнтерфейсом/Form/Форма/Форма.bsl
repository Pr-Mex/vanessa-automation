...
Функция ПолучитьСписокТестов(КонтекстФреймворкаBDD) Экспорт
	...
	Ванесса.ДобавитьШагВМассивТестов(ВсеТесты,"ТабличныйДокументСталРавен(Парам01,ТабПарам)","ТабличныйДокументСталРавен","И табличный документ ""РеквизитТабличныйДокумент"" стал равен:" + Символы.ПС + "	| Значение1 | Значение2 |" + Символы.ПС + "	| Значение3 | Значение4 |","Проверяет равенство табличного документа переданной таблице Gherkin. Необходимо указать параметры считывания макета.","UI.Табличный документ.Проверка значения всего табличного документа.Таблица Gherkin");
