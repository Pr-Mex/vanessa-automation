...
Процедура ОбработичкОжиданияЯЖдуЧтоВТаблицеКоличествоСтрокБудетВТеченииСекунд()
	...
	Если (ТекущаяДата() - ДатаНачалаОбработкиОжидания) > КоличествоСекундОбработкаОжидания Тогда
		ОтключитьОбработчикОжидания("ОбработичкОжиданияЯЖдуЧтоВТаблицеКоличествоСтрокБудетВТеченииСекунд");
		Ванесса.ПродолжитьВыполнениеШагов(Истина,"Ожидали в течение <" + КоличествоСекундОбработкаОжидания + "> секунд у таблицы <" + ИмяТаблицыОбработкаОжидания + "> количество строк " + ВидСравненияОбрабткаОжидания + " " + КоличествоСтрокОбработкаОжидания + ". Текущее значение <" + МассивСтрок.Количество() + ">");
		Возврат;
	КонецЕсли;
