...
Функция ПолучитьСписокТестов(КонтекстФреймворкаBDD) Экспорт
	...
	Ванесса.ДобавитьШагВМассивТестов(ВсеТесты,"ВТЧИзВыпадающегоСпискаЯВыбираюСВыбором(Парам01,Парам02,Парам03)","ВТЧИзВыпадающегоСпискаЯВыбираюСВыбором","И В таблице ""ИмяТаблицы"" из выпадающего списка ""ИмяПоля"" я выбираю ""ЗначениеПоля"" с выбором",,);
	...
	Ванесса.ДобавитьШагВМассивТестов(ВсеТесты,"УПоляКалендаряЯВыбираюДату(Парам01)","УПоляКалендаряЯВыбираюДату","И у поля календаря ""ИмяПоля"" я выбираю дату","Делает выбор даты, которая установлена в календаре","UI.Формы.Календарь");
	...
	Ванесса.ДобавитьШагВМассивТестов(ВсеТесты,"ЯНажимаюНаКнопку(Парам01)","ЯНажимаюНаКнопку","И     я нажимаю на кнопку ""ИмяКнопки""","Нажимает на кнопку с нужным заголовком","UI.Формы.Кнопки");
	...
	Ванесса.ДобавитьШагВМассивТестов(ВсеТесты,"ЭлементФормыСталРавенШаблону(Парам01,Парам02)","ЭлементФормыСталРавенШаблону","Тогда элемент формы ""ИмяПоля"" стал равен шаблону ""Шаблон""","Проверка значения элемента формы. В значении допускаются символы *","UI.Формы.Поля.Проверка значения поля");
	...
	Ванесса.ДобавитьШагВМассивТестов(ВсеТесты,"ВФормеВТаблицеЯПерехожуКСтроке(Парам01,Парам02,ТабПарам)","ВФормеВТаблицеЯПерехожуКСтроке","И     В форме ""Справочник2"" в таблице ""ИмяТаблицы"" я перехожу к строке:" + Символы.ПС + "		| Наименование |" + Символы.ПС + "		|    Товар1    |");
	...
	Ванесса.ДобавитьШагВМассивТестов(ВсеТесты,"ВФормеВТаблицеЯРазворачиваюСтроку(Парам01,Парам02,ТабПарам)","ВФормеВТаблицеЯРазворачиваюСтроку","И     В форме ""Справочник2"" в таблице ""ИмяТаблицы"" я разворачиваю строку:" + Символы.ПС + "		| Наименование |" + Символы.ПС + "		|    Товар1    |");
	Ванесса.ДобавитьШагВМассивТестов(ВсеТесты,"ВТаблицеЯРазворачиваюСтроку(Парам01,ТабПарам)","ВТаблицеЯРазворачиваюСтроку","И    в таблице ""ИмяТаблицы"" я разворачиваю строку:" + Символы.ПС + "		| Наименование |" + Символы.ПС + "		|    Товар1    |","Развернуть группу строк","UI.Таблицы.Развернуть/Свернуть.Произвольная строка");
	...
	Ванесса.ДобавитьШагВМассивТестов(ВсеТесты,"ВФормеВТаблицеЯСворачиваюСтроку(Парам01,Парам02,ТабПарам)","ВФормеВТаблицеЯСворачиваюСтроку","И     В форме ""Справочник2"" в таблице ""ИмяТаблицы"" я сворачиваю строку:" + Символы.ПС + "		| Наименование |" + Символы.ПС + "		|    Товар1    |");
	Ванесса.ДобавитьШагВМассивТестов(ВсеТесты,"ВТаблицеЯСворачиваюСтроку(Парам01,ТабПарам)","ВТаблицеЯСворачиваюСтроку","И    в таблице ""ИмяТаблицы"" я сворачиваю строку:" + Символы.ПС + "		| Наименование |" + Символы.ПС + "		|    Товар1    |","Свернуть группу строк","UI.Таблицы.Развернуть/Свернуть.Произвольная строка");
	...
	Ванесса.ДобавитьШагВМассивТестов(ВсеТесты,"ВТаблицеВПолеЯВвожуТекущуюДату(Парам01,Парам02)","ВТаблицеВПолеЯВвожуТекущуюДату","И в таблице ""ИмяТаблицы"" в поле ""ИмяПоля"" я ввожу текущую дату","Ввод текущей даты в поле таблицы","UI.Таблицы.Реквизиты");
	
	Ванесса.ДобавитьШагВМассивТестов(ВсеТесты,"ВТаблицеПолеИмеетЗначение(Парам01,Парам02,Парам03)","ВТаблицеПолеИмеетЗначение","И     в таблице ""ИмяТаблицы"" поле ""ИмяФлага"" имеет значение ""Да""","Проверка значения поля текущей строки таблицы","UI.Таблицы.Значение ячейки таблицы");
	...
	Ванесса.ДобавитьШагВМассивТестов(ВсеТесты,"ЯНажимаюНаКнопкуОткрытияПоля(Парам01)","ЯНажимаюНаКнопкуОткрытияПоля","И     я нажимаю на кнопку открытия поля ""ИмяПоля""","Нажимает на кнопку открытия поля ввода.","UI.Формы.Поля.Открыть");
	...
	Ванесса.ДобавитьШагВМассивТестов(ВсеТесты,"ЯНажимаюНаКнопкуСоздатьПоля(Парам01)","ЯНажимаюНаКнопкуСоздатьПоля","И я нажимаю на кнопку создать поля ""ИмяПоля""","Эмулирует нажатие кнопки ""Создать"" у выпадающего списка.","UI.Формы.Поля.Создать");
	...
	Ванесса.ДобавитьШагВМассивТестов(ВсеТесты,"ЯЗапоминаюЗначениеТаблицыПоляКак(Парам01,Парам02,Парам03)","ЯЗапоминаюЗначениеТаблицыПоляКак","И     я запоминаю значение таблицы ""ИмяТаблицы"" поля ""ИмяПоля"" как ""ИмяПеременной""","Сохранение значения поля таблицы в переменную Контекст","Контекст.Контекст.Сохранить значение.Таблица.Поле таблицы");
	...
	Ванесса.ДобавитьШагВМассивТестов(ВсеТесты,"ЯЗапоминаюЗначениеПоляКакГлобально(Парам01,Парам02)","ЯЗапоминаюЗначениеПоляКакГлобально","И     я запоминаю значение поля ""ИмяПоля"" как ""ИмяПеременной"" глобально","Сохранение значения поля в переменную КонтекстСохраняемый","Контекст.Контекст сохраняемый.Сохранить значение.Поле формы");
	...
	Ванесса.ДобавитьШагВМассивТестов(ВсеТесты,"ВПолеВвожуЗначениеПеременной(Парам01,Парам02)","ВПолеВвожуЗначениеПеременной","И     в поле ""ИмяПоля"" ввожу значение переменной ""ИмяПеременной""");
	Ванесса.ДобавитьШагВМассивТестов(ВсеТесты,"ВТаблицуВПолеВвожуЗначениеПеременной(Парам01,Парам02,Парам03)","ВТаблицуВПолеВвожуЗначениеПеременной","И     в Таблицу ""ИмяТаблицы"" в поле ""ИмяПоля"" ввожу значение переменной ""ИмяПеременной""");
	Ванесса.ДобавитьШагВМассивТестов(ВсеТесты,"ВПолеВвожуЗначениеКлюча(Парам01,Парам02)","ВПолеВвожуЗначениеКлюча","И     в поле ""ИмяПоля"" ввожу значение ключа ""Номер документа""");
	Ванесса.ДобавитьШагВМассивТестов(ВсеТесты,"ВПолеВвожуЗначениеГлобальнойПеременной(Парам01,Парам02)","ВПолеВвожуЗначениеГлобальнойПеременной","И     в поле ""ИмяПоля"" ввожу значение глобальной переменной ""ИмяПеременной""");
	Ванесса.ДобавитьШагВМассивТестов(ВсеТесты,"ВПолеВвожуЗначениеГлобальногоКлюча(Парам01,Парам02)","ВПолеВвожуЗначениеГлобальногоКлюча","И     в поле ""ИмяПоля"" ввожу значение глобального ключа ""Ключ""");
	
	Ванесса.ДобавитьШагВМассивТестов(ВсеТесты,"ВПолеЯВвожуЗначениеПеременной(Парам01,Парам02)","ВПолеЯВвожуЗначениеПеременной","И в поле ""ИмяПоля"" я ввожу значение переменной ""ИмяПеременной""", "Вставка значения ранее сохраненной переменной в реквизит", "Контекст.Контекст.Прочитать значение");
	Ванесса.ДобавитьШагВМассивТестов(ВсеТесты,"ВТаблицуВПолеЯВвожуЗначениеПеременной(Парам01,Парам02,Парам03)","ВТаблицуВПолеЯВвожуЗначениеПеременной","И в Таблицу ""ИмяТаблицы"" в поле ""ИмяПоля"" я ввожу значение переменной ""ИмяПеременной""", "Вставка значения ранее сохраненной переменной в реквизит", "Контекст.Контекст.Прочитать значение");
	Ванесса.ДобавитьШагВМассивТестов(ВсеТесты,"ВПолеЯВвожуЗначениеКлюча(Парам01,Парам02)","ВПолеЯВвожуЗначениеКлюча","И в поле ""ИмяПоля"" я ввожу значение ключа ""Номер документа""", "Вставка значения ранее сохраненного произвольного ключа в реквизит", "Контекст.Контекст.Прочитать значение");
	Ванесса.ДобавитьШагВМассивТестов(ВсеТесты,"ВПолеЯВвожуЗначениеГлобальнойПеременной(Парам01,Парам02)","ВПолеЯВвожуЗначениеГлобальнойПеременной","И в поле ""ИмяПоля"" я ввожу значение глобальной переменной ""ИмяПеременной""", "Вставка значения ранее сохраненной переменной в реквизит", "Контекст.Контекст сохраняемый.Прочитать значение");
	Ванесса.ДобавитьШагВМассивТестов(ВсеТесты,"ВПолеЯВвожуЗначениеГлобальногоКлюча(Парам01,Парам02)","ВПолеЯВвожуЗначениеГлобальногоКлюча","И в поле ""ИмяПоля"" я ввожу значение глобального ключа ""Ключ""", "Вставка значения ранее сохраненного ключа в реквизит", "Контекст.Контекст сохраняемый.Прочитать значение");
	...
	Ванесса.ДобавитьШагВМассивТестов(ВсеТесты,"ПолеТаблицыРавноПеременной(Парам01,Парам02,Парам03)","ПолеТаблицыРавноПеременной","И поле таблицы ""ИмяТаблицы"" ""ИмяПоля"" равно переменной ""ИмяПеременной""","Сравнение значения поля с переменной Контекста","Контекст.Контекст.Прочитать значение.Таблица.Поле таблицы");
	...
	Ванесса.ДобавитьШагВМассивТестов(ВсеТесты,"ВТаблицеПолеДоступноНеТолькоДляПросмотра(ИмяТЧ, ИмяРеквизита)", "ВТаблицеПолеДоступноНеТолькоДляПросмотра","И     В таблице ""ИмяТаблицы"" поле ""ИмяРеквизита"" доступно не только для просмотра", "Проверка установленного флага ""Только просмотр"" для реквизита в таблице","UI.Таблицы.Просмотр");	
	...
	Ванесса.ДобавитьШагВМассивТестов(ВсеТесты,"ВПолеЯУвеличиваюЗначение(Парам01)","ВПолеЯУвеличиваюЗначение","И в поле ""ИмяПоля"" я увеличиваю значение","Увеличивает значение поля в помощью специальной кнопки","UI.Формы.Поля.Увеличить значение");
	...
	Ванесса.ДобавитьШагВМассивТестов(ВсеТесты,"ВПолеЯУменьшаюЗначение(Парам01)","ВПолеЯУменьшаюЗначение","И в поле ""ИмяПоля"" я уменьшаю значение","Уменьшает значение поля в помощью специальной кнопки","UI.Формы.Поля.Уменьшить значение");
	...
	Ванесса.ДобавитьШагВМассивТестов(ВсеТесты,"ВТаблицеВПолеЯУвеличиваюЗначение(Парам01,Парам02)","ВТаблицеВПолеЯУвеличиваюЗначение","И в таблице ""ИмяТаблицы"" в поле ""ИмяПоля"" я увеличиваю значение","Увеличивает значение поля в помощью специальной кнопки","UI.Таблицы.Реквизиты");
	Ванесса.ДобавитьШагВМассивТестов(ВсеТесты,"ВТаблицеВПолеСИменемЯУвеличиваюЗначение(Парам01,Парам02)","ВТаблицеВПолеСИменемЯУвеличиваюЗначение","И в таблице ""ИмяТаблицы"" в поле с именем ""ИмяПоля"" я увеличиваю значение","Увеличивает значение поля в помощью специальной кнопки","UI.Таблицы.Реквизиты");
	Ванесса.ДобавитьШагВМассивТестов(ВсеТесты,"ВТаблицеВПолеЯУменьшаюЗначение(Парам01,Парам02)","ВТаблицеВПолеЯУменьшаюЗначение","И в таблице ""ИмяТаблицы"" в поле ""ИмяПоля"" я уменьшаю значение","Уменьшает значение поля в помощью специальной кнопки","UI.Таблицы.Реквизиты");
	Ванесса.ДобавитьШагВМассивТестов(ВсеТесты,"ВТаблицеВПолеСИменемЯУменьшаюЗначение(Парам01,Парам02)","ВТаблицеВПолеСИменемЯУменьшаюЗначение","И в таблице ""ИмяТаблицы"" в поле с именем ""ИмяПоля"" я уменьшаю значение","Уменьшает значение поля в помощью специальной кнопки","UI.Таблицы.Реквизиты");
	
	
	Ванесса.ДобавитьШагВМассивТестов(ВсеТесты,"ВТаблицеЯПерехожуКСледующейЯчейке(Парам01)","ВТаблицеЯПерехожуКСледующейЯчейке","И в таблице ""ИмяТаблицы"" я перехожу к следующей ячейке","","");
	Ванесса.ДобавитьШагВМассивТестов(ВсеТесты,"ВТаблицеЯПерехожуКПредыдущейЯчейке(Парам01)","ВТаблицеЯПерехожуКПредыдущейЯчейке","И в таблице ""ИмяТаблицы"" я перехожу к предыдущей ячейке","","");
	...
	Ванесса.ДобавитьШагВМассивТестов(ВсеТесты,"ПредставлениеЭлементаСталоРавно(Парам01,Парам02)","ПредставлениеЭлементаСталоРавно","И представление элемента ""ИмяЭлемента"" стало равно ""ПредставлениеЭлемента""","Проверяет представление элемента формы. Работает, начиная с 8.3.12.","UI.Формы.Поля.Представление элемента");
...
Процедура ОбработичкОжиданияВОткрытойФормеЯЖдуПоявленияЭлементаВТеченииСекунд()
	...
	Если ЭлементФормы = Неопределено Тогда
		Если (ТекущаяДата() - ДатаНачалаОбработкиОжидания) > КоличествоСекундОбработкаОжидания Тогда
			...
			Ванесса.ПродолжитьВыполнениеШагов(Истина,"Ожидали в течение <" + КоличествоСекундОбработкаОжидания + "> секунд появления поля <" + ИмяПоляОбработкаОжидания + ">. Но такой элемент на форме не найден.");
			Возврат;
		КонецЕсли;	 
		Возврат;
	КонецЕсли;	 
	...
	Если (ТекущаяДата() - ДатаНачалаОбработкиОжидания) > КоличествоСекундОбработкаОжидания Тогда
		ОтключитьОбработчикОжидания(ИмяОбработчика);
		Ванесса.ПродолжитьВыполнениеШагов(Истина,"Ожидали в течение <" + КоличествоСекундОбработкаОжидания + "> секунд появления поля <" + ИмяПоляОбработкаОжидания + ">. ТекущаяВидимость=" + ТекущаяВидимость);
		Возврат;
	КонецЕсли;	 
КонецПроцедуры
...
Процедура ОбработичкОжиданияУЭлементаЯЖдуЗначенияВТеченииСекунд()
	...
	Если (ТекущаяДата() - ДатаНачалаОбработкиОжидания) > КоличествоСекундОбработкаОжидания Тогда
		ОтключитьОбработчикОжидания("ОбработичкОжиданияУЭлементаЯЖдуЗначенияВТеченииСекунд");
		Ванесса.ПродолжитьВыполнениеШагов(Истина,"Ожидали в течение <" + КоличествоСекундОбработкаОжидания + "> секунд у поля <" + ИмяПоляОбработкаОжидания + "> значения <" + ЗначениеОбрабткаОжидания + ">. Текущее значение <" + ТекущееЗначение + ">");
		Возврат;
	КонецЕсли;	 
...
Процедура ОткрылосьОкно(Знач ИмяОкна,ЧастьИмени2 = Неопределено
	...
	Иначе	
		Таймаут       = Ванесса.Объект.КоличествоСекундПоискаОкна;
		...
		Если Не ЭтоМодальныйДиалогПлатформы Тогда
			Если АктивноеОкно.Заголовок <> АктивноеОкно2.Заголовок Тогда
				ВызватьИсключение "Ожидали, что активным окном будет <" + ИмяОкна + ">, а нашли <" + АктивноеОкно.Заголовок + ">! Таймаут поиска окна: " + Таймаут;
			КонецЕсли;	 
		КонецЕсли;	 
...
Процедура ОткрыласьФорма(Знач ИмяФормыTestClient,ИскатьПоИмени = Ложь) Экспорт
	...
	Если НужнаяФорма = Неопределено Тогда
		ВызватьИсключение "Форма <" + ИмяФормыTestClient + "> не найдена.";
	КонецЕсли;	 
КонецПроцедуры
...
Процедура ЯЖдуЗакрытияОкнаВТеченииСекундОбработчикОжидания()
	...
	Если (ТекущаяДата() - ДатаНачалаОбработкиОжидания) > КоличествоСекундОбработкаОжидания Тогда
		ОтключитьОбработчикОжидания("ЯЖдуЗакрытияОкнаВТеченииСекундОбработчикОжидания");
		Ванесса.ПродолжитьВыполнениеШагов(Истина,"Ожидали в течение <" + КоличествоСекундОбработкаОжидания + "> секунд, что закроется окно с заголовком <" + ЗначениеОбрабткаОжидания + ">");
		Возврат;
	КонецЕсли;	 
КонецПроцедуры
...
Процедура ЯЖдуОткрытияОкнаВТеченииСекундОбработчикОжидания()
	...
	Если (ТекущаяДата() - ДатаНачалаОбработкиОжидания) > КоличествоСекундОбработкаОжидания Тогда
		ОтключитьОбработчикОжидания("ЯЖдуОткрытияОкнаВТеченииСекундОбработчикОжидания");
		Ванесса.ПродолжитьВыполнениеШагов(Истина,"Ожидали в течение <" + КоличествоСекундОбработкаОжидания + "> секунд, что откроется окно с заголовком <" + ЗначениеОбрабткаОжидания + ">");
		Возврат;
	КонецЕсли;	 
КонецПроцедуры
...
Функция СделатьПереход(ТаблицаСписок,ОписаниеСтроки,ОшибкаПереходВниз,ОшибкаПереходВверх)
	Возврат Ванесса.СделатьПереход(ТаблицаСписок,ОписаниеСтроки,ОшибкаПереходВниз,ОшибкаПереходВверх);
КонецФункции	
...
Функция ПолучитьОшибкуПерехода(ИмяТЧ,ОшибкаПереходВниз,ОшибкаПереходВверх,ТабПарам)
	...
	ТекстСообщения = "Не удалось перейти к нужной строке в таблице <%1>. %2";
...
Функция ПолучитьОписаниеСтрокиИзТаблицы(ТабПарам,ИмяТаблицы = Неопределено)
	Возврат Ванесса.ПолучитьОписаниеСтрокиИзТаблицы(ТабПарам,ИмяТаблицы);
КонецФункции	
...
Процедура ВОткрытойФормеЯОткрываюВыпадающийСписокСЗаголовком(ИмяРеквизита,ИскатьПоИмени = Ложь) Экспорт
	...
	Если НЕ Нашли Тогда
		Если ИскатьПоИмени Тогда
			ТекстСообщения = "Выпадающий список с именем <%1> не найден!";
		Иначе	
			ТекстСообщения = "Выпадающий список с заголовком <%1> не найден!";
		КонецЕсли;	 
	...
	Если НЕ Нашли Тогда
		Если ДопПараметры.Свойство("АктивноеОкно") Тогда
			Если ДопПараметры.АктивноеОкно <> Неопределено Тогда
				Если ДопПараметры.АктивноеОкно.Заголовок = "1С:Предприятие" Тогда
...
Процедура ВОткрытойФормеЯМеняюЗначениеПереключателяСЗаголовкомНа(ИмяРеквизита,Значение,ИскатьПоИмени = Ложь) Экспорт
	...
	Если НЕ Нашли Тогда
		Если ИскатьПоИмени Тогда
			ТекстСообщения = "Переключатель с именем <%1> не найден!";
		Иначе	
			ТекстСообщения = "Переключатель с заголовком <%1> не найден!";
		КонецЕсли;	 
		ТекстСообщения = СтрЗаменить(ТекстСообщения,"%1",ИмяРеквизита); 
...
Процедура ВОткрытойФормеВТЧЯНажимаюНаКнопкуСЗаголовком(ИмяТЧ,ИмяКнопки,ИскатьПоИмени = Ложь) Экспорт
	...
	Если Не НашлиТЧ Тогда
		ТекстСообщения = "ТЧ с именем <%1> не найдена!";
		ТекстСообщения = СтрЗаменить(ТекстСообщения,"%1",ИмяТЧ); 
...
Процедура ВОткрытойФормеВТЧВПолеСЗаголовкомЯВвожуТекст(ИмяТЧ,ИмяРеквизита,Знач Текст,ИскатьПоИмени = Ложь) Экспорт
	...
	Если ПолеРеквизит = Неопределено Тогда
		Если ИскатьПоИмени Тогда
			ТекстСообщения = "Поле с именем <%1> не найдено!";
		Иначе	
			ТекстСообщения = "Поле с заголовком <%1> не найдено!";
		КонецЕсли;	 
		ТекстСообщения = СтрЗаменить(ТекстСообщения,"%1",ИмяРеквизита); 
...
Процедура ВОткрытойФормеЯПерехожуКЗакладкеСЗаголовком(ИмяЗакладки,ИскатьПоИмени = Ложь) Экспорт
	...
	Если НЕ Нашли Тогда
		Если ИскатьПоИмени Тогда
			ТекстСообщения = "Закладка с именем <%1> не найдена!";
		Иначе	
			ТекстСообщения = "Закладка с заголовком <%1> не найдена!";
		КонецЕсли;	 
...
Процедура ВОткрытойФормеЯСворачиваюГруппуСЗаголовком(ИмяГруппы,ИскатьПоИмени = Ложь) Экспорт
	...
	Если НЕ Нашли Тогда
		Если ИскатьПоИмени Тогда
			ТекстСообщения = "Группа с именем <%1> не найдена!";
		Иначе	
			ТекстСообщения = "Группа с заголовком <%1> не найдена!";
		КонецЕсли;	 
...
Процедура ВОткрытойФормеЯНажимаюНаГиперссылкуСЗаголовком(ИмяРеквизита,ИскатьПоИмени = Ложь) Экспорт
	...
	ДопПараметры = Новый Структура;
	ДопПараметры.Вставить("ИскатьТолькоПоляНадписей",Истина);
	ПолеГиперссылка = Ванесса.НайтиРеквизитОткрытойФормыПоЗаголовку(ИмяРеквизита,ИскатьПоИмени,,,ДопПараметры);	
...
Процедура ТекстЯчейкиТаблицыСталРавен(ИмяТЧ,ИмяЭлемента,Знач СтроковоеПредставление) Экспорт
...
Процедура ТаблицаСталаРавнойМакету(ИмяТЧ,ИмяМакета,СравнениеПоШаблону = Ложь) Экспорт
	...
	Для Ккк = 1 По ТабДокБыло.ВысотаТаблицы-1 Цикл //в первой строке шапка
		...
		Для каждого ИмяКолонкиСтарое Из МассивКолонок Цикл
			...
			Если НЕ СравнениеПоШаблону Тогда
				Если ЗначНовое <> ЗначСтарое Тогда
					Ванесса.АктивизироватьЭлементформы(ТЧ);
					ВызватьИсключение "Таблица " + ИмяТЧ + ". Строка № " + (Ккк) + ". Колонка " + ИмяКолонкиСтарое + ". Ожидали <" + ЗначСтарое + ">, а получили <" + ЗначНовое + ">";
				КонецЕсли;	 
			Иначе
				Если Не Ванесса.СтрокаСоответствуетШаблону(ЗначНовое,ЗначСтарое) Тогда
					Ванесса.АктивизироватьЭлементформы(ТЧ);
...
Процедура ТаблицаРавнаМакетуПоШаблону(ИмяТЧ,ИмяМакета) Экспорт
	ТаблицаСталаРавнойМакету(ИмяТЧ,ИмяМакета,Истина);
КонецПроцедуры
...
Функция УбратьВсеЗапрещенныеСимволы(Знач Стр)
	...
	Цифры = "1234567890";
	Если Найти(Цифры,Лев(Стр,1)) > 0 Тогда
		Стр = "_" + Стр;
	КонецЕсли;		
...
Функция ПолучитьТЗТекущихДанных(ЗначениеТЧ)
	...
	Если ТЗСтало = Неопределено Тогда
		ВызватьИсключение "Не смог получить строки таблицы.";
	КонецЕсли;	 
...
Процедура ТаблицаФормыСИменемСодержитСтроки(ИмяТЧ,ТабПарам) Экспорт
	...
	Если КоличествоСтрокТаблицы = 0 Тогда
		ВызватьИсключение "Не смог получить строки таблицы <" + ИмяТЧ + ">";
	КонецЕсли;	 
...
Процедура ВПанелиРазделовЯВыбираю(ИмяКнопки) Экспорт
	...
	Если КнопкаКомандногоИнтерфейса = Неопределено Тогда
		ТекстСообщения = "Кнопка панели разделов <%1> не найдена!";
		ТекстСообщения = СтрЗаменить(ТекстСообщения,"%1",ИмяКнопки); 
		Сообщить(ТекстСообщения);
		ВызватьИсключение ТекстСообщения;
	КонецЕсли;	 
...
Процедура ВПанелиФункцийЯВыбираю(ИмяКнопки) Экспорт
	...
	Если КнопкаКомандногоИнтерфейса = Неопределено Тогда
		ТекстСообщения = "Команда меню <%1> не найдена в панели функций!";
		ТекстСообщения = СтрЗаменить(ТекстСообщения,"%1",ИмяКнопки); 
		Сообщить(ТекстСообщения);
		ВызватьИсключение ТекстСообщения;
	КонецЕсли;	 
...
Процедура ВПанелиОткрытыхЯВыбираю(ИмяКнопки) Экспорт
	...
	КнопкаКомандногоИнтерфейса = ПанельРазделов.НайтиОбъект(Тип("ТестируемаяКнопкаКомандногоИнтерфейса"), ИмяКнопки,,10);
	Если КнопкаКомандногоИнтерфейса = Неопределено Тогда
		ТекстСообщения = "Кнопка панели открытых окон <%1> не найдена!";
		ТекстСообщения = СтрЗаменить(ТекстСообщения,"%1",ИмяКнопки); 
		Сообщить(ТекстСообщения);
		ВызватьИсключение ТекстСообщения;
	КонецЕсли;	 
...
Процедура ТабличныйДокументФормыСИменемСталРавен(ИмяРеквизита,ТабПарамБыло,СталПустым = Ложь,ДопПараметры = Неопределено) Экспорт
	...
	Для каждого ТекущаяФорма Из МассивФорм Цикл
		...
		Если СталПустым Тогда
			Если ТабДокСтало.Количество() = 0 Тогда
				Возврат;
			Иначе
				ТекстСообщения = "В табличном документе %1 строк, а ожидалось, что он пустой.";
		...
		Если ТабДокСтало.Количество() <> ТабПарамБыло.Количество() Тогда
			ТекстСообщения = "В табличном документе %1 строк, а ожидалось %2 строк.";
			ТекстСообщения = СтрЗаменить(ТекстСообщения,"%1",ТабДокСтало.Количество()); 
		...
		Для каждого СтрСтало Из ТабДокСтало Цикл
			...
			Если СтрСтало.Количество() <> СтрБыло.Количество() Тогда
				ТекстСообщения = "В табличном документе %1 колонок, а ожидалось %2 колонок.";
			...
			Для каждого ЗнСтало Из СтрСтало Цикл
				...
				Если НЕ СравнениеПоШаблону Тогда
					Если ЗнСтало <> ЗнБыло Тогда
						Если ЗнБыло <> "*" Тогда
							ТекстСообщения = "В табличном документе в колонке №%1 значение= <%2> , а ожидалось <%3>";
	...
	Если НЕ Нашли Тогда
		ТекстСообщения = "Элемент формы с именем <%1> не найден!";
		ТекстСообщения = СтрЗаменить(ТекстСообщения,"%1",ИмяРеквизита); 
		Сообщить(ТекстСообщения);
		ВызватьИсключение ТекстСообщения;
	КонецЕсли;	 
...
Процедура ТабличныйДокументФормыСИменемСодержитСтроки(ИмяРеквизита,ТабПарамБыло) Экспорт
	...
	Для каждого СтрБыло Из ТабПарамБыло Цикл
		...
		Если НЕ СтрокаСовпала Тогда
			ТекстСообщения = "Строка №%1 не найдена в табличном документе на форме";
...
Процедура ЯЗакрываюОкноСЗаголовком(ЗаголовокОкна) Экспорт
	...
	Если ОкноПриложения = Неопределено Тогда
		ТекстСообщения = "Окно с заголовком <%1> не найдено!";
...
Процедура ВОткрытойФормеВТаблицеСИменемВКолонкеНетЗначения(ИмяТЧ,ИмяКолонки,ПроверяемоеЗначение) Экспорт
	...
	Для каждого СтрокаТЧ Из ЗначениеТЧ Цикл
		...
		Если Значение = Неопределено Тогда
			ТекстСообщения = "В таблице <%1>  нет колонки <%2>";
			ТекстСообщения = СтрЗаменить(ТекстСообщения,"%1",ИмяТЧ); 
		...
		Если Значение = ПроверяемоеЗначение Тогда
			ТекстСообщения = "В таблице <%1> в строке №%2 найдено значение %3, а его не должно было быть.";
			ТекстСообщения = СтрЗаменить(ТекстСообщения,"%1",ИмяТЧ); 
...
Процедура ВОткрытойФормеВТаблицеСИменемВКолонкеЕстьЗначение(ИмяТЧ,ИмяКолонки,ПроверяемоеЗначение) Экспорт
	...
	Если Не Нашли Тогда
		ТекстСообщения = "В таблице <%1>  НЕ найдено значение %2, а оно должно было быть.";
		ТекстСообщения = СтрЗаменить(ТекстСообщения,"%1",ИмяТЧ); 
...
Процедура ВОткрытойФормеВТЧЯАктивизируюПоле(ИмяТЧ,ИмяРеквизита,ИскатьПоИмени = Ложь) Экспорт
	...
	Если ПолеРеквизит = Неопределено Тогда
		Если ИскатьПоИмени Тогда
			ТекстСообщения = "В таблице <%1> поле с именем <%2> не найдено!";
		Иначе	
			ТекстСообщения = "В таблице <%1> поле с заголовком <%2> не найдено!";
		КонецЕсли;	 
		ТекстСообщения = СтрЗаменить(ТекстСообщения,"%1",ИмяТЧ); 
...
Процедура ЯБудуВыбиратьВнешнийФайл(Знач ИмяФайла) Экспорт
	...
	Если Лев(ИмяФайла,1) = "$" и Прав(ИмяФайла,1) = "$" Тогда
		...
		ИмяФайла = Контекст[ИмяПеременной];
	КонецЕсли;	 
...
Процедура ЯЗапоминаюЗначениеТаблицыПоляКак(ИмяТЧ,ИмяПоля,ИмяПеременной,ИскатьПоИмени = Ложь) Экспорт
	...
	Исключение
		ВызватьИсключение "Не смог получить значение поля <" + ИмяПоля + "> у таблицы <" + ИмяТЧ + ">." + Символы.ПС + ОписаниеОшибки();
	КонецПопытки;
	Контекст.Вставить(ИмяПеременной,Значение);
КонецПроцедуры
...
Процедура КоличествоСтрокТаблицыРавноПеременной(ИмяТаблицы,ИмяПеременной) Экспорт
	...
	Если Таблица.Количество() <> ЗначениеВКонтексте Тогда
		ВызватьИсключение "Ожидали, что количество строк таблицы <" + ИмяТаблицы + "> будет равно переменной <" + ИмяПеременной + ">. Значение переменной <" + ЗначениеВКонтексте + ">. Количество строк <" + Таблица.Количество() + ">";
	КонецЕсли;	 
КонецПроцедуры
...
Процедура ДоступенДляПросмотра(ИмяЭлемента, ИскатьПоИмени = Ложь)
	...
	Если НЕ Нашли Тогда
		Если ИскатьПоИмени Тогда
			ТекстСообщения = "Элемент с именем <%1> доступен только для просмотра";
		Иначе
			ТекстСообщения = "Элемент с заголовком <%1> доступен только для просмотра";
		КонецЕсли;
...
Процедура ВОткрытойФормеЯВижуЭлемент(ИмяЭлемента, ИскатьПоИмени = Ложь)
	...
	Если НЕ Нашли Тогда
		Если ИскатьПоИмени Тогда
			ТекстСообщения = "Элемент с именем <%1> не виден на текущей форме";
		Иначе
			ТекстСообщения = "Элемент с заголовком <%1> не виден на текущей форме";
		КонецЕсли;
		ТекстСообщения = СтрЗаменить(ТекстСообщения,"%1",ИмяЭлемента); 
		Сообщить(ТекстСообщения);
		ВызватьИсключение ТекстСообщения;
...
Процедура ВОткрытойФормеЯНеВижуЭлемент(ИмяЭлемента, ИскатьПоИмени = Ложь)
	...
	Если ТекущаяВидимость Тогда
		Если ИскатьПоИмени Тогда
			ТекстСообщения = "Элемент с именем <%1> виден на текущей форме";
		Иначе
			ТекстСообщения = "Элемент с заголовком <%1> виден на текущей форме";
		КонецЕсли;
		ТекстСообщения = СтрЗаменить(ТекстСообщения,"%1",ИмяЭлемента); 
		Сообщить(ТекстСообщения);
		ВызватьИсключение ТекстСообщения;
...
Процедура ЯПроверяюДоступностьЭлементаФормы(ИмяЭлемента, ИскатьПоИмени = Ложь)
	...
	Если НЕ Нашли Тогда
		Если ИскатьПоИмени Тогда
			ТекстСообщения = "Элемент с именем <%1> не доступен на форме";
		Иначе	
			ТекстСообщения = "Элемент с заголовком <%1> не доступен на форме";
		КонецЕсли;
		ТекстСообщения = СтрЗаменить(ТекстСообщения,"%1",ИмяЭлемента); 
		Сообщить(ТекстСообщения);
		ВызватьИсключение ТекстСообщения;
...
Процедура ЯПроверяюНеДоступностьЭлементаФормы(ИмяЭлемента, ИскатьПоИмени = Ложь)
	...
	Если Нашли Тогда
		Если ИскатьПоИмени Тогда
			ТекстСообщения = "Элемент с именем <%1> доступен на форме";
		Иначе	
			ТекстСообщения = "Элемент с заголовком <%1> доступен на форме";
		КонецЕсли;
		ТекстСообщения = СтрЗаменить(ТекстСообщения,"%1",ИмяЭлемента); 
		Сообщить(ТекстСообщения);
		ВызватьИсключение ТекстСообщения;
...
Процедура ВТЧПолеДоступноНеТолькоДляПросмотра(ИмяТЧ,ИмяРеквизита,ИскатьПоИмени = Ложь) Экспорт
	...
	Если Нашли Тогда
		Если ИскатьПоИмени Тогда
			ТекстСообщения = "Элемент с именем <%1> доступен не только для просмотра";
		Иначе
			ТекстСообщения = "Элемент с заголовком <%1> доступен не только для просмотра";
		КонецЕсли;
		ТекстСообщения = СтрЗаменить(ТекстСообщения,"%1",ИмяРеквизита); 
		Сообщить(ТекстСообщения);
		ВызватьИсключение ТекстСообщения;
...
Процедура ВТабличномДокументеЯчейкаСАдресомРавна(ИмяРеквизита,АдресЯчейки,Значение) Экспорт
	ЭлементФормы = Ванесса.НайтиРеквизитОткрытойФормыПоЗаголовку(ИмяРеквизита,Истина);
	ТекстОбласти = ЭлементФормы.ПолучитьТекстОбласти(АдресЯчейки);
	
	Если ТекстОбласти <> Значение Тогда
		ВызватьИсключение "Ожидали, что у табличного документа <" + ИмяРеквизита + "> в ячейке с адресом <" + АдресЯчейки + "> будет значение <" + Значение + ">, а получили <" + ТекстОбласти + "> ";
	КонецЕсли;	 
КонецПроцедуры
...
Процедура ОбработичкОжиданияЯЖдуЧтоВТаблицеКоличествоСтрокБудетВТеченииСекунд()
	...
	Если (ТекущаяДата() - ДатаНачалаОбработкиОжидания) > КоличествоСекундОбработкаОжидания Тогда
		ОтключитьОбработчикОжидания("ОбработичкОжиданияЯЖдуЧтоВТаблицеКоличествоСтрокБудетВТеченииСекунд");
		Ванесса.ПродолжитьВыполнениеШагов(Истина,"Ожидали в течение <" + КоличествоСекундОбработкаОжидания + "> секунд у таблицы <" + ИмяТаблицыОбработкаОжидания + "> количество строк " + ВидСравненияОбрабткаОжидания + " " + КоличествоСтрокОбработкаОжидания + ". Текущее количество строк <" + МассивСтрок.Количество() + ">");
		Возврат;
	КонецЕсли;
...
Процедура ТабличныйДокументСодержитЗначенияОбластей(ИмяЭлементаФормы,ТабПарам) Экспорт
	...
	Если МассивРасхождений.Количество() > 0 Тогда
		...
		СтрокаОшибки = Вычислить("СтрСоединить(МассивРасхождений, Символы.ПС)");
...
Процедура ТабличныйДокументСодержитЗначенияОбластейПоШаблону(ИмяЭлементаФормы,ТабПарам) Экспорт
	...
	Если МассивРасхождений.Количество() > 0 Тогда
		...
		МассивРасхождений.Вставить(0, СтрокаОшибки);
		СтрокаОшибки = СтрСоединить(МассивРасхождений, Символы.ПС);
		ВызватьИсключение СтрокаОшибки;
	КонецЕсли;
...
Процедура ОбработичкОжиданияЯЖдуЧтоПолеПерестанетБытьПустымВТеченииСекунд()
	...
	Если (ТекущаяДата() - ДатаНачалаОбработкиОжидания) > КоличествоСекундОбработкаОжидания Тогда
		ОтключитьОбработчикОжидания(ИмяОбработчикаОжидания);
		Ванесса.ПродолжитьВыполнениеШагов(Истина,"Ожидали в течение <" + КоличествоСекундОбработкаОжидания + "> секунд, что поле <" + ИмяПоляОбработкаОжидания + "> будет заполненным.");
		Возврат;
	КонецЕсли;
...
Процедура ВТаблицеВПолеЯУвеличиваюЗначение(ИмяТЧ,ИмяРеквизита,ИскатьПоИмени = Ложь) Экспорт
	...
	Если ПолеРеквизит = Неопределено Тогда
		ВызватьИсключение "Реквизит <" + ИмяРеквизита + "> не найден.";
	КонецЕсли;	 
...
Процедура ПредставлениеЭлементаСталоРавно(ИмяРеквизита,ПредставлениеЭлемента,ИскатьПоИмени = Ложь) Экспорт
	...
	Если НРег(ОтображаемыйТекст) <> НРег(ПредставлениеЭлемента) Тогда
		ВызватьИсключение "У поля <" + ИмяРеквизита + "> ожидали отображаемый текст <" + ПредставлениеЭлемента + ">, а получили <" + ОтображаемыйТекст + ">";
	КонецЕсли;	 
КонецПроцедуры
