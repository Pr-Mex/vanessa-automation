...
Функция ПолучитьСписокТестов(КонтекстФреймворкаBDD) Экспорт
	...
	Ванесса.ДобавитьШагВМассивТестов(ВсеТесты,"ОткрыласьФорма(Парам01)","ОткрыласьФорма","Тогда открылась форма с именем ""Справочник.Справочник1.Форма.ФормаЭлемента""","Проверяет, что на экране есть активное окно с нужной формой","UI.Окна");
...
Процедура УЭлементаФормыСИменемТекстРедактированияСталРавен(ИмяЭлемента,НужныйТекстРедактирования) Экспорт
	...
	Если НЕ ЗначениеЗаполнено(ТекТекстРедактирования) Тогда
		Попытка
