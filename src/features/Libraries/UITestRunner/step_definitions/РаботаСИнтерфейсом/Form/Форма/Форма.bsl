...
Функция ПолучитьСписокТестов(КонтекстФреймворкаBDD) Экспорт
	...
	Ванесса.ДобавитьШагВМассивТестов(ВсеТесты,"ЯИзменяюФлаг(Парам01)","ЯИзменяюФлаг","И     я изменяю флаг ""Реквизит булево""");
	...
	Ванесса.ДобавитьШагВМассивТестов(ВсеТесты,"ЯИзменяюФлагСИменем(Парам01)","ЯИзменяюФлагСИменем","И     я изменяю флаг с именем ""Реквизит булево""");
	...
	Ванесса.ДобавитьШагВМассивТестов(ВсеТесты,"ЯСнимаюФлаг(Парам01)","ЯСнимаюФлаг","И     я снимаю флаг ""Реквизит булево""","Устанавилвает флаг в Ложь","UI.Флаги");
	...
	Ванесса.ДобавитьШагВМассивТестов(ВсеТесты,"ЯСнимаюФлагСИменем(Парам01)","ЯСнимаюФлагСИменем","И     я снимаю флаг с именем ""Реквизит булево""");
	...
	Ванесса.ДобавитьШагВМассивТестов(ВсеТесты,"ЯУстанавливаюФлаг(Парам01)","ЯУстанавливаюФлаг","И     я устанавливаю флаг ""Реквизит булево""","Устанавилвает флаг в Истина","UI.Флаги");
	...
	Ванесса.ДобавитьШагВМассивТестов(ВсеТесты,"ЯУстанавливаюФлагСИменем(Парам01)","ЯУстанавливаюФлагСИменем","И     я устанавливаю флаг с именем ""Реквизит булево""");
	...
	Ванесса.ДобавитьШагВМассивТестов(ВсеТесты,"ЯОжидаюПоявленияВТекущейФормеЭлементаВТечениеСекунд(Парам01, Парам02)", "ЯОжидаюПоявленияВТекущейФормеЭлементаВТечениеСекунд","И я ожидаю появления в текущей форме элемента ""Имя элемента"" в течение ""Таймаут"" секунд");
	Ванесса.ДобавитьШагВМассивТестов(ВсеТесты,"ЯОжидаюПоявленияВТекущейФормеЭлементаСИменемВТечениеСекунд(Парам01, Парам02)", "ЯОжидаюПоявленияВТекущейФормеЭлементаСИменемВТечениеСекунд","И я ожидаю появления в текущей форме элемента с именем ""Имя элемента"" в течение ""Таймаут"" секунд");
...
&НаКлиенте
Процедура ЯОжидаюПоявленияВТекущейФормеЭлемента(ИмяЭлемента, Таймаут, ИскатьПоИмени = Ложь)
	...
	Если ИскатьПоИмени Тогда
		ЭлементФормы = АктивнаяФорма.НайтиОбъект(,, ИмяЭлемента, Таймаут);
	Иначе
		ЭлементФормы = АктивнаяФорма.НайтиОбъект(, ИмяЭлемента,, Таймаут);
	КонецЕсли;
...
&НаКлиенте
//И я ожидаю появления в текущей форме элемента "Имя элемента" в течение "Таймаут" секунд
//@ЯОжидаюПоявленияВТекущейФормеЭлементаВТечениеСекунд()
Процедура ЯОжидаюПоявленияВТекущейФормеЭлементаВТечениеСекунд(Парам01, Парам02) Экспорт
	ЯОжидаюПоявленияВТекущейФормеЭлемента(Парам01, Парам02);
КонецПроцедуры

&НаКлиенте
//И я ожидаю появления в текущей форме элемента с именем "Имя элемента" в течение "Таймаут" секунд
//@ЯОжидаюПоявленияВТекущейФормеЭлементаСИменемВТечениеСекунд()
Процедура ЯОжидаюПоявленияВТекущейФормеЭлементаСИменемВТечениеСекунд(Парам01, Парам02) Экспорт
	ЯОжидаюПоявленияВТекущейФормеЭлемента(Парам01, Парам02, Истина);
КонецПроцедуры
