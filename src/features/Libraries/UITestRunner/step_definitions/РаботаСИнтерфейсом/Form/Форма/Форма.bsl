...
Функция ПолучитьСписокТестов(КонтекстФреймворкаBDD) Экспорт
	...
	Ванесса.ДобавитьШагВМассивТестов(ВсеТесты,"ВОткрытойФормеВТЧИзВыпадающегоСпискаЯВыбираюСВыбором(Парам01,Парам02,Парам03)","ВОткрытойФормеВТЧИзВыпадающегоСпискаЯВыбираюСВыбором","В открытой форме в ТЧ ""ТабличнаяЧасть1"" из выпадающего списка ""Реквизит справочник"" я выбираю ""ТестовыйЭлемент21"" с выбором",,"");//устаревшее
	Ванесса.ДобавитьШагВМассивТестов(ВсеТесты,"ВТЧИзВыпадающегоСпискаЯВыбираюСВыбором(Парам01,Парам02,Парам03)","ВТЧИзВыпадающегоСпискаЯВыбираюСВыбором","В ТЧ ""ТабличнаяЧасть1"" из выпадающего списка ""Реквизит справочник"" я выбираю ""ТестовыйЭлемент21"" с выбором","Выбор из выпадающего списка в ТЧ с дополнительным вызовом метода Выбрать(). Применялось на 8.3.6.","UI.ТЧ.Прочее");
	
	Ванесса.ДобавитьШагВМассивТестов(ВсеТесты,"ВФормеВТЧЯЗавершаюРедактированиеСтроки(Парам01,Парам02)","ВФормеВТЧЯЗавершаюРедактированиеСтроки","В форме ""Справочник1"" в ТЧ ""ТабличнаяЧасть1"" я завершаю редактирование строки","Завершение редактирования строки с указанием ТЧ","UI.ТЧ.Прочее");
	Ванесса.ДобавитьШагВМассивТестов(ВсеТесты,"ЯЗавершаюРедактированиеСтроки()","ЯЗавершаюРедактированиеСтроки","Я завершаю редактирование строки","Завершение редактирования строки","UI.ТЧ.Прочее");
	
	Ванесса.ДобавитьШагВМассивТестов(ВсеТесты,"ВОткрытойФормеВТЧЯНажимаюКнопкуВыбораУРеквизитаСЗаголовком(Парам01,Парам02)","ВОткрытойФормеВТЧЯНажимаюКнопкуВыбораУРеквизитаСЗаголовком","В открытой форме в ТЧ ""ДокументыПоВидам"" я нажимаю кнопку выбора у реквизита с заголовком ""Скан""","","");//устаревшее
	...
	Ванесса.ДобавитьШагВМассивТестов(ВсеТесты,"ВТЧЯНажимаюКнопкуВыбораУРеквизита(Парам01,Парам02)","ВТЧЯНажимаюКнопкуВыбораУРеквизита","В ТЧ ""ДокументыПоВидам"" я нажимаю кнопку выбора у реквизита ""Скан""","Нажатие кнопки выбора у реквизита в ТЧ","UI.ТЧ.Прочее");
	...
	Ванесса.ДобавитьШагВМассивТестов(ВсеТесты,"ВОткрытойФормеВТЧЯПерехожуНаОднуСтрокуВнизСВыделением(Парам01)","ВОткрытойФормеВТЧЯПерехожуНаОднуСтрокуВнизСВыделением","И     В открытой форме в ТЧ  ""Список"" я перехожу на одну строку вниз с выделением", "Переходим в ТЧ на следующую строку с выделением", "UI.ТЧ.Переход к строке");
	Ванесса.ДобавитьШагВМассивТестов(ВсеТесты,"ВОткрытойФормеВТЧЯПерехожуНаОднуСтрокуВверхСВыделением(Парам01)","ВОткрытойФормеВТЧЯПерехожуНаОднуСтрокуВверхСВыделением","И     В открытой форме в ТЧ  ""Список"" я перехожу на одну строку вверх с выделением", "Переходим в ТЧ на предыдущую строку с выделением", "UI.ТЧ.Переход к строке");
	
	Ванесса.ДобавитьШагВМассивТестов(ВсеТесты,"ВОткрытойФормеВТЧЯПерехожуНаПервуюСтроку(Парам01)","ВОткрытойФормеВТЧЯПерехожуНаПервуюСтроку","И     В открытой форме в ТЧ  ""Список"" я перехожу на первую строку", "Переходим в ТЧ на первую строку", "UI.ТЧ.Переход к строке");
	Ванесса.ДобавитьШагВМассивТестов(ВсеТесты,"ВОткрытойФормеВТЧЯПерехожуНаПоследнююСтроку(Парам01)","ВОткрытойФормеВТЧЯПерехожуНаПоследнююСтроку","И     В открытой форме в ТЧ  ""Список"" я перехожу на последнюю строку", "Переходим в ТЧ на последнюю строку", "UI.ТЧ.Переход к строке");
	
	
	Ванесса.ДобавитьШагВМассивТестов(ВсеТесты,"ВТЧЯПерехожуНаОднуСтрокуВниз(Парам01)","ВТЧЯПерехожуНаОднуСтрокуВниз","И     в ТЧ  ""Список"" я перехожу на одну строку вниз", "Переходим в ТЧ на следующую строку", "UI.ТЧ.Переход к строке");
	Ванесса.ДобавитьШагВМассивТестов(ВсеТесты,"ВТЧЯПерехожуНаОднуСтрокуВверх(Парам01)","ВТЧЯПерехожуНаОднуСтрокуВверх","И     в ТЧ  ""Список"" я перехожу на одну строку вверх", "Переходим в ТЧ на предыдущую строку", "UI.ТЧ.Переход к строке");
	...
	Ванесса.ДобавитьШагВМассивТестов(ВсеТесты,"ВФормеВТаблицеЯПерехожуКСтроке(Парам01,Парам02,ТабПарам)","ВФормеВТаблицеЯПерехожуКСтроке","И     В форме ""Справочник2"" в таблице ""Список"" я перехожу к строке:","Переход к нужной строке данной таблицы","UI.ТЧ.Переход к строке");
	Ванесса.ДобавитьШагВМассивТестов(ВсеТесты,"ВФормеВТЧЯВыбираюТекущуюСтроку(Парам01,Парам02)","ВФормеВТЧЯВыбираюТекущуюСтроку","И     В форме ""Справочник2"" в ТЧ ""Список"" я выбираю текущую строку","Выбор текущей строки с указанием ТЧ","UI.ТЧ.Прочее");
...
Процедура ТаблицаФормыСИменемСодержитСтроки(ИмяТЧ,ТабПарам) Экспорт
	...
	Если ТабПарам.Количество() < 2 Тогда	// шапка + строка данных
		ВызватьИсключение "Должно быть передано хотя бы 1 строка содержащая данные для проверки.";
	КонецЕсли;
