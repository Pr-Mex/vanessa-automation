...
Функция ПолучитьСписокТестов(КонтекстФреймворкаBDD) Экспорт
	...
	Ванесса.ДобавитьШагВМассивТестов(ВсеТесты,"ВТаблицеВПолеЯУвеличиваюЗначение(Парам01,Парам02)","ВТаблицеВПолеЯУвеличиваюЗначение","И в таблице ""ТабличнаяЧасть1"" в поле ""ИмяПоля"" я увеличиваю значение","Увеличивает значение поля в помощью специальной кнопки","UI.Таблицы.Реквизиты");
	Ванесса.ДобавитьШагВМассивТестов(ВсеТесты,"ВТаблицеВПолеСИменемЯУвеличиваюЗначение(Парам01,Парам02)","ВТаблицеВПолеСИменемЯУвеличиваюЗначение","И в таблице ""ТабличнаяЧасть1"" в поле с именем ""ИмяПоля"" я увеличиваю значение","Увеличивает значение поля в помощью специальной кнопки","UI.Таблицы.Реквизиты");
	Ванесса.ДобавитьШагВМассивТестов(ВсеТесты,"ВТаблицеВПолеЯУменьшаюЗначение(Парам01,Парам02)","ВТаблицеВПолеЯУменьшаюЗначение","И в таблице ""ТабличнаяЧасть1"" в поле ""ИмяПоля"" я уменьшаю значение","Уменьшает значение поля в помощью специальной кнопки","UI.Таблицы.Реквизиты");
	Ванесса.ДобавитьШагВМассивТестов(ВсеТесты,"ВТаблицеВПолеСИменемЯУменьшаюЗначение(Парам01,Парам02)","ВТаблицеВПолеСИменемЯУменьшаюЗначение","И в таблице ""ТабличнаяЧасть1"" в поле с именем ""ИмяПоля"" я уменьшаю значение","Уменьшает значение поля в помощью специальной кнопки","UI.Таблицы.Реквизиты");
