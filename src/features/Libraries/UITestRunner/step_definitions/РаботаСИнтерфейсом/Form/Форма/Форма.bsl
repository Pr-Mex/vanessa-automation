...
Функция ПолучитьСписокТестов(КонтекстФреймворкаBDD) Экспорт
	...
	Ванесса.ДобавитьШагВМассивТестов(ВсеТесты,"ЯУдаляюВсеСтрокиТаблицы(Парам01)","ЯУдаляюВсеСтрокиТаблицы","И я удаляю все строки таблицы ""График""","Очистить таблицу","UI.Таблицы.Прочее");
	...
	Ванесса.ДобавитьШагВМассивТестов(ВсеТесты,"ВТаблицеСИменемЯВыделяюВсеСтроки(Парам01)","ВТаблицеСИменемЯВыделяюВсеСтроки","Тогда в таблице с именем ""Список"" я выделяю все строки", "Выделение всех строк в таблице", "UI.Таблицы.Выделение строк");
	...
	Ванесса.ДобавитьШагВМассивТестов(ВсеТесты,"ВФормеВТаблицеЯПерехожуКСтроке(Парам01,Парам02,ТабПарам)","ВФормеВТаблицеЯПерехожуКСтроке","И     В форме ""Справочник2"" в таблице ""Список"" я перехожу к строке:" + Символы.ПС + "		| Наименование |" + Символы.ПС + "		|    Товар1    |","Переход к нужной строке данной таблицы","UI.Таблицы.Переход к строке");
	Ванесса.ДобавитьШагВМассивТестов(ВсеТесты,"ВФормеВТаблицеЯРазворачиваюСтроку(Парам01,Парам02,ТабПарам)","ВФормеВТаблицеЯРазворачиваюСтроку","И     В форме ""Справочник2"" в таблице ""Список"" я разворачиваю строку:" + Символы.ПС + "		| Наименование |" + Символы.ПС + "		|    Товар1    |","Развернуть группу строк","UI.Таблицы.Развернуть/Свернуть");
	Ванесса.ДобавитьШагВМассивТестов(ВсеТесты,"ВФормеВТаблицеЯСворачиваюСтроку(Парам01,Парам02,ТабПарам)","ВФормеВТаблицеЯСворачиваюСтроку","И     В форме ""Справочник2"" в таблице ""Список"" я сворачиваю строку:" + Символы.ПС + "		| Наименование |" + Символы.ПС + "		|    Товар1    |","Свернуть группу строк","UI.Таблицы.Развернуть/Свернуть");
	...
	Ванесса.ДобавитьШагВМассивТестов(ВсеТесты,"ЯЗапоминаюЗначениеПоляКак(Парам01,Парам02)","ЯЗапоминаюЗначениеПоляКак","И     я запоминаю значение поля ""Номер"" как ""НомерДокумента""","Сохранение значения поля в переменную Контекст","Прочее");
	Ванесса.ДобавитьШагВМассивТестов(ВсеТесты,"ВПолеВвожуЗначениеПеременной(Парам01,Парам02)","ВПолеВвожуЗначениеПеременной","И     в поле ""Номер"" ввожу значение переменной ""НомерДокумента""", "Вставка значения ранее сохраненной переменной в реквиит", "Прочее");
	Ванесса.ДобавитьШагВМассивТестов(ВсеТесты,"ВПолеСИменемВвожуЗначениеПеременной(Парам01,Парам02)","ВПолеСИменемВвожуЗначениеПеременной","И     в поле с именем ""Номер"" ввожу значение переменной ""НомерДокумента""", "Вставка значения ранее сохраненной переменной в реквиит", "Прочее");
