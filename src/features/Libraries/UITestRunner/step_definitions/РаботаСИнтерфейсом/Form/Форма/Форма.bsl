...
Функция ПолучитьСписокТестов(КонтекстФреймворкаBDD) Экспорт
	...
	Ванесса.ДобавитьШагВМассивТестов(ВсеТесты,"ВОткрытойФормеВТЧИзВыпадающегоСпискаСЗаголовкомЯВыбираюСВыбором(Парам01,Парам02,Парам03)","ВОткрытойФормеВТЧИзВыпадающегоСпискаСЗаголовкомЯВыбираюСВыбором","И В открытой форме в таблице ""ИмяТаблицы"" из выпадающего списка с заголовком ""Реквизит справочник"" я выбираю ""ЗначениеПоля"" с выбором",,"");//устаревшее
	Ванесса.ДобавитьШагВМассивТестов(ВсеТесты,"ВОткрытойФормеВТЧИзВыпадающегоСпискаЯВыбираюСВыбором(Парам01,Парам02,Парам03)","ВОткрытойФормеВТЧИзВыпадающегоСпискаЯВыбираюСВыбором","И В открытой форме в таблице ""ИмяТаблицы"" из выпадающего списка ""Реквизит справочник"" я выбираю ""ЗначениеПоля"" с выбором",,"");//устаревшее
	Ванесса.ДобавитьШагВМассивТестов(ВсеТесты,"ВТЧИзВыпадающегоСпискаЯВыбираюСВыбором(Парам01,Парам02,Парам03)","ВТЧИзВыпадающегоСпискаЯВыбираюСВыбором","И В таблице ""ИмяТаблицы"" из выпадающего списка ""Реквизит справочник"" я выбираю ""ЗначениеПоля"" с выбором","Выбор из выпадающего списка в таблице с дополнительным вызовом метода Выбрать(). Применялось на 8.3.6.","UI.Таблицы.Прочее");
	...
	Ванесса.ДобавитьШагВМассивТестов(ВсеТесты,"ВОткрытойФормеВТЧЯНажимаюКнопкуВыбораУРеквизитаСЗаголовком(Парам01,Парам02)","ВОткрытойФормеВТЧЯНажимаюКнопкуВыбораУРеквизитаСЗаголовком","И В открытой форме в таблице ""ИмяТаблицы"" я нажимаю кнопку выбора у реквизита с заголовком ""Скан""","","");//устаревшее
	Ванесса.ДобавитьШагВМассивТестов(ВсеТесты,"ВОткрытойФормеВТЧЯНажимаюКнопкуВыбораУРеквизита(Парам01,Парам02)","ВОткрытойФормеВТЧЯНажимаюКнопкуВыбораУРеквизита","В открытой форме в таблице ""ИмяТаблицы"" я нажимаю кнопку выбора у реквизита ""Скан""","","");//устаревшее
	Ванесса.ДобавитьШагВМассивТестов(ВсеТесты,"ВТЧЯНажимаюКнопкуВыбораУРеквизита(Парам01,Парам02)","ВТЧЯНажимаюКнопкуВыбораУРеквизита","И В таблице ""ИмяТаблицы"" я нажимаю кнопку выбора у реквизита ""Скан""");
	Ванесса.ДобавитьШагВМассивТестов(ВсеТесты,"ВТаблицеЯНажимаюКнопкуВыбораУРеквизита(Парам01,Парам02)","ВТаблицеЯНажимаюКнопкуВыбораУРеквизита","И В таблице ""ИмяТаблицы"" я нажимаю кнопку выбора у реквизита ""Скан""","Нажатие кнопки выбора у реквизита в ТЧ","UI.Таблицы.Реквизиты");
	Ванесса.ДобавитьШагВМассивТестов(ВсеТесты,"ВТаблицеЯНажимаюКнопкуВыбораУРеквизитаСИменем(Парам01,Парам02)","ВТаблицеЯНажимаюКнопкуВыбораУРеквизитаСИменем","И В таблице ""ИмяТаблицы"" я нажимаю кнопку выбора у реквизита с именем ""Скан""","Нажатие кнопки выбора у реквизита в ТЧ","UI.Таблицы.Реквизиты");
	Ванесса.ДобавитьШагВМассивТестов(ВсеТесты,"ВТаблицеЯНажимаюКнопкуОчиститьУПоля(Парам01,Парам02)","ВТаблицеЯНажимаюКнопкуОчиститьУПоля","И В таблице ""ИмяТаблицы"" я нажимаю кнопку очистить у поля ""Скан""","Нажатие кнопки очистить у поля в ТЧ","UI.Таблицы.Реквизиты");
	Ванесса.ДобавитьШагВМассивТестов(ВсеТесты,"ВТаблицеЯНажимаюКнопкуОчиститьУПоляСИменем(Парам01,Парам02)","ВТаблицеЯНажимаюКнопкуОчиститьУПоляСИменем","И В таблице ""ИмяТаблицы"" я нажимаю кнопку очистить у поля с именем ""Скан""","Нажатие кнопки очистить у поля в ТЧ","UI.Таблицы.Реквизиты");
	...
	Ванесса.ДобавитьШагВМассивТестов(ВсеТесты,"ВПолеЯВвожуТекст(Парам01,Парам02)","ВПолеЯВвожуТекст","И     в поле ""Наименование"" я ввожу текст ""111""","Вводит текст в поле","UI.Формы.Поля");
	...
	Ванесса.ДобавитьШагВМассивТестов(ВсеТесты,"ВПолеЯВвожуЗначениеВыражения(Парам01,Парам02)","ВПолеЯВвожуЗначениеВыражения","И в поле ""Наименование"" я ввожу значение выражения ""1+1""","Вычисляет выражение и вводит результат в поле","UI.Формы.Поля");
	Ванесса.ДобавитьШагВМассивТестов(ВсеТесты,"ВПолеСИменемЯВвожуЗначениеВыражения(Парам01,Парам02)","ВПолеСИменемЯВвожуЗначениеВыражения","И в поле с именем ""Наименование"" я ввожу значение выражения ""1+1""","Вычисляет выражение и вводит результат в поле","UI.Формы.Поля");
	
	
	Ванесса.ДобавитьШагВМассивТестов(ВсеТесты,"УТабличногоДокументаСИменемЯПерехожуКЯчейке(Парам01,Парам02)","УТабличногоДокументаСИменемЯПерехожуКЯчейке","И     у табличного документа с именем ""ТабДок"" я перехожу к ячейке ""R4C2""","Делает нужную ячейку табличного документа активной","UI.Табличный документ.Ячейки");
	Ванесса.ДобавитьШагВМассивТестов(ВсеТесты,"УТабличногоДокументаСИменемЯВвожуТекст(Парам01,Парам02)","УТабличногоДокументаСИменемЯВвожуТекст","И     у табличного документа с именем ""ТабДок"" я ввожу текст ""222""","Вводит текст в нужную ячейку табличного документа","UI.Табличный документ.Ячейки");
	...
	Ванесса.ДобавитьШагВМассивТестов(ВсеТесты,"ТаблицаФормыСИменемСодержитСтроки(Парам01,ТабПарам)","ТаблицаФормыСИменемСодержитСтроки","И     таблица формы с именем ""ИмяТаблицы"" содержит строки:","Проверяет, что таблица TestClient содержит строки таблицы Gherkin","UI.Таблицы.Проверка значения таблицы");
	...
	Ванесса.ДобавитьШагВМассивТестов(ВсеТесты,"ВПанелиРазделовЯВыбираю(Парам01)","ВПанелиРазделовЯВыбираю","Когда В панели разделов я выбираю ""Склады""","Нажатие кнопки на панели разделов","UI.Командный интерфейс");
	Ванесса.ДобавитьШагВМассивТестов(ВсеТесты,"ВПанелиОткрытыхЯВыбираю(Парам01)","ВПанелиОткрытыхЯВыбираю","Когда В панели открытых я выбираю ""Склады""","Нажатие кнопки на панели открытых окон","UI.Командный интерфейс");
	Ванесса.ДобавитьШагВМассивТестов(ВсеТесты,"ВПанелиФункцийЯВыбираю(Парам01)","ВПанелиФункцийЯВыбираю","И     В панели функций я выбираю ""Склады""","Нажатие кнопки на панели функций","UI.Командный интерфейс");
	Ванесса.ДобавитьШагВМассивТестов(ВсеТесты,"ВПанелиФункцийВГруппеЯВыбираю(Парам01,Парам02)","ВПанелиФункцийВГруппеЯВыбираю","И     В панели функций в группе ""Основное"" я выбираю ""Склады""","Нажатие кнопки на панели функций нужной группы","UI.Командный интерфейс");
	...
	Ванесса.ДобавитьШагВМассивТестов(ВсеТесты,"ЯНажимаюКнопкуВыбораУПоляСИменем(Парам01)","ЯНажимаюКнопкуВыбораУПоляСИменем","И     я нажимаю кнопку выбора у поля с именем ""Реквизит4""","Нажимает на кнопку выбора у поля","UI.Формы.Поля");
	Ванесса.ДобавитьШагВМассивТестов(ВсеТесты,"ТабличныйДокументФормыСИменемСталРавен(Парам01,ТабПарам)","ТабличныйДокументФормыСИменемСталРавен","И     табличный документ формы с именем ""РеквизитТабличныйДокумент"" стал равен:","Проверяет равенство табличного документа переданной таблице Gherkin. Необходимо указать параметры считывания макета.","UI.Табличный документ.Проверка значения");
	...
	Ванесса.ДобавитьШагВМассивТестов(ВсеТесты,"ЯНажимаюКнопкуКомандногоИнтерфейса(Парам01)","ЯНажимаюКнопкуКомандногоИнтерфейса","Когда Я нажимаю кнопку командного интерфейса ""Основная""","Нажимает на кнопку командного интерфейса","UI.Командный интерфейс");
	...
	Ванесса.ДобавитьШагВМассивТестов(ВсеТесты,"ВПолеСИменемЯВвожуТекст(Парам01,Парам02)","ВПолеСИменемЯВвожуТекст","И     в поле с именем ""Наименование"" я ввожу текст ""111""","Вводит текст в поле","UI.Формы.Поля");
	...
	Ванесса.ДобавитьШагВМассивТестов(ВсеТесты,"УГруппыСтраницТекущаяСтраница(Парам01,Парам02)","УГруппыСтраницТекущаяСтраница","И у группы страниц ""ГруппаСтраниц"" текущая страница ""ТекущаяСтраница""","Проверяет что у заданной группы текущей страницей является указанная","UI.Формы.Группы");
	Ванесса.ДобавитьШагВМассивТестов(ВсеТесты,"ЯЖдуЧтоУГруппыСтраницТекущейСтраницейСтанетВТеченииСекунд(Парам01,Парам02,Парам03)","ЯЖдуЧтоУГруппыСтраницТекущейСтраницейСтанетВТеченииСекунд","И я жду, что у группы страниц ""ГруппаСтраниц"" текущей страницей станет ""ТекущаяСтраница"" в течении 20 секунд","Ожидает, что у заданной группы текущей страницей станет нужная группа в течении указанного числа секунд","UI.Формы.Группы");
	...
	Ванесса.ДобавитьШагВМассивТестов(ВсеТесты,"ВОткрытойФормеВТЧВПолеСЗаголовкомЯВвожуТекст(Парам01,Парам02,Парам03)","ВОткрытойФормеВТЧВПолеСЗаголовкомЯВвожуТекст","И     В открытой форме в таблице ""ИмяТаблицы"" в поле с заголовком ""ИмяПоля"" я ввожу текст ""56,78""");
	Ванесса.ДобавитьШагВМассивТестов(ВсеТесты,"ВОткрытойФормеВТЧВПолеЯВвожуТекст(Парам01,Парам02,Парам03)","ВОткрытойФормеВТЧВПолеЯВвожуТекст","И     В открытой форме в таблице ""ИмяТаблицы"" в поле ""ИмяПоля"" я ввожу текст ""56,78""");
	Ванесса.ДобавитьШагВМассивТестов(ВсеТесты,"ВТЧВПолеЯВвожуТекст(Парам01,Парам02,Парам03)","ВТЧВПолеЯВвожуТекст","И     в таблице ""ИмяТаблицы"" в поле ""ИмяПоля"" я ввожу текст ""56,78""");
	Ванесса.ДобавитьШагВМассивТестов(ВсеТесты,"ВТаблицеВПолеЯВвожуТекст(Парам01,Парам02,Парам03)","ВТаблицеВПолеЯВвожуТекст","И     в таблице ""ИмяТаблицы"" в поле ""ИмяПоля"" я ввожу текст ""56,78""","Ввод текста в поле таблицы","UI.Таблицы.Реквизиты");
	...
	Ванесса.ДобавитьШагВМассивТестов(ВсеТесты,"ВОткрытойФормеВТЧВПолеСИменемЯВвожуТекст(Парам01,Парам02,Парам03)","ВОткрытойФормеВТЧВПолеСИменемЯВвожуТекст","И     В открытой форме в таблице ""ИмяТаблицы"" в поле с именем ""ИмяПоля"" я ввожу текст ""56,78""");
	Ванесса.ДобавитьШагВМассивТестов(ВсеТесты,"ВТЧВПолеСИменемЯВвожуТекст(Парам01,Парам02,Парам03)","ВТЧВПолеСИменемЯВвожуТекст","И     в таблице ""ИмяТаблицы"" в поле с именем ""ИмяПоля"" я ввожу текст ""56,78""");
	Ванесса.ДобавитьШагВМассивТестов(ВсеТесты,"ВТаблицеВПолеСИменемЯВвожуТекст(Парам01,Парам02,Парам03)","ВТаблицеВПолеСИменемЯВвожуТекст","И     в таблице ""ИмяТаблицы"" в поле с именем ""ИмяПоля"" я ввожу текст ""56,78""","Ввод текста в поле таблицы","UI.Таблицы.Реквизиты");
	
	
	
	Ванесса.ДобавитьШагВМассивТестов(ВсеТесты,"ВОткрытойФормеВТЧИзВыпадающегоСпискаСЗаголовкомЯВыбираю(Парам01,Парам02,Парам03)","ВОткрытойФормеВТЧИзВыпадающегоСпискаСЗаголовкомЯВыбираю","И     В открытой форме в таблице ""ИмяТаблицы"" из выпадающего списка с заголовком ""Реквизит справочник"" я выбираю ""ЗначениеПоля""");
	Ванесса.ДобавитьШагВМассивТестов(ВсеТесты,"ВОткрытойФормеВТЧИзВыпадающегоСпискаЯВыбираю(Парам01,Парам02,Парам03)","ВОткрытойФормеВТЧИзВыпадающегоСпискаЯВыбираю","И     В открытой форме в таблице ""ИмяТаблицы"" из выпадающего списка ""Реквизит справочник"" я выбираю ""ЗначениеПоля""");
	Ванесса.ДобавитьШагВМассивТестов(ВсеТесты,"ВТЧИзВыпадающегоСпискаЯВыбираю(Парам01,Парам02,Парам03)","ВТЧИзВыпадающегоСпискаЯВыбираю","И     в таблице ""ИмяТаблицы"" из выпадающего списка ""Реквизит справочник"" я выбираю ""ЗначениеПоля""");
	Ванесса.ДобавитьШагВМассивТестов(ВсеТесты,"ВТаблицеИзВыпадающегоСпискаЯВыбираю(Парам01,Парам02,Парам03)","ВТаблицеИзВыпадающегоСпискаЯВыбираю","И     в таблице ""ИмяТаблицы"" из выпадающего списка ""Реквизит справочник"" я выбираю ""ЗначениеПоля""","Выбор значения из выпадающего списка","UI.Таблицы.Реквизиты");
	Ванесса.ДобавитьШагВМассивТестов(ВсеТесты,"ВТаблицеИзВыпадающегоСпискаСИменемЯВыбираю(Парам01,Парам02,Парам03)","ВТаблицеИзВыпадающегоСпискаСИменемЯВыбираю","И     в таблице ""ИмяТаблицы"" из выпадающего списка с именем ""Реквизит справочник"" я выбираю ""ЗначениеПоля""","Выбор значения из выпадающего списка","UI.Таблицы.Реквизиты");
	...
	Ванесса.ДобавитьШагВМассивТестов(ВсеТесты,"ИзВыпадающегоСпискаЯВыбираю(Парам01,Парам02)","ИзВыпадающегоСпискаЯВыбираю","И     из выпадающего списка ""ИмяПоля"" я выбираю ""ЗначениеПоля""","Выбор из выпадающего списка","UI.Выпадающий список");
	...
	Ванесса.ДобавитьШагВМассивТестов(ВсеТесты,"ИзВыпадающегоСпискаСИменемЯВыбираю(Парам01,Парам02)","ИзВыпадающегоСпискаСИменемЯВыбираю","И     из выпадающего списка с именем ""МойВыпадающийСписок"" я выбираю ""ЗначениеИзСписка""","Выбор из выпадающего списка","UI.Выпадающий список");
	...
	Ванесса.ДобавитьШагВМассивТестов(ВсеТесты,"ЯНажимаюКнопкуОчиститьУПоля(Парам01)","ЯНажимаюКнопкуОчиститьУПоля","И     я нажимаю кнопку очистить у поля ""Отбор""","Очищает поле","UI.Формы.Поля");
	...
	Ванесса.ДобавитьШагВМассивТестов(ВсеТесты,"ЯНажимаюКнопкуОчиститьУПоляСИменем(Парам01)","ЯНажимаюКнопкуОчиститьУПоляСИменем","И     я нажимаю кнопку очистить у поля с именем ""Отбор""","Очищает поле","UI.Формы.Поля");
	
	Ванесса.ДобавитьШагВМассивТестов(ВсеТесты,"ТабличныйДокументФормыСИменемСталПустым(Парам01)","ТабличныйДокументФормыСИменемСталПустым","И     табличный документ формы с именем ""РеквизитТабличныйДокумент"" стал пустым","Проверяет, что табличный документ пустой","UI.Табличный документ.Проверка значения");
	...
	Ванесса.ДобавитьШагВМассивТестов(ВсеТесты,"ЯБудуВыбиратьВнешнийФайл(Парам01)","ЯБудуВыбиратьВнешнийФайл","И     я буду выбирать внешний файл ""c:\temp\333.epf""","Устанавливает результат диалога выбора файла.","Файлы");
	...
	Ванесса.ДобавитьШагВМассивТестов(ВсеТесты,"УПоляЯВыбираюПунктКонтекстногоМеню(Парам01,Парам02)","УПоляЯВыбираюПунктКонтекстногоМеню","И     у поля ""ИмяПоля"" я выбираю пункт контекстного меню ""ПунктМеню""");
	Ванесса.ДобавитьШагВМассивТестов(ВсеТесты,"УПоляСИменемЯВыбираюПунктКонтекстногоМеню(Парам01,Парам02)","УПоляСИменемЯВыбираюПунктКонтекстногоМеню","И     у поля с именем ""ИмяПоля"" я выбираю пункт контекстного меню ""ПунктМеню""");
	...
	Ванесса.ДобавитьШагВМассивТестов(ВсеТесты,"ЯЗапоминаюЗначениеПоляКак(Парам01,Парам02)","ЯЗапоминаюЗначениеПоляКак","И     я запоминаю значение поля ""Номер"" как ""ПеременнаяНомерДокумента""","Сохранение значения поля в переменную Контекст","Контекст.Контекст.Сохранить значение");
	Ванесса.ДобавитьШагВМассивТестов(ВсеТесты,"ЯЗапоминаюЗначениеТаблицыПоляКак(Парам01,Парам02,Парам03)","ЯЗапоминаюЗначениеТаблицыПоляКак","И     я запоминаю значение таблицы ""ИмяТаблицы"" поля ""Номер"" как ""ПеременнаяНомерДокумента""","Сохранение значения поля таблицы в переменную Контекст","Контекст.Контекст.Сохранить значение");
	...
	Ванесса.ДобавитьШагВМассивТестов(ВсеТесты,"ВТаблицуВПолеВвожуЗначениеПеременной(Парам01,Парам02,Парам03)","ВТаблицуВПолеВвожуЗначениеПеременной","И     в Таблицу ""ИмяТаблицы"" в поле ""Номер"" ввожу значение переменной ""НомерДокумента""", "Вставка значения ранее сохраненной переменной в реквизит", "Контекст.Контекст.Прочитать значение");
	...
	Ванесса.ДобавитьШагВМассивТестов(ВсеТесты,"ЯВывожуЗначениеПеременной(Парам01)","ЯВывожуЗначениеПеременной","И     я вывожу значение переменной ""ВариантЗаполненияСостава""","Выводит значение переменной контекста в окно сообщений","Контекст.Контекст.Прочитать значение");
	...
	Ванесса.ДобавитьШагВМассивТестов(ВсеТесты,"ЯМеняюЗначениеПереключателяНаЗначениеПеременной(Парам01,Парам02)","ЯМеняюЗначениеПереключателяНаЗначениеПеременной","И     я меняю значение переключателя ""Реквизит переключатель"" на значение переменной ""ЗначениеПереключателя""", "Изменение значение переключателя на значение ранее сохраненной переменной", "Контекст.Контекст.Прочитать значение");
	Ванесса.ДобавитьШагВМассивТестов(ВсеТесты,"ЯМеняюЗначениеПереключателяСИменемНаЗначениеПеременной(Парам01,Парам02)","ЯМеняюЗначениеПереключателяСИменемНаЗначениеПеременной","И     я меняю значение переключателя с именем ""РеквизитПереключатель"" на значение переменной ""ЗначениеПереключателя""", "Изменение значение переключателя на значение ранее сохраненной переменной", "Контекст.Контекст.Прочитать значение");
	...
	Ванесса.ДобавитьШагВМассивТестов(ВсеТесты,"ЭлементДоступенДляПросмотра(ИмяЭлемента)",                     "ЭлементДоступенДляПросмотра",                     "И элемент ""Имя элемента"" доступен для просмотра",                          "Проверка отсутствия флага ""Только просмотр""","UI.Формы.Поля.Просмотр");
	Ванесса.ДобавитьШагВМассивТестов(ВсеТесты,"ЭлементСИменемДоступенДляПросмотра(ИмяЭлемента)",              "ЭлементСИменемДоступенДляПросмотра",              "И элемент с именем ""ИмяЭлемента"" доступен для просмотра",                 "Проверка отсутствия флага ""Только просмотр""","UI.Формы.Поля.Просмотр");
	...
	Ванесса.ДобавитьШагВМассивТестов(ВсеТесты,"ЭлементДоступенНеТолькоДляПросмотра(ИмяЭлемента)",       "ЭлементДоступенНеТолькоДляПросмотра",       "И элемент ""ИмяПоля"" доступен не только для просмотра","Проверка установленного флага ""Только просмотр""",         "UI.Формы.Поля.Просмотр");
	Ванесса.ДобавитьШагВМассивТестов(ВсеТесты,"ЭлементСИменемДоступенНеТолькоДляПросмотра(ИмяЭлемента)","ЭлементСИменемДоступенНеТолькоДляПросмотра","И элемент с именем ""ИмяПоля"" доступен не только для просмотра","Проверка установленного флага ""Только просмотр""","UI.Формы.Поля.Просмотр");	
	...
	Ванесса.ДобавитьШагВМассивТестов(ВсеТесты,"ВТаблицеПолеДоступно(ИмяТЧ, ИмяРеквизита)", "ВТаблицеПолеДоступно","И     В таблице ""ИмяТаблицы"" поле ""ИмяРеквизита"" доступно", "Проверка доступности элемента ТЧ","UI.Таблицы.Доступность");
	...
	Ванесса.ДобавитьШагВМассивТестов(ВсеТесты,"ВТаблицеПолеСИменемДоступно(ИмяТЧ, ИмяРеквизита)", "ВТаблицеПолеСИменемДоступно","И     В таблице ""ИмяТаблицы"" поле с именем ""ИмяРеквизита"" доступно", "Проверка доступности элемента ТЧ","UI.Таблицы.Доступность");
	...
	Ванесса.ДобавитьШагВМассивТестов(ВсеТесты,"ВТаблицеПолеНеДоступно(ИмяТЧ, ИмяРеквизита)", "ВТаблицеПолеНеДоступно","И     В таблице ""ИмяТаблицы"" поле ""ИмяРеквизита"" не доступно", "Проверка не доступности элемента ТЧ","UI.Таблицы.Доступность");
	...
	Ванесса.ДобавитьШагВМассивТестов(ВсеТесты,"ВТаблицеПолеСИменемНеДоступно(ИмяТЧ, ИмяРеквизита)", "ВТаблицеПолеСИменемНеДоступно","И     В таблице ""ИмяТаблицы"" поле с именем ""ИмяРеквизита"" не доступно", "Проверка не доступности элемента ТЧ","UI.Таблицы.Доступность");
	...
	Ванесса.ДобавитьШагВМассивТестов(ВсеТесты,"ВТаблицеПолеДоступноТолькоДляПросмотра(ИмяТЧ, ИмяРеквизита)", "ВТаблицеПолеДоступноТолькоДляПросмотра","И     В таблице ""ИмяТаблицы"" поле ""ИмяРеквизита"" доступно только для просмотра", "Проверка установленного флага ""Только просмотр"" для реквизита в ТЧ","UI.Таблицы.Просмотр");
	...
	Ванесса.ДобавитьШагВМассивТестов(ВсеТесты,"ВТаблицеПолеСИменемДоступноТолькоДляПросмотра(ИмяТЧ, ИмяРеквизита)", "ВТаблицеПолеСИменемДоступноТолькоДляПросмотра","И     В таблице ""ИмяТаблицы"" поле с именем ""ИмяПоля"" доступно только для просмотра", "Проверка установленного флага ""Только просмотр"" для реквизита в ТЧ","UI.Таблицы.Просмотр");
	...
	Ванесса.ДобавитьШагВМассивТестов(ВсеТесты,"ВТаблицеПолеДоступноНеТолькоДляПросмотра(ИмяТЧ, ИмяРеквизита)", "ВТаблицеПолеДоступноНеТолькоДляПросмотра","И     В таблице ""ИмяТаблицы"" поле с именем ""ИмяРеквизита"" доступно не только для просмотра", "Проверка установленного флага ""Только просмотр"" для реквизита в ТЧ","UI.Таблицы.Просмотр");	
	...
	Ванесса.ДобавитьШагВМассивТестов(ВсеТесты,"ВТаблицеПолеСИменемДоступноНеТолькоДляПросмотра(ИмяТЧ, ИмяРеквизита)", "ВТаблицеПолеСИменемДоступноНеТолькоДляПросмотра","И     В таблице ""ИмяТаблицы"" поле с именем ""ИмяРеквизита"" доступно не только для просмотра", "Проверка установленного флага ""Только просмотр"" для реквизита в ТЧ","UI.Таблицы.Просмотр");	
...
&НаКлиенте
//И я жду, что у группы страниц ""ГруппаСтраниц"" текущей страницей станет ""ТекущаяСтраница"" в течении 20 секунд
