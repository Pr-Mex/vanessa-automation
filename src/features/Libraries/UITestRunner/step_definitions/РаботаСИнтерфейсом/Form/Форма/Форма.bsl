...
Функция ПолучитьСписокТестов(КонтекстФреймворкаBDD) Экспорт
	...
	Ванесса.ДобавитьШагВМассивТестов(ВсеТесты,"ВОткрытойФормеВТЧЯПерехожуНаОднуСтрокуВнизСВыделением(Парам01)","ВОткрытойФормеВТЧЯПерехожуНаОднуСтрокуВнизСВыделением","И     В открытой форме в ТЧ  ""Список"" я перехожу на одну строку вниз с выделением", "Переходим в ТЧ на следующую строку с выделением", "UI.Таблицы.Переход к строке");
	Ванесса.ДобавитьШагВМассивТестов(ВсеТесты,"ВОткрытойФормеВТЧЯПерехожуНаОднуСтрокуВверхСВыделением(Парам01)","ВОткрытойФормеВТЧЯПерехожуНаОднуСтрокуВверхСВыделением","И     В открытой форме в ТЧ  ""Список"" я перехожу на одну строку вверх с выделением", "Переходим в ТЧ на предыдущую строку с выделением", "UI.Таблицы.Переход к строке");
	
	Ванесса.ДобавитьШагВМассивТестов(ВсеТесты,"ВОткрытойФормеВТЧЯПерехожуНаПервуюСтроку(Парам01)","ВОткрытойФормеВТЧЯПерехожуНаПервуюСтроку","И     В открытой форме в ТЧ  ""Список"" я перехожу на первую строку", "Переходим в ТЧ на первую строку", "UI.Таблицы.Переход к строке");
	Ванесса.ДобавитьШагВМассивТестов(ВсеТесты,"ВОткрытойФормеВТЧЯПерехожуНаПоследнююСтроку(Парам01)","ВОткрытойФормеВТЧЯПерехожуНаПоследнююСтроку","И     В открытой форме в ТЧ  ""Список"" я перехожу на последнюю строку", "Переходим в ТЧ на последнюю строку", "UI.Таблицы.Переход к строке");
	...
	Ванесса.ДобавитьШагВМассивТестов(ВсеТесты,"ВОткрытойФормеЯИзменяюФлагСЗаголовком(Парам01)","ВОткрытойФормеЯИзменяюФлагСЗаголовком","И     В открытой форме я изменяю флаг с заголовком ""Реквизит булево""", "Изменяет текущее состояние флага", "UI.Флаги");
	Ванесса.ДобавитьШагВМассивТестов(ВсеТесты,"ВОткрытойФормеЯИзменяюФлаг(Парам01)","ВОткрытойФормеЯИзменяюФлаг","И     В открытой форме я изменяю флаг ""Реквизит булево""", "Изменяет текущее состояние флага", "UI.Флаги");
	...
	Ванесса.ДобавитьШагВМассивТестов(ВсеТесты,"ВОткрытойФормеЯИзменяюФлагСИменем(Парам01)","ВОткрытойФормеЯИзменяюФлагСИменем","И     В открытой форме я изменяю флаг с именем ""Реквизит булево""", "Изменяет текущее состояние флага", "UI.Флаги");
	...
	Ванесса.ДобавитьШагВМассивТестов(ВсеТесты,"ВОткрытойФормеВТЧЯИзменяюФлагСЗаголовком(Парам01,Парам02)","ВОткрытойФормеВТЧЯИзменяюФлагСЗаголовком","И     В открытой форме в ТЧ ""ТабличнаяЧасть1"" я изменяю флаг с заголовком ""Реквизит булево""", "Изменяет текущее состояние флага", "UI.Таблицы.Флаги");
	Ванесса.ДобавитьШагВМассивТестов(ВсеТесты,"ВОткрытойФормеВТЧЯИзменяюФлаг(Парам01,Парам02)","ВОткрытойФормеВТЧЯИзменяюФлаг","И     В открытой форме в ТЧ ""ТабличнаяЧасть1"" я изменяю флаг ""Реквизит булево""", "Изменяет текущее состояние флага", "UI.Таблицы.Флаги");
	...
	Ванесса.ДобавитьШагВМассивТестов(ВсеТесты,"ВОткрытойФормеВТЧЯУстанавливаюФлагСЗаголовком(Парам01,Парам02)","ВОткрытойФормеВТЧЯУстанавливаюФлагСЗаголовком","И     В открытой форме в ТЧ ""ТабличнаяЧасть1"" я устанавливаю флаг с заголовком ""Реквизит булево""", "Устанавливает флаг в Истина", "UI.Таблицы.Флаги");
	Ванесса.ДобавитьШагВМассивТестов(ВсеТесты,"ВОткрытойФормеВТЧЯУстанавливаюФлаг(Парам01,Парам02)","ВОткрытойФормеВТЧЯУстанавливаюФлаг","И     В открытой форме в ТЧ ""ТабличнаяЧасть1"" я устанавливаю флаг ""Реквизит булево""", "Устанавливает флаг в Истина", "UI.Таблицы.Флаги");
	...
	// В ТЧ Я Снимаю Флаг
	Ванесса.ДобавитьШагВМассивТестов(ВсеТесты,"ВОткрытойФормеВТЧЯСнимаюФлагСЗаголовком(Парам01,Парам02)","ВОткрытойФормеВТЧЯСнимаюФлагСЗаголовком","И     В открытой форме в ТЧ ""ТабличнаяЧасть1"" я снимаю флаг с заголовком ""Реквизит булево""", "Устанавливает флаг в Ложь", "UI.Таблицы.Флаги");
	Ванесса.ДобавитьШагВМассивТестов(ВсеТесты,"ВОткрытойФормеВТЧЯСнимаюФлаг(Парам01,Парам02)","ВОткрытойФормеВТЧЯСнимаюФлаг","И     В открытой форме в ТЧ ""ТабличнаяЧасть1"" я снимаю флаг ""Реквизит булево""", "Устанавливает флаг в Ложь", "UI.Таблицы.Флаги");
	...
	// Я Устанавливаю Флаг
	Ванесса.ДобавитьШагВМассивТестов(ВсеТесты,"ВОткрытойФормеЯУстанавливаюФлагСЗаголовком(Парам01)","ВОткрытойФормеЯУстанавливаюФлагСЗаголовком","И     В открытой форме я устанавливаю флаг с заголовком ""Реквизит булево""", "Устанавливает флаг в Истина", "UI.Флаги");
	Ванесса.ДобавитьШагВМассивТестов(ВсеТесты,"ВОткрытойФормеЯУстанавливаюФлаг(Парам01)","ВОткрытойФормеЯУстанавливаюФлаг","И     В открытой форме я устанавливаю флаг ""Реквизит булево""", "Устанавливает флаг в Истина", "UI.Флаги");
	...
	Ванесса.ДобавитьШагВМассивТестов(ВсеТесты,"ВОткрытойФормеЯУстанавливаюФлагСИменем(Парам01)","ВОткрытойФормеЯУстанавливаюФлагСИменем","И     В открытой форме я устанавливаю флаг с именем ""Реквизит булево""", "Устанавливает флаг в Истина", "UI.Флаги");
	...
	Ванесса.ДобавитьШагВМассивТестов(ВсеТесты,"ЯВижуЭлемент(ИмяЭлемента)",               "ЯВижуЭлемент",               "И я вижу элемент ""Имя элемента""",                  "Проверяет видимость элемента на форме", "UI.Формы.Видимость элемента");
	Ванесса.ДобавитьШагВМассивТестов(ВсеТесты,"ЯВижуЭлементНаФорме(ИмяЭлемента)",        "ЯВижуЭлементНаФорме",        "И я вижу элемент ""Имя элемента"" на форме",         "Проверяет видимость элемента на форме", "UI.Формы.Видимость элемента");
	Ванесса.ДобавитьШагВМассивТестов(ВсеТесты,"ЯВижуЭлементСИменем(ИмяЭлемента)",        "ЯВижуЭлемент",               "И я вижу элемент с именем ""Имя элемента""",         "Проверяет видимость элемента на форме", "UI.Формы.Видимость элемента");
	Ванесса.ДобавитьШагВМассивТестов(ВсеТесты,"ЯВижуЭлементСИменемНаФорме(ИмяЭлемента)", "ЯВижуЭлементНаФорме",        "И я вижу элемент с именем ""Имя элемента"" на форме","Проверяет видимость элемента на форме", "UI.Формы.Видимость элемента");
	
	// стоит флаг "только просмотр"
	Ванесса.ДобавитьШагВМассивТестов(ВсеТесты,"ЭлементДоступенТолькоДляПросмотра(ИмяЭлемента)","ЭлементДоступенТолькоДляПросмотра","И элемент ""Имя элемента"" доступен только для просмотра","","UI.Формы.Только просмотр");
	Ванесса.ДобавитьШагВМассивТестов(ВсеТесты,"ЭлементСИменемДоступенТолькоДляПросмотра(ИмяЭлемента)","ЭлементСИменемДоступенТолькоДляПросмотра","И элемент с именем ""Имя элемента"" доступен только для просмотра","","UI.Формы.Только просмотр");
	Ванесса.ДобавитьШагВМассивТестов(ВсеТесты,"ВОткрытойФормеЭлементДоступенТолькоДляПросмотра(ИмяЭлемента)","ВОткрытойФормеЭлементДоступенТолькоДляПросмотра","И в открытой форме элемент ""Имя элемента"" доступен только для просмотра","","UI.Формы.Только просмотр");
	Ванесса.ДобавитьШагВМассивТестов(ВсеТесты,"ВОткрытойФормеЭлементСИменемДоступенТолькоДляПросмотра(ИмяЭлемента)","ВОткрытойФормеЭлементСИменемДоступенТолькоДляПросмотра","И в открытой форме элемент с именем ""Имя элемента"" доступен только для просмотра","","UI.Формы.Только просмотр");
	
	// проверка доступность элемента
	Ванесса.ДобавитьШагВМассивТестов(ВсеТесты,"ЭлементФормыДоступен(ИмяЭлемента)","ЭлементФормыДоступен","И     элемент формы ""ИмяЭлемента"" доступен","","");
	Ванесса.ДобавитьШагВМассивТестов(ВсеТесты,"ЭлементФормыНеДоступен(ИмяЭлемента)","ЭлементФормыНеДоступен","И     элемент формы ""ИмяЭлемента"" не доступен","","");
	Ванесса.ДобавитьШагВМассивТестов(ВсеТесты,"ЭлементФормыСИменемДоступен(ИмяЭлемента)","ЭлементФормыСИменемДоступен","И     элемент формы с именем ""ИмяЭлемента"" доступен","","");
	Ванесса.ДобавитьШагВМассивТестов(ВсеТесты,"ЭлементФормыСИменемНеДоступен(ИмяЭлемента)","ЭлементФормыСИменемНеДоступен","И     элемент формы с именем ""ИмяЭлемента"" не доступен","","");
...
&НаКлиенте
Процедура ДоступенТолькоДляПросмотра(ИмяЭлемента, ИскатьПоИмени = Ложь)
...
Процедура ЭлементДоступенТолькоДляПросмотра(ИмяЭлемента) Экспорт
	ДоступенТолькоДляПросмотра(ИмяЭлемента, Ложь);
КонецПроцедуры
...
Процедура ЭлементСИменемДоступенТолькоДляПросмотра(ИмяЭлемента) Экспорт
	ДоступенТолькоДляПросмотра(ИмяЭлемента, Истина);
КонецПроцедуры
...
Процедура ВОткрытойФормеЭлементДоступенТолькоДляПросмотра(ИмяЭлемента) Экспорт
	ДоступенТолькоДляПросмотра(ИмяЭлемента, Ложь);
КонецПроцедуры
...
Процедура ВОткрытойФормеЭлементСИменемДоступенТолькоДляПросмотра(ИмяЭлемента) Экспорт
	ДоступенТолькоДляПросмотра(ИмяЭлемента, Истина);
КонецПроцедуры
