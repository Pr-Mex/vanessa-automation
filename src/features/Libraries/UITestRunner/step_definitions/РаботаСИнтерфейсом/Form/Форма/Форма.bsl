...
Функция ПолучитьСписокТестов(КонтекстФреймворкаBDD) Экспорт
	...
	Ванесса.ДобавитьШагВМассивТестов(ВсеТесты,"ВТаблицеСИменемЯУдаляюТекущуюСтроку(Парам01)","ВТаблицеСИменемЯУдаляюТекущуюСтроку","И     в таблице с именем ""ТабличнаяЧасть1"" я удаляю текущую строку","Удаляет текущую строку таблицы","UI.Таблицы.Удаление строк");
