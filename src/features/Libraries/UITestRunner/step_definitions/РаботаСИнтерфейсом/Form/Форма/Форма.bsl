...
Функция ПолучитьСписокТестов(КонтекстФреймворкаBDD) Экспорт
	...
	Ванесса.ДобавитьШагВМассивТестов(ВсеТесты,"ТаблицаФормыСИменемСталаРавной(Парам01,ТабПарам)","ТаблицаФормыСИменемСталаРавной","И     таблица формы с именем ""ИмяТаблицы"" стала равной:","Проверяет, что таблица TestClient стала равна таблице Gherkin","UI.Таблицы.Проверка значения таблицы");
	...
	Ванесса.ДобавитьШагВМассивТестов(ВсеТесты,"ТабличныйДокументСталРавен(Парам01,ТабПарам)","ТабличныйДокументСталРавен","И табличный документ ""РеквизитТабличныйДокумент"" стал равен:" + Символы.ПС + "	| Значение1 | Значение2 |" + Символы.ПС + "	| Значение3 | Значение4 |","Проверяет равенство табличного документа переданной таблице Gherkin. Чтобы получить mxl файл из TestClient, в тонком клиенте будет сделана попытка сохранить табличный документ в файл. В Web клиенте он всегда будет считываться по ячейкам, согласно указанной системной области чтения.","UI.Табличный документ.Проверка значения всего табличного документа.Таблица Gherkin");
	...
	Ванесса.ДобавитьШагВМассивТестов(ВсеТесты,"ТабличныйДокументСодержитЗначенияОбластей(Парам01,ТабПарам)","ТабличныйДокументСодержитЗначенияОбластей","И Табличный документ ""ИмяТабДок"" содержит в себе значения областей" + Символы.ПС + "| ИмяОбласти |" + Символы.ПС + "| ЗначениеОбласти |","Проверяет что в табличном документа содержатся значения, перечисленные в таблице. Таблица состоит из двух колонок: ""ИмяОбласти"" и ""Значение""","UI.Табличный документ.Проверка значений именнованных областей");

	
	Ванесса.ДобавитьШагВМассивТестов(ВсеТесты,"ТабличныйДокументСодержитЗначения(Парам01,ТабПарам)","ТабличныйДокументСодержитЗначения","И табличный документ ""РеквизитТабличныйДокумент"" содержит значения:","Проверяет, что в табличном документе есть значения из таблицы","UI.Табличный документ.Содержит значения");
	Ванесса.ДобавитьШагВМассивТестов(ВсеТесты,"ТабличныйДокументНеСодержитЗначения(Парам01,ТабПарам)","ТабличныйДокументНеСодержитЗначения","И табличный документ ""РеквизитТабличныйДокумент"" не содержит значения:","Проверяет, что в табличном документе нет значений из таблицы","UI.Табличный документ.Содержит значения");
	...
	Ванесса.ДобавитьШагВМассивТестов(ВсеТесты,"ЭлементФормыСталРавен(Парам01,Парам02)","ЭлементФормыСталРавен","Тогда элемент формы ""ИмяПоля"" стал равен ""Значение поля""","Проверка значения элемента формы","UI.Формы.Ожидание значения элемента");
	Ванесса.ДобавитьШагВМассивТестов(ВсеТесты,"ЭлементФормыСИменемСталРавен(Парам01,Парам02)","ЭлементФормыСИменемСталРавен","Тогда элемент формы с именем ""ИмяПоля"" стал равен ""Значение поля""","Проверка значения элемента формы","UI.Формы.Ожидание значения элемента");
	...
	Ванесса.ДобавитьШагВМассивТестов(ВсеТесты,"ЯОткрываюВыпадающийСписок(Парам01)","ЯОткрываюВыпадающийСписок","И     я открываю выпадающий список ""Имя списка""","Открывает выпадающий список","UI.Выпадающий список");
	...
	Ванесса.ДобавитьШагВМассивТестов(ВсеТесты,"ЯОткрываюВыпадающийСписокСИменем(Парам01)","ЯОткрываюВыпадающийСписокСИменем","И     я открываю выпадающий список с именем ""ИмяСписка""","Открывает выпадающий список","UI.Выпадающий список");
	...
	Ванесса.ДобавитьШагВМассивТестов(ВсеТесты,"ИзВыпадающегоСпискаЯВыбираю(Парам01,Парам02)","ИзВыпадающегоСпискаЯВыбираю","И из выпадающего списка ""ИмяПоля"" я выбираю ""ЗначениеПоля""","Выбор из выпадающего списка. Значение будет выбрано через ввод по строке. Допускается вводить строку не целиком.","UI.Выпадающий список");
	...
	Ванесса.ДобавитьШагВМассивТестов(ВсеТесты,"ВОткрытойФормеВТЧЯАктивизируюПоле(Парам01,Парам02)","ВОткрытойФормеВТЧЯАктивизируюПоле","И     В открытой форме в таблице ""Отборы"" я активизирую поле ""ИмяПоля""");
	Ванесса.ДобавитьШагВМассивТестов(ВсеТесты,"ВТЧЯАктивизируюПоле(Парам01,Парам02)","ВТЧЯАктивизируюПоле","И     в таблице ""Отборы"" я активизирую поле ""ИмяПоля""");
	...
	Ванесса.ДобавитьШагВМассивТестов(ВсеТесты,"ВОткрытойФормеВТЧЯАктивизируюПолеСИменем(Парам01,Парам02)","ВОткрытойФормеВТЧЯАктивизируюПолеСИменем","И     В открытой форме в таблице ""Отборы"" я активизирую поле с именем ""ИмяПоля""");
	Ванесса.ДобавитьШагВМассивТестов(ВсеТесты,"ВТЧЯАктивизируюПолеСИменем(Парам01,Парам02)","ВТЧЯАктивизируюПолеСИменем","И     в таблице ""Отборы"" я активизирую поле с именем ""ИмяПоля""");
...
&НаСервере
Функция ПолучитьРасхожденияТД(ФайлМакета, ТабПарам)
	...
	Для Каждого СтрокаОжидаемая Из ТабПарам Цикл
		...
		Если СтрокаТаблицыМакета = Неопределено Тогда
			СтрокаРасхождения = Вычислить("СтрШаблон(""%1 не найден;"", ИмяПараметра)");
			МассивРасхождений.Добавить(СтрокаРасхождения);
		ИначеЕсли СтрокаТаблицыМакета.Значение <> ЗначениеПараметра Тогда
...
Процедура ТабличныйДокументСодержитЗначенияОбластей(ИмяЭлементаФормы,ТабПарам) Экспорт
	...
	МассивРасхождений = ПолучитьРасхожденияТД(ФайлМакета, ТабПарам);
