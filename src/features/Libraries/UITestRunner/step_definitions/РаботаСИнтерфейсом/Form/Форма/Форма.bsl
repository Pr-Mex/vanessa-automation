...
Процедура СделатьДействияПриЗаписиHTML(ПарамСтр = "")
	Если Ванесса.Объект.СоздаватьИнструкциюHTML Тогда
		Если ПарамСтр = "толькофрейм" Тогда
			Ванесса.ПодсветитьАктивныйЭлементФормыHTML();
		ИначеЕсли ПарамСтр = "толькомышь" Тогда
			Ванесса.ПереместитьКурсорМышиКАктивномуОбъектуHTML();
		Иначе	
			Ванесса.ПереместитьКурсорМышиКАктивномуОбъектуHTML();
			Ванесса.ПодсветитьАктивныйЭлементФормыHTML();
		КонецЕсли;	 
		
		Ванесса.ДобавитьВЛогИнструкцииHTMLВыполненияШага();
		Ванесса.СкриншотСделаннВСценарии = Истина;
		Ванесса.УбратьПодсветкуАктвиногоЭлемента();
	КонецЕсли;	 
	...
	Если Ванесса.Объект.СоздаватьИнструкциюMarkdown Тогда
		...
		Ванесса.ДобавитьВЛогИнструкцииЬMarkdownВыполненияШага();
		Ванесса.СкриншотСделаннВСценарии = Истина;
		Ванесса.УбратьПодсветкуАктвиногоЭлемента();
	КонецЕсли;	 
КонецПроцедуры
