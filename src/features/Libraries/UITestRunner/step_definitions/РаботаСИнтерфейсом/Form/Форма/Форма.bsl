...
Функция ПолучитьСписокТестов(КонтекстФреймворкаBDD) Экспорт
	...
	Ванесса.ДобавитьШагВМассивТестов(ВсеТесты,"ТабличныйДокументСодержитВСебеЗначения(Парам01,ТабПарам)","ТабличныйДокументСодержитВСебеЗначения","И Табличный документ ""ИмяТабДок"" содержит в себе значения" + Символы.ПС + "| ИмяОбласти |" + Символы.ПС + "| ЗначениеОбласти |","Проверяет что в табличном документа содержатся значения, перечисленные в таблице. Таблица состоит из двух колонок: ""ИмяОбласти"" и ""Значение""","UI.Табличный документ");
...
//@ТабличныйДокументСодержитВСебеЗначения(Парам01,ТабПарам)
Процедура ТабличныйДокументСодержитВСебеЗначения(ИмяЭлементаФормы,ТабПарам) Экспорт
