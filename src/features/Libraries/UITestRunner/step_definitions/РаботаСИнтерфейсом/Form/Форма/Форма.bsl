...
Функция ПолучитьСписокТестов(КонтекстФреймворкаBDD) Экспорт
	...
	Ванесса.ДобавитьШагВМассивТестов(ВсеТесты,"ВТаблицеЯНажимаюКнопкуОчиститьУПоля(Парам01,Парам02)","ВТаблицеЯНажимаюКнопкуОчиститьУПоля","И В таблице ""ДокументыПоВидам"" я нажимаю кнопку очистить у поля ""Скан""","Нажатие кнопки очистить у поля в ТЧ","UI.Таблицы.Реквизиты");
	Ванесса.ДобавитьШагВМассивТестов(ВсеТесты,"ВТаблицеЯНажимаюКнопкуОчиститьУПоляСИменем(Парам01,Парам02)","ВТаблицеЯНажимаюКнопкуОчиститьУПоляСИменем","И В таблице ""ДокументыПоВидам"" я нажимаю кнопку очистить у поля с именем ""Скан""","Нажатие кнопки очистить у поля в ТЧ","UI.Таблицы.Реквизиты");
	...
	Ванесса.ДобавитьШагВМассивТестов(ВсеТесты,"ВТЧЯПерехожуНаПервуюСтроку(Парам01)","ВТЧЯПерехожуНаПервуюСтроку","И     В ТЧ  ""Список"" я перехожу на первую строку");
	Ванесса.ДобавитьШагВМассивТестов(ВсеТесты,"ВТЧЯПерехожуНаПоследнююСтроку(Парам01)","ВТЧЯПерехожуНаПоследнююСтроку","И     В ТЧ  ""Список"" я перехожу на последнюю строку");
	...
	Ванесса.ДобавитьШагВМассивТестов(ВсеТесты,"УТабличногоДокументаСИменемЯПерехожуКЯчейке(Парам01,Парам02)","УТабличногоДокументаСИменемЯПерехожуКЯчейке","И     у табличного документа с именем ""ТабДок"" я перехожу к ячейке ""R4C2""","Делает нужную ячейку табличного документа активной","UI.Табличный документ");
	Ванесса.ДобавитьШагВМассивТестов(ВсеТесты,"УТабличногоДокументаСИменемЯВвожуТекст(Парам01,Парам02)","УТабличногоДокументаСИменемЯВвожуТекст","И     у табличного документа с именем ""ТабДок"" я ввожу текст ""222""","Вводит текст в нужную ячейку табличного документа","UI.Табличный документ");
	
	
	
	Ванесса.ДобавитьШагВМассивТестов(ВсеТесты,"ТаблицаФормыСИменемСталаРавной(Парам01,ТабПарам)","ТаблицаФормыСИменемСталаРавной","И     таблица формы с именем ""ТабличнаяЧасть1"" стала равной:","Проверяет, что таблица TestClient стала равна таблице Gherkin","UI.Таблицы.Проверка значения");
	Ванесса.ДобавитьШагВМассивТестов(ВсеТесты,"ТаблицаФормыСИменемСодержитСтроки(Парам01,ТабПарам)","ТаблицаФормыСИменемСодержитСтроки","И     таблица формы с именем ""ТабличнаяЧасть1"" содержит строки:","Проверяет, что таблица TestClient содержит строки таблицы Gherkin","UI.Таблицы.Проверка значения");
	
	Ванесса.ДобавитьШагВМассивТестов(ВсеТесты,"ТаблицаФормыСИменемСодержитИзменения(Парам01,ТабПарам)","ТаблицаФормыСИменемСодержитИзменения","Тогда таблица формы с именем ""ТабличнаяЧасть1"" содержит изменения:");//дублирует ТаблицаФормыСИменемСталаРавной
	...
	Ванесса.ДобавитьШагВМассивТестов(ВсеТесты,"ЯНажимаюКнопкуВыбораУПоля(Парам01)","ЯНажимаюКнопкуВыбораУПоля","И     я нажимаю кнопку выбора у поля ""Реквизит2""","Нажимает на кнопку выбора у поля","UI.Формы.Поля");
	
	Ванесса.ДобавитьШагВМассивТестов(ВсеТесты,"ПолеСуществует(Парам01)","ПолеСуществует","И     поле ""Реквизит2"" существует","Проверка существования поля","UI.Формы.Поля.Проверка существования");
	Ванесса.ДобавитьШагВМассивТестов(ВсеТесты,"ПолеСИменемСуществует(Парам01)","ПолеСИменемСуществует","И     поле с именем ""Реквизит2"" существует","Проверка существования поля","UI.Формы.Поля.Проверка существования");
	Ванесса.ДобавитьШагВМассивТестов(ВсеТесты,"ПолеНеСуществует(Парам01)","ПолеНеСуществует","И     поле ""Реквизит2"" не существует","Проверка не существования поля","UI.Формы.Поля.Проверка существования");
	Ванесса.ДобавитьШагВМассивТестов(ВсеТесты,"ПолеСИменемНеСуществует(Парам01)","ПолеСИменемНеСуществует","И     поле с именем ""Реквизит2"" не существует","Проверка не существования поля","UI.Формы.Поля.Проверка существования");
	
	Ванесса.ДобавитьШагВМассивТестов(ВсеТесты,"ПолеПрисутствуетНаФорме(Парам01)","ПолеПрисутствуетНаФорме","И     поле ""Реквизит2"" присутствует на форме","Проверка видимости поля","UI.Формы.Поля.Проверка видимости");
	Ванесса.ДобавитьШагВМассивТестов(ВсеТесты,"ПолеСИменемПрисутствуетНаФорме(Парам01)","ПолеСИменемПрисутствуетНаФорме","И     поле с именем ""Реквизит2"" присутствует на форме","Проверка видимости поля","UI.Формы.Поля.Проверка видимости");
	Ванесса.ДобавитьШагВМассивТестов(ВсеТесты,"ПолеОтсутствуетНаФорме(Парам01)","ПолеОтсутствуетНаФорме","И     поле ""Реквизит2"" отсутствует на форме","Проверка невидимости поля","UI.Формы.Поля.Проверка видимости");
	Ванесса.ДобавитьШагВМассивТестов(ВсеТесты,"ПолеСИменемОтсутствуетНаФорме(Парам01)","ПолеСИменемОтсутствуетНаФорме","И     поле с именем ""Реквизит2"" отсутствует на форме","Проверка невидимости поля","UI.Формы.Поля.Проверка видимости");
	
	
	Ванесса.ДобавитьШагВМассивТестов(ВсеТесты,"ПолеСИменемИмеетЗаголовок(Парам01,Парам02)","ПолеСИменемИмеетЗаголовок","И     поле с именем ""Реквизит2"" имеет заголовок ""Заголовок""","Проверка, что у поля нужный заголовок. Поле ищется по внутреннему идентификатору.","UI.Формы.Поля.Заголовок");
	Ванесса.ДобавитьШагВМассивТестов(ВсеТесты,"УПоляСИменемТекстПодсказкиРавен(Парам01,Парам02)","УПоляСИменемТекстПодсказкиРавен","И     у поля с именем ""Реквизит2"" текст подсказки равен ""Заголовок""","Проверка, что у поля нужный текст подсказки. Поле ищется по внутреннему идентификатору.","UI.Формы.Поля.Подсказка");
	...
	Ванесса.ДобавитьШагВМассивТестов(ВсеТесты,"ТабличныйДокументФормыСИменемСталРавен(Парам01,ТабПарам)","ТабличныйДокументФормыСИменемСталРавен","И     табличный документ формы с именем ""РеквизитТабличныйДокумент"" стал равен:","Проверяет равенство табличного документа переданной таблице Gherkin","UI.Табличный документ");
	Ванесса.ДобавитьШагВМассивТестов(ВсеТесты,"ТабличныйДокументФормыСИменемСодержитСтроки(Парам01,ТабПарам)","ТабличныйДокументФормыСИменемСодержитСтроки","И     табличный документ формы с именем ""РеквизитТабличныйДокумент"" содержит строки:", "Проверяет, что табличный документ TestClient содержит строки таблицы Gherkin", "UI.Табличный документ");
	Ванесса.ДобавитьШагВМассивТестов(ВсеТесты,"ТабличныйДокументСодержитЗначенияОбластей(Парам01,ТабПарам)","ТабличныйДокументСодержитЗначенияОбластей","И Табличный документ ""ИмяТабДок"" содержит в себе значения областей" + Символы.ПС + "| ИмяОбласти |" + Символы.ПС + "| ЗначениеОбласти |","Проверяет что в табличном документа содержатся значения, перечисленные в таблице. Таблица состоит из двух колонок: ""ИмяОбласти"" и ""Значение""","UI.Табличный документ");

	
	Ванесса.ДобавитьШагВМассивТестов(ВсеТесты,"ТабличныйДокументСодержитЗначения(Парам01,ТабПарам)","ТабличныйДокументСодержитЗначения","И табличный документ ""РеквизитТабличныйДокумент"" содержит значения:","Проверяет, что в табличном документе есть значения из таблицы","UI.Табличный документ");
	Ванесса.ДобавитьШагВМассивТестов(ВсеТесты,"ТабличныйДокументНеСодержитЗначения(Парам01,ТабПарам)","ТабличныйДокументНеСодержитЗначения","И табличный документ ""РеквизитТабличныйДокумент"" не содержит значения:","Проверяет, что в табличном документе нет значений из таблицы","UI.Табличный документ");
	
	Ванесса.ДобавитьШагВМассивТестов(ВсеТесты,"ВТабличномДокументеЗначенияВКолонкеРавноЗначению(Парам01,Парам02,Парам03)","ВТабличномДокументеЗначенияВКолонкеРавноЗначению","И в табличном документе ""РеквизитТабличныйДокумент"" значения в колонке ""ИмяКолонки"" равно значению """"","Проверяет, что в табличном документе значение в колонке равно переданному параметру","UI.Табличный документ");
	Ванесса.ДобавитьШагВМассивТестов(ВсеТесты,"ВТабличномДокументеЗначенияВКолонкеНеравноЗначению(Парам01,Парам02,Парам03)","ВТабличномДокументеЗначенияВКолонкеНеравноЗначению","И в табличном документе ""РеквизитТабличныйДокумент"" значения в колонке ""ИмяКолонки"" неравно значению """"","Проверяет, что в табличном документе значение в колонке равно переданному параметру","UI.Табличный документ");
	Ванесса.ДобавитьШагВМассивТестов(ВсеТесты,"ВТабличномДокументеЗначенияВКолонкеСоответствуютУсловию(Парам01,Парам02,Парам03,Парам04)","ВТабличномДокументеЗначенияВКолонкеСоответствуютУсловию","И в табличном документе ""РеквизитТабличныйДокумент"" значения в колонке ""ИмяКолонки"" соответствуют условию  ""равно""  10","Проверяет, что в табличном документе значение в колонке соответствует условию. Можно использовать числа.","UI.Табличный документ");
	...
	Ванесса.ДобавитьШагВМассивТестов(ВсеТесты,"ЯОткрываюВыпадающийСписок(Парам01)","ЯОткрываюВыпадающийСписок","И     я открываю выпадающий список ""Реквизит2""","Открывает выпадающий список","UI.Выпадающий список");
	...
	Ванесса.ДобавитьШагВМассивТестов(ВсеТесты,"ЯОткрываюВыпадающийСписокСИменем(Парам01)","ЯОткрываюВыпадающийСписокСИменем","И     я открываю выпадающий список с именем ""Реквизит2""","Открывает выпадающий список","UI.Выпадающий список");
	...
	Ванесса.ДобавитьШагВМассивТестов(ВсеТесты,"ЯВыбираюЗначениеРеквизитаИзФормыСписка(Парам01)","ЯВыбираюЗначениеРеквизитаИзФормыСписка","И     я выбираю значение реквизита ""Реквизит2"" из формы списка","Нажимает на кнопку ""Выбрать из списка"" у поля","UI.Формы.Поля");
	...
	Ванесса.ДобавитьШагВМассивТестов(ВсеТесты,"ЯВыбираюЗначениеРеквизитаСИменемИзФормыСписка(Парам01)","ЯВыбираюЗначениеРеквизитаСИменемИзФормыСписка","И     я выбираю значение реквизита с именем ""Реквизит2"" из формы списка","Нажимает на кнопку ""Выбрать из списка"" у поля","UI.Формы.Поля");
	...
	Ванесса.ДобавитьШагВМассивТестов(ВсеТесты,"ВТаблицеПолеИмеетЗначение(Парам01,Парам02,Парам03)","ВТаблицеПолеИмеетЗначение","И     в таблице ""ТабличнаяЧасть1"" поле ""Реквизит булево"" имеет значение ""Да""","Проверка значения поля текущей строки таблицы","UI.Таблицы.Значение поля");
	...
	Ванесса.ДобавитьШагВМассивТестов(ВсеТесты,"ВТекущемОкнеЯНажимаюКнопкуКомандногоИнтерфейса(Парам01)","ВТекущемОкнеЯНажимаюКнопкуКомандногоИнтерфейса","И     В текущем окне я нажимаю кнопку командного интерфейса ""Общая команда для справочника1""","Нажатие кнопки командного интерфейса в текущей форме","UI.Командный интерфейс");
	...
	Ванесса.ДобавитьШагВМассивТестов(ВсеТесты,"ИзВыпадающегоСпискаСИменемЯВыбираю(Парам01,Парам02)","ИзВыпадающегоСпискаСИменемЯВыбираю","И     из выпадающего списка с именем ""Реквизит2"" я выбираю ""ТестовыйЭлемент21""","Выбор из выпадающего списка","UI.Выпадающий список");
	...
	Ванесса.ДобавитьШагВМассивТестов(ВсеТесты,"ТабличныйДокументФормыСИменемСталПустым(Парам01)","ТабличныйДокументФормыСИменемСталПустым","И     табличный документ формы с именем ""РеквизитТабличныйДокумент"" стал пустым","Проверяет, что табличный документ пустой","UI.Табличный документ");
	...
	Ванесса.ДобавитьШагВМассивТестов(ВсеТесты,"ВТЧЯУстанавливаюФлаг(Парам01,Парам02)","ВТЧЯУстанавливаюФлаг","И     в ТЧ ""ТабличнаяЧасть1"" я устанавливаю флаг ""Реквизит булево""");
	Ванесса.ДобавитьШагВМассивТестов(ВсеТесты,"ВТаблицеЯУстанавливаюФлаг(Парам01,Парам02)","ВТаблицеЯУстанавливаюФлаг","И     в таблице ""ТабличнаяЧасть1"" я устанавливаю флаг ""Реквизит булево""", "Устанавливает флаг в Истина", "UI.Таблицы.Флаги");
	...
	Ванесса.ДобавитьШагВМассивТестов(ВсеТесты,"ВТЧЯСнимаюФлаг(Парам01,Парам02)","ВТЧЯСнимаюФлаг","И     в ТЧ ""ТабличнаяЧасть1"" я снимаю флаг ""Реквизит булево""");
	Ванесса.ДобавитьШагВМассивТестов(ВсеТесты,"ВТаблицеЯСнимаюФлаг(Парам01,Парам02)","ВТаблицеЯСнимаюФлаг","И     в таблице ""ТабличнаяЧасть1"" я снимаю флаг ""Реквизит булево""", "Устанавливает флаг в Ложь", "UI.Таблицы.Флаги");
	
	// Я Снимаю Флаг
	Ванесса.ДобавитьШагВМассивТестов(ВсеТесты,"ВОткрытойФормеЯСнимаюФлагСЗаголовком(Парам01)","ВОткрытойФормеЯСнимаюФлагСЗаголовком","И     В открытой форме я снимаю флаг с заголовком ""Реквизит булево""");
	Ванесса.ДобавитьШагВМассивТестов(ВсеТесты,"ВОткрытойФормеЯСнимаюФлаг(Парам01)","ВОткрытойФормеЯСнимаюФлаг","И     В открытой форме я снимаю флаг ""Реквизит булево""");
	...
	Ванесса.ДобавитьШагВМассивТестов(ВсеТесты,"ВОткрытойФормеЯСнимаюФлагСИменем(Парам01)","ВОткрытойФормеЯСнимаюФлагСИменем","И     В открытой форме я снимаю флаг с именем ""Реквизит булево""");
	...
	Ванесса.ДобавитьШагВМассивТестов(ВсеТесты,"ЯВижуЭлементСИменем(ИмяЭлемента)",        "ЯВижуЭлемент",               "И я вижу элемент с именем ""Имя элемента""",         "Проверяет видимость элемента на форме", "UI.Формы.Поля.Видимость");
	Ванесса.ДобавитьШагВМассивТестов(ВсеТесты,"ЯВижуЭлементСИменемНаФорме(ИмяЭлемента)", "ЯВижуЭлементНаФорме",        "И я вижу элемент с именем ""Имя элемента"" на форме","Проверяет видимость элемента на форме", "UI.Формы.Поля.Видимость");
	...
	Ванесса.ДобавитьШагВМассивТестов(ВсеТесты,"ЯНеВижуЭлементСИменем(ИмяЭлемента)",       "ЯНеВижуЭлементСИменем",       "И я не вижу элемент с именем ""Имя элемента""",         "Проверяет не видимость элемента на форме","UI.Формы.Поля.Видимость");
	Ванесса.ДобавитьШагВМассивТестов(ВсеТесты,"ЯНеВижуЭлементСИменемНаФорме(ИмяЭлемента)","ЯНеВижуЭлементСИменемНаФорме","И я не вижу элемент с именем ""Имя элемента"" на форме","Проверяет не видимость элемента на форме","UI.Формы.Поля.Видимость");	
	...
	Ванесса.ДобавитьШагВМассивТестов(ВсеТесты,"ЭлементСИменемДоступенДляПросмотра(ИмяЭлемента)",              "ЭлементСИменемДоступенДляПросмотра",              "И элемент с именем ""Имя элемента"" доступен для просмотра",                 "Проверка отсутствия флага ""Только просмотр""","UI.Формы.Поля.Просмотр");
	...
	Ванесса.ДобавитьШагВМассивТестов(ВсеТесты,"ЭлементДоступенНеТолькоДляПросмотра(ИмяЭлемента)",       "ЭлементДоступенНеТолькоДляПросмотра",       "И элемент ""Реквизит1"" доступен не только для просмотра","Проверка установленного флага ""Только просмотр""",         "UI.Формы.Поля.Просмотр");
	Ванесса.ДобавитьШагВМассивТестов(ВсеТесты,"ЭлементСИменемДоступенНеТолькоДляПросмотра(ИмяЭлемента)","ЭлементСИменемДоступенНеТолькоДляПросмотра","И элемент с именем ""Реквизит1"" доступен не только для просмотра","Проверка установленного флага ""Только просмотр""","UI.Формы.Поля.Просмотр");	
...
Процедура ТабличныйДокументФормыСИменемСодержитСтроки(ИмяРеквизита,ТабПарамБыло) Экспорт
	Нашли = Ложь;
	МассивФорм = НайтиФормыТекущегоОкна();
	Ванесса.СчитываниеМакетаКолСтр = 300;
...
&НаКлиенте
//И     поле ""Реквизит2"" присутствует на форме
...
&НаКлиенте
//И     поле с именем ""Реквизит2"" присутствует на форме
...
&НаКлиенте
//И     поле ""Реквизит2"" отсутствует на форме
...
&НаКлиенте
//И     поле с именем ""Реквизит2"" отсутствует на форме
...
&НаКлиенте
Функция ФайлТабличногоДокумента(ИмяВременногоФайла,ИмяЭлементаФормы)
	ИмяВременногоФайла = ПолучитьИмяВременногоФайла("mxl");
	КонтекстСохраняемый.ТестовоеПриложение.УстановитьРезультатДиалогаВыбораФайла(Истина, ИмяВременногоФайла);
...
&НаСервереБезконтекста
Процедура ПроверитьВхождениеСтрокВТабличныйДокументСервер(ФайлМакета,МассивДляПоиска,ЗначенияВходят)
	ИмяВременногоФайла = ПолучитьИмяВременногоФайла("mxl");
...
Процедура ТабличныйДокументСодержитЗначения(ИмяЭлементаФормы,ТабПарам,ЗначенияВходят = Истина) Экспорт
	ИмяВременногоФайла = "";
	ФайлТабличногоДокумента = ФайлТабличногоДокумента(ИмяВременногоФайла,ИмяЭлементаФормы);
	...
	ПроверитьВхождениеСтрокВТабличныйДокументСервер(ФайлТабличногоДокумента,МассивДляПоиска,ЗначенияВходят);
...
&НаСервереБезконтекста
Процедура ПроверитьЗначениеКолонкиНаЗначениеСтроки(ФайлТабличногоДокумента,ИмяКолонки,Значение,ПроверятьРавенство)
	ИмяВременногоФайла = ПолучитьИмяВременногоФайла("mxl");
...
&НаСервереБезконтекста
Процедура ПроверитьЗначениеКолонкиНаЗначениеУсловия(ФайлТабличногоДокумента,ИмяКолонки,ВидСравнения,Значение);
	ИмяВременногоФайла = ПолучитьИмяВременногоФайла("mxl");
	ФайлТабличногоДокумента.Записать(ИмяВременногоФайла);
...
Процедура ВТабличномДокументеЗначенияВКолонкеРавноЗначению(ИмяЭлементаФормы,ИмяКолонки,Значение,ПроверятьРавенство = Истина) Экспорт
	...
	ПроверитьЗначениеКолонкиНаЗначениеСтроки(ФайлТабличногоДокумента,ИмяКолонки,Значение,ПроверятьРавенство);
...
Процедура ВТабличномДокументеЗначенияВКолонкеСоответствуютУсловию(ИмяЭлементаФормы,ИмяКолонки,ВидСравнения,Значение) Экспорт
	...
	ПроверитьЗначениеКолонкиНаЗначениеУсловия(ФайлТабличногоДокумента,ИмяКолонки,ВидСравнения,Значение);
