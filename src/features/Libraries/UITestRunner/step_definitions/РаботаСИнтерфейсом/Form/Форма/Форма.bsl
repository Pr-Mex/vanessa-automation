...
Функция ПолучитьСписокТестов(КонтекстФреймворкаBDD) Экспорт
	...
	Ванесса.ДобавитьШагВМассивТестов(ВсеТесты,"ВТаблицеПолеИмеетЗначение(Парам01,Парам02,Парам03)","ВТаблицеПолеИмеетЗначение","И в таблице ""ИмяТаблицы"" поле ""ИмяПоля"" имеет значение ""ЗначениеПоля""","Проверка значения поля текущей строки таблицы","UI.Таблицы.Значение ячейки таблицы");
	Ванесса.ДобавитьШагВМассивТестов(ВсеТесты,"ВТаблицеПолеСИменемИмеетЗначение(Парам01,Парам02,Парам03)","ВТаблицеПолеСИменемИмеетЗначение","И в таблице ""ИмяТаблицы"" поле с именем ""ИмяПоля"" имеет значение ""ЗначениеПоля""","Проверка значения поля текущей строки таблицы","UI.Таблицы.Значение ячейки таблицы");
