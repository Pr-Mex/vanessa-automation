...
&НаСервере
Функция ПолучитьРасхожденияТД(Макет, ТабПарам)
...
Процедура ТабличныйДокументСодержитЗначенияОбластей(ИмяЭлементаФормы,ТабПарам) Экспорт
	...
	МассивРасхождений = ПолучитьРасхожденияТД(ТабДок, ТабПарам);
