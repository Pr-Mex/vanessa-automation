...
Функция ПолучитьСписокТестов(КонтекстФреймворкаBDD) Экспорт
	...
	Ванесса.ДобавитьШагВМассивТестов(ВсеТесты,"ВТаблицеСтрок(Парам01,Парам02)","ВТаблицеСтрок","И     в таблице ""ТабличнаяЧасть1"" 0 строк","Проверяет количество строк в таблице","");
	Ванесса.ДобавитьШагВМассивТестов(ВсеТесты,"ВТаблицеСтроки(Парам01,Парам02)","ВТаблицеСтроки","И     в таблице ""ТабличнаяЧасть1"" 2 строки","Проверяет количество строк в таблице","");
	Ванесса.ДобавитьШагВМассивТестов(ВсеТесты,"ВТаблицеСтрока(Парам01,Парам02)","ВТаблицеСтрока","И     в таблице ""ТабличнаяЧасть1"" 2 строка","Проверяет количество строк в таблице","");
	Ванесса.ДобавитьШагВМассивТестов(ВсеТесты,"ВТаблицеБольшеИлиРавноСтрок(Парам01,Парам02)","ВТаблицеБольшеИлиРавноСтрок","И     в таблице ""ТабличнаяЧасть1"" больше или равно 2 строк","Проверяет количество строк в таблице","");
	Ванесса.ДобавитьШагВМассивТестов(ВсеТесты,"ВТаблицеБольшеИлиРавноСтроки(Парам01,Парам02)","ВТаблицеБольшеИлиРавноСтроки","И     в таблице ""ТабличнаяЧасть1"" больше или равно 1 строки","Проверяет количество строк в таблице","");
	Ванесса.ДобавитьШагВМассивТестов(ВсеТесты,"ВТаблицеБольшеСтроки(Парам01,Парам02)","ВТаблицеБольшеСтроки","И     в таблице ""ТабличнаяЧасть1"" больше 1 строки","Проверяет количество строк в таблице","");
	Ванесса.ДобавитьШагВМассивТестов(ВсеТесты,"ВТаблицеБольшеСтрок(Парам01,Парам02)","ВТаблицеБольшеСтрок","И     в таблице ""ТабличнаяЧасть1"" больше 0 строк","Проверяет количество строк в таблице","");
	Ванесса.ДобавитьШагВМассивТестов(ВсеТесты,"ВТаблицеМеньшеСтрок(Парам01,Парам02)","ВТаблицеМеньшеСтрок","И     в таблице ""ТабличнаяЧасть1"" меньше 3 строк","Проверяет количество строк в таблице","");
	Ванесса.ДобавитьШагВМассивТестов(ВсеТесты,"ВТаблицеМеньшеСтроки(Парам01,Парам02)","ВТаблицеМеньшеСтроки","И     в таблице ""ТабличнаяЧасть1"" меньше 3 строки","Проверяет количество строк в таблице","");
	Ванесса.ДобавитьШагВМассивТестов(ВсеТесты,"ВТаблицеМеньшеИлиРавноСтрок(Парам01,Парам02)","ВТаблицеМеньшеИлиРавноСтрок","И     в таблице ""ТабличнаяЧасть1"" меньше или равно 2 строк","Проверяет количество строк в таблице","");
	Ванесса.ДобавитьШагВМассивТестов(ВсеТесты,"ВТаблицеМеньшеИлиРавноСтроки(Парам01,Парам02)","ВТаблицеМеньшеИлиРавноСтроки","И     в таблице ""ТабличнаяЧасть1"" меньше или равно 2 строки","Проверяет количество строк в таблице","");
	Ванесса.ДобавитьШагВМассивТестов(ВсеТесты,"ВТаблицеКоличествоСтрокТогда(Парам01,Парам02,Парам03)","ВТаблицеКоличествоСтрокТогда","Если в таблице ""ТабличнаяЧасть1"" количество строк ""меньше или равно"" 2 Тогда","Условие. Проверяет количество строк в таблице","UI.Таблицы.Количество строк","Условие");
	Ванесса.ДобавитьШагВМассивТестов(ВсеТесты,"ВТаблицеКоличествоСтрок(Парам01,Парам02,Парам03)","ВТаблицеКоличествоСтрок","Тогда в таблице ""ТабличнаяЧасть1"" количество строк ""меньше или равно"" 2","Проверка на количество строк в таблице","UI.Таблицы.Количество строк");
...
Процедура ВТаблицеКоличествоСтрок(ИмяТаблицы,Знач Сравнение,КоличествоСтрок) Экспорт
	...
	Если НЕ Результат Тогда
		ВызватьИсключение "В таблице <" + ИмяТаблицы + "> ожидали получить " + СравнениеОригинал + " " + КоличествоСтрок + " строк, а получили <" + Таблица.Количество() + "> строк.";
	КонецЕсли;	 
КонецПроцедуры
