...
Функция ПолучитьСписокТестов(КонтекстФреймворкаBDD) Экспорт
	...
	Ванесса.ДобавитьШагВМассивТестов(ВсеТесты,"ВТаблицеКоличествоСтрокТогда(Парам01,Парам02,Парам03)","ВТаблицеКоличествоСтрокТогда","Если в таблице ""ТабличнаяЧасть1"" количество строк ""меньше или равно"" 2 Тогда","Условие на количество строк в таблице","UI.Таблицы.Количество строк","Условие");
