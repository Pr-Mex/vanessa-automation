...
Функция ПолучитьСписокТестов(КонтекстФреймворкаBDD) Экспорт
	...
	Ванесса.ДобавитьШагВМассивТестов(ВсеТесты,"ВТаблицеСтрок(Парам01,Парам02)","ВТаблицеСтрок","И     в таблице ""ТабличнаяЧасть1"" 0 строк","Проверяет количество строк в таблице","UI.Таблицы.Количество строк");
	...
	Ванесса.ДобавитьШагВМассивТестов(ВсеТесты,"ВТаблицеСтрока(Парам01,Парам02)","ВТаблицеСтрока","И     в таблице ""ТабличнаяЧасть1"" 2 строка","Проверяет количество строк в таблице","UI.Таблицы.Количество строк");
	...
	Ванесса.ДобавитьШагВМассивТестов(ВсеТесты,"ВТаблицеМеньшеСтроки(Парам01,Парам02)","ВТаблицеМеньшеСтроки","И     в таблице ""ТабличнаяЧасть1"" меньше 3 строки","Проверяет количество строк в таблице","UI.Таблицы.Количество строк");
	...
	Ванесса.ДобавитьШагВМассивТестов(ВсеТесты,"ВТаблицеМеньшеИлиРавноСтроки(Парам01,Парам02)","ВТаблицеМеньшеИлиРавноСтроки","И     в таблице ""ТабличнаяЧасть1"" меньше или равно 2 строки","Проверяет количество строк в таблице","UI.Таблицы.Количество строк");
