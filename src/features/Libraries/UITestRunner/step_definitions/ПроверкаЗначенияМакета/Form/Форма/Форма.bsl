...
Функция ПолучитьСписокТестов(КонтекстФреймворкаBDD) Экспорт
	...
	Ванесса.ДобавитьШагВМассивТестов(ВсеТесты,"ТабличныйДокументСоответствуетМакету(Парам01,Парам02)","ТабличныйДокументСоответствуетМакету","И табличный документ ""ТабДок"" соответствует макету ""ИмяТабличногоДокумента""","Сравнивает значения макета с эталоном. Макет ищется сначала в обработке фича файла, затем в каталоге проекта.","UI.Табличный документ.Проверка значения");
	Ванесса.ДобавитьШагВМассивТестов(ВсеТесты,"ОбластьТабличногоДокументаСоответствуетМакету(Парам01,Парам02,Парам03)","ОбластьТабличногоДокументаСоответствуетМакету","И область ""R1C1:R10C10"" табличного документа ""ТабДок"" соответствует макету ""ИмяТабличногоДокумента""","Сравнивает значения указанной области макета с эталоном. Макет ищется сначала в обработке фича файла, затем в каталоге проекта.","UI.Табличный документ.Проверка значения");
...
&НаКлиенте
Процедура ПреобразоватьОбласатьЧтенияДанных(Знач ИмяОбласти,НачСтр,НачКол,КолСтр,КолКол)
...
Процедура ОбластьТабличногоДокументаСоответствуетМакету(ИмяОбласти,ИмяРеквизита,ИмяМакета) Экспорт
	...
	КолКол = -1;
	Попытка
		ПреобразоватьОбласатьЧтенияДанных(ИмяОбласти,НачСтр,НачКол,КолСтр,КолКол);
	Исключение
