...
Функция ПолучитьСписокТестов(КонтекстФреймворкаBDD) Экспорт
	...
	ДобавитьШагВМассивТестов(ВсеТесты,"СуществуетДокументСКодом(Парам01,Парам02)","СуществуетДокументСКодом","Когда Существует документ ""Документ1"" с кодом ""000000001""");
	...
	ДобавитьШагВМассивТестов(ВсеТесты,"СуществуетЭлементСправочникаСКодом(Парам01,Парам02)","СуществуетЭлементСправочникаСКодом","Когда Существует элемент справочника ""Справочник2"" с кодом ""000000001""");
	ДобавитьШагВМассивТестов(ВсеТесты,"ВФормеЭлементаСправочникаСКодомИнтерактивноНажимаюКнопкуПанелиПодменюСИменем(Парам01,Парам02,Парам03,Парам04,Парам05)","ВФормеЭлементаСправочникаСКодомИнтерактивноНажимаюКнопкуПанелиПодменюСИменем","Тогда В форме элемента справочника ""Справочник2"" с кодом ""000000001"" интерактивно нажимаю кнопку панели ""ДействияФормы"" подменю ""Подменю"" с именем ""Действие1""");
	ДобавитьШагВМассивТестов(ВсеТесты,"ВФормеЭлементаСправочникаСКодомИнтерактивноНажимаюКнопкуПанелиСИменем(Парам01,Парам02,Парам03,Парам04)","ВФормеЭлементаСправочникаСКодомИнтерактивноНажимаюКнопкуПанелиСИменем","Тогда В форме элемента справочника ""Справочник2"" с кодом ""000000001"" интерактивно нажимаю кнопку панели ""ДействияФормы"" с именем ""Действие1""");
