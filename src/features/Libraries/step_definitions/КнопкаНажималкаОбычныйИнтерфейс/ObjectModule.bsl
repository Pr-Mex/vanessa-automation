...
Функция ПолучитьСписокТестов(КонтекстФреймворкаBDD) Экспорт
	...
	ДобавитьШагВМассивТестов(ВсеТесты,"ВФормеДокументаСНомеромИнтерактивноНажимаюКнопкуПанелиПодменюСИменем(Парам01,Парам02,Парам03,Парам04,Парам05)","ВФормеДокументаСНомеромИнтерактивноНажимаюКнопкуПанелиПодменюСИменем","Когда В форме документа ""ПрочиеЗатраты"" с номером ""АГ000000001"" интерактивно нажимаю кнопку панели ""ДействияФормы"" подменю ""Подменю"" с именем ""Действие6""");
	ДобавитьШагВМассивТестов(ВсеТесты,"ВФормеДокументаСНомеромИнтерактивноНажимаюКнопкуПанелиСИменем(Парам01,Парам02,Парам03,Парам04)","ВФормеДокументаСНомеромИнтерактивноНажимаюКнопкуПанелиСИменем","Когда В форме документа ""ПрочиеЗатраты"" с номером ""АГ000000001"" интерактивно нажимаю кнопку панели ""ДействияФормы"" с именем ""Действие1""");
	ДобавитьШагВМассивТестов(ВсеТесты,"ВФормеСправочникаСКодомИнтерактивноНажимаюКнопкуПанелиПодменюСИменем(Парам01,Парам02,Парам03,Парам04,Парам05)","ВФормеСправочникаСКодомИнтерактивноНажимаюКнопкуПанелиПодменюСИменем","Когда В форме справочника ""Номенклатура"" с кодом ""NSIN0000982023"" интерактивно нажимаю кнопку панели ""ДействияФормы"" подменю ""Подменю"" с именем ""Действие1""");
	ДобавитьШагВМассивТестов(ВсеТесты,"ВФормеСправочникаСКодомИнтерактивноНажимаюКнопкуПанелиСИменем(Парам01,Парам02,Парам03,Парам04)","ВФормеСправочникаСКодомИнтерактивноНажимаюКнопкуПанелиСИменем","Когда В форме справочника ""Номенклатура"" с кодом ""NSIN0000982023"" интерактивно нажимаю кнопку панели ""ДействияФормы"" с именем ""Настройка""");
