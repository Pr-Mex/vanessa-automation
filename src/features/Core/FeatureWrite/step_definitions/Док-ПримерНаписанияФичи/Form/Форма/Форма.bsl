...
Процедура ЯПишуТекстFeature_файла() Экспорт
	Ванесса.Шаг("И я эмулирую набор текста из файла """ + Ванесса.Объект.КаталогИнструментов + "\features\Core\FeatureWrite\Demo.feature" + """");
КонецПроцедуры
...
Процедура ЯПишуЗаголовокФичи() Экспорт
	Ванесса.Шаг("И я эмулирую набор текста из файла """ + Ванесса.Объект.КаталогИнструментов + "\features\Core\FeatureWrite\Lib\Example01Header.feature" + """");
КонецПроцедуры
...
Процедура ЯПишуСекциюКонтекст() Экспорт
	Ванесса.Шаг("И я эмулирую набор текста из файла """ + Ванесса.Объект.КаталогИнструментов + "\features\Core\FeatureWrite\Lib\Example01Context.feature" + """");
КонецПроцедуры
...
Процедура ЯПишуСекциюСценарий() Экспорт
	Ванесса.Шаг("И я эмулирую набор текста из файла """ + Ванесса.Объект.КаталогИнструментов + "\features\Core\FeatureWrite\Lib\Example01Scenario.feature" + """");
КонецПроцедуры
...
Процедура ЯПишуСекциюСтруктураСценария() Экспорт
	Ванесса.Шаг("И я эмулирую набор текста из файла """ + Ванесса.Объект.КаталогИнструментов + "\features\Core\FeatureWrite\Lib\Example01ScenarioOutline.feature" + """");
КонецПроцедуры
