...
Функция ПолучитьСписокТестов(КонтекстФреймворкаBDD) Экспорт
	...
	Ванесса.ДобавитьШагВМассивТестов(ВсеТесты,"ЯВыделаюСтрокиНачинаяСИВставляюИхПосле(Парам01,Парам02,Парам03)","ЯВыделаюСтрокиНачинаяСИВставляюИхПосле","И я выделаю 4 строки начиная с ""В панели разделов"" и вставляю их после ""Когда я открываю журнал""");
	Ванесса.ДобавитьШагВМассивТестов(ВсеТесты,"Ывавыаыва()","Ывавыаыва","И ывавыаыва");
	Ванесса.ДобавитьШагВМассивТестов(ВсеТесты,"ЯОткрываюВТекстовомРедактореФайл(Парам01)","ЯОткрываюВТекстовомРедактореФайл","И я открываю в текстовом редакторе файл ""Support\Instructions\Temp\ФичаПримерТегTree.feature""");
	...
	Ванесса.ДобавитьШагВМассивТестов(ВсеТесты,"ЯСоздаюНовыйДокументПриходнаяНакладная()","ЯСоздаюНовыйДокументПриходнаяНакладная","И я Создаю новый документ Приходная накладная");
...
//@ЯСоздаюНовыйДокументПриходнаяНакладная()
Процедура ЯСоздаюНовыйДокументПриходнаяНакладная() Экспорт
...
&НаКлиенте
//И я выделаю 4 строки начиная с "В панели разделов" и вставляю их после "Когда я открываю журнал"
//@ЯВыделаюСтрокиНачинаяСИВставляюИхПосле(Парам01,Парам02,Парам03)
Процедура ЯВыделаюСтрокиНачинаяСИВставляюИхПосле(КолСтрок,Стр1,Стр2) Экспорт
	...
	Результат = Ванесса.ВыполнитьSikuliСкрипт(Ванесса.Объект.КаталогИнструментов + "\tools\Sikuli\TypeTAB.sikuli");
	Ванесса.ПроверитьРавенство(Результат, 0 , "Произошло выполнение скрипта <TypeTAB>");
	Результат = Ванесса.ВыполнитьSikuliСкрипт(Ванесса.Объект.КаталогИнструментов + "\tools\Sikuli\TypeTAB.sikuli");
	Ванесса.ПроверитьРавенство(Результат, 0 , "Произошло выполнение скрипта <TypeTAB>");
