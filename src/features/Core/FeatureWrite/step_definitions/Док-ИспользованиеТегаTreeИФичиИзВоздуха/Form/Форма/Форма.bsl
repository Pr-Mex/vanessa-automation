...
Функция ПолучитьСписокТестов(КонтекстФреймворкаBDD) Экспорт
	...
	Ванесса.ДобавитьШагВМассивТестов(ВсеТесты,"ЯВыделяюСтрокиНачинаяСИВставляюИхВТекстФичиПосле(Парам01,Парам02,Парам03)","ЯВыделяюСтрокиНачинаяСИВставляюИхВТекстФичиПосле","И я выделяю 4 строки начиная с ""В панели разделов"" и вставляю их в текст фичи после ""Когда я открываю журнал""");
