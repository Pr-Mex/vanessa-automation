...
Функция ПолучитьСписокТестов(КонтекстФреймворкаBDD) Экспорт
	...
	Ванесса.ДобавитьШагВМассивТестов(ВсеТесты,"ЯВыделяюСтрокиНачинаяСИВставляюИхПосле(Парам01,Парам02,Парам03)","ЯВыделяюСтрокиНачинаяСИВставляюИхПосле","И я выделяю 4 строки начиная с ""В панели разделов"" и вставляю их после ""Когда я открываю журнал""");
...
&НаКлиенте
//И я выделяю 4 строки начиная с "В панели разделов" и вставляю их после "Когда я открываю журнал"
//@ЯВыделяюСтрокиНачинаяСИВставляюИхПосле(Парам01,Парам02,Парам03)
Процедура ЯВыделяюСтрокиНачинаяСИВставляюИхПосле(КолСтрок,Стр1,Стр2) Экспорт
