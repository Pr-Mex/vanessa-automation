...
Процедура ВТаблицеНомерБудетКолонки(НомерТаблицы,КоличествоКолонок) Экспорт
	Если Контекст.МассивТаблиц[НомерТаблицы-1][0]._КоличествоКолонок <> КоличествоКолонок Тогда
		ВызватьИсключение "Ожидали в таблице №" + НомерТаблицы + " получить " + КоличествоКолонок + " колонок. А получили " + Контекст.МассивТаблиц[НомерТаблицы-1][0]._КоличествоКолонок;
	КонецЕсли;	 
КонецПроцедуры
