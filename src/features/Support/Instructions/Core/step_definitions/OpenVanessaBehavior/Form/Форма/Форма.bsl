...
Функция ПолучитьСписокТестов(КонтекстФреймворкаBDD) Экспорт
	...
	ДобавитьШагВМассивТестов(ВсеТесты,"ЯЗапускаю1СВРежимеКлиентаТестирвания()","ЯЗапускаю1СВРежимеКлиентаТестирвания","Дано Я запускаю 1С в режиме клиента тестирвания");
	ДобавитьШагВМассивТестов(ВсеТесты,"ЯВЗапущеномЭкземпляре1СВРежимеКлиентаТесторованияОткрываюОбработкуVanessa_behavior()","ЯВЗапущеномЭкземпляре1СВРежимеКлиентаТесторованияОткрываюОбработкуVanessa_behavior","И Я в запущеном экземпляре 1С в режиме клиента тесторования открываю обработку vanessa-behavior");
	ДобавитьШагВМассивТестов(ВсеТесты,"ЯЗакрываюЗапущенныйВРежимеКлиентТестированияЭкземпляр1С()","ЯЗакрываюЗапущенныйВРежимеКлиентТестированияЭкземпляр1С","Дано Я закрываю запущенный в режиме клиент тестирования экземпляр 1С");
