...
Функция ПолучитьСписокТестов(КонтекстФреймворкаBDD) Экспорт
	...
	Ванесса.ДобавитьШагВМассивТестов(ВсеТесты,"ЯПерехожуКНачалуСтроки()","ЯПерехожуКНачалуСтроки","И я перехожу к началу строки");
...
//@ЯПерехожуКНачалуСтроки()
Процедура ЯПерехожуКНачалуСтроки() Экспорт
