...
Функция ПолучитьСписокТестов(КонтекстФреймворкаBDD) Экспорт
	...
	Ванесса.ДобавитьШагВМассивТестов(ВсеТесты,"Выпавыпвап()","Выпавыпвап","И выпавыпвап");
	...
	Ванесса.ДобавитьШагВМассивТестов(ВсеТесты,"ЯСохраняюФайлОткрытыйВРедактореКак(Парам01)","ЯСохраняюФайлОткрытыйВРедактореКак","И я сохраняю файл открытый в редакторе как ""Support\Instructions\Temp\СозданиеОдногоЭлементаСправочника2.feature""");
...
Процедура УдалитьСлужебныеФайлы()
	Путь = Ванесса.Объект.КаталогИнструментов + "\features\Support\Instructions\Temp\СозданиеОдногоЭлементаСправочника2.feature";
	Если Ванесса.ФайлСуществуетКомандаСистемы(Путь) Тогда
		Ванесса.УдалитьФайлыКомандаСистемы(Путь);
	КонецЕсли;	 
	
	Путь = Ванесса.Объект.КаталогИнструментов + "\features\Support\Instructions\Temp\СозданиеНесколькихЭлементовСправочника2.feature";
	Если Ванесса.ФайлСуществуетКомандаСистемы(Путь) Тогда
		Ванесса.УдалитьФайлыКомандаСистемы(Путь);
	КонецЕсли;	 
КонецПроцедуры
