...
Функция ПолучитьСписокТестов(КонтекстФреймворкаBDD) Экспорт
	...
	Ванесса.ДобавитьШагВМассивТестов(ВсеТесты,"ЯВыбираюТекщуюСтроку()","ЯВыбираюТекщуюСтроку","И я выбираю текщую строку");
...
//@ЯВыбираюТекщуюСтроку()
Процедура ЯВыбираюТекщуюСтроку() Экспорт
	Ванесса.Шаг("И я набираю текст ""#enter""");
КонецПроцедуры
