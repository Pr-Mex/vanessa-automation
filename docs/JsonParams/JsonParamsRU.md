...
*  Отчеты Allure, jUnit, СППР, Cucumber
...
*  Автоинструкции при работе с браузером
...
*  Эмуляция действий мышки

      * **ЭмулироватьДвиженияМышкиVanessaExt {emulatemousemovementswithVanessaExt}**:
         Включает эмуляцию движения мышки с помощью компоненты VanessaExt. По умолчанию опция включает перемещение мышки, когда клиентом тестирования является браузер. Для тонкого и толстого клиента нужно включать режим UI Automation.
