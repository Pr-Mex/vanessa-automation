...
*  Дымовые тесты
      ...
      * **КаталогГенерированияДымовыхТестов {SmokeTestGenerationPath}**:
         Каталог, в который будут записаны итоговые feature-файлы

      * **КаталогФайловИсключаемыхОбъектовИзДымовогоТестирования {CatalogOfFilesOfExcludedObjectsFromTheSmokeTest}**:
         Каталог, в котором хранятся текстовые файлы с объектами-исключениями.

      * **ПутьНастройкиСценариеДымовыхТестов {TheSetupPathOfTheSmokeTestScenario}**:
      ...
      * **ИмяКонфигурацииПоставщика {NameOfTheVendorConfiguration}**:
         Имя конфигурации поставщика для сравнения конфигураций

      * **ТолькоИзмененныеОтносительноКонфигурацииПоставщикаДляДымовогоТестирования {OnlyChangedRelativelyProviderConfiguration}**:
      ...
      * **ТолькоВведенныеОбъектыДляДымовогоТестирования {OnlyEnteredObjects}**:
