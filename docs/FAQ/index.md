...
28. Как ускорить работу Vanessa Automation при локальной работе.
       - Если в конфигурации, в которой происходио локальный запуск Vanessa Automation запрещены синхронные вызовы, то лучше запускать сеанс 1С не из конфигуратора.
