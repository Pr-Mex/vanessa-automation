...
* Текущий статус выполнения всех шагов #842 Спасибо @KrapivinAndrey
...
* Загрузка макетов VAEditor и VanessaExt при сборке. #999
...
* Проверка что строка с путем к библиотекеVA не пустая #815 Спасибо @KrapivinAndrey
