...
* Cравнятор фич надо добавить не только в панели гита но и с произвольным файлом #1220
...
* Уважение к параметрам из файла VAParams. #1254
...
* Расширение синтаксиса языка Gherkin. Новая секция в фиче - Переменные #1278 Спасибо @lintest
* Расширение синтаксиса языка Gherkin. В параметрах шагов можно использовать символы {} для вычисления выражений #1279 Спасибо @lintest
* Показывать в табло переменных содержимое Структур, Соответствий и Массивов. #1293
* Возможность приеладывать скриншоты в формате отчетов junit #1162 Спасибо @KrapivinAndrey
...
* Доработки генератора тестовых данных: #1307 Спасибо @Teomit
   ...
   2. Поддержка реквизитов с русскими именами, совпадающиими с системными реквизитами
...
* Управление отображением контекстного меню редактора #1305 Спасибо @lintest
