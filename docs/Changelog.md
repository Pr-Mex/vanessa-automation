...
* Расширение синтаксиса языка Gherkin. Новая секция в фиче - Переменные #1278
* Расширение синтаксиса языка Gherkin. В параметрах шагов можно использовать символы {} для вычисления выражений #1279
