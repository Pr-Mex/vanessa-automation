...
## 1.2.031
### Новые возможности
* Использование компоненты 1cWinCtrl в отчетах Allure. #710
...
* Перевод снятия скриншотов окна на внешнюю компоненту 1cWinCtrl. #720
* Формирование корректных имен скриншотов в отчете Allure при использовании компоненты 1cWinCtrl. #721
* Возможность передавать несколько переменных в один параметр шага. #728
...
* Сохранение представления текущего поля в переменную. И я запоминаю представление текущего поля как "ИмяПеременной". #735
...
* Подключение внешней компоненты 1cWinCtrl без перезапуска 1C #683 Спасибо @lintest
...
* Снимать скриншоты новой компонентой 1cWinCtrl если стоит необходимый флаг #637 Спасибо @ViktorErmakov
...
* Добавлена внешняя компонента 1cWinCtrl #600 Спасибо @lintest 
