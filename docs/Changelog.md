...
* Описание параметров запуска из командной строки #517 @fenixnow
...
* Возможность указания произвольного текста в markdown-разметке #588 @alexey-stepanenko 
* Добавлены шаги для работы с объектами ИБ #573 @theshadowco
...
### Новые шаги
* Шаг выбора внешнего файла с индексом фильтра #589 @asosnoviy
...
### Разные доработки
* Безопасный способ записи HTML-инструкции #597 @lintest
...
* Разные типы при сравнении #519 @hawk911
* Юнит тесты для ассертов #580 @DoublesunRUS
* Доработка определения модальных диалогов #570. Спасибо @gatinv
* Переделал логику "ОжидаемЗавершенияФоновогоФормированияОтчетаВТечениеСекунд. #592 @rentgengl
