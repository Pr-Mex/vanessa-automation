...
Функция ПолучитьСписокТестов(КонтекстФреймворкаBDD) Экспорт
	...
	Ванесса.ДобавитьШагВМассивТестов(ВсеТесты,"ВТестируемомЭкземпляреЯУстановилФлагВ(Парам01,Парам02)","ВТестируемомЭкземпляреЯУстановилФлагВ","И в тестируемом экземпляре я установил флаг ""ВыполнятьШагиАсинхронно"" в ""Ложь""","","");
...
&НаКлиенте
Процедура ОбработчикЯЖдуКогдаВТестируемомЭкземпляреРеквизитФормыБудетРавенВТечениеСекунд()
	ИмяОбработчика = "ОбработчикЯЖдуКогдаВТестируемомЭкземпляреРеквизитФормыБудетРавенВТечениеСекунд";
...
Процедура ЯЖдуКогдаВТестируемомЭкземпляреРеквизитФормыБудетРавенВТечениеСекунд(ИмяРеквизита,ЗначениеСтрока,КолСекунд) Экспорт
	...
	ПодключитьОбработчикОжидания("ОбработчикЯЖдуКогдаВТестируемомЭкземпляреРеквизитФормыБудетРавенВТечениеСекунд",1,Ложь);
КонецПроцедуры
