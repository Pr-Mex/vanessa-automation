...
Функционал: Инструкция по использованию флага "ОстановкаПриВозникновенииОшибки"
	Как Разработчик
	Я Хочу чтобы если флаг ОстановкаПриВозникновенииОшибки установлен, тогда выполнение всех сценариев останавливалось при возникновении первой ошибки
...
Сценарий: Остановка выполнения всех сценариев при возникновении первой ошибки
	...
	И теперь мы ещё раз выполним нашу фичу
			...
			И Я нажимаю на кнопку Выполнить Сценарии
			И Пауза 5
			И обратите внимание 'Обратите внимание. Второй сценарий не был выполнен.'
