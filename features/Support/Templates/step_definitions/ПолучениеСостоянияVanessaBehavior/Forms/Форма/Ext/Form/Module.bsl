...
Функция ПолучитьСписокТестов(КонтекстФреймворкаBDD) Экспорт
	...
	ДобавитьШагВМассивТестов(ВсеТесты,"ЯПолучаюСостояниеVanessaBehvior()","ЯПолучаюСостояниеVanessaBehvior","Когда я получаю состояние Vanessa Behvior");
...
Процедура ПередНачаломСценария() Экспорт
	СостояниеVanessaBehvior = Ванесса.ПолучитьСостояниеVanessaAutomation();
КонецПроцедуры
