...
Функция ПолучитьСписокТестов(КонтекстФреймворкаBDD) Экспорт
	...
	Ванесса.ДобавитьШагВМассивТестов(ВсеТесты,"ЯПрерываюВыполнениеШаговИВызывыаюСпециальнуюПроцедуруВКоторойЕстьОповещение()","ЯПрерываюВыполнениеШаговИВызывыаюСпециальнуюПроцедуруВКоторойЕстьОповещение","Когда я прерываю выполнение шагов и вызывыаю специальную процедуру, в которой есть оповещение");
	Ванесса.ДобавитьШагВМассивТестов(ВсеТесты,"ЯСмогуПроверитьЧтоПеременнаяКонтекстИмеетТипСтруктура()","ЯСмогуПроверитьЧтоПеременнаяКонтекстИмеетТипСтруктура","Тогда я смогу проверить что переменная контекст имеет тип Структура");
