...
Функция ПолучитьСписокТестов(КонтекстФреймворкаBDD) Экспорт
	...
	Ванесса.ДобавитьШагВМассивТестов(ВсеТесты,"ЯВыполняюДействияДляЗагрузкиFeature_файла()","ЯВыполняюДействияДляЗагрузкиFeature_файла","Когда Я выполняю действия для загрузки feature-файла");
