...
Процедура ПередОкончаниемСценария() Экспорт
	...
	Если Файл.Существует() Тогда
		Ванесса.ПолучитьФорму("Форма").СообщитьПользователю("ПередОкончаниемСценария(). Удаляю файл " + ИмяОжидаемогоФайла);
...
Процедура ЯНажалНаКнопку(ИмяКнопки) Экспорт
	...
	Иначе
		ТекстСообщения = "Не получилось обработать нажатие кнопки: %1";
