...
Функция ПолучитьСписокТестов(КонтекстФреймворкаBDD) Экспорт
	...
	Ванесса.ДобавитьШагВМассивТестов(
		ВсеТесты,
		"ЯВставляюРазрывСтраницыВАвтоинструкцию(Парам)",
...
//И я вставляю разрыв страницы в автоинструкцию
//@ЯВставляюРазрывСтраницыВАвтоинструкцию()
Функция ЯВставляюРазрывСтраницыВАвтоинструкцию(Парам = Неопределено) Экспорт
	...
	Иначе
		ВызватьИсключение НСтр("ru = 'У шага нет параметров'");
	КонецЕсли;
