...
Функция ПолучитьСписокТестов(КонтекстФреймворкаBDD) Экспорт
	...
	Ванесса.ДобавитьШагВМассивТестов(ВсеТесты, "КликНаТекст(Парам01)", "КликНаТекст","Затем клик на текст ""Текст""",
		...
		|Готовить файл не нужно: VA сама рисует картинку из переданного текста и ищет её на экране. Поиск нечёткий — SikuliX сравнивает по похожести, а не пиксель в пиксель, — но нарисованная надпись всё равно должна быть близка к экранной, иначе похожести не хватит. Поэтому шрифт, размер и цвета подгоняют под интерфейс шагом <И я устанавливаю основной профиль цвета>.
		...
		|### Пример. Клик по надписи на экране
		|```Gherkin
	...
	Ванесса.ДобавитьШагВМассивТестов(ВсеТесты, "КликПравойКнопкойНаТекст(Парам01)", "КликПравойКнопкойНаТекст","Дано клик правой кнопкой на текст ""Текст""",
		...
		|### Пример. Контекстное меню по надписи
		|```Gherkin
		|	И я запускаю SikuliX сервер
	...
	Ванесса.ДобавитьШагВМассивТестов(ВсеТесты, "КурсорККартинке(Парам01)", "КурсорККартинке","Дано курсор к картинке ""ИмяКартинки""",
		...
		|Курсор переезжает в центр найденной картинки, но не нажимает. Пригождается везде, где важно само наведение: всплывающая подсказка, меню, раскрывающееся по наведению, подсветка элемента под курсором. В видеоинструкциях им же показывают зрителю, куда смотреть, до того как произойдёт клик.
	...
	+ Символы.ПС + "Обе картинки должны быть видны на экране одновременно, иначе шаг не найдёт одну из них и упадёт. Правила поиска файлов картинок — как у <Затем клик на картинку ""ИмяКартинки"">."
	...
	+ Символы.ПС + "```"
	+ Символы.ПС + "### Пример. Стрелка от центра экрана"
	+ Символы.ПС + "Первый параметр пустой — стрелка пойдёт из центра экрана."
	+ Символы.ПС + "```Gherkin"
	...
	+ Символы.ПС + "### Пример. Стрелка между надписями на экране"
	+ Символы.ПС + "```Gherkin"
	...
	Ванесса.ДобавитьШагВМассивТестов(ВсеТесты, "ЯЗапускаюSikuliXСервер()", "ЯЗапускаюSikuliXСервер","И я запускаю SikuliX сервер",
		...
		|Для поиска картинок сервер больше не нужен: эту работу взяла на себя компонента VanessaExt, она быстрее и не требует Java. Отдельный сервер остался ради того, чего компонента не умеет, — генерации картинок из текста и хоткеев.
	...
	Ванесса.ДобавитьШагВМассивТестов(ВсеТесты, "ЯНажимаюХоткей(Парам01,Парам02)", "ЯНажимаюХоткей","Дано я нажимаю хоткей ""ХотКей"" ""Модификатор""",
		...
		|Первый параметр — сама клавиша, второй — модификатор: `ctrl`, `alt`, `shift`. Регистр модификатора не важен. Если модификатор не нужен, передают `no`.
		...
		|### Пример. Поиск по тексту в конфигураторе
		|```Gherkin
		|	И я запускаю SikuliX сервер
		|	Дано я нажимаю хоткей 'f' 'ctrl'
	...
	Ванесса.ДобавитьШагВМассивТестов(ВсеТесты, "ЯОпределяюКоординатыКартинкиКак(Парам01,Парам02)", "ЯОпределяюКоординатыКартинкиКак","И я определяю координаты картинки ""ИмяКартинки"" как ""ИмяПеременной""",
		...
		|Так связывают поиск по картинке с эффектами, которые сами картинок не ищут: сначала находим область на экране, потом рисуем поверх неё.
	...
	|Профилей можно завести несколько и переключаться между ними шагом <И я устанавливаю профиль цвета ""ИмяПрофиля"">; этот шаг задаёт профиль, который используется по умолчанию.
	...
	|То же, что <И я устанавливаю основной профиль цвета>, но профиль получает имя и его можно завести не один. Нужно, когда в одном сценарии текст ищется в разных местах интерфейса: в списке шрифт один, в шапке отчёта другой, в чужом приложении третий.
	|### Пример. Отдельный профиль для заголовков
	|```Gherkin
	|	И я запускаю SikuliX сервер
	...
	Ванесса.ДобавитьШагВМассивТестов(ВсеТесты, "ЯПоказываюПодсказкуEnjoyHintУКартинкиНаЭкране(Парам01,Парам02,ТабПарам)",
		...
		|Правила поиска файла картинки — как у <Затем клик на картинку ""ИмяКартинки"">. Шаг ничего не проверяет, он для видеоинструкций.
	...
	Ванесса.ДобавитьШагВМассивТестов(ВсеТесты,
		...
		|Отличие от <И я определяю координаты картинки ""ИмяКартинки"" как ""ИмяПеременной""> — в форме результата: тот кладёт структуру в одну переменную, а этот раскладывает координаты по шести отдельным. Их удобно подставлять поодиночке в шаги, которые принимают числа.
	...
	Ванесса.ДобавитьШагВМассивТестов(ВсеТесты,
		...
		|`transparency` — плотность затемнения от 0 до 255, `duration` — сколько миллисекунд держать эффект, `thickness` — толщина рамки выреза, `frameDelay` — задержка между кадрами анимации, `text` — подпись рядом с вырезом.
