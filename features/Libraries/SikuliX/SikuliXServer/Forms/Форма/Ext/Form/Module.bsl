...
Функция ПолучитьСписокТестов(КонтекстФреймворкаBDD) Экспорт
	...
	+ Символы.ПС + "- Цвет (Color) - строка, из перечисления WebЦвета, например ""Зеленый""."
	+ Символы.ПС + "- Длительность (Duration) - сколько милисекунд рамка будет находится на экране, например - 2000.","Прочее.SikuliX");
...
Процедура ЯРисуюРамкуВокругКартинки(ИмяКартинки, ТабПарам) Экспорт
	...
	СтрокаКоманды = ИмяФайлРамки + " %1 %2 %3 %4 %5 %6 %7 %8 %9";	
