...
Функция ПолучитьСписокТестов(КонтекстФреймворкаBDD) Экспорт
	...
	Ванесса.ДобавитьШагВМассивТестов(ВсеТесты, "КликНаТекст(Парам01)", "КликНаТекст","Затем клик на текст ""Текст""",
		...
		|Готовить файл не нужно: VA сама рисует картинку из переданного текста и ищет её на экране. Расплата — совпадение должно быть попиксельным, поэтому шрифт, размер и цвета в профиле должны в точности повторять то, что на экране; настраивается это шагом <И я устанавливаю основной профиль цвета>.
	...
	Ванесса.ДобавитьШагВМассивТестов(ВсеТесты, "КликПравойКнопкойНаТекст(Парам01)", "КликПравойКнопкойНаТекст","Дано клик правой кнопкой на текст ""Текст""",
		...
		|Правый клик по варианту с генерацией картинки из текста — все оговорки те же, что у <Затем клик на текст ""Текст"">: нужен сервер SikuliX, попиксельное совпадение шрифта и настроенный профиль цвета. Шаг устаревший.
	...
	Ванесса.ДобавитьШагВМассивТестов(ВсеТесты, "КурсорККартинке(Парам01)", "КурсорККартинке","Дано курсор к картинке ""ИмяКартинки""",
		...
		|Курсор переезжает в центр найденной картинки, но не нажимает. Нужен в двух случаях: показать всплывающую подсказку или раскрыть меню, которое реагирует на наведение, — и в видеоинструкциях, чтобы зритель видел, куда смотреть, до того как произойдёт клик.
