...
Функция ПолучитьСписокТестов(КонтекстФреймворкаBDD) Экспорт
	...
	Ванесса.ДобавитьШагВМассивТестов(ВсеТесты, "КликНаКартинку(Парам01)", "КликНаКартинку","Затем клик на картинку ""ИмяКартинки""","Эмулирует клик левой кнопкой мышки по картинке. Картинка, поиск которой будет происходить на экране, должна находиться в каталоге проекта.", "Прочее.VanessaExt.Клик на картинку");
	...
	Ванесса.ДобавитьШагВМассивТестов(ВсеТесты, "КурсорККартинке(Парам01)", "КурсорККартинке","Дано курсор к картинке ""ИмяКартинки""","Эмулирует перемещение курсора мышки к картинке. Картинка, поиск которой будет происходить на экране, должна находиться в каталоге проекта.", "Прочее.VanessaExt.Курсор к картинке");
	...
	Ванесса.ДобавитьШагВМассивТестов(ВсеТесты, "ДвойнойКликНаКартинку(Парам01)", "ДвойнойКликНаКартинку","Дано двойной клик на картинку ""ИмяКартинки""","Делает двойной клик по картинке. Картинка, поиск которой будет происходить на экране, должна находиться в каталоге проекта.", "Прочее.VanessaExt.Клик на картинку");
	...
	Ванесса.ДобавитьШагВМассивТестов(ВсеТесты, "ЯПеретаскиваюКартинкуК(Парам01,Парам02)", "ЯПеретаскиваюКартинкуК","И я перетаскиваю картинку ""ИмяКартинки1"" к ""ИмяКартинки2""","Эмулирует Drag-and-drop от ""ИмяКартинки1"" к ""ИмяКартинки2"". Картинки, поиск которых будет происходить на экране, должны находиться в каталоге проекта.", "Прочее.VanessaExt.Перетаскивание картинки");
