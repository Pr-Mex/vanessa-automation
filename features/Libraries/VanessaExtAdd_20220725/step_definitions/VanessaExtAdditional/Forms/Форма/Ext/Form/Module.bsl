...
Функция ПолучитьСписокТестов(КонтекстФреймворкаBDD) Экспорт
	...
	Ванесса.ДобавитьШагВМассивТестов(ВсеТесты,"ЯРисуюРамкуПоКоординатам(Парам01,Парам02,Парам03,Парам04,ТабПарам)","ЯРисуюРамкуПоКоординатам","И Я рисую рамку по координатам 'ФигураX' 'ФигураY' 'ФигураW' 'ФигураH' 'ТабПараметрыРисования'",
										"Отрисовка рамки по координатам ""ТочкаX"" ""ТочкаY"" ""Длина"" ""Ширина"". Также указывается цвет рамки, задержка итд. Пример: 
										|Я рисую рамку по координатам ""542"" ""153"" ""34"" ""34""
										|        |'Цвет'      | 'Красный'    |
										|        |'Длительность'  | '2000'       |
										|        |'Прозрачность'   | '127'         |
										|        |'Толщина'     | '2'         |",
										"Прочее.VanessaExt.Фигуры по координатам");
	Ванесса.ДобавитьШагВМассивТестов(ВсеТесты,"ЯРисуюЭллипсПоКоординатам(Парам01,Парам02,Парам03,Парам04,ТабПарам)","ЯРисуюЭллипсПоКоординатам","И Я рисую эллипс по координатам 'ФигураX' 'ФигураY' 'ФигураW' 'ФигураH' 'ТабПараметрыРисования'",
										"Отрисовка эллипса (овала) по координатам ""ТочкаX"" ""ТочкаY"" ""Длина"" ""Ширина"". Также указывается цвет рамки, задержка итд. Пример: 
										|Я рисую эллипс по координатам ""542"" ""153"" ""34"" ""34""
										|        |'Цвет'      | 'Красный'    |
										|        |'Длительность'  | '2000'       |
										|        |'Прозрачность'   | '127'         |
										|        |'Толщина'     | '2'         |"
										,"Прочее.VanessaExt.Фигуры по координатам");
	Ванесса.ДобавитьШагВМассивТестов(ВсеТесты,"ЯРисуюТеньПоКоординатамТекстНадписи(Парам01,Парам02,Парам03,Парам04,ТекстНадписи,ТабПарам)","ЯРисуюТеньПоКоординатамТекстНадписи","И Я рисую тень по координатам 'ФигураX' 'ФигураY' 'ФигураW' 'ФигураH' текст надписи 'ТекстНадписи' 'ТабПараметрыРисования'",
										...
										|Я рисую тень по координатам ""100"" ""100"" ""1000"" ""400"" текст надписи ""Текст подсказки""
										|        |'Цвет'      | 'Красный'    |
										|        |'Длительность'  | '2000'       |
										|        |'Прозрачность'   | '127'         |
										|        |'Толщина'     | '2'         |"
										,"Прочее.VanessaExt.Фигуры по координатам");
	Ванесса.ДобавитьШагВМассивТестов(ВсеТесты,"ЯРисуюНадписьПоТочкамТекстНадписи(Парам01,Парам02,ТекстНадписи,ТабПарам)","ЯРисуюНадписьПоТочкамТекстНадписи","И Я рисую надпись по точкам 'ФигураX' 'ФигураY' текст надписи 'ТекстНадписи' 'ТабПараметрыРисования'",
										...
										|Я рисую надпись по точкам ""100"" ""150"" текст надписи ""Привет Мир!""
										|        'ЦветШрифта'      | 'Красный'    |
										|        'РазмерШрифта'      | '14'    |
										|        'Длительность'  | '2000'       |
										|        'Прозрачность'   | '127'         |
										|        'Толщина'     | '2'         |"
										,"Прочее.VanessaExt.Фигуры по координатам");
	Ванесса.ДобавитьШагВМассивТестов(ВсеТесты,"ЯРисуюПодсказку_балонПоТочкамТекстНадписи(Парам01,Парам02,Парам03,ТабПарам)","ЯРисуюПодсказку_балонПоТочкамТекстНадписи","И Я рисую подсказку-балон по точкам 'ФигураX' 'ФигураY' текст надписи 'ТекстНадписи' 'ТабПараметрыРисования'",
										...
										|Я рисую подсказку-балон по точкам ""100"" ""150"" текст надписи ""Привет Мир!""
										|        'ЦветШрифта'      | 'Красный'    |
										|        'РазмерШрифта'      | '14'    |
										|        'Длительность'  | '2000'       |
										|        'Прозрачность'   | '127'         |
