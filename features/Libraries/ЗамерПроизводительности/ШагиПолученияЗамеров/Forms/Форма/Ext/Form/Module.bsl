...
Функция ПолучитьСписокТестов(КонтекстФреймворкаBDD) Экспорт
	...
	Ванесса.ДобавитьШагВМассивТестов(
		...
		|### Пример. Включить замер и обмерить участок сценария
		|Замер включается один раз в начале, дальше обмеряется нужный кусок сценария.
		|```Gherkin
	...
	Ванесса.ДобавитьШагВМассивТестов(
		...
		|Работает только вместе с <Допустим я буду выполнять замер производительности 'ВыполнятьЗамер''>: если замер не включен,
		...
		|Не достучались до сервера — шаг не падает: он пишет сообщение и выключает замер до конца прогона.
		|Результат замера смотрят там же, где обычно, — в конфигураторе или EDT.
		|### Пример. Обмерить проведение документа
