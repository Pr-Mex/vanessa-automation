...
Функция ПолучитьСписокТестов(КонтекстФреймворкаBDD) Экспорт
	...
	Ванесса.ДобавитьШагВМассивТестов(ВсеТесты,"ЯБудуВыполнятьЗамерПроизводительности(Парам01, Парам02, Парам03)","ЯБудуВыполнятьЗамерПроизводительности","Допустим я буду выполнять замер производительности 'Выполнять' 'Адрес' 'Порт'","","");
...
Функция ТелоЗапросаВключитьЗамер()
	...
	Возврат Ванесса.Объект.ДополнительныеПараметры.ПараметрыЗамера.Мекеты.ВключитьЗамер; 
...
Функция ТелоЗапросаВыключитьЗамер()
	...
	Возврат Ванесса.Объект.ДополнительныеПараметры.ПараметрыЗамера.Мекеты.ВыключитьЗамер; 
...
Процедура ИнициализацияЗамера()
	...
	ПараметрыЗамера.Вставить("Мекеты", Макеты);
...
Функция РазложитьСтрокуАдресОтладчика(АдресОтладчика)
	...
	ПозицияРазделителя = СтрНайти(СтрокаОтладки, ":", НаправлениеПоиска.СКонца);
