...
Сценарий: Проверка состояния ТЧ
	...
	И     таблица формы с именем "ТабличнаяЧасть1" содержит строки:
		| 'Реквизит справочник' | 'N' | 'Реквизит дата' | 'Реквизит справочник выбор из формы списка' | 'Реквизит строка' | 'Реквизит булево' | 'Реквизит число' |
		| 'ТестовыйЭлемент21'   | '1' | '11.09.1983'    | 'ТестовыйЭлемент21'                         | 'ТестСтрока'      | 'Да'              | '56,78'          |
		| 'ТестовыйЭлемент20'   | '2' | '15.05.1987'    | ''                                          | 'СтрокаТест'      | 'Нет'             | '12,58'          |
	...
	И     таблица формы с именем "ТабличнаяЧасть1" содержит строки:
		| 'Реквизит справочник' | 'N' | 'Реквизит справочник выбор из формы списка' | 'Реквизит строка' | 'Реквизит булево' | 'Реквизит число' | 'Реквизит дата' |
		| 'ТестовыйЭлемент20'   | '2' | ''                                          | 'СтрокаТест'      | 'Нет'             | '12,58'          | '15.05.1987'    |
		| 'ТестовыйЭлемент21'   | '1' | 'ТестовыйЭлемент21'                         | 'ТестСтрока'      | 'Да'              | '56,78'          | '11.09.1983'    |

	# смена порядка строк + смена порядка столбцов + меньше колонок для проверки
	И     таблица формы с именем "ТабличнаяЧасть1" содержит строки:
		| 'Реквизит справочник' | 'Реквизит справочник выбор из формы списка' | 'Реквизит строка' | 'Реквизит булево' | 'Реквизит число' | 'Реквизит дата' |
		| 'ТестовыйЭлемент20'   | ''                                          | 'СтрокаТест'      | 'Нет'             | '12,58'          | '15.05.1987'    |
		| 'ТестовыйЭлемент21'   | 'ТестовыйЭлемент21'                         | 'ТестСтрока'      | 'Да'              | '56,78'          | '11.09.1983'    |
