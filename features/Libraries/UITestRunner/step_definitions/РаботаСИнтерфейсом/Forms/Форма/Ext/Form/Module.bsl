...
Функция ПолучитьСписокТестов(КонтекстФреймворкаBDD) Экспорт
	...
	Ванесса.ДобавитьШагВМассивТестов(ВсеТесты,"ЯЖдуПоявленияЭлементаВТеченииСекунд(Парам01, Парам02)", 			"ЯЖдуПоявленияЭлементаВТеченииСекунд", 			"И я жду появления элемента ""Имя элемента"" в течении 20 секунд");
	Ванесса.ДобавитьШагВМассивТестов(ВсеТесты,"ЯЖдуПоявленияЭлементаВТечениеСекунд(Парам01, Парам02)", 			"ЯЖдуПоявленияЭлементаВТечениеСекунд", 			"И я жду появления элемента ""Имя элемента"" в течение 20 секунд","Ожидание появления элемента формы с нужным заголовком в течение указанного числа секунд","UI.Формы.Ожидание появления элемента");
	...
	Ванесса.ДобавитьШагВМассивТестов(ВсеТесты,"ЯЖдуПоявленияЭлементаСИменемВТечениеСекунд(Парам01, Парам02)", 	"ЯЖдуПоявленияЭлементаСИменемВТечениеСекунд", 	"И я жду появления элемента с именем ""ИмяЭлемента"" в течение 20 секунд","Ожидание появления элемента формы с нужным именем в течение указанного числа секунд","UI.Формы.Ожидание появления элемента");
	
	
	Ванесса.ДобавитьШагВМассивТестов(ВсеТесты,"ЯЖдуДоступностиЭлементаВТечениеСекунд(Парам01, Парам02)", 			"ЯЖдуДоступностиЭлементаВТечениеСекунд", 			"И я жду доступности элемента ""Имя элемента"" в течение 20 секунд","Ожидание доступности элемента формы с нужным заголовком в течение указанного числа секунд","UI.Формы.Ожидание доступности элемента");
...
Процедура ТаблицаНеСодержитСтроки(ИмяТЧ,ТабПарам,ИмяМакета = Неопределено) Экспорт
	...
	Если ЗначениеТЧ = Неопределено Тогда
		ТекстСообщения = "Не получилось получить значение таблицы <%1>";
		ТекстСообщения = СтрЗаменить(ТекстСообщения,"%1",ИмяТЧ);
		ВызватьИсключение ТекстСообщения;
	КонецЕсли;
...
Процедура ВОткрытойФормеИзВыпадающегоСпискаСЗаголовкомЯВыбираю(ИмяРеквизита,Знач ВыбираемоеЗначение,ИскатьПоИмени = Ложь) Экспорт
	...
	Исключение
		...
		Исключение
			...
			СтарыйТекстОшибки = Символы.ПС + СтарыйТекстОшибки + Символы.ПС;
			
			ТекстСообщения = "Предыдущая ошибка: %1. ТаймаутОжидания=%2";
			ТекстСообщения = СтрЗаменить(ТекстСообщения,"%1",СтарыйТекстОшибки); 
			ТекстСообщения = СтрЗаменить(ТекстСообщения,"%2",ТаймаутОжидания); 
			
			НовыйТекстОшибки = НовыйТекстОшибки + Символы.ПС + ТекстСообщения;
			
			ВызватьИсключение НовыйТекстОшибки;
		КонецПопытки;
	КонецПопытки;
