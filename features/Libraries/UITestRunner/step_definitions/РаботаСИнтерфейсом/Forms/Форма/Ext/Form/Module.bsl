...
Функция ПолучитьСписокТестов(КонтекстФреймворкаBDD) Экспорт
	...
	Ванесса.ДобавитьШагВМассивТестов(ВсеТесты,"ЗначениеПоляНеСодержитТекст(Парам01,Парам02)","ЗначениеПоляНеСодержитТекст","Тогда значение поля ""ИмяПоля"" не содержит текст ""Подстрока""","Проверка, что значение поля формы содержит текст","UI.Формы.Поля.Содержит текст");
	...
	Ванесса.ДобавитьШагВМассивТестов(ВсеТесты,"ВОткрытойФормеЯМеняюЗначениеПереключателяСЗаголовкомНа(Парам01,Парам02)","ВОткрытойФормеЯМеняюЗначениеПереключателяСЗаголовкомНа","И В открытой форме я меняю значение переключателя с заголовком ""ИмяЭлемента"" на ""Значение переключателя""");
	Ванесса.ДобавитьШагВМассивТестов(ВсеТесты,"ВОткрытойФормеЯМеняюЗначениеПереключателяНа(Парам01,Парам02)","ВОткрытойФормеЯМеняюЗначениеПереключателяНа","И В открытой форме я меняю значение переключателя ""ИмяЭлемента"" на ""Значение переключателя""");
	Ванесса.ДобавитьШагВМассивТестов(ВсеТесты,"ЯМеняюЗначениеПереключателяНа(Парам01,Парам02)","ЯМеняюЗначениеПереключателяНа","И я меняю значение переключателя ""ИмяЭлемента"" на ""Значение переключателя""","Меняет значение переключателя (радиобаттона)","UI.Формы.Поля.Переключатели");
	Ванесса.ДобавитьШагВМассивТестов(ВсеТесты,"ЯМеняюЗначениеПереключателяНаПоШаблону(Парам01,Парам02)","ЯМеняюЗначениеПереключателяНаПоШаблону","И я меняю значение переключателя 'ИмяЭлемента' на 'Значение переключателя' по шаблону","Меняет значение переключателя (радиобаттона). При этом возможно использовать символ * в значении. Работает в 8.3.12 и выше.","UI.Формы.Поля.Переключатели");
	...
	Ванесса.ДобавитьШагВМассивТестов(ВсеТесты,"ВТаблицеЯАктивизируюКолонкуВГруппе(Парам01,Парам02,Парам03)","ВТаблицеЯАктивизируюКолонкуВГруппе","И в таблице ""ИмяТаблицы"" я активизирую колонку ""ИмяКолонки"" в группе ""ИмяГруппыКолонок""","Активизирует поле таблицы в указанной группе колонок.","UI.Таблицы.Поля.Активизировать поле");
	...
	Ванесса.ДобавитьШагВМассивТестов(ВсеТесты,"ЯМеняюЗначениеПереключателяНаЗначениеПеременной(Парам01,Парам02)","ЯМеняюЗначениеПереключателяНаЗначениеПеременной","И я меняю значение переключателя ""ИмяЭлемента"" на значение переменной ""ИмяПеременной""", "Изменение значение переключателя на значение ранее сохраненной переменной", "Контекст.Контекст.Прочитать значение");
	...
	Ванесса.ДобавитьШагВМассивТестов(ВсеТесты,"ЯЖдуПоявленияЭлементаВТечениеСекунд(Парам01, Парам02)", 			"ЯЖдуПоявленияЭлементаВТечениеСекунд", 			"И я жду появления элемента ""Имя элемента"" в течение 20 секунд","Ожидание появления (видимости) элемента формы с нужным заголовком в течение указанного числа секунд","UI.Формы.Ожидание появления элемента");
...
&НаКлиенте
Функция ЗагловокиОконТиповыхКонфигурацийНРег()
	Массив = Новый Массив;
...
Процедура ЯЗакрылВсеОкнаКлиентскогоПриложения() Экспорт
	...
	ЗагловокиОконТиповыхКонфигураций = ЗагловокиОконТиповыхКонфигурацийНРег();
	...
	Для Ккк = 0 По ОкнаПриложения.Количество()-1 Цикл
		...
		ИначеЕсли ЗаголовокНрег = Нрег("Legitimate software") Тогда
			Продолжить;
		ИначеЕсли ЗагловокиОконТиповыхКонфигураций.Найти(ЗаголовокНрег) <> Неопределено Тогда
			Продолжить;
		КонецЕсли;	 
