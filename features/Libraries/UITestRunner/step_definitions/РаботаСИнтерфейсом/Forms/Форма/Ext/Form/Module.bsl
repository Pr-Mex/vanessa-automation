...
Функция ПолучитьСписокТестов(КонтекстФреймворкаBDD) Экспорт
	...
	Ванесса.ДобавитьШагВМассивТестов(ВсеТесты,"ЯВыбираюФайл(Парам01,Парам02,Парам03,Парам04,Парам05,Парам06,Парам07)","ЯВыбираюФайл","И я выбираю файл ""ИмяФайла""","Устанавливает результат диалога выбора файла. Шаг необходимо вызывать до того действия, которое приводит к появлению диалога выбора файлов.","Файлы");
	Ванесса.ДобавитьШагВМассивТестов(ВсеТесты,"ЯВыбираюФайлСИндексомФильтра(Индекс,Парам01,Парам02,Парам03,Парам04,Парам05,Парам06,Парам07)","ЯВыбираюФайлСИндексомФильтра","И я выбираю файл с индексом фильтра ""Индекс"" ""ИмяФайла""", "Устанавливает результат диалога выбора файла с учетом индекса фильтра в диалоге после выбора файлов. Шаг необходимо вызывать до того действия, которое приводит к появлению диалога выбора файлов.","Файлы");
