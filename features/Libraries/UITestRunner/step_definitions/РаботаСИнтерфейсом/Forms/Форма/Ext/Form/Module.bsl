...
Функция ПолучитьСписокТестов(КонтекстФреймворкаBDD) Экспорт
	...
	Ванесса.ДобавитьШагВМассивТестов(ВсеТесты,"ЯИзменяюФлаг(Парам01)","ЯИзменяюФлаг","И я изменяю флаг ""ИмяФлага""", "Изменяет текущее состояние флага", "UI.Формы.Поля.Флаги");
	...
	Ванесса.ДобавитьШагВМассивТестов(ВсеТесты,"ЯМеняюЗначениеПереключателяНа(Парам01,Парам02)","ЯМеняюЗначениеПереключателяНа","И я меняю значение переключателя ""Реквизит переключатель"" на ""Первое значение""","Меняет значение переключателя (радиобаттона)","UI.Формы.Поля.Переключатели");
	...
	Ванесса.ДобавитьШагВМассивТестов(ВсеТесты,"ЯМеняюЗначениеПереключателяСИменемНа(Парам01,Парам02)","ЯМеняюЗначениеПереключателяСИменемНа","И я меняю значение переключателя с именем ""РеквизитПереключатель"" на ""Первое значение""","Меняет значение переключателя (радиобаттона)","UI.Формы.Поля.Переключатели");
	...
	Ванесса.ДобавитьШагВМассивТестов(ВсеТесты,"ЯСнимаюФлаг(Парам01)","ЯСнимаюФлаг","И я снимаю флаг ""ИмяФлага""","Устанавливает флаг в Ложь", "UI.Формы.Поля.Флаги");
	...
	Ванесса.ДобавитьШагВМассивТестов(ВсеТесты,"ЯУстанавливаюФлаг(Парам01)","ЯУстанавливаюФлаг","И я устанавливаю флаг ""ИмяФлага""","Устанавливает флаг в Истина","UI.Формы.Поля.Флаги");
	...
	Ванесса.ДобавитьШагВМассивТестов(ВсеТесты,"ФлагРавен(Парам01,Парам02)","ФлагРавен","И     флаг ""ИмяФлага"" равен ""Истина""","Проверяет значение флага","UI.Формы.Поля.Флаги");
	...
	Ванесса.ДобавитьШагВМассивТестов(ВсеТесты,"УПоляЯНажимаюГиперссылку(Парам01,Парам02)","УПоляЯНажимаюГиперссылку","И у поля ""ИмяПоля"" я нажимаю гиперссылку 'ИмяГиперссылки'","Нажимает на гиперссылку в поле с данным заголовком. Гиперссылка задаётся либо по её представлению, либо по номеру.","UI.Формы.Поля.Гиперссылки");
