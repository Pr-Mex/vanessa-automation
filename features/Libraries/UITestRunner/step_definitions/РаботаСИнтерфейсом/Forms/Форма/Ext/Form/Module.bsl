...
Функция ПолучитьСписокТестов(КонтекстФреймворкаBDD) Экспорт
	...
	Ванесса.ДобавитьШагВМассивТестов(ВсеТесты,"ЯУстанавливаюФильтрНаспискеслиЭтоВозможно(ТабПарам)","ЯУстанавливаюФильтрНаспискеслиЭтоВозможно","И Я устанавливаю фильтр на список если это возможно" + Символы.ПС + "	| 'Наименование' | 'Содержит' | 'Товар1' |"," Позволяет установить фильтр на список через меню ""Ещё/Настроить список"". Причём если такого поля нет, то исключение вызываться не будет.","UI.Таблицы.Фильтр формы списка");
	Ванесса.ДобавитьШагВМассивТестов(ВсеТесты,"ЯУстанавливаюФильтрНаспискеслиЭтоВозможноRu(ТабПарам)","ЯУстанавливаюФильтрНаспискеслиЭтоВозможноRu","И Я устанавливаю фильтр на список если это возможно ru" + Символы.ПС + "	| 'Наименование' | 'Содержит' | 'Товар1' |","","");
...
//@ЯУстанавливаюФильтрНаспискеслиЭтоВозможно(ТабПарам)
Функция ЯУстанавливаюФильтрНаспискеслиЭтоВозможно(ТабПарам) Экспорт
...
//@ЯУстанавливаюФильтрНаспискеслиЭтоВозможноRu()
Функция ЯУстанавливаюФильтрНаспискеслиЭтоВозможноRu(ТабПарам) Экспорт
	ЯУстанавливаюФильтрНаспискеслиЭтоВозможно(ТабПарам);
КонецФункции
