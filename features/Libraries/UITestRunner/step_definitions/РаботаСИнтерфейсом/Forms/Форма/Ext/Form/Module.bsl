...
Функция ПолучитьСписокТестов(КонтекстФреймворкаBDD) Экспорт
	...
	Ванесса.ДобавитьШагВМассивТестов(ВсеТесты,"ВПолеСИменемЯВвожуЗначениеПеременной(Парам01,Парам02)","ВПолеСИменемЯВвожуЗначениеПеременной","И в поле с именем ""ИмяПоля"" я ввожу значение переменной ""ИмяПеременной""", "Вставка значения ранее сохраненной переменной в реквизит", "Контекст.Контекст.Прочитать значение");
	...
	Ванесса.ДобавитьШагВМассивТестов(ВсеТесты,"ЯФиксируюГруппу(Парам01)","ЯФиксируюГруппу","И я фиксирую группу ""ИмяГруппы""","Фиксирует группу, с которой будет работать пользователь. Т.е. поиск элементов будет происходить только в этой группе.","UI.Группы.Зафиксировать группу");
	Ванесса.ДобавитьШагВМассивТестов(ВсеТесты,"ЯФиксируюГруппуСИменем(Парам01)","ЯФиксируюГруппуСИменем","И я фиксирую группу с именем ""ИмяГруппы""","Фиксирует группу, с которой будет работать пользователь. Т.е. поиск элементов будет происходить только в этой группе.","UI.Группы.Зафиксировать группу");
	...
	Ванесса.ДобавитьШагВМассивТестов(ВсеТесты,"ЯЗапоминаюЗначениеТекущегоПоляКак(Парам01)","ЯЗапоминаюЗначениеТекущегоПоляКак","И я запоминаю значение текущего поля как ""ИмяПеременной""","Запоминает значение активного поля или я чейки таблицы в переменную.","UI.Формы.Поля.Запомнить значение поля");
	Ванесса.ДобавитьШагВМассивТестов(ВсеТесты,"ЯЗапоминаюПредставлениеТекущегоПоляКак(Парам01)","ЯЗапоминаюПредставлениеТекущегоПоляКак","И я запоминаю представление текущего поля как ""ИмяПеременной""","Запоминает представление активного поля или я чейки таблицы в переменную.","UI.Формы.Поля.Запомнить значение поля");
