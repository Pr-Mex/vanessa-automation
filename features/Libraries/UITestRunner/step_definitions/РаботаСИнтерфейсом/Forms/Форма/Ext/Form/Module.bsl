...
Функция ПолучитьСписокТестов(КонтекстФреймворкаBDD) Экспорт
	...
	Ванесса.ДобавитьШагВМассивТестов(ВсеТесты,"ЯПерехожуКПредыдущемуРеквизиту()","ЯПерехожуКПредыдущемуРеквизиту","И я перехожу к предыдущему реквизиту","Переходит к следующему реквизиту формы","UI.Формы.Поля.Перейти к предыдущему реквизиту");
