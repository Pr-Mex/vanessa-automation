...
Функция ПолучитьСписокТестов(КонтекстФреймворкаBDD) Экспорт
	...
	Ванесса.ДобавитьШагВМассивТестов(ВсеТесты,
		...
		"Вызывает запись в файл у текущего элемента формы. Применимо для табличного документа, текстового документа, форматированного документа.",
...
Функция ВТабличномДокументеЯПерехожуНаЯчейкуОтносительноТекущей(ИмяРеквизита,
	...
	ПозицияСимволаКолонки = СтрНайти(АдресТекущейОбласти, "C");
