...
Функция ПолучитьСписокТестов(КонтекстФреймворкаBDD) Экспорт
	...
	Ванесса.ДобавитьШагВМассивТестов(ВсеТесты,"ЯЗапоминаюИмяФормыВПеременную(Парам01)","ЯЗапоминаюИмяФормыВПеременную","И я запоминаю имя формы в переменную ""ИмяФормы""","","");
	Ванесса.ДобавитьШагВМассивТестов(ВсеТесты,"ЯЗапоминаюЗаголовокФормыВПеременную(Парам01)","ЯЗапоминаюЗаголовокФормыВПеременную","И я запоминаю заголовок формы в переменную ""ЗаголовокФормы""","","");
