...
Функция ПолучитьСписокТестов(КонтекстФреймворкаBDD) Экспорт
	...
	Ванесса.ДобавитьШагВМассивТестов(ВсеТесты,"ВТаблицеЯНажимаюКнопкуВыбораУРеквизита(Парам01,Парам02)","ВТаблицеЯНажимаюКнопкуВыбораУРеквизита","И В таблице ""ИмяТаблицы"" я нажимаю кнопку выбора у реквизита ""ИмяКолонки""","Нажатие кнопки выбора у реквизита в таблице","UI.Таблицы.Поля.Кнопка выбора");
	...
	Ванесса.ДобавитьШагВМассивТестов(ВсеТесты,"ВТаблицеЯНажимаюКнопкуОчиститьУПоля(Парам01,Парам02)","ВТаблицеЯНажимаюКнопкуОчиститьУПоля","И В таблице ""ИмяТаблицы"" я нажимаю кнопку очистить у поля ""ИмяКолонки""","Нажатие кнопки очистить у поля в таблице","UI.Таблицы.Поля.Очистить поле");
	...
	Ванесса.ДобавитьШагВМассивТестов(ВсеТесты,"ВТаблицеВПолеЯВвожуТекст(Парам01,Парам02,Парам03)","ВТаблицеВПолеЯВвожуТекст","И в таблице ""ИмяТаблицы"" в поле ""ИмяПоля"" я ввожу текст ""НужныйМнеТекст""","Ввод текста в поле таблицы","UI.Таблицы.Поля.Ввод текста");
	Ванесса.ДобавитьШагВМассивТестов(ВсеТесты,"ВТаблицеВПолеЯВвожуТекущуюДату(Парам01,Парам02)","ВТаблицеВПолеЯВвожуТекущуюДату","И в таблице ""ИмяТаблицы"" в поле ""ИмяПоля"" я ввожу текущую дату","Ввод текущей даты в поле таблицы","UI.Таблицы.Поля.Ввод даты");
	...
	Ванесса.ДобавитьШагВМассивТестов(ВсеТесты,"ВТаблицеЯАктивизируюПоле(Парам01,Парам02)","ВТаблицеЯАктивизируюПоле","И в таблице ""ИмяТаблицы"" я активизирую поле ""ИмяПоля""","Активизирует поле таблицы","UI.Таблицы.Поля.Активизировать поле");
	...
	Ванесса.ДобавитьШагВМассивТестов(ВсеТесты,"ЯЗапоминаюЗначениеТаблицыПоляКак(Парам01,Парам02,Парам03)","ЯЗапоминаюЗначениеТаблицыПоляКак","И я запоминаю значение таблицы ""ИмяТаблицы"" поля ""ИмяПоля"" как ""ИмяПеременной""");
	...
	Ванесса.ДобавитьШагВМассивТестов(ВсеТесты,"ЯЗапоминаюЗначениеПоляТаблицыКак(Парам01,Парам02,Парам03)","ЯЗапоминаюЗначениеПоляТаблицыКак","И я запоминаю значение поля ""ИмяПоля"" таблицы ""ИмяТаблицы"" как ""ИмяПеременной""","Сохранение значения поля таблицы в переменную Контекст","Контекст.Контекст.Сохранить значение.Таблица.Поле таблицы");
	...
	Ванесса.ДобавитьШагВМассивТестов(ВсеТесты,"ВТаблицеВПолеЯУвеличиваюЗначение(Парам01,Парам02)","ВТаблицеВПолеЯУвеличиваюЗначение","И в таблице ""ИмяТаблицы"" в поле ""ИмяПоля"" я увеличиваю значение","Увеличивает значение поля в помощью специальной кнопки","UI.Таблицы.Поля.Увеличить значение");
	...
	Ванесса.ДобавитьШагВМассивТестов(ВсеТесты,"ВТаблицеВПолеЯУменьшаюЗначение(Парам01,Парам02)","ВТаблицеВПолеЯУменьшаюЗначение","И в таблице ""ИмяТаблицы"" в поле ""ИмяПоля"" я уменьшаю значение","Уменьшает значение поля в помощью специальной кнопки","UI.Таблицы.Поля.Уменьшить значение");
	...
	Ванесса.ДобавитьШагВМассивТестов(ВсеТесты,"ЯЗапоминаюЗначениеТаблицыКак(Парам01,Парам02,ТабПарам)","ЯЗапоминаюЗначениеТаблицыКак","И я запоминаю значение таблицы ""Таблица1"" как ""ИмяПеременной""","Запоминает значение указанных колонок таблицы в переменную","UI.Таблицы.Запомнить значение таблицы");
...
Процедура ВОткрытойФормеЯВижуЭлемент(ИмяЭлемента, ИскатьПоИмени = Ложь)
	...
	ТекущаяВидимость = ЭлементФормы.ТекущаяВидимость();
	Если ТекущаяВидимость и Ванесса.Версия8313ИлиВыше Тогда
		//проверим также видимость групп, т.к. у них видимость может отличаться от видимости элемента
		ТекущаяВидимость = Ванесса.ВидимостьЭлементаСУчетомРодителя(ДопПараметры.ТекущаяФормаЭлемента,ЭлементФормы);
	КонецЕсли;	 
...
Процедура ОбработичкОжиданияЯЖдуЧтоВТабличномДокументеЯчейкаСтанетРавнаВТечениеСекунд()
	...
	ПолеРеквизит = Ванесса.НайтиРеквизитОткрытойФормыПоЗаголовку(ИмяПоляОбработкаОжидания,Истина,Ложь);
	
	Если (ТекущаяДата() - ДатаНачалаОбработкиОжидания) > КоличествоСекундОбработкаОжидания Тогда
		ОтключитьОбработчикОжидания(ИмяОбработчикаОжидания);
		ТекстСообщения = Ванесса.ПолучитьТекстСообщенияПользователю("Ожидали, что у табличного документа <%1> в течение <%2> секунд значение ячейки <%3> станет равно <%4>.");
		ТекстСообщения = СтрЗаменить(ТекстСообщения,"%1",ИмяПоляОбработкаОжидания);
		ТекстСообщения = СтрЗаменить(ТекстСообщения,"%2",КоличествоСекундОбработкаОжидания);
...
Процедура ЯЗапоминаюЗначениеТаблицыКак(ИмяТаблицы,ИмяПеременной,ТабПарам) Экспорт
	ТабПарам = Ванесса.ПолучитьЗначенияТаблицыGherkinИзКонтекста(ТабПарам);
	ТЧ       = НайтиТЧПоИмени(ИмяТаблицы);
