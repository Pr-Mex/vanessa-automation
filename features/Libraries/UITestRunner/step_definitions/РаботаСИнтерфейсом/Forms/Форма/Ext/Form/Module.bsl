...
Функция ПолучитьСписокТестов(КонтекстФреймворкаBDD) Экспорт
	...
	Ванесса.ДобавитьШагВМассивТестов(ВсеТесты,"ЭлементФормыСуществуетИНевидимНаФорме(Парам01)","ЭлементФормыСуществуетИНевидимНаФорме","И элемент формы ""Имя поля"" существует и невидим на форме","Проверка невидимости поля. Поле обязано существовать.","UI.Формы.Поля.Проверка видимости");
	...
	Ванесса.ДобавитьШагВМассивТестов(ВсеТесты,"ЯНажимаюКнопкуКомандногоИнтерфейса(Парам01)","ЯНажимаюКнопкуКомандногоИнтерфейса","Когда я нажимаю кнопку командного интерфейса ""Имя кнопки""","Нажимает на кнопку командного интерфейса","UI.Командный интерфейс.Панель разделов");
	...
	Ванесса.ДобавитьШагВМассивТестов(ВсеТесты,"ЯСворачиваюГруппу(Парам01)","ЯСворачиваюГруппу","И я сворачиваю группу ""ИмяГруппы""","Сворачивает группу","UI.Формы.Группы.Развернуть/свернуть группу");
	...
	Ванесса.ДобавитьШагВМассивТестов(ВсеТесты,"ЯРазворачиваюГруппу(Парам01)","ЯРазворачиваюГруппу","И я разворачиваю группу ""ИмяГруппы""","Разворачивает группу","UI.Формы.Группы.Развернуть/свернуть группу");
	...
	Ванесса.ДобавитьШагВМассивТестов(ВсеТесты,"ВТаблицеУПоляЯЖдуЗначенияВТечениеСекунд(Парам01,Парам02,Парам03,Парам04)","ВТаблицеУПоляЯЖдуЗначенияВТечениеСекунд","И в таблице ""ИмяТаблицы"" у поля ""Имя элемента"" я жду значения ""Значение"" в течение 20 секунд","Ожидает значения в ячейке таблицы в текущей строке в течение указанного числа секунд. Ячейка указывается по её заголовку.","UI.Таблицы.Ожидание значения ячейки таблицы");
	...
	Ванесса.ДобавитьШагВМассивТестов(ВсеТесты,"ВТаблицеУПоляЯЖдуЗначенияОтличногоОтВТечениеСекунд(Парам01,Парам02,Парам03,Парам04)","ВТаблицеУПоляЯЖдуЗначенияОтличногоОтВТечениеСекунд","И в таблице ""ИмяТаблицы"" у поля ""Имя элемента"" я жду значения отличного от ""Значение"" в течение 20 секунд","Ожидает значения отличного от указанного в ячейке таблицы в текущей строке в течение указанного числа секунд. Ячейка указывается по её заголовку.","UI.Таблицы.Ожидание значения ячейки таблицы");
