...
Функция ПолучитьСписокТестов(КонтекстФреймворкаBDD) Экспорт
	...
	Ванесса.ДобавитьШагВМассивТестов(ВсеТесты,"ВПолеЯВвожуТекст(Парам01,Парам02)","ВПолеЯВвожуТекст","И в поле ""ИмяПоля"" я ввожу текст ""Значение поля""","Вводит текст в поле. Также вводит текст в форматированный документ и поле HTML документа.","UI.Формы.Поля.Ввод текста");
	...
	Ванесса.ДобавитьШагВМассивТестов(ВсеТесты,"ВПолеЯВвожуНачалоТекущегоМесяца(Парам01)","ВПолеЯВвожуНачалоТекущегоМесяца","И в поле ""ИмяПоля"" я ввожу начало текущего месяца","Вводит в поле текстовое представление значения даты равной началу текущего месяца. Например ""01.01.2018"".","UI.Формы.Поля.Ввод даты");
	Ванесса.ДобавитьШагВМассивТестов(ВсеТесты,"ВПолеЯВвожуКонецТекущегоМесяца(Парам01)","ВПолеЯВвожуКонецТекущегоМесяца","И в поле ""ИмяПоля"" я ввожу конец текущего месяца","Вводит в поле текстовое представление значения даты равной концу текущего месяца. Например ""31.01.2018"".","UI.Формы.Поля.Ввод даты");
	Ванесса.ДобавитьШагВМассивТестов(ВсеТесты,"ВПолеЯВвожуНачалоСледующегоМесяца(Парам01)","ВПолеЯВвожуНачалоСледующегоМесяца","И в поле ""ИмяПоля"" я ввожу начало следующего месяца","Вводит в поле текстовое представление значения даты равной началу следующего месяца. Например ""01.01.2018"".","UI.Формы.Поля.Ввод даты");
	Ванесса.ДобавитьШагВМассивТестов(ВсеТесты,"ВПолеЯВвожуКонецСледующегоМесяца(Парам01)","ВПолеЯВвожуКонецСледующегоМесяца","И в поле ""ИмяПоля"" я ввожу конец следующего месяца","Вводит в поле текстовое представление значения даты равной концу следующего месяца. Например ""31.01.2018"".","UI.Формы.Поля.Ввод даты");
	...
	Ванесса.ДобавитьШагВМассивТестов(ВсеТесты,"ПолеПрисутствуетНаФорме(Парам01)","ПолеПрисутствуетНаФорме","И поле ""Имя поля"" присутствует на форме");
	...
	Ванесса.ДобавитьШагВМассивТестов(ВсеТесты,"ПолеОтсутствуетНаФорме(Парам01)","ПолеОтсутствуетНаФорме","И поле ""Имя поля"" отсутствует на форме");
	...
	Ванесса.ДобавитьШагВМассивТестов(ВсеТесты,"ЭлементФормыПрисутствуетНаФорме(Парам01)","ЭлементФормыПрисутствуетНаФорме","И элемент формы ""Имя поля"" присутствует на форме","Проверка видимости поля. Поле обязано существовать.","UI.Формы.Поля.Проверка видимости");
	...
	Ванесса.ДобавитьШагВМассивТестов(ВсеТесты,"ЭлементФормыОтсутствуетНаФорме(Парам01)","ЭлементФормыОтсутствуетНаФорме","И элемент формы ""Имя поля"" отсутствует на форме","Проверка невидимости поля. Поле может не существовать.","UI.Формы.Поля.Проверка видимости");
	...
	Ванесса.ДобавитьШагВМассивТестов(ВсеТесты,"ЯЖдуЗакрытияОкнаВТеченииСекунд(Парам01,Парам02)","ЯЖдуЗакрытияОкнаВТеченииСекунд","И я жду закрытия окна ""Имя окна"" в течении 20 секунд");
	Ванесса.ДобавитьШагВМассивТестов(ВсеТесты,"ЯЖдуЗакрытияОкнаВТечениеСекунд(Парам01,Парам02)","ЯЖдуЗакрытияОкнаВТечениеСекунд","И я жду закрытия окна ""Имя окна"" в течение 20 секунд","Ожидает, что окно исчезнет в течение указанного числа секунд. Поиск окна происходит среди всех открытых окон. Поэтому шаг будет ждать пока закроются все окна, удовлетворяющие переданному параметру ""Имя окна"".","UI.Окна");
	
	Ванесса.ДобавитьШагВМассивТестов(ВсеТесты,"ЯЖдуОткрытияОкнаВТеченииСекунд(Парам01,Парам02)","ЯЖдуОткрытияОкнаВТеченииСекунд","И я жду открытия окна ""Имя окна"" в течении 20 секунд");
	Ванесса.ДобавитьШагВМассивТестов(ВсеТесты,"ЯЖдуОткрытияОкнаВТечениеСекунд(Парам01,Парам02)","ЯЖдуОткрытияОкнаВТечениеСекунд","И я жду открытия окна ""Имя окна"" в течение 20 секунд","Ожидает, что окно появится в течение указанного числа секунд","UI.Окна");
	...
	Ванесса.ДобавитьШагВМассивТестов(ВсеТесты,"ВТаблицеЯПерехожуКСтрокеПоШаблону(Парам01,ТабПарам)","ВТаблицеЯПерехожуКСтрокеПоШаблону","И в таблице ""ИмяТаблицы"" я перехожу к строке по шаблону" + Символы.ПС + "	|'Наименование'|"  + Символы.ПС + "	|'*ЧастьСтроки*'|","Переход к строке таблицы, когда в значении колонок встречаются символы *","UI.Таблицы.Переход к строке");
	...
	Ванесса.ДобавитьШагВМассивТестов(ВсеТесты,"ВТаблицеПолеИмеетЗначение(Парам01,Парам02,Парам03)","ВТаблицеПолеИмеетЗначение","И в таблице ""ИмяТаблицы"" поле ""ИмяПоля"" имеет значение ""ЗначениеПоля""","Проверка значения поля (ячейки) текущей строки таблицы","UI.Таблицы.Значение ячейки таблицы");
	...
	Ванесса.ДобавитьШагВМассивТестов(ВсеТесты,"ВТаблицеИзВыпадающегоСпискаЯВыбираю(Парам01,Парам02,Парам03)","ВТаблицеИзВыпадающегоСпискаЯВыбираю","И в таблице ""ИмяТаблицы"" из выпадающего списка ""ИмяПоля"" я выбираю ""ЗначениеПоля""");
	...
	Ванесса.ДобавитьШагВМассивТестов(ВсеТесты,"ВТаблицеЯВыбираюЗначениеРеквизитаИзФормыСписка(Парам01,Парам02)","ВТаблицеЯВыбираюЗначениеРеквизитаИзФормыСписка","И в таблице ""ИмяТаблицы"" я выбираю значение реквизита ""ИмяРеквизита"" из формы списка","Выбор значения реквизита из выпадающего списка","UI.Таблицы.Реквизиты");
	...
	Ванесса.ДобавитьШагВМассивТестов(ВсеТесты,"ИзВыпадающегоСпискаЯВыбираю(Парам01,Парам02)","ИзВыпадающегоСпискаЯВыбираю","И из выпадающего списка ""ИмяПоля"" я выбираю ""ЗначениеПоля""");
	//устаревшее. делает ввод по строке
	...
	Ванесса.ДобавитьШагВМассивТестов(ВсеТесты,"ИзВыпадающегоСпискаЯВыбираюПоСтроке(Парам01,Парам02)","ИзВыпадающегоСпискаЯВыбираюПоСтроке","И из выпадающего списка ""ИмяПоля"" я выбираю по строке ""ЧастьСтроки""","Выбор из выпадающего списка. Значение будет выбрано через ввод по строке. Допускается вводить строку не целиком.","UI.Выпадающий список.Ввод по строке");
	...
	Ванесса.ДобавитьШагВМассивТестов(ВсеТесты,"ЯЗапоминаюЗначениеТаблицыПоляСИменемКак(Парам01,Парам02,Парам03)","ЯЗапоминаюЗначениеТаблицыПоляСИменемКак","И я запоминаю значение таблицы ""ИмяТаблицы"" поля с именем ""ИмяПоля"" как ""ИмяПеременной""","Сохранение значения поля таблицы в переменную Контекст","Контекст.Контекст.Сохранить значение.Таблица.Поле таблицы");
	...
	Ванесса.ДобавитьШагВМассивТестов(ВсеТесты,"ЯЖдуПоявленияЭлемента(Парам01)", 								"ЯЖдуПоявленияЭлемента", 						"И я жду появления элемента ""Имя элемента""","Ожидание появления элемента формы с нужным заголовком","");
	//убрал шаг, т.к. есть аналогичный
	...
	Ванесса.ДобавитьШагВМассивТестов(ВсеТесты,"ЯЖдуПоявленияЭлементаВТеченииСекунд(Парам01, Парам02)", 			"ЯЖдуПоявленияЭлементаВТеченииСекунд", 			"И я жду появления элемента ""Имя элемента"" в течении 120 секунд");
	Ванесса.ДобавитьШагВМассивТестов(ВсеТесты,"ЯЖдуПоявленияЭлементаВТечениеСекунд(Парам01, Парам02)", 			"ЯЖдуПоявленияЭлементаВТечениеСекунд", 			"И я жду появления элемента ""Имя элемента"" в течение 120 секунд","Ожидание появления элемента формы с нужным заголовком в течение указанного числа секунд","UI.Формы.Ожидание появления элемента");
	
	Ванесса.ДобавитьШагВМассивТестов(ВсеТесты,"ЯЖдуПоявленияЭлементаСИменемВТеченииСекунд(Парам01, Парам02)", 	"ЯЖдуПоявленияЭлементаСИменемВТеченииСекунд", 	"И я жду появления элемента с именем ""ИмяЭлемента"" в течении 120 секунд");
	Ванесса.ДобавитьШагВМассивТестов(ВсеТесты,"ЯЖдуПоявленияЭлементаСИменемВТечениеСекунд(Парам01, Парам02)", 	"ЯЖдуПоявленияЭлементаСИменемВТечениеСекунд", 	"И я жду появления элемента с именем ""ИмяЭлемента"" в течение 120 секунд","Ожидание появления элемента формы с нужным именем в течение указанного числа секунд","UI.Формы.Ожидание появления элемента");
	
	
	Ванесса.ДобавитьШагВМассивТестов(ВсеТесты,"ЯЖдуДоступностиЭлементаВТечениеСекунд(Парам01, Парам02)", 			"ЯЖдуДоступностиЭлементаВТечениеСекунд", 			"И я жду доступности элемента ""Имя элемента"" в течение 120 секунд","Ожидание доступности элемента формы с нужным заголовком в течение указанного числа секунд","UI.Формы.Ожидание доступности элемента");
	Ванесса.ДобавитьШагВМассивТестов(ВсеТесты,"ЯЖдуДоступностиЭлементаСИменемВТечениеСекунд(Парам01, Парам02)", 	"ЯЖдуДоступностиЭлементаСИменемВТечениеСекунд", 	"И я жду доступности элемента с именем ""ИмяЭлемента"" в течение 120 секунд","Ожидание доступности элемента формы с нужным именем в течение указанного числа секунд","UI.Формы.Ожидание доступности элемента");
	
	
	//убрал шаг, т.к. есть аналогичный
	Ванесса.ДобавитьШагВМассивТестов(ВсеТесты,"УЭлементаЯЖдуЗначения(Парам01,Парам02)", 							"УЭлементаЯЖдуЗначения", 						"И у элемента ""Имя элемента"" я жду значения ""Значение""","Ожидание что элемент формы примет нужное значение (таймаут 10)","");
	//убрал шаг, т.к. есть аналогичный
	...
	Ванесса.ДобавитьШагВМассивТестов(ВсеТесты,"ЯВижуЭлемент(ИмяЭлемента)",               "ЯВижуЭлемент",               "И я вижу элемент ""Имя элемента""");
	Ванесса.ДобавитьШагВМассивТестов(ВсеТесты,"ЯВижуЭлементНаФорме(ИмяЭлемента)",        "ЯВижуЭлементНаФорме",        "И я вижу элемент ""Имя элемента"" на форме");
	...
	Ванесса.ДобавитьШагВМассивТестов(ВсеТесты,"ЯНеВижуЭлемент(ИмяЭлемента)",              "ЯНеВижуЭлемент",              "И я не вижу элемент ""Имя элемента""");
	Ванесса.ДобавитьШагВМассивТестов(ВсеТесты,"ЯНеВижуЭлементНаФорме(ИмяЭлемента)",       "ЯНеВижуЭлементНаФорме",       "И я не вижу элемент ""Имя элемента"" на форме");
	...
	Ванесса.ДобавитьШагВМассивТестов(ВсеТесты,"ВПолеЯВвожуТекстИзМакета(Парам01,Парам02)","ВПолеЯВвожуТекстИзМакета","И в поле ""ИмяПоля"" я ввожу текст из макета ""ИмяМакета""","Вводит текст в поле. Текст будет взят из макета. Также вводит текст в форматированный документ и поле HTML документа.","UI.Формы.Поля.Ввод текста");
	
	Ванесса.ДобавитьШагВМассивТестов(ВсеТесты,"ЯЖдуЧтоПолеПерестанетБытьПустымВТеченииСекунд(Парам01,Парам02)","ЯЖдуЧтоПолеПерестанетБытьПустымВТеченииСекунд","И я жду, что поле ""ИмяПоля"" перестанет быть пустым в течении 30 секунд");
	Ванесса.ДобавитьШагВМассивТестов(ВсеТесты,"ЯЖдуЧтоПолеПерестанетБытьПустымВТечениеСекунд(Парам01,Парам02)","ЯЖдуЧтоПолеПерестанетБытьПустымВТечениеСекунд","И я жду, что поле ""ИмяПоля"" перестанет быть пустым в течение 30 секунд","Проверяет, что в течение нужного числа секунд текстовое поле станет заполненным.","UI.Формы.Поля.Заполненность");
	
	Ванесса.ДобавитьШагВМассивТестов(ВсеТесты,"ЗначениеПоляРавноЗначениюИзМакета(Парам01,Парам02)","ЗначениеПоляРавноЗначениюИзМакета","И значение поля ""ИмяПоля"" равно значению из макета ""Xml_1En""","","");
	...
	Ванесса.ДобавитьШагВМассивТестов(ВсеТесты,"ЯПрикрепляюКСценариюЗначениеТаблицыКак(Парам01,Парам02)","ЯПрикрепляюКСценариюЗначениеТаблицыКак","И я прикрепляю к сценарию значение таблицы ""ИмяТаблицы"" как ""ИмяЗначния""","Прикрепляет к сценарию указанную таблицу. Параметр ""ИмяЗначения"" будет использован для имени файла. Прикрепленные данные пойдут в отчет о выполнении сценария.","Прочее.Результат выполнения сценария");
...
Процедура ОбработичкОжиданияВОткрытойФормеЯЖдуДоступностиЭлементаВТечениеСекунд()
	...
	Если ЭлементФормы = Неопределено Тогда
		Если (ТекущаяДата() - ДатаНачалаОбработкиОжидания) > КоличествоСекундОбработкаОжидания Тогда
			ОтключитьОбработчикОжидания(ИмяОбработчика);
			ТекстСообщения = "Ожидали в течение <%1> секунд доступности поля <%2>. Но такой элемент на форме не найден.";
			ТекстСообщения = СтрЗаменить(ТекстСообщения,"%1",КоличествоСекундОбработкаОжидания);
			ТекстСообщения = СтрЗаменить(ТекстСообщения,"%2",ИмяПоляОбработкаОжидания);
			Ванесса.ПродолжитьВыполнениеШагов(Истина,ТекстСообщения);
			Возврат;
	...
	Если (ТекущаяДата() - ДатаНачалаОбработкиОжидания) > КоличествоСекундОбработкаОжидания Тогда
		ОтключитьОбработчикОжидания(ИмяОбработчика);
		ТекстСообщения = "Ожидали в течение <%1> секунд доступности поля <%2>. ТекущаяДоступность=%3";
		ТекстСообщения = СтрЗаменить(ТекстСообщения,"%1",КоличествоСекундОбработкаОжидания);
		ТекстСообщения = СтрЗаменить(ТекстСообщения,"%2",ИмяПоляОбработкаОжидания);
...
Процедура ВОткрытойФормеЯСнимаюФлагСЗаголовком(ИмяРеквизита,ИскатьПоИмени = Ложь) Экспорт
	...
	Для каждого ТекущаяФорма Из МассивФорм Цикл
		...
		Если Ванесса.ЗначениеФлагаСоответствуетИстина(ПолеРеквизит.ПолучитьПредставлениеДанных()) Тогда
			ПолеРеквизит.УстановитьОтметку();
		КонецЕсли;	 
		СделатьДействияПриЗаписиHTML();
...
Процедура ЯЗакрылВсеОкнаКлиентскогоПриложения() Экспорт
	...
	//Для каждого ОкноПриложение Из ОкнаПриложения Цикл
		...
		Если НРег(ОкноПриложение.Заголовок) = Нрег("Initial configuration setup") Тогда
			Продолжить;
		КонецЕсли;	 
...
Процедура ВФормеВТаблицеЯПерехожуКСтроке(ИмяФормы,ИмяТЧ,ТабПарам) Экспорт
	ТекстСообщения = "Строка должна быть описана таблицей с двумя строками.";
...
Процедура ВТаблицеЯПерехожуКСтрокеСодержащейПодстроки(ИмяТЧ, ТабПарам,СравнениеПоШаблону = Ложь) Экспорт
	...
	Если ТаблицаTestclient.Количество() > 0 Тогда
		...
		Для Каждого ЭлементФильтра Из ФильтрПоКолонкам Цикл
			Если ОписаниеСтроки[ЭлементФильтра.Ключ] = Неопределено Тогда
				ТекстСообщения = "В таблице <%1> отсутствует колонка <%2>, указнная в параметрах.";
				ТекстСообщения = СтрЗаменить(ТекстСообщения,"%1",ИмяТЧ); 
	...
	Если ТаблицаTestclient.Количество() = 1 и Ванесса.Версия8312ИлиВыше Тогда
		//значит возможна ситуация, когда в таблице запрещено получение всех строк
		
		//Ванесса.ПосмотретьЗначение(ТаблицаTestclient);
		ТаблицаTestclient = Новый Массив;
		
		//будем получать значение таблицы через переход к каждой строке
		ТЧ.ПерейтиКПервойСтроке();
		
		Пока Истина Цикл
			СтрокаТаблицы = ТЧ.ПолучитьВыделенныеСтроки();
			Если СтрокаТаблицы.Количество() <> 1 Тогда
				ВызватьИсключение "Ожидали получить только одну строку таблицы.";
			КонецЕсли;	 
			
			ТаблицаTestclient.Добавить(СтрокаТаблицы[0]);
...
Процедура ВОткрытойФормеВТЧИзВыпадающегоСпискаСЗаголовкомЯВыбираю(ИмяТЧ,ИмяРеквизита,ВыбираемоеЗначение,ИскатьПоИмени = Ложь) Экспорт
	...
	Попытка
		...
		Исключение
			...
			Если Ванесса.Версия8311ИлиВыше И НЕ СписокСформировался Тогда
				ТекстСообщения = "Выпадающий список <%1> не открылся для ввода текста.";
				ТекстСообщения = СтрЗаменить(ТекстСообщения,"%1",ИмяРеквизита); 
				Сообщить(ТекстСообщения);
				ВызватьИсключение ТекстСообщения;
			КонецЕсли;	 
		...
		ДождалисьФормированияВыпадающегоСписка = Истина;
		
		Попытка
			ДождалисьФормированияВыпадающегоСписка = ПолеРеквизит.ОжидатьФормированияВыпадающегоСписка(ТаймаутОжидания);
		Исключение
		КонецПопытки;
		
		Если Не ДождалисьФормированияВыпадающегоСписка Тогда
			ТекстСообщения = "В таблице <%1> у поля <%2> ожидали открытия выпадающего списка, но не дождались.";
			ТекстСообщения = СтрЗаменить(ТекстСообщения,"%1",ИмяТЧ); 
		...
		Для Ккк = 1 По КоличествоПопыток Цикл
			Попытка
				...
				Если Ванесса.Версия8310ИлиВыше Тогда
					Для Ррр = 1 По КоличествоПопыток Цикл
						ВыпадающийСписокОткрыт = Истина;
						Попытка
							ВыпадающийСписокОткрыт = ПолеРеквизит.ВыпадающийСписокОткрыт();
						Исключение
							//значит, возможно, открылось другое окно
							Прервать;
						КонецПопытки;
		...
		ТекстСообщения = "Не смог в таблице <%1> сделать выбрать из списка выбора <%2> по строке <%3>";
		ТекстСообщения = СтрЗаменить(ТекстСообщения,"%1",ИмяТЧ); 
		ТекстСообщения = СтрЗаменить(ТекстСообщения,"%2",ИмяРеквизита); 
	...
	Исключение
		ТекстИсключения = ОписаниеОшибки() + Символы.ПС + "Предыдущая ошибка:" + Символы.ПС + ТекстИсключения;
...
Процедура ЕстьЭлементСправочникаСНаименованиемИРеквизитомРавным(ИмяСпр,Наименование,ИмяРек,СтроковокПредставление) Экспорт
	ТекстСообщения = "Не нашел значение реквизита у спр: ИмяСпр=%1, Наименование=%2, ИмяРек=%3, СтроковокПредставление=%4";
...
Процедура ТекстЯчейкиТаблицыСталРавен(ИмяТЧ,ИмяЭлемента,Знач СтроковоеПредставление,ИскатьПоИмени = Истина) Экспорт
	...
	Иначе
		...
		Если ВыделенныеСтроки.Количество() = 0 Тогда
			ТекстСообщения = "В таблице <%1> не найдено ни одной строки";
			ТекстСообщения = СтрЗаменить(ТекстСообщения,"%1",ИмяТЧ);
			ВызватьИсключение ТекстСообщения;
		КонецЕсли;	 
		...
		Если ПредставлениеДанных = Неопределено Тогда
			ТекстСообщения = "В таблице <%1> не найдено ячейки с заголовком <%2>";
			ТекстСообщения = СтрЗаменить(ТекстСообщения,"%1",ИмяТЧ);
...
Процедура ТаблицаФормыСИменемСталаРавной(ИмяТЧ,ТабПарам,ДопПараметры = Неопределено) Экспорт
	...
	Если ЗначениеЗаполнено(ОшибкаНетКолонок) Тогда
		ТекстСообщения = "Ошибка проверки значения таблицы <%1>. %2";
		ТекстСообщения = СтрЗаменить(ТекстСообщения,"%1",ИмяТЧ);
		ТекстСообщения = СтрЗаменить(ТекстСообщения,"%2",ОшибкаНетКолонок);
		ВызватьИсключение ТекстСообщения;
	КонецЕсли;	 
	...
	Если ЗначениеТЧ.Количество() <> КолСтрок Тогда
		ТекстСообщения = "Таблица %1 не соответствует эталону. Ожидали %2 строк, а в ней %3 строк.";
		ТекстСообщения = СтрЗаменить(ТекстСообщения,"%1",ИмяТЧ);
...
Функция ПолучитьМакетИзОбработкиИлиИзКаталогаПроекта(ИмяМакета,ДопПараметры = Неопределено,ВызыватьИсключение = Истина)
	...
	Если Макет = Неопределено Тогда
		Если ВызыватьИсключение Тогда
			ТекстСообщения = "Не смог получить макет %1";
			ТекстСообщения = СтрЗаменить(ТекстСообщения,"%1",ИмяМакета); 
			ВызватьИсключение ТекстСообщения;
		КонецЕсли;	 
	КонецЕсли;	 
...
Процедура ТаблицаНеСодержитСтроки(ИмяТЧ,ТабПарам,ИмяМакета = Неопределено) Экспорт
	...
	Если МассивНайденныхСтрок.Количество() > 0 Тогда
		...
		ТекстСообщения = "Нашли строки в таблице <%1>:%2";
		ТекстСообщения = СтрЗаменить(ТекстСообщения,"%1",ИмяТЧ);
...
Процедура ВПанелиРазделовЯВыбираю(ИмяКнопки) Экспорт
	...
	Исключение
		Ванесса.ОбработатьОшибкуПодключенияTestClient();
		ТекстСообщения = "Не подключен Testclient.";
	...
	Для каждого Элем Из ПодчиненныеОбъекты Цикл
		Если НРег(Элем.ТекстЗаголовка) = НРег("Панель разделов") Тогда
			ПанельРазделов = Элем;
		ИначеЕсли НРег(Элем.ТекстЗаголовка) = НРег("Section panel") Тогда
			ПанельРазделов = Элем;
		КонецЕсли;	 
	КонецЦикла;
...
Процедура ВПанелиФункцийЯВыбираю(ИмяКнопки) Экспорт
	...
	Для каждого Элем Из ПодчиненныеОбъекты Цикл
		...
		ИначеЕсли НРег(Элем.ТекстЗаголовка) = НРег("Functions menu") Тогда
			МенюФункций = Элем;
		ИначеЕсли НРег(Элем.ТекстЗаголовка) = НРег("Function menu") Тогда
			МенюФункций = Элем;
...
Процедура ВОткрытойФормеИзВыпадающегоСпискаСЗаголовкомЯВыбираю(ИмяРеквизита,Знач ВыбираемоеЗначение,ИскатьПоИмени = Ложь) Экспорт
	...
	Попытка
		...
		СписокСформировался = ПолеРеквизит.ОжидатьФормированияВыпадающегоСписка(ТаймаутОжидания);
		Если Ванесса.Версия8311ИлиВыше И НЕ СписокСформировался Тогда
			ТекстСообщения = "Выпадающий список <%1> не был сформирован.";
			ТекстСообщения = СтрЗаменить(ТекстСообщения,"%1",ИмяРеквизита); 
			Сообщить(ТекстСообщения);
			ВызватьИсключение ТекстСообщения;
		КонецЕсли;	 
		...
		Если НЕ Ванесса.Версия8310ИлиВыше Тогда
			...
			Если ТекТекст <> ВыбираемоеЗначение Тогда
				...
				ТекстСообщения = "Выпадающий список <%1>. Ожидали, что в нём будет текст %2, а получили %3.";
				ТекстСообщения = СтрЗаменить(ТекстСообщения,"%1",ИмяРеквизита); 
		...
		ТекстСообщения = "Не смог сделать выбрать из списка выбора <%1> по строке <%2>";
		ТекстСообщения = СтрЗаменить(ТекстСообщения,"%1",ИмяРеквизита); 
		ТекстСообщения = СтрЗаменить(ТекстСообщения,"%2",ВыбираемоеЗначение); 
		Сообщить(ТекстСообщения);
		ВызватьИсключение ТекстСообщения;
	...
	Исключение
		...
		Попытка
			ПолеРеквизит.ВыполнитьВыборИзСпискаВыбора(ВыбираемоеЗначение);
		Исключение
			НовыйТекстОшибки = ОписаниеОшибки();
			
			ВызватьИсключение НовыйТекстОшибки + Символы.ПС + "Предыдущая ошибка: " + Символы.ПС + СтарыйТекстОшибки + Символы.ПС + "ТаймаутОжидания=" + ТаймаутОжидания;
		КонецПопытки;
	КонецПопытки;
...
Процедура ЯЗапоминаюЗначениеТаблицыПоляКак(ИмяТЧ,ИмяПоля,ИмяПеременной,ИскатьПоИмени = Ложь) Экспорт
	...
	Попытка
		...
		Если СтрокиТаблицы.Количество() = 0 Тогда
			ТекстСообщения = "Не смог получить строку таблицы %1";
			ТекстСообщения = СтрЗаменить(ТекстСообщения,"%1",ИмяТЧ);
			ВызватьИсключение ТекстСообщения;
		КонецЕсли;
...
Процедура ЯЗапоминаюЗначениеТаблицыПолясИменемКак(ИмяТЧ,ИмяПоля,ИмяПеременной,ИскатьПоИмени = Ложь) Экспорт
	ТЧ = НайтиТЧПоИмени(ИмяТЧ);
	Попытка
		Значение = ТЧ.ПолучитьТекстЯчейки(ИмяПоля); 
	Исключение
...
Функция ПолучитьРасхожденияТД(Макет, ТабПарам,ТипСравнения)
	...
	Для Каждого СтрокаОжидаемая Из ТабПарам Цикл
		...
		Если СтрокаТаблицыМакета = Неопределено Тогда
			ТекстСообщения = "Именованная область %1 не найдена;";
		...
		ИначеЕсли ТипСравнения = "точный" Тогда
			Если СтрокаТаблицыМакета.Значение <> ЗначениеПараметра Тогда
				ТекстСообщения = "Значение параметра %1: ожидали <%2>, получили <%3>;";
				ТекстСообщения = СтрЗаменить(ТекстСообщения,"%1",ИмяПараметра); 
		...
		ИначеЕсли ТипСравнения = "подстрока" Тогда
			Если Найти(СтрокаТаблицыМакета.Значение,ЗначениеПараметра) = 0 Тогда
				ТекстСообщения = "Значение параметра %1: ожидали подстроку <%2>, в <%3>;";
				ТекстСообщения = СтрЗаменить(ТекстСообщения,"%1",ИмяПараметра); 
				ТекстСообщения = СтрЗаменить(ТекстСообщения,"%2",ЗначениеПараметра); 
				ТекстСообщения = СтрЗаменить(ТекстСообщения,"%3",СтрокаТаблицыМакета.Значение); 
				МассивРасхождений.Добавить(ТекстСообщения);
...
Процедура ТабличныйДокументСодержитЗначенияОбластей(ИмяЭлементаФормы,ТабПарам) Экспорт
	...
	Если МассивРасхождений.Количество() > 0 Тогда
		ТекстСообщения = "Ошибка при поиске значений в макете %1:";
...
Процедура ТабличныйДокументСодержитЗначенияОбластейПоШаблону(ИмяЭлементаФормы,ТабПарам) Экспорт
	...
	Если МассивРасхождений.Количество() > 0 Тогда
		...
		ТекстСообщения = СтрЗаменить(ТекстСообщения,"%1",ИмяЭлементаФормы); 
		МассивРасхождений.Вставить(0, ТекстСообщения);
		ТекстСообщения = СтрСоединить(МассивРасхождений, Символы.ПС);
		ВызватьИсключение ТекстСообщения;
	КонецЕсли;
...
Процедура ЯФиксируюТекущуюФорму() Экспорт
	...
	Если МассивФорм = Неопределено Тогда
		ТекстСообщения = "Не смог получить форму текущего окна.";
		ВызватьИсключение ТекстСообщения;
	КонецЕсли;	 
	...
	Если МассивФорм.Количество() > 1 Тогда
		ТекстСообщения = "У текущего окна найдено %1 форм.";
...
Процедура ЯЗапоминаюЗначениеТекущегоПоляКак(ИмяПеременной) Экспорт
	...
	Если ТекущееПоле = Неопределено Тогда
		ТекстСообщения = "Не найден активный элемент формы.";
		ВызватьИсключение ТекстСообщения;
	КонецЕсли;	 
