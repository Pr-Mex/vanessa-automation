...
Функция ПолучитьСписокТестов(КонтекстФреймворкаBDD) Экспорт
	...
	Ванесса.ДобавитьШагВМассивТестов(ВсеТесты,"втабличномдокументеимакетеодинаковыеизображения(Парам01,Парам02)","втабличномдокументеимакетеодинаковыеизображения","Дано В Табличном документе ""ИмяРеквизита"" и макете ""ИмяМакета"" одинаковые изображения","Шаг позволяет убедиться, что количество картинок и их содержание одинаково");
