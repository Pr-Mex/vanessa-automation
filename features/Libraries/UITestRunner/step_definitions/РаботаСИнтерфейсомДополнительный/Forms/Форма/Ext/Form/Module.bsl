...
Функция ПолучитьСписокТестов(КонтекстФреймворкаBDD) Экспорт
	...
	Ванесса.ДобавитьШагВМассивТестов(ВсеТесты,"ЯСохраняюДанныеЭлементаФормыВФайл(Парам01)","ЯСохраняюДанныеЭлементаФормыВФайл","И я сохраняю данные элемента формы ""Заголовок элемента"" в файл","Вызвает сохранение данных реквизита в файл. Подходит для табличного документа, текстового документа, форматированного документа. Элемент ищется по заголовку.","UI.Формы.Поля.Сохранить в файл");
	Ванесса.ДобавитьШагВМассивТестов(ВсеТесты,"ЯСохраняюДанныеЭлементаФормыСИменемВФайл(Парам01)","ЯСохраняюДанныеЭлементаФормыСИменемВФайл","И я сохраняю данные элемента формы с именем ""ИмяЭлемента"" в файл","Вызвает сохранение данных реквизита в файл. Подходит для табличного документа, текстового документа, форматированного документа. Элемент ищется по имени.","UI.Формы.Поля.Сохранить в файл");
