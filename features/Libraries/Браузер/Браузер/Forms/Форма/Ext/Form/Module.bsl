...
Функция ПолучитьСписокТестов(КонтекстФреймворкаBDD) Экспорт
	...
	Ванесса.ДобавитьШагВМассивТестов(ВсеТесты, "ЯПоказываюЗаставкуВБраузере(Парам01,ТабПарам)",
		...
		|Единственный шаг библиотеки с явной проверкой типа клиента: если текущий клиент тестирования не Web, шаг молча ничего не делает — ни заставки, ни ошибки. Сценарий при этом не падает, поэтому отсутствие титра в готовом ролике легко списать на что угодно, кроме настроек клиента.
