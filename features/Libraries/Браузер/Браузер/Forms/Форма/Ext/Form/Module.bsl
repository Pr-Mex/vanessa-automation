...
Функция ПолучитьСписокТестов(КонтекстФреймворкаBDD) Экспорт
	...
	Ванесса.ДобавитьШагВМассивТестов(ВсеТесты, "ЯРисуюРамкуВокругЭлементаПанелиРазделовВБраузере(Парам01,ТабПарам)",
		...
		|		|'timeout'|'5000'|",
		"### Описание
		|Рисует рамку вокруг раздела панели разделов в браузере. Раздел ищется по заголовку. 571: Рисует рамку вокруг команды панели функций в браузере. Команда ищется по заголовку.
