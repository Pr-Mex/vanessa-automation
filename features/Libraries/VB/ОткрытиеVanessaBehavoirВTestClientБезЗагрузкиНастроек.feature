...
Функционал: Открытие Vanessa-Behavoir без загрузки сохраненных настроек
	Как Разработчик
	Я Хочу чтобы чтобы у меня была возможность открыть Vanessa-Behavoir в TestClient без загрузки сохраненных настроек
	Чтобы я мог использовать этот сеанс для записи инструкций
 

Сценарий: Я открываю Vanessa-Behavoir в TestClient без загрузки сохраненных настроек
