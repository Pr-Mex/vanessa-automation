...
Сценарий: Я нажимаю на кнопку перезагрузить сценарии в Vanessa-Behavior TestClient
	Дано  я снимаю флаг "Сценарии загружены"
	И     Я нажимаю на кнопку "Перезагрузить сценарии"
	И     у элемента "Сценарии загружены" я жду значения "Да" в течение 30 секунд

	
Сценарий: Я нажимаю на кнопку выполнить сценарии в Vanessa-Behavior TestClient
	Дано  я снимаю флаг "Сценарии выполнены"
	И     Я нажимаю на кнопку "Выполнить сценарии"
	И     у элемента "Сценарии выполнены" я жду значения "Да" в течение 30 секунд
