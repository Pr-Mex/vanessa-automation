...
//	Ванесса.ДобавитьШагВМассивТестов(ВсеТесты, Снипет, ИмяПроцедуры, ПредставлениеТеста, ОписаниеШага, ТипШага, Транзакция, Параметр);
	Ванесса.ДобавитьШагВМассивТестов(ВсеТесты, "ЯОткрываюОбщуюФорму(Парам01)", "ЯОткрываюОбщуюФорму", "я открываю общую форму ""ИмяОбщейФормы""", "Открывает Общую форму по её имени в метаданных", "UI.Навигационные ссылки");
	...
	Ванесса.ДобавитьШагВМассивТестов(ВсеТесты, "ЯОткрываюОсновнуюФормуЖурналаДокументов(Парам01)", "ЯОткрываюОсновнуюФормуЖурналаДокументов", "я открываю основную форму журнала документов ""ИмяЖурналаДокументов""", "Открывает основную форму списка журнала документов по его имени в метаданных", "UI.Навигационные ссылки");
	...
	Ванесса.ДобавитьШагВМассивТестов(ВсеТесты, "ЯОткрываюОсновнуюФормуПланаВидовРасчета(Парам01)", "ЯОткрываюОсновнуюФормуПланаВидовРасчета", "я открываю основную форму плана видов расчета ""ИмяПВР""", "Открывает основную форму плана видов расчета по его имени в метаданных", "UI.Навигационные ссылки");
	Ванесса.ДобавитьШагВМассивТестов(ВсеТесты, "ЯОткрываюОсновнуюФормуСпискаПланаВидовРасчета(Парам01)", "ЯОткрываюОсновнуюФормуСпискаПланаВидовРасчета", "я открываю основную форму списка плана видов расчета ""ИмяПВР""", "Открывает основную форму списка плана видов расчета по его имени в метаданных", "UI.Навигационные ссылки");
