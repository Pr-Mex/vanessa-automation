...
Функция ПолучитьСписокТестов(КонтекстФреймворкаBDD) Экспорт
	...
	Ванесса.ДобавитьШагВМассивТестов(ВсеТесты,"ЯУстанавливаюФлагНастройкиVanessa_Automation(Парам01)","ЯУстанавливаюФлагНастройкиVanessa_Automation","И я устанавливаю флаг настройки Vanessa-Automation ""ИмяФлага""","Устанавливает флаг настройки Vanessa Automation.","Прочее.Vanessa Automation");
	Ванесса.ДобавитьШагВМассивТестов(ВсеТесты,"ЯСнимаюФлагНастройкиVanessa_Automation(Парам01)","ЯСнимаюФлагНастройкиVanessa_Automation","И я снимаю флаг настройки Vanessa-Automation ""ИмяФлага""","Снимает флаг настройки Vanessa Automation.","Прочее.Vanessa Automation");
	Ванесса.ДобавитьШагВМассивТестов(ВсеТесты,"ЯУстанавливаюОпциюVanessa_Automation(Парам01,Парам02)","ЯУстанавливаюОпциюVanessa_Automation","И я устанавливаю опцию Vanessa-Automation ""ИмяФлага"" ""Значение""","Устанавливает парметрVanessa Automation в нужное значение. Параметр должен быть типа ""Строка"" или ""Число"".","Прочее.Vanessa Automation");
...
//@ЯУстанавливаюФлагНастройкиVanessa_Automation(Парам01)
Функция ЯУстанавливаюФлагНастройкиVanessa_Automation(ИмяОпции) Экспорт
	Ванесса.Объект[ИмяОпции] = Истина;
КонецФункции

&НаКлиенте
//И я снимаю флаг настройки Vanessa-Automation "ИмяФлага"
//@ЯСнимаюФлагНастройкиVanessa_Automation(Парам01)
Функция ЯСнимаюФлагНастройкиVanessa_Automation(ИмяОпции) Экспорт
	Ванесса.Объект[ИмяОпции] = Ложь;
КонецФункции

&НаКлиенте
//И я устанавливаю опцию Vanessa-Automation "ИмяФлага" "Значение"
//@ЯУстанавливаюОпциюVanessa_Automation(Парам01,Парам02)
Функция ЯУстанавливаюОпциюVanessa_Automation(ИмяОпции, Значение) Экспорт
