...
Функция ЭтотЭлементЯвляетсяИсключением(Элем, ИмяЭлемента)
	...
	ИначеЕсли ИмяЭлемента = "УровеньОтчета3Служебный" Тогда
		Возврат Истина;
	ИначеЕсли ИмяЭлемента = "ГруппировкаTestParentSuites" Тогда
		Возврат Истина;
	ИначеЕсли ИмяЭлемента = "ГруппировкаTestSuites" Тогда
		Возврат Истина;
	ИначеЕсли ИмяЭлемента = "ГруппировкаTestSubSuites" Тогда
		Возврат Истина;
