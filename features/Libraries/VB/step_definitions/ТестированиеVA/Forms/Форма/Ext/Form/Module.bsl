...
Функция ЯПроверяюЧтоДляВсехФичаФайловУстановленТегДляРазделенияФичНаПотоки() Экспорт
	...
	Для Каждого Файл Из Файлы Цикл
		...
		Для Сч = 0 По МассивСтрок.Количество()-1 Цикл
			...
			Если ТекСтрока = "@uf-part1" ИЛИ ТекСтрока = "@uf-part2" Тогда
				Нашли = Истина;
				Прервать;
	...
	Если Ошибки.Количество() > 0 Тогда
		ТекстОшибки = Ванесса.Локализовать("Есть фича файлы без тега @uf-part1 и @uf-part2. Должен быть один из этих тегов. Список проблемных файлов:");
