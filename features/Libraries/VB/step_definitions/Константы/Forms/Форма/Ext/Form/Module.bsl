...
Функция ПолучитьСписокТестов(КонтекстФреймворкаBDD) Экспорт
	...
	Ванесса.ДобавитьШагВМассивТестов(ВсеТесты,"ЯУстанавливаюВКонстантуЗначение(Парам01,Парам02)","ЯУстанавливаюВКонстантуЗначение","И Я устанавливаю в константу ""ИмяКонстанты"" значение ""Ложь""","Устанавливает константе нужное значение.","Прочее.Константы.Установить значение константы");
