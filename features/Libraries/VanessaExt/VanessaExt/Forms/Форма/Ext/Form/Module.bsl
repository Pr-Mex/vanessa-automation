...
Функция ПолучитьСписокТестов(КонтекстФреймворкаBDD) Экспорт
	...
	Ванесса.ДобавитьШагВМассивТестов(ВсеТесты,
			"ЯЭмулируюСканированиеШтрихкодаБСПЧерезБуферОбмена(Парам01)",
			"ЯЭмулируюСканированиеШтрихкодаБСПЧерезБуферОбмена",
			"И я эмулирую сканирование штрихкода БСП ""4670003110011"" через буфер обмена",
			"Эмуляция сканирования штрихкода (эмуляция вызова БСП)" + Символы.ПС 
			+ "можно использовать тег ""\x_GS"" для передачи символа FNC1(29)" + Символы.ПС  
			+ " К примеру:" + Символы.ПС 
			+ "   И я сканирую штрихкод ""0146700031100112112345\x_GS941234"" через БСП" + Символы.ПС 
			+ "   И я эмулирую сканирование штрихкода БСП ""0146700031100112112345\x_GS941234"" через буфер обмена" + Символы.ПС 
			+ "Использовать VAExtension версии 1.02 и выше только под ОС Windows" + Символы.ПС 
...
// И я эмулирую сканирование штрихкода БСП ""4670003110011"" через буфер обмена
// @ЯЭмулируюСканированиеШтрихкодаБСПЧерезБуферОбмена(Парам01)
Функция ЯЭмулируюСканированиеШтрихкодаБСПЧерезБуферОбмена(Знач Штрихкод) Экспорт
