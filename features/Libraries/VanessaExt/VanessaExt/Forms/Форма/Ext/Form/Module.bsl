...
Функция ПолучитьСписокТестов(КонтекстФреймворкаBDD) Экспорт
	...
	Ванесса.ДобавитьШагВМассивТестов(ВсеТесты,
		...
		|Оговорка про строковый тип касается подстановки: `$Переменная$` **внутри** более длинного текста заменяется только для строк. Когда же параметр целиком равен `$Имя$`, VA передаёт значение переменной как есть, любого типа, и реализация шага принимает и число, и строку.
