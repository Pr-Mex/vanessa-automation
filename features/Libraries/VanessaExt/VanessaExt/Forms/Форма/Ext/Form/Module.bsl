...
Функция ПолучитьСписокТестов(КонтекстФреймворкаBDD) Экспорт
	...
	Ванесса.ДобавитьШагВМассивТестов(ВсеТесты, "ЯОткрываюВнешнийФайл(ИмяФайла)",
		"ЯОткрываюВнешнийФайл",
		"И я открываю внешний файл ""ИмяФайла""",
		"Открывает произвольный внешний файл, например файл внешней обработки. "
...
&НаКлиенте
//И я открываю внешний файл "ИмяФайла"
Процедура ЯОткрываюВнешнийФайл(ИмяФайла) Экспорт
