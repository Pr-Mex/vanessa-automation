...
Функция ПолучитьСписокТестов(КонтекстФреймворкаBDD) Экспорт
	...
	Ванесса.ДобавитьШагВМассивТестов(ВсеТесты,
		...
		|Оговорка про строковый тип не формальность: подстановка `$Переменная$` работает только со строками, и число в переменной в текст шага не подставится. Шаги, которые отдают PID, — <И я получаю данные процесса по заголовку окна ""Заголовок""> и <И я читаю данные текущего профиля клиента тестирования> — кладут его строкой.
