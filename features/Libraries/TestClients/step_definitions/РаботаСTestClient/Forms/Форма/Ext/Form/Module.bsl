...
Функция ПолучитьСписокТестов(КонтекстФреймворкаBDD) Экспорт
	...
	Ванесса.ДобавитьШагВМассивТестов(ВсеТесты,"ВТаблицеКлиентовТестированияЯАктивизируюСтроку(Парам01)","ВТаблицеКлиентовТестированияЯАктивизируюСтроку","И в таблице клиентов тестирования я активизирую строку 'ИмяКлиентаТестирования'","Активизирует строку с нужным клиентом тестирования. Поиск строки происходит с начала по имени, затем по синониму.","Подключение TestClient.Прочее.Активизировать строку");
