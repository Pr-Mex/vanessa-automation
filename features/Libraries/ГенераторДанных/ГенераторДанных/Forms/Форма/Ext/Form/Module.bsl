...
Функция ПолучитьСписокТестов(КонтекстФреймворкаBDD) Экспорт
	...
	Ванесса.ДобавитьШагВМассивТестов(ВсеТесты,
		...
		|### Пример. Имя выбирается заново на каждой итерации
	...
	Ванесса.ДобавитьШагВМассивТестов(ВсеТесты,
		...
		|Макет с именами встроен в Vanessa, список доступных имён можно найти в макете обработки.
		|### Пример. Женское имя в поле формы
	...
	Ванесса.ДобавитьШагВМассивТестов(ВсеТесты,
		...
		|В окно сообщений попадёт значение вида `770123456780`, проверка убедится, что разрядов ровно 12.
		|```Gherkin
	...
	Ванесса.ДобавитьШагВМассивТестов(ВсеТесты,
		...
		|В окно сообщений попадёт значение вида `770101001`, проверка убедится, что разрядов ровно 9.
		|```Gherkin
		|	И я запоминаю случайный КПП юридического лица в переменную 'КПП'
		|	И я вывожу значение переменной 'КПП'
	...
	Ванесса.ДобавитьШагВМассивТестов(ВсеТесты,
		...
		|Макет с наименованиями встроен в Vanessa, список содержит наименования ТН ВЭД.
