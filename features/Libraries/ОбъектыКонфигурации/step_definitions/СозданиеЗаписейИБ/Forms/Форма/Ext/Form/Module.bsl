...
Функция ПолучитьСписокТестов(КонтекстФреймворкаBDD) Экспорт
	...
	Ванесса.ДобавитьШагВМассивТестов(ВсеТесты,
		...
		|Ссылка находится по наименованию и подставляется в реквизит другого элемента. В окно сообщений попадёт представление найденной ссылки.
		|```Gherkin
		...
		|	И я программно изменяю элемент справочника 'Справочник1' с 'Наименование' равным 'Элемент #1' установив реквизиты
	...
	Ванесса.ДобавитьШагВМассивТестов(ВсеТесты,
		...
		|Элемент ищется по наименованию и коду сразу. В окно сообщений попадёт представление найденной ссылки.
		|```Gherkin
		|	Дано я запоминаю строку 'Элемент #2' в переменную 'Наименование2'
	...
	Ванесса.ДобавитьШагВМассивТестов(ВсеТесты,
		...
		|Удаляется только элемент с нужным наименованием, и проверка подтверждает, что его больше нет. В окно сообщений попадёт `Элемент удалён`.
		|```Gherkin
		|	Дано я запоминаю строку 'Элемент #4' в переменную 'Наименование4'
