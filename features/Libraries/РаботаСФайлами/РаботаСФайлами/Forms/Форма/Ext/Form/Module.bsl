...
Функция ПолучитьСписокТестов(КонтекстФреймворкаBDD) Экспорт
	...
	Ванесса.ДобавитьШагВМассивТестов(ВсеТесты,"ФайлСуществет(Парам01)","ФайлСуществет","И Файл ""ИмяФайла"" существет","Проверяет существование файла","Файлы");
...
//@ФайлСуществет(Парам01)
Процедура ФайлСуществет(Знач ИмяФайла) Экспорт
	ИмяФайла = Ванесса.ПолучитьЗначениеИзКонтекстаЕслиЭтоВозможно(ИмяФайла);
