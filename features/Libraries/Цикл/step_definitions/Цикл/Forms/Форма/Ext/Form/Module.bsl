...
Функция ПолучитьСписокТестов(КонтекстФреймворкаBDD) Экспорт
	...
	Ванесса.ДобавитьШагВМассивТестов(ВсеТесты,
		...
		|Если за 20 секунд условие так и не выполнится, шаг завершится с ошибкой.
	...
	Ванесса.ДобавитьШагВМассивТестов(ВсеТесты,
		...
		|При переходе к следующей строке будет создаваться переменная с именем каждой колонки.
		|### Пример. Перебор строк макета формы
		|`ДляПроверкиЦиклов14_Макет` — имя макета в текущей форме клиента тестирования. `Счетчик` — имя колонки макета, оно же имя переменной.
		|```Gherkin
