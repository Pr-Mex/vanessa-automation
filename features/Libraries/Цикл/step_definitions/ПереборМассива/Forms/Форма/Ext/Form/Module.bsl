...
Функция ПолучитьСписокТестов(КонтекстФреймворкаBDD) Экспорт
	...
	Ванесса.ДобавитьШагВМассивТестов(ВсеТесты,"ДляКаждогоФайлаИзКаталога(Парам01,Парам02)","ДляКаждогоФайлаИзКаталога",
		...
		|Имя выводится для каждого файла каталога, а счётчик — только для подошедших по расширению. По выводу видно, какие файлы попали в подсчёт: в окне сообщений останется столько значений счётчика, сколько в каталоге файлов `.png`.
		|```Gherkin
