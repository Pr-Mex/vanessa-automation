...
Функция ПолучитьСписокТестов(КонтекстФреймворкаBDD) Экспорт
	...
	Ванесса.ДобавитьШагВМассивТестов(ВсеТесты,
		...
		"### Описание
		|Создаёт в памяти таблицу строк по переданной таблице.
	...
	Ванесса.ДобавитьШагВМассивТестов(ВсеТесты,
		...
		"### Описание
		|Цикл. Перебирает массив значений. Сам массив — строка, в которой значения разделены символом `;`.
		...
		|		И я вывожу значение переменной 'ЗначениеПереключателя'
		|```
		|### Пример. Массив из переменной
		|Значения массива выводятся по одному — 111, потом 222, — а в `Итого` они накапливаются: последний вывод, уже за циклом, даёт 333.
		|```Gherkin
	...
	Ванесса.ДобавитьШагВМассивТестов(ВсеТесты,"ДляКаждогоЗначенияИзТаблицыВПамяти(Парам01,Парам02)",
		...
		"### Описание
		|Цикл. Перебирает значения из указанной переменной. Первый параметр - это имя переменной, которое будет доступно в Контексте.
		...
		|```
		|### Пример. Таблица из одной колонки как массив
	...
	Ванесса.ДобавитьШагВМассивТестов(ВсеТесты,"ДляКаждогоЗначенияИзМассиваВПамяти(Парам01,Парам02)",
		...
		"### Описание
		|Цикл. Перебирает значения из указанной переменной. Первый параметр - это имя переменной, которое будет доступно в Контексте.
		|Второй параметр — имя массива, который сохранён в контексте.
		|Предполагается, что в массиве находятся либо структуры, либо какие-то значения одного типа, например, строки.
		|По мере перебора элементов массива будут обновляться значения в переменной Контекст, где именем переменной будет имя ключа структуры либо именем переменной будет первый параметр шага.
		|### Пример. Массив структур из json
		|В отличие от шага <И для каждого значения 'ЗначениеИзМассива' из массива 'МассивЗначенийЧерезТочкуСЗапятой'>, здесь во втором параметре — имя переменной, в которой лежит настоящий массив, а не строка через `;`.
		|Если в массиве структуры, переменные создаются по ключам структуры, а не по первому параметру шага. Для файла с массивом из двух структур будет выведено 'Тест1', 'Код1', затем 'Тест2', 'Код2'.
		|```Gherkin
	...
	Ванесса.ДобавитьШагВМассивТестов(ВсеТесты,"ДляКаждогоФайлаИзКаталога(Парам01,Парам02)","ДляКаждогоФайлаИзКаталога",
		...
		"### Описание
		|Цикл. Делает перебор файлов в каталоге, исключая подкаталоги. В переменную `ТекущийФайл` будет помещён полный путь к файлу. Также создаёт переменные:  _Имя, _ПолноеИмя, _ИмяБезРасширения, _Путь, _Расширение.
		|### Пример. Подсчёт файлов нужного расширения
		|Имя выводится для каждого файла каталога, а счётчик — только для файлов с нужным расширением. По выводу видно, какие файлы попали в подсчёт: в окно сообщений попадёт столько значений счётчика, сколько в каталоге файлов `.png`.
		|```Gherkin
		|	И Я запоминаю значение выражения '0' в переменную 'НашлиСкриншот'
		|	И для каждого файла 'ТекФайл' из каталога '$КаталогПроекта$\data'
	...
	Ванесса.ДобавитьШагВМассивТестов(ВсеТесты,"ДляКаждогоФайлаИзКаталогаВключаяПодкаталоги(Парам01,Парам02)","ДляКаждогоФайлаИзКаталогаВключаяПодкаталоги",
		...
		"### Описание
		|Цикл. Делает перебор файлов в каталоге, включая подкаталоги. В переменную `ТекущийФайл` будет помещён полный путь к файлу. Также создаёт переменные:  _Имя, _ПолноеИмя, _ИмяБезРасширения, _Путь, _Расширение.
	...
	Ванесса.ДобавитьШагВМассивТестов(ВсеТесты,"ЯСохраняюИмяФайлаИзПеременнойКак(Парам01,Парам02)","ЯСохраняюИмяФайлаИзПеременнойКак",
		...
		|Для файла `$КаталогПроекта$\temp\Отчет.xlsx` первый вывод даст полный путь, второй — `Отчет.xlsx`.
		|```Gherkin
	...
	Ванесса.ДобавитьШагВМассивТестов(ВсеТесты,
		...
		"### Описание
		|Предполагается, что в файле в формате json находится массив структур. Создаёт переменную для каждого значения структуры.
