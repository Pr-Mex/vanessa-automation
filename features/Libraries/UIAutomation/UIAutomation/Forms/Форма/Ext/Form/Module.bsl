...
Функция ПолучитьСписокТестов(КонтекстФреймворкаBDD) Экспорт
	...
	Ванесса.ДобавитьШагВМассивТестов(ВсеТесты,
		...
		|Отличие от <И я делаю подсветку элементов VA UI Automation> — не нужно перечислять элементы таблицей: шаг сам разворачивает группу и берёт всё, что в ней лежит. Имя группы указывается так, как оно задано в форме VA.
