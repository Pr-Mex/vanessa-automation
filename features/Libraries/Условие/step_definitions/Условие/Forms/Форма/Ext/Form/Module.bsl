...
Процедура СуществуетПеременнаяТогда(ИмяПеременной) Экспорт
	
	Ванесса.УстановитьРезультатУсловия(Контекст.Свойство(ИмяПеременной));
...
Процедура НеСуществуетПеременнаяТогда(ИмяПеременной) Экспорт
	...
	Ванесса.УстановитьРезультатУсловия(НЕ Контекст.Свойство(ИмяПеременной));
