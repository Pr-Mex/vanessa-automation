...
Функция ПолучитьСписокТестов(КонтекстФреймворкаBDD) Экспорт
	...
	Ванесса.ДобавитьШагВМассивТестов(ВсеТесты,
		...
		"Прочее.Расширение VAExtension.Распровести документ программно");
	...
	Ванесса.ДобавитьШагВМассивТестов(ВсеТесты,
		...
		"ЯОтменяюПроведениеВсеДокументыЭтогоСценарияПоИхНавигационнымСсылкамрасширение",
		...
		"Прочее.Расширение VAExtension.Распровести документы программно");
	...
	Ванесса.ДобавитьШагВМассивТестов(ВсеТесты,
		...
		"Прочее.Расширение VAExtension.Получить состояние документа или элемента справочника");
...
Функция ЯЖдуЗавершенияВыполненияВсехФоновыхЗаданийРасширение(КолСекунд = Неопределено) Экспорт
	...
	РеквизитВыполненаБыстраяПроверка = Ванесса.НайтиРеквизитОткрытойФормыПоЗаголовку("ВыполненаБыстраяПроверка", Истина);
...
//И я отменяю проведение всех документов этого сценария по их навигационным ссылкам (расширение)
//@ЯОтменяюПроведениеВсеДокументыЭтогоСценарияПоИхНавигационнымСсылкамРасширение()
Функция ЯОтменяюПроведениеВсеДокументыЭтогоСценарияПоИхНавигационнымСсылкамРасширение() Экспорт
