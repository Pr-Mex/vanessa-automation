...
&НаКлиенте
Функция СгенерироватьСерийныйНомер(КоличествоСимволов, СпецСимволы = Ложь) Экспорт
...
Функция СформироватьШтрихкодУпаковки(ЦифраРасширения, ПрефиксКомпании) Экспорт
	...
	МассивСтрок.Добавить(СгенерироватьСерийныйНомер(18-2-ДлиннаПрефикса));
	МассивСтрок.Добавить("0"); // Временный контрольный символ
	
	НовыйSSCC = СтрСоединить(МассивСтрок);
