...
Функция ПолучитьСписокТестов(КонтекстФреймворкаBDD) Экспорт
	...
	Ванесса.ДобавитьШагВМассивТестов(ВсеТесты,
		"ЯОткрываюСсылкуПоСтроковомуПредставлениюСсылкиРасширение(Парам01)",
		"ЯОткрываюСсылкуПоСтроковомуПредставлениюСсылкиРасширение",
		"И я открываю ссылку по строковому представлению ссылки ""ИмяПеременной"" (расширение)",
		"Открывает в клиенте тестирования ссылку на справочник, документ и т.д.
...
//И я открываю ссылку по строковому представлению ссылки "ИмяПеременной" (расширение)
//@ЯОткрываюСсылкуПоСтроковомуПредставлениюСсылкиРасширение(Парам01)
Функция ЯОткрываюСсылкуПоСтроковомуПредставлениюСсылкиРасширение(ИмяПеременной) Экспорт
