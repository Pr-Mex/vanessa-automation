...
Функция ЯЭмулируюСканированиеШтрихкодаБПОЧерезФайлСобытияРасширение(Знач Штрихкод) Экспорт
	...
	Если НЕ КонтекстСохраняемый.Свойство("_ЗапущенМониторингКаталогаСобытий") Тогда
		Возврат Неопределено;
	КонецЕсли;	
	...
	Если КонтекстСохраняемый._ЗапущенМониторингКаталогаСобытий Тогда
		...
		ФайлСобытия = КонтекстСохраняемый._ПутьДоКаталогаСобытий + ПолучитьРазделительПути() + "Event_BK_"+Строка(УникальныйИдентификаторСобытия)+".json";
...
Функция ЯВыполняюКодВстроенногоЯзыкаЧерезФайлСобытияРасширениеСлужебный(Код, НаКлиенте, ПривилегированныйРежим = Ложь)
	...
	Если КонтекстСохраняемый._ЗапущенМониторингКаталогаСобытий Тогда
		...
		УникальныйИдентификаторСобытия = Новый УникальныйИдентификатор;
		ФайлСобытия = КонтекстСохраняемый._ПутьДоКаталогаСобытий + ПолучитьРазделительПути() + "Event_RC_"+Строка(УникальныйИдентификаторСобытия)+".json";
...
Функция ЯВызываюВнешнееСобытиеССобытиемСДаннымиЧерезФайлСобытияРасширение(Источник, Событие, Данные) Экспорт
	...
	Если КонтекстСохраняемый._ЗапущенМониторингКаталогаСобытий Тогда
		...
		УникальныйИдентификаторСобытия = Новый УникальныйИдентификатор;
		ФайлСобытия = КонтекстСохраняемый._ПутьДоКаталогаСобытий + ПолучитьРазделительПути() + "Event_OE_"+Строка(УникальныйИдентификаторСобытия)+".json";
