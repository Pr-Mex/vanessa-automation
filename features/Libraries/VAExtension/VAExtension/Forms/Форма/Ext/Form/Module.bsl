...
Функция ПолучитьСписокТестов(КонтекстФреймворкаBDD) Экспорт
	...
	Ванесса.ДобавитьШагВМассивТестов(ВсеТесты,"УПоляСИменемЯНажимаюГиперссылкуПоПредставлениюРасширение(Парам01,Парам02)","УПоляСИменемЯНажимаюГиперссылкуПоПредставлениюРасширение","И у поля с именем ""ИмяЭлемента"" я нажимаю гиперссылку по представлению ""ЧастьПредставления"" (расширение)","Нажимает на гиперссылку в поле HTML документа. Гиперссылка ищется по её представлению. Возможно указывать часть представления гиперссылки.","Прочее.Расширение VAExtension.Гиперссылки");
