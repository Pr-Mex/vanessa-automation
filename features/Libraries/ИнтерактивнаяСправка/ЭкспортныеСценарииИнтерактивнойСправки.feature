...
Сценарий: Я запускаю сценарий VA в режиме обучения и жду окончания выполнения
		...
		И Пауза 1
		И выражение внутреннего языка 'КонтекстСохраняемый.VAОткрытаяДляОбучения.ФлагСценарииВыполнены' стало Истинно в течение 20 секунд 
...
//	"""bsl
//		КонтекстСохраняемый.VAОткрытаяДляОбучения.$ПеремИмяПоля$ = "$ПеремТекстПоля$";
//	"""
//	И Пауза 0.1
//	И я нажимаю сочетание клавиш "ENTER"
