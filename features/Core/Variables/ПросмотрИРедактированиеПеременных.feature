...
Сценарий: Генерация шага по переменным из табло переменных
	...
	* Проверка
		...
		Тогда элемент формы с именем 'ШагПроверкиЗначенияПеременной' стал равен "Тогда выражение внутреннего языка \'Контекст.attachments0.Количество()\' имеет значение 3"
		...
		И в таблице 'ТаблоПеременных' я перехожу на одну строку вверх
		Тогда элемент формы с именем 'ШагПроверкиЗначенияПеременной' стал равен "Тогда выражение внутреннего языка \'Контекст.steps0.Количество()\' имеет значение 9"
