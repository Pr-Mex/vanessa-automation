...
@IgnoreOn8314
@IgnoreOn8315
Сценарий: Прикрепление скриншота, когда используется 1cWinCtrl. Все сеансы 1С. Все окна клиента тестирования.
...
Сценарий: Прикрепление скриншота, когда используется 1cWinCtrl. Один TestClient. Все окна клиента тестирования.
	Дано Я закрыл все окна клиентского приложения
	И я закрываю сеанс TESTCLIENT
	Когда я запускаю служебный сеанс TestClient с ключом TestManager в той же базе
