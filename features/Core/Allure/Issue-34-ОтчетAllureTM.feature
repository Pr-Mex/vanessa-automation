...
Сценарий: Проверка приложения макетов после сравнения отчетов или таблиц с эталоном к Allure
	...
	// к подвалу сценария прикреплено 3 mxl файла сравнения таблицы с эталоном
	И выражение внутреннего языка '$ДанныеJson$.attachments.Количество() = 3' Истинно
	// к подвалу сценария прикреплено 3 mxl файла сравнения таблицы с эталоном и файл csv - таблица шага
	И выражение внутреннего языка '$ДанныеJson$.steps[3].attachments.Количество() = 4' Истинно
