...
Сценарий: Проверка приложения макетов после сравнения отчетов или таблиц с эталоном к Allure. Плюс файлы diffa.
	...
	И я снимаю флаг с именем 'СохранятьMxlКакHTMLВAllure'
	...
	И выражение внутреннего языка '$ДанныеJson$.attachments.Количество() = 7' Истинно
	// к подвалу сценария прикреплено 3 mxl файла сравнения таблицы с эталоном и файл csv - таблица шага
	И выражение внутреннего языка '$ДанныеJson$.steps[11].attachments.Количество() = 7' Истинно
