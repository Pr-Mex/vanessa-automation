...
Сценарий: Проверка, что при видео прохождения сценариев будет приложено к отчету Allure. Запись видео через тег.
...
@IgnoreOnNoSyncBuilds
Сценарий: Проверка, что при видео прохождения сценариев будет приложено к отчету Allure. Запись видео через настройки.
...
Сценарий: Проверка, что после остановки сценария неш лишних шагов в отчете Allure
