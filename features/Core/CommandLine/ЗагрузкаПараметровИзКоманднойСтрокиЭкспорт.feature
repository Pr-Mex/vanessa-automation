...
Сценарий: Я запускаю клиент тестирования с эмуляцией запуска из командной строки "ИмяJson" "ДопПараметрКоманднойСтроки" "ОставитьЗагрузчикНастроек" "УбратьПараметрПоказаОсновнойФормы"
