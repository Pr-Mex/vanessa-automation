...
Сценарий: Я запускаю клиент тестирования с эмуляцией запуска из командной строки "ИмяJson"
	...
	И Я запоминаю значение выражения '" /TESTCLIENT -TPort 48111 /Execute " + Ванесса.Объект.КаталогИнструментов + "/" + $ИмяEpf$ + " /CStartFeaturePlayer;Debug;VBParams=" + $TestJson$' в переменную "ДопПараметр"
