...
Сценарий: Проверка отчета Markdown. Группа как шаг. Нет тегов screenshot ни у одного шага в группе.
		...
		Затем количество файлов в каталоге "$КаталогMarkdown$\ПроверкаИнструкцииMarkdown03" я запоминаю как "КоличествоФайловСкриншотов"	
...
Сценарий: Проверка отчета Markdown. Группа как шаг. Два тега screenshot на несколько шагов.
		...
		Затем количество файлов в каталоге "$КаталогMarkdown$\ПроверкаИнструкцииMarkdown02" я запоминаю как "КоличествоФайловСкриншотов"	
...
Сценарий: Проверка отчета Markdown. Группа как шаг. Один тег screenshot на несколько шагов.
		...
		Затем количество файлов в каталоге "$КаталогMarkdown$\ПроверкаИнструкцииMarkdown01" я запоминаю как "КоличествоФайловСкриншотов"	
		Тогда переменная "КоличествоФайловСкриншотов" имеет значение 1
