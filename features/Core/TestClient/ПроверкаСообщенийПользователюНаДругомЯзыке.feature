...
Сценарий: Проверка сообщений пользователю на другом языке на английском языке
	...
	И В командном интерфейсе я выбираю 'Основная' 'ОткрытьVanessaBehavior'
	...
	И я перехожу к закладке "Run and Invoke"
