...
&НаСервере
Функция УдалитьЭлементСправочникаЕслиОнЕсть(ВидСправочника)
	Запрос = Новый Запрос;
	Запрос.Текст = 
		"ВЫБРАТЬ
	...
	Пока ВыборкаДетальныеЗаписи.Следующий() Цикл
		...
		ТекстСообщения = "Удаляю элемент справочника <%1> : <%2>";
...
Процедура ПередНачаломСценария() Экспорт
	УдалитьЭлементСправочникаЕслиОнЕсть("Справочник1");
	УдалитьЭлементСправочникаЕслиОнЕсть("Справочник2");
