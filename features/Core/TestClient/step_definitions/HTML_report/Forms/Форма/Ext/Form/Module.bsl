...
Процедура ВПолеКаталогОтчетаHTMLЯУказываюПутьКОтносительномуКаталогу(ЧастьПути) Экспорт
	...
	Поле = Ванесса.НайтиРеквизитОткрытойФормыПоЗаголовку("КаталогOutputИнструкцияHTML",Истина);
...
Процедура ВОткрытойФормеВПолеЯВвожуКомандуДляIrfanView(ИмяПоля) Экспорт
	...
	Поле = Ванесса.НайтиРеквизитОткрытойФормыПоЗаголовку("Консольная команда создания скриншотов",Ложь);
