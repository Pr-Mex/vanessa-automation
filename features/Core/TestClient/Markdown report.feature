...
Сценарий: Проверка отчета Markdown
	...
	И     В открытой форме в поле "Консольная команда создания скриншотов" я ввожу текст '"C:\Program Files (x86)\IrfanView\i_view32.exe" /capture=1 /convert='
	...
	И в Файле инструкции "Instr_ФичаДляПроверкиОтчетаMarkdown.Markdown" нет строки "я выполняю простой шаг контекста"
