...
Сценарий: Проверка работы цикла и вложенного сценария
	...
	И я выбираю пункт контекстного меню "Выполнить один шаг" на элементе формы с именем "ДеревоТестов"
	...
	И я выбираю пункт контекстного меню "Выполнить данный сценарий с текущего шага" на элементе формы с именем "ДеревоТестов"
