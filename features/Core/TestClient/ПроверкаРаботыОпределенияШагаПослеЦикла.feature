...
Сценарий: Проверка работы цикла и вложенного сценария
	...
	#И     в таблице "ДеревоТестов" я нажимаю на кнопку "Выполнить данный сценарий с текущего шага"
	И я выбираю пункт контекстного меню "Выполнить данный сценарий с текущего шага" на элементе формы "ДеревоТестов"
