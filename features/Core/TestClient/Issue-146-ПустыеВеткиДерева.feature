...
Сценарий: Загруза фич без пустых веток
	...
	#заполним тег
	И     В открытой форме я нажимаю кнопку выбора у поля с заголовком "Список тегов исключение"
	...
	И В открытой форме в таблице с именем "ДеревоТестов" в колонке "Имя" нет значения "Temp2"
