...
Функция ПолучитьСписокТестов(КонтекстФреймворкаBDD) Экспорт
	...
	Ванесса.ДобавитьШагВМассивТестов(ВсеТесты,"ЯВыполняюШагСОбычнымПараметромИВПараметрыКоторогоПереданаТаблица(Парам01,ТабПарам)","ЯВыполняюШагСОбычнымПараметромИВПараметрыКоторогоПереданаТаблица","Когда я выполняю шаг с обычным параметром ""ОбычныйПараметр"" и в параметры которого передана таблица:");
	Ванесса.ДобавитьШагВМассивТестов(ВсеТесты,"ВПеременнойКонтекстБудeтЗначениеИзТаблицыТип(Парам01,Парам02)","ВПеременнойКонтекстБудeтЗначениеИзТаблицыТип","Тогда в переменной контекст будeт значение из таблицы 10 Тип ""ЧислоВТаблице""");
	Ванесса.ДобавитьШагВМассивТестов(ВсеТесты,"ВПеременнойКонтекстБудeтОбычноеЗначениеПереданногоПараметраТип(Парам01,Парам02)","ВПеременнойКонтекстБудeтОбычноеЗначениеПереданногоПараметраТип","И     в переменной контекст будeт Обычное значение переданного параметра ""ОбычныйПараметр"" Тип ""ОбычныйПараметрИзПроцедуры""");
	Ванесса.ДобавитьШагВМассивТестов(ВсеТесты,"ВПеременнойКонтекстБудeтЧислоМинусОдиннадцать()","ВПеременнойКонтекстБудeтЧислоМинусОдиннадцать","И     в переменной контекст будeт число минус одиннадцать");
	Ванесса.ДобавитьШагВМассивТестов(ВсеТесты,"ЯВыполняюШагСВКоторомПередаётсяТаблицаСоСтрокойВКавычкахТоНеВозникаетОшибок(ТабПарам)","ЯВыполняюШагСВКоторомПередаётсяТаблицаСоСтрокойВКавычкахТоНеВозникаетОшибок","Когда я выполняю шаг с в котором передаётся таблица со строкой в кавычках то не возникает ошибок:");
...
Процедура ВПеременнойКонтекстБудeтЗначениеИзТаблицыТип(Значение,Тип) Экспорт
	Зн = Контекст[Тип];
	ТекстСообщения = "ВПеременнойКонтекстБудeтЗначениеИзТаблицыТип=%1";
	ТекстСообщения = СтрЗаменить(ТекстСообщения,"%1",Зн);
