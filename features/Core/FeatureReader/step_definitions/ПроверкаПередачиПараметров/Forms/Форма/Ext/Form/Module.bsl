...
Функция ПолучитьСписокТестов(КонтекстФреймворкаBDD) Экспорт
	...
	Ванесса.ДобавитьШагВМассивТестов(ВсеТесты,"ВПеременнойБудетНаходитьсяЗначениеТипа(Парам01,Парам02)","ВПеременнойБудетНаходитьсяЗначениеТипа","Тогда в переменной ""$ПеременнаяМассив$"" будет находиться значение типа ""Массив""","","");
...
//@ВПеременнойБудетНаходитьсяЗначениеТипа(Парам01,Парам02)
Процедура ВПеременнойБудетНаходитьсяЗначениеТипа(ИмяПеременной,ТипЗначенияСтрокой) Экспорт
