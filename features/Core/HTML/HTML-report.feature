...
Сценарий: Проверка отчета HTML. Группа как шаг. Нет тегов screenshot ни у одного шага в группе.
		...
		Затем количество файлов в каталоге "$КаталогHTML$\ПроверкаИнструкцииHTML03" я запоминаю как "КоличествоФайловСкриншотов"	
...
Сценарий: Проверка отчета HTML. Группа как шаг. Два тега screenshot на несколько шагов.
		...
		Затем количество файлов в каталоге "$КаталогHTML$\ПроверкаИнструкцииHTML02" я запоминаю как "КоличествоФайловСкриншотов"	
...
Сценарий: Проверка отчета HTML. Группа как шаг. Один тег screenshot на несколько шагов.
		...
		Затем количество файлов в каталоге "$КаталогHTML$\ПроверкаИнструкцииHTML01" я запоминаю как "КоличествоФайловСкриншотов"	
		Тогда переменная "КоличествоФайловСкриншотов" имеет значение 1
