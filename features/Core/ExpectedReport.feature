...
#КонецОбласти
	...
	Тогда Я задаю системные параметры считывания макета НачСтр 1 НачКол 1 КолСтр 20 КолКол 10
...
#Область Проверка созданного кода Gherkin по изменениям элементов формы
	...
	Тогда В реквизите Vanessa-Behavior "СгенерированныйСценарий" будет содержаться строка 'Ссылка'
