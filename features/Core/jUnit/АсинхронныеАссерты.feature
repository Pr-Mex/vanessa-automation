...
Сценарий: Проверка асинхронных ассертов
	...
	И В открытой форме я устанавливаю флаг "Формировать отчет в формате jUnit"
	И в поле с именем "КаталогВыгрузкиJUnit" я ввожу текст "tools\jUnit"
	И Я нажимаю на кнопку перезагрузить сценарии в Vanessa-Automation TestClient
	И я нажимаю на кнопку с именем 'кнВыполнитьСценарии'
