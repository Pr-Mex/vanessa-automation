...
Сценарий: Загрузка бухгалтерских проводок
        Когда я создаю fixtures по макету "Контрагенты"
        Когда я создаю fixtures по макету "ПредопределеннаяОрганизация"
        Когда я создаю fixtures по макету "ПланыВидовХарактеристик"
        Когда я создаю fixtures по макету "ПланыСчетов"
        Когда я создаю fixtures по макету "ДокументТМЦ"
        Когда я создаю fixtures по макету "РегистрБухгалтерии"
        И Я открыл новый сеанс TestClient или подключил уже существующий
        ...
        И я нажимаю на кнопку с именем 'ФормаПроводки'
        Тогда таблица 'Список' стала равной:
