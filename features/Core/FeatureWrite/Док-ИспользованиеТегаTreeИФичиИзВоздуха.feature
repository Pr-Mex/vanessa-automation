...
Сценарий: Написание требований бизнес аналитиком и их детализация
	...
	Теперь добавим в наш feature файл полученные шаги.
			...
			И я выделяю 1 строки начиная с 'я нажимаю на кнопку "Создать"' вставляю их в текст фичи после "И я создаю новый документ"
			И я выделяю 2 строки начиная с 'в поле "Склад"' вставляю их в текст фичи после "я указываю склад"
			И я выделяю 6 строки начиная с 'я нажимаю на кнопку "Добавить"' вставляю их в текст фичи после "я указываю товары"
			И я выделяю 1 строки начиная с 'Провести и закрыть' вставляю их в текст фичи после "я записываю документ"
