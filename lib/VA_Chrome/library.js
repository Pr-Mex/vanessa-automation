...
function getFormElement(id) {
    let e;
    let prefix = getActiveFormPrefix();
    if (e = $('#' + prefix + id)[0]) return e;
    if (e = $('#thpage_' + prefix + id)[0]) return e;
    if (e = $('#' + prefix + 'popup_' + id)[0]) return e;
    if (e = $('#' + prefix + id + '\\#title_text')[0]) return e.firstChild;
}
