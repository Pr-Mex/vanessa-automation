...
function tableColumnIndex(tableId, columnTitle) {
	...
	let columnIndex;
	let table = (typeof tableId == "string") ? elem(tableId) : tableId;
	table.querySelectorAll('.gridHead .gridBoxText').forEach(function(e, idx) {
...
function getTableRegionCoordinates(tableId, params) {	
	let table = (typeof tableId == "string") ? elem(tableId) : tableId;
	...
	if(params.columnIndex === null || params.columnIndex === undefined) {
		...
		params.columnIndexEnd = table.querySelectorAll('.gridHead .gridLine .gridBox').length - 1;
	}
