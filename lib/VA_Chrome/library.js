...
function findFormElement(id, selector, regexp = 'form\\d{1,}_') {
    return $(selector).filter((i, e) => e.id.match(regexp + id)).last()[0];
}

function field(id) {
    return findFormElement(id, '.field:visible');
}

function checkbox(id) {
    return findFormElement(id, '.checkbox:visible');
}

function radio(id) {
    return findFormElement(id, '.radio:visible');
}

function page(id) {
    return findFormElement(id, '.tabsItem:visible');
}
