...
Процедура ОбработкаКоманды(ПараметрКоманды, ПараметрыВыполненияКоманды)
	...
	Если ДанныеJSON.НаКлиенте Тогда
		ВыполнитьКодКлиент(ДанныеJSON.Код);	
	Иначе	
		ВыполнитьКодСервер(ДанныеJSON.Код, ДанныеJSON.ПривилегированныйРежим);	
	КонецЕсли;	
	
КонецПроцедуры

&НаКлиенте
Процедура ВыполнитьКодКлиент(КодДляВыполнения)
...
&НаСервере
Процедура ВыполнитьКодСервер(КодДляВыполнения, ПривилегированныйРежим)
