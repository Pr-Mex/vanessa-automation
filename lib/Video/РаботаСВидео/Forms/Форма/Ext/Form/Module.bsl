...
Процедура СоздатьIntro(ПараметрыВидео)
	...
	Текст.Закрыть();
	Если Найти(СтрокаФичи,"#[autodoc.ignore.featureslide]") > 0 или ПараметрыВидео.ЗаписьВидеоОтключитьСлайдЗаголовок Или ПараметрыВидео.ЗаписьВидеоЗаменитьСлайдЗаголовок Тогда
...
Процедура СобратьФинальноеВидеоИзЧастей(ПараметрыВидео,МассивЧастей)
	...
	Если ПараметрыВидео.ФайлМузыки <> Неопределено Тогда
		...
		Если ПараметрыВидео.ЗаписьВидеоЗаменитьСлайдЗаголовок И ПараметрыВидео.ЗаписьВидеоДобавитьМузыкуКСлайдуЗаголовок Тогда
	...
	Если ПараметрыВидео.ЗаписьВидеоЗаменитьСлайдЗаголовок И (Не ПараметрыВидео.ЗаписьВидеоДобавитьМузыкуКСлайдуЗаголовок Или ПараметрыВидео.ФайлМузыки = Неопределено) Тогда
