...
Процедура СоздатьIntro(ПараметрыВидео)
	...
	Текст.Закрыть();
	Если Найти(СтрокаФичи,"#[autodoc.ignore.featureslide]") > 0 или ПараметрыВидео.ЗаписьВидеоОтключитьСлайдСЗаголовкомФичи Или ПараметрыВидео.ЗаписьВидеоЗаменитьIntroФайл Тогда
...
Процедура СоздатьOutro(ПараметрыВидео)
	...
	СтрокаФичи = Текст.Прочитать();
	Текст.Закрыть();
	Если Найти(СтрокаФичи,"#[autodoc.ignore.finalslide]") > 0 Или ПараметрыВидео.ЗаписьВидеоОтключитьСлайдФинал Или ПараметрыВидео.ЗаписьВидеоЗаменитьOutroФайл Тогда
...
&НаКлиенте
Процедура СобратьВидеоВставкуИзКартинки(ПараметрыВидео,ИмяФайлаШага,Знач ТекстВставки,ИмяКартинки,НомерСценария,НомерШага)
	ИмяФайлаШага = СтрЗаменить(ИмяФайлаШага,".mp4",".mpg");//так реально создан mpg и дальше нам надо mpg
	Ванесса.УдалитьФайлыКомандаСистемы(ИмяФайлаШага);
	ИсходныйТекст = ТекстВставки;
	...
	Ванесса.УдалитьФайлыКомандаСистемы(Картинка);
...
Процедура СобратьФинальноеВидеоИзЧастей(ПараметрыВидео,МассивЧастей)
	...
	Если ПараметрыВидео.ФайлМузыки <> Неопределено Тогда
		...
		Если ПараметрыВидео.ЗаписьВидеоЗаменитьIntroФайл И ПараметрыВидео.ЗаписьВидеоДобавитьМузыкуКIntroВидеоФайлу Тогда
			
			ИмяФайлаСобранноеВидео = ДобавитьIntroВидеоФайлКСобранномуВидео(ПараметрыВидео, ГдеИскать, ИмяФайлаСобранноеВидео, СобранноеВидео4)
			
		КонецЕсли;
		
		Если ПараметрыВидео.ЗаписьВидеоЗаменитьOutroФайл И ПараметрыВидео.ЗаписьВидеоДобавитьМузыкуКOutroВидеоФайлу Тогда
			
			ИмяФайлаСобранноеВидео = ДобавитьOutroВидеоФайлКСобранномуВидео(ПараметрыВидео, ГдеИскать, ИмяФайлаСобранноеВидео, СобранноеВидео4)
	...
	Если ПараметрыВидео.ЗаписьВидеоЗаменитьIntroФайл И (Не ПараметрыВидео.ЗаписьВидеоДобавитьМузыкуКIntroВидеоФайлу Или ПараметрыВидео.ФайлМузыки = Неопределено) Тогда
		
		ИмяФайлаСобранноеВидео = ДобавитьIntroВидеоФайлКСобранномуВидео(ПараметрыВидео, ГдеИскать, ИмяФайлаСобранноеВидео, СобранноеВидео5)
		
	КонецЕсли;
	
	Если ПараметрыВидео.ЗаписьВидеоЗаменитьOutroФайл И (Не ПараметрыВидео.ЗаписьВидеоДобавитьМузыкуКOutroВидеоФайлу Или ПараметрыВидео.ФайлМузыки = Неопределено) Тогда
		
		ИмяФайлаСобранноеВидео = ДобавитьOutroВидеоФайлКСобранномуВидео(ПараметрыВидео, ГдеИскать, ИмяФайлаСобранноеВидео, СобранноеВидео5)
...
&НаКлиенте
Функция ДобавитьIntroВидеоФайлКСобранномуВидео(ПараметрыВидео, ГдеИскать, ИмяФайлаСВидео, СобранноеВидео)
	
	Если Ванесса.ФайлСуществуетКомандаСистемы(ПараметрыВидео.ЗаписьВидеоПутьКIntroВидеоФайлу) Тогда
		
		ФайлIntro = Новый Файл(ПараметрыВидео.ЗаписьВидеоПутьКIntroВидеоФайлу);
		СобранноеВидеоIntro = ГдеИскать + "\intro.mp4";
		
		Если ФайлIntro.Расширение = "mp4" Тогда
			
			Ванесса.КопироватьФайлКомандаСистемы(ПараметрыВидео.ЗаписьВидеоПутьКIntroВидеоФайлу, СобранноеВидеоIntro);
			
		Иначе
			ПолноеИмяФайлаIntro = ГдеИскать + "\"+ФайлIntro.Имя;
			Ванесса.КопироватьФайлКомандаСистемы(ПараметрыВидео.ЗаписьВидеоПутьКIntroВидеоФайлу, ПолноеИмяФайлаIntro);
			//конверт в mp4
			Состояние("Сжатие видео...");
			ИмяВременногоФайла = ПолучитьИмяВременногоФайла("cmd");
			ЗТ = Новый ЗаписьТекста(ИмяВременногоФайла,"UTF-8",,Истина);
			...
			Если Не Ванесса.ФайлСуществуетКомандаСистемы(СобранноеВидеоIntro) Тогда
				ВызватьИсключение(Ванесса.ПолучитьТекстСообщенияПользователю("Команда ffmpeg по кодированию файла с заголовком фичи в mp4 не выполнена."));
			КонецЕсли;
		...
		Команда = "" + ПараметрыВидео.ЗаписьВидеоКомандаFfmpeg + " -i " + СобранноеВидеоIntro + " -vf scale=<screenwidth>:<screenheight>,setdar=16:9,setsar=1:1 -c:a copy "+ СобранноеВидеоIntro2; 
		Команда = СтрЗаменить(Команда,"<screenwidth>",Формат(ПараметрыВидео.ЗаписьВидеоЭкранШирина,"ND=10; NG=0"));
		Команда = СтрЗаменить(Команда,"<screenheight>",Формат(ПараметрыВидео.ЗаписьВидеоЭкранВысота,"ND=10; NG=0"));
		Команда = СтрокаОтключенияВыводаКонсоли(Команда,ПараметрыВидео);
		Ванесса.Отладка(Команда);
		...
		Команда = "" + ПараметрыВидео.ЗаписьВидеоКомандаFfmpeg + " -i intro2.mp4" + " -i " + ИмяФайлаСВидео + " -filter_complex ""[0:v]scale=<screenwidth>:<screenheight>:force_original_aspect_ratio=1[v0]; [1:v]scale=<screenwidth>:<screenheight>:force_original_aspect_ratio=1[v1]; [v0][0:a][v1][1:a]concat=n=2:v=1:a=1[v][a]"" -map [v] -map [a] " + СобранноеВидеоIntro;
		Команда = СтрЗаменить(Команда,"<screenwidth>",Формат(ПараметрыВидео.ЗаписьВидеоЭкранШирина,"ND=10; NG=0"));
		Команда = СтрЗаменить(Команда,"<screenheight>",Формат(ПараметрыВидео.ЗаписьВидеоЭкранВысота,"ND=10; NG=0"));
		Команда = СтрокаОтключенияВыводаКонсоли(Команда,ПараметрыВидео);
		Ванесса.Отладка(Команда);
		...
		ВыполнитьКоманду(ПараметрыВидео,ИмяВременногоФайла);
		Если Не Ванесса.ФайлСуществуетКомандаСистемы(СобранноеВидеоIntro) Тогда
			ВызватьИсключение(Ванесса.ПолучитьТекстСообщенияПользователю("Команда ffmpeg по слиянию файла с заголовком фичи с основным видео не выполнена."));
		КонецЕсли;
...
&НаКлиенте
Функция ДобавитьOutroВидеоФайлКСобранномуВидео(ПараметрыВидео, ГдеИскать, ИмяФайлаСВидео, СобранноеВидео)
	
	Если Ванесса.ФайлСуществуетКомандаСистемы(ПараметрыВидео.ЗаписьВидеоПутьКOutroВидеоФайлу) Тогда
		
		ФайлOutro = Новый Файл(ПараметрыВидео.ЗаписьВидеоПутьКOutroВидеоФайлу);
		СобранноеВидеоOutro = ГдеИскать + "\outro.mp4";
		
		Если ФайлOutro.Расширение = "mp4" Тогда
			
			Ванесса.КопироватьФайлКомандаСистемы(ПараметрыВидео.ЗаписьВидеоПутьКOutroВидеоФайлу, СобранноеВидеоOutro);
			
		Иначе
			ПолноеИмяФайлаOutro = ГдеИскать + "\"+ФайлOutro.Имя;
			Ванесса.КопироватьФайлКомандаСистемы(ПараметрыВидео.ЗаписьВидеоПутьКOutroВидеоФайлу, ПолноеИмяФайлаOutro);
			//конверт в mp4
			Состояние("Сжатие видео...");
			ИмяВременногоФайла = ПолучитьИмяВременногоФайла("cmd");
			ЗТ = Новый ЗаписьТекста(ИмяВременногоФайла,"UTF-8",,Истина); 
			...
			Если Не Ванесса.ФайлСуществуетКомандаСистемы(СобранноеВидеоOutro) Тогда
				ВызватьИсключение(Ванесса.ПолучитьТекстСообщенияПользователю("Команда ffmpeg по кодированию финального файла в mp4 не выполнена."));
			КонецЕсли;	 
		КонецЕсли;	 
		...
		Команда = "" + ПараметрыВидео.ЗаписьВидеоКомандаFfmpeg + " -i " + СобранноеВидеоOutro + " -vf scale=<screenwidth>:<screenheight>,setdar=16:9,setsar=1:1 -c:a copy "+ СобранноеВидеоOutro2; 
		Команда = СтрЗаменить(Команда,"<screenwidth>",Формат(ПараметрыВидео.ЗаписьВидеоЭкранШирина,"ND=10; NG=0"));
		Команда = СтрЗаменить(Команда,"<screenheight>",Формат(ПараметрыВидео.ЗаписьВидеоЭкранВысота,"ND=10; NG=0"));
		Команда = СтрокаОтключенияВыводаКонсоли(Команда,ПараметрыВидео);
		Ванесса.Отладка(Команда);
		...
		Команда = "" + ПараметрыВидео.ЗаписьВидеоКомандаFfmpeg + " -i " + ИмяФайлаСВидео + " -i Outro2.mp4" + " -filter_complex ""[0:v]scale=<screenwidth>:<screenheight>:force_original_aspect_ratio=1[v0]; [1:v]scale=<screenwidth>:<screenheight>:force_original_aspect_ratio=1[v1]; [v0][0:a][v1][1:a]concat=n=2:v=1:a=1[v][a]"" -map [v] -map [a] " + СобранноеВидеоOutro;
		Команда = СтрЗаменить(Команда,"<screenwidth>",Формат(ПараметрыВидео.ЗаписьВидеоЭкранШирина,"ND=10; NG=0"));
		Команда = СтрЗаменить(Команда,"<screenheight>",Формат(ПараметрыВидео.ЗаписьВидеоЭкранВысота,"ND=10; NG=0"));
		Команда = СтрокаОтключенияВыводаКонсоли(Команда,ПараметрыВидео);
		Ванесса.Отладка(Команда);
		...
		ВыполнитьКоманду(ПараметрыВидео,ИмяВременногоФайла);
		Если Не Ванесса.ФайлСуществуетКомандаСистемы(СобранноеВидеоOutro) Тогда
			ВызватьИсключение(Ванесса.ПолучитьТекстСообщенияПользователю("Команда ffmpeg по слиянию финального файла с основным видео не выполнена."));
		КонецЕсли;
...
Процедура ЗавершитьЗаписьИнструкцииВидео(ПараметрыВидео)
	...
	Для каждого Сценарий Из МассивСценариевДляВыполнения Цикл
		...
		Для каждого Шаг Из Шаги Цикл
			...
			ПараметрыГолоса = ПолучитьПараметрыГолосаYandex(ПараметрыВидео, Шаг.МассивТеговШага);
...
Функция ПолучитьФайлMP3ИзТекста(ПараметрыВидео, Текст, Знач ИмяФайла, ПараметрыГолоса = Неопределено)
	...
	Если ПараметрыВидео.ЗаписьВидеоКэшироватьФайлыTTS и ПараметрыВидео.Свойство("ДанныеКэшMp3") Тогда
		Если ПараметрыВидео.ЗаписьВидеоТипОзвучкиTTS = 1 Тогда
			СтрокаПоиск = ПараметрыГолоса.Голос + РазделительСтроки 
...
Процедура СоздатьФайлыTTS(ПараметрыВидео) Экспорт
	...
	Для каждого Сценарий Из МассивСценариевДляВыполнения Цикл
		...
		Для каждого Шаг Из Шаги Цикл
			...
			ИмяMP3 = ПолучитьФайлMP3ИзТекста(ПараметрыВидео,Шаг.ТекстИнструкция,"scen_" + ДобавитьНулей(НомерСценария,3) + "_step_" + ДобавитьНулей(НомерШага,3) + "_main", ПараметрыГолоса);
		КонецЦикла;
	КонецЦикла;
КонецПроцедуры

&НаКлиенте
Функция ПолучитьПараметрыГолосаYandex(ПараметрыВидео, ТегиШага)
	ПараметрыГолоса = Новый Структура;
	ПараметрыГолоса.Вставить("Голос", ПараметрыВидео.ЗаписьВидеоYandexTTSГолос);
	ПараметрыГолоса.Вставить("Эмоция", ПараметрыВидео.ЗаписьВидеоYandexTTSЭмоция);
	...
	Если ТегиШага.Количество()>0 Тогда
		Для Каждого ЭлементМассива Из ТегиШага Цикл
			Если Лев(НРег(ЭлементМассива), 9) = "yandextts" Тогда
				...
				МассивПараметровГолоса = СтрРазделить(СтрокаГолосаЭмоции, ",");
				Если МассивПараметровГолоса.Количество() = 2 Тогда
					ПараметрыГолоса.Голос = МассивПараметровГолоса[0];
					ПараметрыГолоса.Эмоция = МассивПараметровГолоса[1];
				Иначе
					ПараметрыГолоса.Голос = МассивПараметровГолоса[0];
				КонецЕсли;	
			КонецЕсли;	
...
&НаКлиенте
Процедура ВыгрузитьКэшMP3YandexВJson(ПараметрыВидео)
	
	СписокГолосов = ПолучитьСписокГолосовYandex();
	...
	Для Каждого Голос Из СписокГолосов Цикл
		...
		Для Каждого СтрокаКэша Из ПараметрыВидео.ДанныеКэшMp3 Цикл
			...
			Если Лев(СтрокаКэша.Ключ, ДлиннаГолоса) = Голос Тогда
				...
				МасссивИзСтроки = СтрРазделить(СтрокаКэша.Ключ, РазделительСтроки);
...
Процедура ВыгрузитьКэшMp3(ПараметрыВидео)
	Если ПараметрыВидео.ЗаписьВидеоТипОзвучкиTTS = 1 Тогда
		ВыгрузитьКэшMP3YandexВJson(ПараметрыВидео);
	Иначе 
		КаталогГдеЛежитКэшMp3 = КаталогГдеЛежитКэш(ПараметрыВидео,ПараметрыВидео.ЗаписьВидеоКэшФайловTTS);
...
&НаКлиенте
Функция ПолучитьСписокГолосовYandex()
	СписокГолосов = Новый Массив;
	СписокГолосов.Добавить("alyss");
	СписокГолосов.Добавить("oksana");
	СписокГолосов.Добавить("omazh");
	СписокГолосов.Добавить("jane");
	СписокГолосов.Добавить("ermil");
	СписокГолосов.Добавить("zahar");
		...
		Для Каждого Голос Из СписокГолосов Цикл
			...
			Если Ванесса.ФайлСуществуетКомандаСистемы(ИмяФайла) Тогда
				...
				Для Каждого СтрокаДанные Из Данные Цикл
					СтрокаПоиск = СтрокаДанные.Voice + РазделительСтроки 
...
Процедура ДобавитьMp3ШагаВКэш(ИмяMP3,Текст,ПараметрыВидео,ПараметрыГолоса)
	...
	Если ПараметрыВидео.ЗаписьВидеоТипОзвучкиTTS = 1 Тогда
		...
		Если ПараметрыГолоса = Неопределено Тогда
			ТекГолос = ПараметрыВидео.ЗаписьВидеоYandexTTSГолос;
			ТекЭмоция = ПараметрыВидео.ЗаписьВидеоYandexTTSЭмоция;
		Иначе
		...
		КаталогХраненияMp3 = ПараметрыВидео.ЗаписьВидеоКэшФайловTTS + "\" + ТекГолос + "\" + ИмяКаталогПараметров;
		...
		СтрокаПоиск = ТекГолос + РазделительСтроки 
