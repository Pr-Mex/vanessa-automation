...
Процедура УскоритьЗамедлитьФайлВидеоИДобавитьMp3(ПараметрыВидео,ИмяФайлВидео,ИмяФайлMP3,ДлительностьВидео,НоваяДлительностьВидео,ДлительностьMP3)
	...
	Если (ТекущаяДлительностьВидео - 0.1) < ДлительностьMP3 Тогда
		НоваяДлительностьВидео = ДлительностьMP3 + 1.2;
...
&НаКлиенте
Функция ПолучитьВременныйФайлШагДляФормировнаияMp3(ПараметрыВидео,Знач Текст)
...
Функция ПолучитьФайлMP3ИзТекста(ПараметрыВидео,Текст,ИмяФайла)
	...
	//получение wav
	ВременныйФайлШаг = ПолучитьВременныйФайлШагДляФормировнаияMp3(ПараметрыВидео,Текст);
