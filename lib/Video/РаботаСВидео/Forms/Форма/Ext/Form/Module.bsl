...
Процедура СобратьФинальноеВидеоИзЧастей(ПараметрыВидео,МассивЧастей)
	...
	КаталогВидео = ПараметрыВидео.КаталогOutputИнструкцияВидео + "\Video";
...
Процедура ЗавершитьЗаписьИнструкцииHTML(ПараметрыВидео)
	...
	КаталогHTML = ПараметрыВидео.КаталогOutputИнструкцияВидео + "\HTML";
...
Процедура ЗавершитьЗаписьВидео(ПараметрыВидео) Экспорт
	...
	КаталогВидео = ПараметрыВидео.КаталогOutputИнструкцияВидео;
