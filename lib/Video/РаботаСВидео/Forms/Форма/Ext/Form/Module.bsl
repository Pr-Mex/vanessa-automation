...
&НаКлиенте
Процедура СобратьВидеоВставкуИзТекста(ПараметрыВидео, ИмяФайлаШага, Знач ТекстВставки, НомерСценария, НомерШага, ПараметрыГолоса, Шаг)
		...
		Для каждого Шаг Из Шаги Цикл
			...
			Если ЭтоШагПервыйВВеткеДерева(ПараметрыВидео, Шаг, МассивВставок, Сценарий) Тогда
				...
				Для Каждого ТекстВставкиВеткиДерева Из МассивВставок Цикл
					...
					СобратьВидеоВставкуИзТекста(ПараметрыВидео, ИмяФайлаШагаВетки, ТекстВставкиВеткиДерева, НомерСценария, НомерШага, ПараметрыГолоса, Шаг);
			...
			Если Ванесса.ЭтоПрерывающйВидеоШаг(Шаг) Тогда
				СобратьВидеоВставкуИзТекста(ПараметрыВидео, ИмяФайлаШага, Шаг.ЗначенияПараметров[0].Значение.Значение, НомерСценария, НомерШага, ПараметрыГолоса, Шаг);
