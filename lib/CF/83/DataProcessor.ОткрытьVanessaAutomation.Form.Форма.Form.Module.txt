...
Процедура ПодключениеОбработкиПродолжение(ИмяОбработки)
	...
	ПараметрыОбработки.Вставить("РежимСамотестирования", Истина);
	ФормаОбработки = ПолучитьФорму("ВнешняяОбработка." + ИмяОбработки + ".Форма.ЧтениеПараметровПриОткрытии", ПараметрыОбработки);
