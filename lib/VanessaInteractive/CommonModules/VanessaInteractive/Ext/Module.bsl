...
Функция ДанныеРеквизитовФормыOnboarding(Форма) Экспорт
	...
	Если ТипОбъекта = "Справочник"  ИЛИ ТипОбъекта = "Reference" Тогда
		ДополнитьДанныеМетаданных(Метаданные.Справочники[ВидОбъекта].СтандартныеРеквизиты, Результат.ДанныеМетаданных);
		ДополнитьДанныеМетаданных(Метаданные.Справочники[ВидОбъекта].Реквизиты, Результат.ДанныеМетаданных);
	КонецЕсли;	
