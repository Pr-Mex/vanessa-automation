...
Сценарий: Основные кнопки работы со сценариями. Часть один.
	...
	* Если перед этим сделать активной строку дерева, которая принадлежит какому-либо фича файлу, то именно этот файл откроется при переходе в редактор.
		Если существует элемент UI Automation "ЭтотСеанс" с именем "Интерактивная справка. Знакомство с Vanessa Automation. Основные элементы формы. Наименование" и типом "" тогда
			И я запоминаю строку "Интерактивная справка. Знакомство с Vanessa Automation. Основные элементы формы. Наименование" в переменную "ИмяПоля"
		Иначе		
			И я запоминаю строку "Интерактивная справка. Знакомство с Vanessa Automation. Основные элементы формы. Description" в переменную "ИмяПоля"
