...
Сценарий: Как устроены шаги сценариев? Ключевые слова.
	...
	* И загр^узим тестовый пример.
		...
		И я загружаю фичи в VA в режиме обучения "$КаталогИнструментов$\training\features\Примеры\ПримерКлючевыеСловаШагов.feature"
	...
	* А этот шаг, начинается с ключевого сл^ова Когда.
		И я делаю подсветку фрагмента текста в редакторе VA в режиме обучения "Когда" 'Ключевое слово "Когда"' подсценарий
	...
	* Ключевые слова могут содержать пробелы, например как в этом шаге.
		И я делаю подсветку фрагмента текста в редакторе VA в режиме обучения "К тому же" 'Ключевое слово "К тому же"' подсценарий

	* Полный список ключевых слов для всех языков, включая русский, можно получить по этой ссылке.
		И я делаю подсветку текста в редакторе VA в режиме обучения с 19 по 19 строку "Полный список ключевых слов на всех языках." подсценарий
