...
Сценарий: Как устроен feature файл? Секция Переменные.
	...
	* Также можно объявлять многострочные строки, как в этом примере
		И я делаю подсветку текста в редакторе VA в режиме обучения с 9 по 14 строку "Многострочная переменная" подсценарий
	...
	* Также одну переменную можно вычислять через другие переменные
		И я делаю подсветку фрагмента текста в редакторе VA в режиме обучения подсценарий 'ЧастьСлева\{Перем6\}ЧастьСправа' "Переменная вычисляется через другую переменную"
	...
	* Все значения из секции Переменные будут проинициализированы перед запуском каждого сценария из ф^ичи.
		И я делаю подсветку текста в редакторе VA в режиме обучения с 7 по 18 строку "Переменные" подсценарий
	...
	* Ты можешь запустить данный сценарий на выполнение. Тогда в окне сообщений пользователя будут выведены значения всех переменных.
		И Я делаю подсветку нескольких элементов VA "Запустить сценарий на выполнение" UI Automation
			| 'Имя'                                  |
