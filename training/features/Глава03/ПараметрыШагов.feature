...
Сценарий: Как устроены шаги сценариев? Параметры шагов.
	...
	* Когда в шаг передается параметр типа Строка, надо значение параметра заключить в кавычки
		И я делаю подсветку фрагмента текста в редакторе VA в режиме обучения '"Hello world!"' "Строка в кавычках" подсценарий
		
	* Или значение параметра надо заключить в ап^острофы
		И я делаю подсветку фрагмента текста в редакторе VA в режиме обучения '\'Hello world!\'' "Строка в апострофах" подсценарий
	...
	* Например так.
		И я делаю подсветку фрагмента текста в редакторе VA в режиме обучения '0' "В параметр передаётся число" подсценарий
	* Или так.
		И я делаю подсветку фрагмента текста в редакторе VA в режиме обучения '10' "В параметр передаётся число" подсценарий
		
		
	* Чтобы передать в шаг параметр типа Дата, нужно просто написать значение даты в одном из двух возможных форматов.	
	* Например так.
		И я делаю подсветку фрагмента текста в редакторе VA в режиме обучения '08.04.81' "В параметр передаётся дата" подсценарий
	* Или так.
		И я делаю подсветку фрагмента текста в редакторе VA в режиме обучения '08.04.1981' "В параметр передаётся число" подсценарий
