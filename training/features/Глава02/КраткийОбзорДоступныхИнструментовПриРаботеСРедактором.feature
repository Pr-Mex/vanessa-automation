...
Сценарий: Краткий обзор доступных инструментов при работе с редактором
	...
	* Пункт меню - Библиотека шагов. Он открывает новое окно в котором содержится список всех доступных в данный момент шагов для написания сценариев.
		...
		//И Я делаю подсветку элемента формы VA по имени и клик по нему "ФормаОткрытьОпределениеШага" "Библиотека шагов"
	...
	* Получить шаг для проверки элементов из шапки формы
		И Я делаю подсветку элемента VA "VanessaEditorПолучитьШагПроверкиШапкиФормы" "Проверка шапки формы" и перемещаю курсор
	...
	* Получить шаг проверки текущего окна
		И Я делаю подсветку элемента VA "VanessaEditorПолучитьШагПроверкиТекущегоОкна" "Получить шаг для проверки текущего окна" и перемещаю курсор
	...
	* Далее идет команда - Показать краткую информацию о шаге
		И Я делаю подсветку элемента VA "VanessaEditorПоказатьКраткуюИнформациюОШаге" "Показать краткую информацию о шаге" и перемещаю курсор
	* Она позволяет показать окно с краткой информацией о текущей строке в редакторе.
	* В этом окне можно узнать, например, информацию о том, в каком модуле определен этот шаг.
