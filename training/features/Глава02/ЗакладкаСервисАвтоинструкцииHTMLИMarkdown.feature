...
Сценарий: Автоинструкции. HTML и Markdown.
	...
	* В этом поле указывается файл стилей (style.css) для HTML инструкций
		И я делаю подсветку нескольких элементов VA с их заголовком "Полный путь к файлу стилей CSS" UI Automation
			| 'Имя'                           |
			| 'СтилиHTMLИнструкции'           |

	* Кнопка редактировать стили откроет указанный файл стилей в редакторе кода в режиме редактирования CSS
		И я делаю подсветку нескольких элементов VA с их заголовком "Открыть редактор стилей" UI Automation
			| 'Имя'                           |
			| 'ОткрытьРедакторHTML'           |
