...
Сценарий: Демонстрация как использовать служебные переменные
	...
	* Основной способ
		И я запоминаю содержимое файла "C:\Temp\FileName.xml" в переменную "ИмяПеременной1"
	...
	* И такой вариант
		И я запоминаю содержимое файла "C:\Temp\FileName.xml" в переменную "ИмяПеременной2"
