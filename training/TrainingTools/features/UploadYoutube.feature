...
Сценарий: Загрузчик видео на Youtube
	...
	И для каждого значения из файла Json "$ДанныеФайловВПравильномПорядке$" 
		...
		Иначе
			...
			И я жду картинки "ДобавитьВидеоVK" в течение 20 секунд
			Затем клик на картинку "ДобавитьВидеоVK"
			И Пауза 0.1
			...
			И Пауза 1
			И я жду картинки "ПубликацияВидео" в течение 20 секунд
...
//			И Пауза 0.1
			...
			// Заголовок видео
			Затем клик на картинку "Дополнительно"
			И Пауза 0.1
			Затем клик на картинку "Информация"
			И Пауза 0.1
			И я нажимаю сочетание клавиш "Tab"
			И Пауза 0.1
			И я нажимаю сочетание клавиш "Tab"
...
//				И Пауза 0.1
			...
			Затем клик на картинку "Далее"
			И Пауза 2
			Затем клик на картинку "Опубликовать"
			И Пауза 1
