...
* For thin and thick client, this is either the path to the file database
		...
		И я устанавливаю в таблице VA "TestClientsData" в режиме обучения в колонке 'ПутьКИнфобазе' 'File="c:\Bases\MyBase";'
		И Пауза 1
		И Я делаю подсветку элемента VA "ДанныеКлиентовТестированияПутьКИнфобазе" "File base"

* Or server database connection string.
		И я устанавливаю в таблице VA "TestClientsData" в режиме обучения в колонке 'ПутьКИнфобазе' 'Srvr="MyServer";Ref="MyBase";'
		И Пауза 1
...
* For a web client, this is a browser link
		...
		И я устанавливаю в таблице VA "TestClientsData" в режиме обучения в колонке 'ПутьКИнфобазе' 'http://localhost/MyBase'
		И Пауза 1
...
* These are usually the username, password, and other startup keys
		И я устанавливаю в таблице VA "TestClientsData" в режиме обучения в колонке "AdditionalParameters" '/N"Администратор" /P"Пароль" /ДопКлючи'
		И Пауза 1
		И Я делаю подсветку элемента VA "ДанныеКлиентовТестированияДопПараметры" "Additional parameters"
