...
* Usually it is 15 38.
		И я устанавливаю в таблице VA "TestClientsData" в режиме обучения в колонке 'ПортЗапускаТестКлиента' '1538'
		И Пауза 1
...
* In this case, in the computer name field, specify the network name of 1C server cluster or its ip address.
		И я устанавливаю в таблице VA "TestClientsData" в режиме обучения в колонке 'ИмяКомпьютера' 'MyServer'
		И Пауза 1
...
* Usually it is 15 41.
		И я устанавливаю в таблице VA "TestClientsData" в режиме обучения в колонке 'ПортЗапускаТестКлиента' '1541'
		И Пауза 1
