...
* Hi! In this lesson, I will tell you about what an Allure script execution report is. Let's open the second copy of Vanessa in training mode.
		И я открываю Vanessa Automation в режиме обучения

* Allure is a framework for building script execution reports.
...
* And here you can see a real Allure report using the tests that are run to check the quality of Vanessa Automation itself.
		И Я делаю подсветку текста в редакторе VA в режиме обучения с 11 по 11 строку 'Example of this report' подсценарий
