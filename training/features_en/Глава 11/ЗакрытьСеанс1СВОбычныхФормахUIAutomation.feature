...
* Let's upload a test case.
		...
		И я загружаю фичи в VA в режиме обучения "$КаталогИнструментов$\training\features_en\ПримерыПримерЗакрытьСеанс1СВОбычныхФормахUIAutomation.feature"

* To do this, use the steps that will perform mouse clicks on the corresponding menu items.
		И Я делаю подсветку текста в редакторе VA в режиме обучения с 7 по 7 строку 'Пункт меню "File"' подсценарий
		И Я делаю подсветку текста в редакторе VA в режиме обучения с 9 по 9 строку 'Пункт меню "Exit"' подсценарий
