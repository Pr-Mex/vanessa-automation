...
Feature: Examples of file selection from the file selection dialog. Thin and thick client.

Scenario: Examples of file selection from the file selection dialog. Thin and thick client.
