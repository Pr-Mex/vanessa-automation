...
* And upload a test example.
		...
		И я загружаю фичи в VA в режиме обучения "$КаталогИнструментов$\training\features_en\ПримерыПримерКакУстроенФичаФайлСекцияПеременныеПростые.feature"
...
* Here is an example when a simple variable is declared.
		И я делаю подсветку фрагмента текста в редакторе VA в режиме обучения подсценарий 'Перем1 = "VariableStringTypeInQuotes"' 'Variable declaration'
* Or here
		И я делаю подсветку фрагмента текста в редакторе VA в режиме обучения подсценарий 'Var2 = \'VariableStringInPostrophes\'' 'Variable declaration'
...
* Also one variable can be calculated through other variables
		И я делаю подсветку фрагмента текста в редакторе VA в режиме обучения подсценарий 'PartLeft\{Var6\}PartRight' "A variable is calculated through another variable"
...
* It is also possible to pass the value of a variable inside another line using curly braces, as shown here.
		И я делаю подсветку фрагмента текста в редакторе VA в режиме обучения подсценарий '"Part3\{Var2\}Part4"' 'Expression inside a string'
