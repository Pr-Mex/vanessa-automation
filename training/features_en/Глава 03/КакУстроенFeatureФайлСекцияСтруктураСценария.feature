...
* And upload a test example.
		...
		И я загружаю фичи в VA в режиме обучения "$КаталогИнструментов$\training\features_en\ПримерыПримерКакУстроенФичаФайлСтруктураСценария.feature"
		И я позиционирую в центр строку редактора VA в режиме обучения 21

* A script structure is a special kind of script that allows to run the same script multiple times with different parameters.

* Let's see how it works.
* The declaration of the script structure is indicated by the corresponding keyword.
		И я делаю подсветку фрагмента текста в редакторе VA в режиме обучения подсценарий "Script structure:" 'Ключевое слово "Структура сценария"'

* Next is its name.
		И я делаю подсветку фрагмента текста в редакторе VA в режиме обучения подсценарий "Structure of script 1" 'Name of the script structure'
...
* Then, after all the steps of the script structure, the mandatory keyword Examples is placed.
...
* The first line lists all the parameters of the script structure that were previously used in the steps in angle brackets.
