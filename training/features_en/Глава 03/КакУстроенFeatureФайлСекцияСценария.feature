...
* Next is the Script section. It is indicated by the corresponding keyword.
		И я делаю подсветку фрагмента текста в редакторе VA в режиме обучения "Script:" "Keyword Script" подсценарий

* The keyword must be followed by the script name. In this case, this is script one.
		И я делаю подсветку фрагмента текста в редакторе VA в режиме обучения "Script 1" "Script Name" подсценарий
...
* The script can have its own tags. They are just above the script definition line.
		И я делаю подсветку текста в редакторе VA в режиме обучения с 17 по 18 строку "Script tags" подсценарий
...
* Next are the steps that will be performed in this script.
		И я делаю подсветку текста в редакторе VA в режиме обучения с 21 по 25 строку "Script steps" подсценарий
