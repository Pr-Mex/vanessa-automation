...
* And upload a test example.
		...
		И я загружаю фичи в VA в режиме обучения "$КаталогИнструментов$\training\features_en\ПримерыПримерКлючевыеСловаШагов.feature"
...
* And this step starts with the key word When.
		И я делаю подсветку фрагмента текста в редакторе VA в режиме обучения "When" 'Ключевое слово "When"' подсценарий
...
* Keywords may contain spaces, such as in this step.
		И я делаю подсветку фрагмента текста в редакторе VA в режиме обучения "Also" 'Ключевое слово "Also"' подсценарий
