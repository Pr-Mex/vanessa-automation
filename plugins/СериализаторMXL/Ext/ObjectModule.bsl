...
Функция СоздатьДанныеПоТекстовомуДокументу(ТабличныйДокументИлиМассивТабличныхДокументов, РежимыЗагрузкиИлиИмяКолонкиЗамещения = Неопределено, ИмяКолонкиЗамещения = Неопределено) Экспорт
	...
	Если ТипЗнч(ТабличныйДокументИлиМассивТабличныхДокументов) = Тип("ТекстовыйДокумент") Тогда
...
Функция ВыгрузитьДанныеВМакетJSON(ДанныеДляВыгрузки)
	...
	КонвертированныйJSON = ПодготовитьJSON(ДанныеДляВыгрузки);
	
	ПараметрыЗаписи = Новый ПараметрыЗаписиJSON(   , Символы.Таб);
	Запись = Новый ЗаписьJSON;
	Запись.ПроверятьСтруктуру = Ложь;
	Запись.УстановитьСтроку(ПараметрыЗаписи);
	ЗаписатьJSON(Запись, КонвертированныйJSON,,"ПреобразованиеНеПоддерживаемыхТипов", ЭтотОбъект);
...
Процедура ПроверитьЗагрузкуМакета(Макет) Экспорт
	...
	ИначеЕсли ТипЗнч(Макет) = Тип("ТекстовыйДокумент") Тогда
		ТестовыеДанные = СоздатьДанныеПоТекстовомуДокументу(Макет);
	КонецЕсли;
...
// аналог ДобавитьПростойРеквизитВМакет
...
// аналог ОбработатьРеквизитыОбъекта
...
// аналог ОбработатьРеквизитОбъекта
...
// аналог ОбработатьТабличныеЧастиОбъекта
...
// аналог ОбработатьРеквизитыТабличнойЧастиОбъекта
...
// аналог ДобавитьДополнительныеСвойства
...
// аналог ДобавитьДопСвойстваВМакет
...
// аналог ОбработатьРежимыОбъекта
...
// аналог ДобавитьПользователяИБ_ВМакет
...
// аналог ДобавитьШапкуПользователяИБ_ВМакет
...
//аналог ДобавитьРеквизитыПользователяИБ_ВМакет
...
// аналог ДобавитьРолиПользователяИБ_ВМакет
