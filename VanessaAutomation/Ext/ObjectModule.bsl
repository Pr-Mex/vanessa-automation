...
Функция СтруктураОбщихНастроек() Экспорт 
	
	Настройки = Новый Структура;
	Настройки.Вставить("ВерсияVA", "");
	Настройки.Вставить("DebugLog", "");
	Настройки.Вставить("ГенерироватьУФ", Ложь);
	...
	Настройки.Вставить("КаталогВыгрузкиAllure", "");
	
	Настройки.Вставить("УровеньОтчета1", "");
	Настройки.Вставить("УровеньОтчета2", "");
	Настройки.Вставить("УровеньОтчета3", "");
	
	Настройки.Вставить("КаталогОтносительноКоторогоНадоСтроитьИерархию", "");
	
	Настройки.Вставить("ДелатьОтчетВоВнутреннемФормате");
	
	Настройки.Вставить("ДелатьОтчетВФорматеjUnit", Ложь);
	Настройки.Вставить("КаталогВыгрузкиJUnit", "");
	
	Настройки.Вставить("ДелатьОтчетВФорматеCucumberJson", Ложь);
	Настройки.Вставить("КаталогВыгрузкиCucumberJson", "");
	
	Настройки.Вставить("текЗначениеОперации", "");
	Настройки.Вставить("КаталогиБиблиотек", "");
	
	Настройки.Вставить("СоздаватьИнструкциюHTML", Ложь);
	Настройки.Вставить("КаталогВыгрузкиИнструкцийHTML", "");
	
	Настройки.Вставить("СоздаватьИнструкциюMarkdown", Ложь);
	Настройки.Вставить("КаталогВыгрузкиИнструкцийMarkdown", "");
	
	Настройки.Вставить("СоздаватьИнструкциюВидео", Ложь);
	Настройки.Вставить("КаталогВыгрузкиИнструкцийВидео", "");
	
	Настройки.Вставить("СоздаватьЗакоментированныйКодДляПереиспользуемыхПроцедур", Ложь);
	...
	Настройки.Вставить("ПодключитьВнешниеОбработкиДляОтладки", Ложь);
	
	Настройки.Вставить("ВыполнятьШагиАссинхронно", Ложь);
	
	Настройки.Вставить("СохранятьКонтекстыПередВыполнениемШагов", Ложь);
	
	Настройки.Вставить("СоздаватьОбластиПриГенерацииКода", Ложь);
	...
	Настройки.Вставить("ИнтервалВыполненияШагаЗаданныйПользователем", 0);
	Настройки.Вставить("КаталогПроекта", "");
	
	Настройки.Вставить("ЗапускатьТестКлиентВРежимеОтладки", Ложь);
	Настройки.Вставить("КлючиОтладки", "");
	Настройки.Вставить("АдресОтладчика", "");
	
	//запись видео
	Настройки.Вставить("ЗаписьВидеоКомандаНачатьЗаписьВидео", "");
	Настройки.Вставить("ЗаписьВидеоЭкранШирина", "");
	Настройки.Вставить("ЗаписьВидеоЭкранВысота", "");
	Настройки.Вставить("ЗаписьВидеоКоличествоКадров", "");
	Настройки.Вставить("ЗаписьВидеоФайлКурсораМышки");
	Настройки.Вставить("ЗаписьВидеоПодсвечиватьАктивныеЭлементыФорм");
	Настройки.Вставить("ЗаписьВидеоПеремещатьКурсорМышкиКАктивномуЭлементуФормы");
	Настройки.Вставить("ЗаписьВидеоКаталогДляВременныхФайлов");
	Настройки.Вставить("ЗаписьВидеоФайлВодянойЗнак");
	Настройки.Вставить("ЗаписьВидеоКомандаFfmpeg");
	Настройки.Вставить("ЗаписьВидеоКомандаConvert");
	Настройки.Вставить("ЗаписьВидеоКаталогМузыки");
	Настройки.Вставить("ЗаписьВидеоГромкостьМузыки");
	Настройки.Вставить("ЗаписьВидеоДелатьНаложениеTTS");
	Настройки.Вставить("ЗаписьВидеоТипОзвучкиTTS");
	Настройки.Вставить("ЗаписьВидеоYandexTTSЯзык");
	Настройки.Вставить("ЗаписьВидеоYandexTTSГолос");
	Настройки.Вставить("ЗаписьВидеоYandexTTSЭмоция");
	Настройки.Вставить("ЗаписьВидеоYandexTTSСкорость");
	Настройки.Вставить("ЗаписьВидеоYandexTTSИдентификаторКаталога");
	Настройки.Вставить("ЗаписьВидеоYandexTTSOauthToken");
	Настройки.Вставить("ЗаписьВидеоПутьКДвижкуTTS");
	Настройки.Вставить("ЗаписьВидеоИмяTTS");
	Настройки.Вставить("ЗаписьВидеоСловарьЗамен");
	Настройки.Вставить("ЗаписьВидеоГруппаШаговКакШаг");
	Настройки.Вставить("ЗаписьВидеоОтключитьМасштабированиеШаговПоВремени");
	Настройки.Вставить("ЗаписьВидеоПодсвечиватьНажатияМышки");
	Настройки.Вставить("ЗаписьВидеоОтключитьСлайдСЗаголовкомФичи");
	Настройки.Вставить("ЗаписьВидеоОтключитьСлайдСценария");
	Настройки.Вставить("ЗаписьВидеоЭмулироватьВводСКлавиатуры");
	Настройки.Вставить("ЗаписьВидеоСкрытьСлужебныеОкна");
	Настройки.Вставить("ЗаписьВидеоСкоростьПроизношения");
	Настройки.Вставить("ЗаписьВидеоКэшироватьФайлыTTS");
	Настройки.Вставить("ЗаписьВидеоКэшФайловTTS");
	Настройки.Вставить("ЗаписьВидеоКэшироватьВидеоВставки");
	Настройки.Вставить("ЗаписьВидеоКэшВидеоВставок");
	Настройки.Вставить("ЗаписьВидеоДобавлятьСубтитры");
	Настройки.Вставить("ЗаписьВидеоПроцентУскорения");
	Настройки.Вставить("ЗаписьВидеоФормироватьИнструкциюТипВидео");
	Настройки.Вставить("ЗаписьВидеоФормироватьИнструкциюТипHTML");
	Настройки.Вставить("ЗаписьВидеоФормироватьИнструкциюТипMarkdown");
	
	Настройки.Вставить("ОстановкаПриВозникновенииОшибки", Ложь);
	Настройки.Вставить("ПоказыватьНомерСтрокиДереваПриВозникновенииОшибки", Ложь);
	Настройки.Вставить("КоличествоСекундПоискаОкна", 0);
	Настройки.Вставить("КоличествоПопытокВыполненияДействия", 0);
	...
	Настройки.Вставить("ТаймаутЗапуска1С", 0);
	Настройки.Вставить("ТаймаутДляАсинхронныхШагов", 0);
	Настройки.Вставить("БезопасноеВыполнениеШагов", Истина);
	Настройки.Вставить("ДиапазонПортовTestclient", "");
	Настройки.Вставить("ОсновнойЯзык", "");
	...
	Настройки.Вставить("КаталогиСкриптовSikuliX", "");
	
	Настройки.Вставить("ИскатьЭлементыФормыПоИмени", Ложь);
	
	Настройки.Вставить("ДобавлятьПриНакликиванииМетаИнформацию", Ложь);
	Настройки.Вставить("ЗапускатьКлиентТестированияСМаксимизированнымОкном", Ложь);
	Настройки.Вставить("ОбновлятьСтатистикуВДереве", Ложь);
	Настройки.Вставить("ОбновлятьДеревоПриНачалеВыполненияСценария", Ложь);
	Настройки.Вставить("ПаузаПриОткрытииОкна", 0);
	Настройки.Вставить("ТегTreeВключенПоУмолчанию", "");
	Настройки.Вставить("ДанныеАллюрМеток", "");
