...
Функция СтруктураОбщихНастроек(НастрокиВыгрузки = Ложь, НастройкиЗагрузки = Ложь) Экспорт 
	...
	//Настройки для запуска в docker-контейнерах
	НастройкиDocker = Новый Структура;
	НастройкиDocker.Вставить("DockerИспользоватьВыполнениеВКонтейнере", Ложь);
	НастройкиDocker.Вставить("DockerКаталогМонтирования", "");
	НастройкиDocker.Вставить("DockerСоздаватьБазуДляМенеджераТестирования", Истина);
	НастройкиDocker.Вставить("DockerИмяОбразаТестирования", "");
	НастройкиDocker.Вставить("DockerПортКонтейнераТестированияДляПросмотра", 5900);
	НастройкиDocker.Вставить("DockerИмяОбразаПросмотрщика", "");
	НастройкиDocker.Вставить("DockerПортКонтейнераПросмотрщика", 8081);
	НастройкиDocker.Вставить("DockerСтрокаСоединенияСБазойТестированияДляКонтейнера", "");
	НастройкиDocker.Вставить("DockerИспользоватьПросмотрщик", Ложь);
	НастройкиDocker.Вставить("DockerКаталогПлатформыВнутриКонтейнераТестирования", "");
	НастройкиDocker.Вставить("DockerРасширениеЭкранаДляПросмотра", 1);
	НастройкиDocker.Вставить("DockerКаталогЛицензийВнутриКонтейнераТестирования", "/var/1C/licenses");
	НастройкиDocker.Вставить("DockerЗаменятьСтрокуПодключенияИзКонтейнера", Истина); 
	НастройкиDocker.Вставить("DockerСтрокаСоединенияСБазойМенеджераТестирования", "");
	НастройкиDocker.Вставить("DockerЛогинБазыМенеджераТестирования", "");
	НастройкиDocker.Вставить("DockerПарольБазыМенеджераТестирования", "");
	Настройки.Вставить("НастройкиDocker", НастройкиDocker);
