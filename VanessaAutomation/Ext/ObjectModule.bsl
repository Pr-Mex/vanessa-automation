...
Функция СтруктураОбщихНастроек(НастрокиВыгрузки = Ложь, НастройкиЗагрузки = Ложь) Экспорт 
	...
	// Устарела.26
	Allure.Вставить("КаталогOutputAllure", "");
	Allure.Вставить("КаталогOutputAllureБазовый", "");
    // Конец Устарела 
	...
	// Устарела.26
	JUnit.Вставить("КаталогOutputjUnit", "");
	// Конец Устарела
	...
	// Устарела.26
	Cucumber.Вставить("КаталогOutputCucumberJson", "");
	// Конец Устарела
	...
	// Устарела.26
	ИнструкцияHTML.Вставить("КаталогOutputИнструкцияHTML", "");
	// Конец Устарела
	...
	// Устарела.26
	ИнструкцияMarkdown.Вставить("КаталогOutputИнструкцияMarkdown", "");
	// Конец Устарела
	...
	// Устарела.26
	ЗаписьВидео.Вставить("КаталогOutputИнструкцияВидео", "");
	// Конец Устарела
