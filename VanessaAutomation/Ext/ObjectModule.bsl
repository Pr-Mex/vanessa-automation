...
Функция СтруктураОбщихНастроек(НастрокиВыгрузки = Ложь, НастройкиЗагрузки = Ложь) Экспорт 
	...
	Настройки.Вставить("ПоказыватьСтрокиПодсценариевVanessaEditor", Истина);
	...
	Настройки.Вставить("КаталогГенерированияДымовыхТестов", "");
	Настройки.Вставить("КаталогФайловИсключаемыхОбъектовИзДымовогоТестирования", "");
	Настройки.Вставить("ТолькоИзмененныеОтносительноКонфигурацииПоставщикаДляДымовогоТестирования", Ложь);
	Настройки.Вставить("ТолькоВведенныеОбъектыДляДымовогоТестирования", Ложь);
	Настройки.Вставить("ИмяКонфигурацииПоставщика", "");
	Настройки.Вставить("ПутьНастройкиСценариеДымовыхТестов", "");
	Настройки.Вставить("ЯзыкШаговДымовыхТестов", "ru");
