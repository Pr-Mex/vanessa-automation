...
Функция СтруктураОбщихНастроек(НастрокиВыгрузки = Ложь, НастройкиЗагрузки = Ложь) Экспорт 
	...
	ЗаписьВидео.Вставить("ЗаписьВидеоЗаменитьIntroФайл");
	ЗаписьВидео.Вставить("ЗаписьВидеоПутьКIntroВидеоФайлу");
	ЗаписьВидео.Вставить("ЗаписьВидеоДобавитьМузыкуКIntroВидеоФайлу");
	ЗаписьВидео.Вставить("ЗаписьВидеоЗаменитьOutroФайл");
	ЗаписьВидео.Вставить("ЗаписьВидеоПутьКOutroВидеоФайлу");
	ЗаписьВидео.Вставить("ЗаписьВидеоДобавитьМузыкуКOutroВидеоФайлу");
