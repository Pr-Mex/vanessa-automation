...
Функция СтруктураОбщихНастроек(НастрокиВыгрузки = Ложь, НастройкиЗагрузки = Ложь) Экспорт 
	...
	ЗаписьВидео.Вставить("ЗаписьВидеоЗаменитьСлайдСЗаголовкомФичи");
	ЗаписьВидео.Вставить("ЗаписьВидеоПутьКСлайдуСЗаголовкомФичи");
	ЗаписьВидео.Вставить("ЗаписьВидеоДобавитьМузыкуКСлайдуСЗаголовкомФичи");
