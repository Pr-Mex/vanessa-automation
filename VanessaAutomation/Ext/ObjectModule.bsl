...
Функция СтруктураОбщихНастроек() Экспорт 
	...
	Allure.Вставить("ДанныеАллюрМеток", "");
	
	Настройки.Вставить("Allure", Allure);
	...
	Настройки.Вставить("JUnit", JUnit);
	...
	Настройки.Вставить("Cucumber", Cucumber);
	...
	ЗаписьВидео.Вставить("ЗаписьВидеоСловарьЗамен");
