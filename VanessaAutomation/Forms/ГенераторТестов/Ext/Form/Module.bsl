...
Процедура ВыгрузитьНастройки(Команда)
	...
	Диалог.Заголовок = "Сохранение настроек";
	Диалог.ПредварительныйПросмотр = Ложь;
	Диалог.МножественныйВыбор = Ложь;
	Диалог.Фильтр = "Настройки (*.json)|*.json";
...
Процедура ЗагрузитьНастройки(Команда)
	...
	Диалог.МножественныйВыбор = Ложь;
	Диалог.Заголовок = "Выберите файл настроек генератора сценариев.";
	Диалог.Фильтр = "Настройки (*.json)|*.json";
	...
	Если Диалог.Выбрать() Тогда
		...
		Если ВерхнийУровень.Пометка <> ПометкаФлажокНеУстановлен() Тогда
			...
			ТекстВопроса = "Обнаружены настройки в дереве конфигурации. Очистить?";
...
&НаСервере
Функция ЛокализоватьСервер(Сообщение)
