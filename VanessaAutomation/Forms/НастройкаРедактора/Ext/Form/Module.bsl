...
Процедура ПриОткрытии(Отказ)
	...
	Ванесса = ВладелецФормы.ПолучитьВанессу();
	VanessaTabs = Ванесса.Элементы.VanessaEditor.Документ.defaultView.VanessaTabs;
...
Процедура ДобавитьПодчиненныеНастройки(НаборЭлементов, СхемаРодителя, ЗначениеРодителя)
	...
	Для каждого Реквизит из СхемаРодителя Цикл
		МассивИмен = Ванесса._СтрРазделить(Реквизит.Ключ, ".");
