...
Процедура ОткрытьФормуГенератораСценариев(Команда)
	...
	ОткрытьФорму(ПолучитьИмяОбработкиVA() + ".Форма.ГенераторТестов", ПараметрыФормы, ЭтотОбъект);
...
Процедура ЗагрузитьГлобальныеПеременные()
	...
	ГлобальныеПеременные = ПрочитатьJSON(ЧтениеJSON, Истина);
	ЧтениеJSON.Закрыть();
...
Процедура УстановитьУсловноеОформление()
	...
	Элементы.ГруппаSikuliXServerПодробно.Видимость = Объект.ИспользоватьSikuliXСервер;
