...
Процедура ЗаполнитьДеревоФичПродолжение()
	...
	ПоказатьОповещениеПользователя(НСтр("ru = 'Фичи загружены'"));
	...
	Если StartFeaturePlayer = Истина Тогда
		...
		Если Объект.ДелатьСкриншотПриВозникновенииОшибки Тогда
			...
			Если СтруктураJSON.Свойство("КаталогOutputСкриншоты") Тогда
				...
				ТекстСообщения = НСтр("ru = 'Использование устаревшего параметра ""КаталогOutputСкриншоты"". Новый параметр - ""КаталогВыгрузкиСкриншотов""'");
				СообщитьПользователю(ТекстСообщения);
				ЗаписатьЛогВЖРОшибка("VanessaAutomation.ЗапускВРежимеКоманднойСтроки", ТекстСообщения);
			Иначе 	
			// Конец Удалить
		...
		Если Объект.СоздаватьИнструкциюHTML Тогда
			...
			Если СтруктураJSON.Свойство("КаталогOutputИнструкцияHTML") Тогда
				...
				СообщитьПользователю(НСтр("ru = 'Использование устаревшего параметра ""КаталогOutputИнструкцияHTML"". Новый параметр - ""КаталогВыгрузкиИнструкцийHTML""'"));
			Иначе 	
			// Конец Удалить
		...
		Если Объект.СоздаватьИнструкциюMarkdown Тогда
			...
			Если СтруктураJSON.Свойство("КаталогOutputИнструкцияMarkdown") Тогда
				...
				СообщитьПользователю(НСтр("ru = 'Использование устаревшего параметра ""КаталогOutputИнструкцияMarkdown"". Новый параметр - ""КаталогВыгрузкиИнструкцийMarkdown""'"));
			Иначе 	
			// Конец Удалить
		...
		Если Объект.СоздаватьИнструкциюВидео Тогда
			...
			Если СтруктураJSON.Свойство("КаталогOutputИнструкцияВидео") Тогда
				...
				СообщитьПользователю(НСтр("ru = 'Использование устаревшего параметра ""КаталогOutputИнструкцияВидео"". Новый параметр - ""КаталогВыгрузкиИнструкцийВидео""'"));
			Иначе 	
			// Конец Удалить
		...
		Если ЗнДелатьОтчетВФорматеjUnit = Истина Тогда
			...
			Если СтруктураJSON.Свойство("КаталогOutputjUnit") Тогда
				...
				СообщитьПользователю(НСтр("ru = 'Использование устаревшего параметра ""КаталогOutputjUnit"". Новый параметр - ""КаталогВыгрузкиjUnit""'"));					
			Иначе 
			// Конец Удалить	
		...
		Если ЗнДелатьОтчетВФорматеCucumberJson = Истина Тогда
			...
			Если СтруктураJSON.Свойство("КаталогOutputCucumberJson") Тогда
				...
				СообщитьПользователю(НСтр("ru = 'Использование устаревшего параметра ""КаталогOutputCucumberJson"". Новый параметр - ""КаталогВыгрузкиCucumberJson""'"));
			Иначе
			// Конец Удалить	
		...
		Если СтруктураJSON.Свойство("КаталогOutputAllure") Тогда
			...
			СообщитьПользователю(НСтр("ru = 'Использование устаревшего параметра ""КаталогOutputAllure"". Новый параметр - ""КаталогВыгрузкиAllure""'"));
		Иначе
		// Конец Удалить
		...
		Если СтруктураJSON.Свойство("КаталогOutputAllureБазовый") Тогда
			...
			СообщитьПользователю(НСтр("ru = 'Использование устаревшего параметра ""КаталогOutputAllureБазовый"". Новый параметр - ""КаталогВыгрузкиAllureБазовый""'"));
		Иначе
		// Конец Удалить	
