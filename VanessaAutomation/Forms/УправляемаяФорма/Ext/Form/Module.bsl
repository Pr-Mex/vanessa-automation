...
Функция СоздатьСтруктуруПараметровЗапуска()
	...
	Рез.Вставить("ЗаписьВидеоТипОзвучкиTTS", "");
	Рез.Вставить("ЗаписьВидеоYandexTTSЯзык", "");
	Рез.Вставить("ЗаписьВидеоYandexTTSГолос", "");
	Рез.Вставить("ЗаписьВидеоYandexTTSЭмоция", "");
	Рез.Вставить("ЗаписьВидеоYandexTTSСкорость", "1.1");
	Рез.Вставить("ЗаписьВидеоYandexTTSИдентификаторКаталога", "");
	Рез.Вставить("ЗаписьВидеоYandexTTSOauthToken", "");
	...
	Рез.Вставить("ЗаписьВидеоСкоростьПроизношения", "1");
	Рез.Вставить("ЗаписьВидеоКэшироватьФайлыTTS", Ложь);
	Рез.Вставить("ЗаписьВидеоКэшФайловTTS", "");
	Рез.Вставить("ЗаписьВидеоКэшироватьВидеоВставки", Ложь);
	Рез.Вставить("ЗаписьВидеоКэшВидеоВставок", "");
	Рез.Вставить("ЗаписьВидеоДобавлятьСубтитры", Истина);
	Рез.Вставить("ЗаписьВидеоПроцентУскорения", 25);
	Рез.Вставить("ЗаписьВидеоФормироватьИнструкциюТипВидео", Истина);
	Рез.Вставить("ЗаписьВидеоФормироватьИнструкциюТипHTML", Ложь);
	Рез.Вставить("ЗаписьВидеоФормироватьИнструкциюТипMarkdown", Ложь);
	...
	Рез.Вставить("ДобавлятьПриНакликиванииМетаИнформацию", Ложь);
	Рез.Вставить("ЗапускатьКлиентТестированияСМаксимизированнымОкном", Ложь);
	Рез.Вставить("ОбновлятьСтатистикуВДереве", Истина);
	Рез.Вставить("ОбновлятьДеревоПриНачалеВыполненияСценария", Истина);
	Рез.Вставить("ПаузаПриОткрытииОкна", "0");
	Рез.Вставить("ТегTreeВключенПоУмолчанию", Истина);
	Рез.вставить("ДанныеАллюрМеток", Неопределено);
...
Функция СоздатьКоллекциюКомандЗапуска()
	...
	Рез.Вставить("ЗаписьВидеоТипОзвучкиTTS", Новый Структура("Р, А", "ЗаписьВидеоТипОзвучкиTTS", "ttstype"));
	Рез.Вставить("ЗаписьВидеоYandexTTSЯзык", Новый Структура("Р, А", "ЗаписьВидеоYandexTTSЯзык", "yandexttslanguage"));
	Рез.Вставить("ЗаписьВидеоYandexTTSГолос", Новый Структура("Р, А", "ЗаписьВидеоYandexTTSГолос", "yandexttsvoice"));
	Рез.Вставить("ЗаписьВидеоYandexTTSЭмоция", Новый Структура("Р, А", "ЗаписьВидеоYandexTTSЭмоция", "yandexttsemotion"));
	Рез.Вставить("ЗаписьВидеоYandexTTSСкорость", Новый Структура("Р, А", "ЗаписьВидеоYandexTTSСкорость", "yandexttsspeed"));
	Рез.Вставить("ЗаписьВидеоYandexTTSИдентификаторКаталога", Новый Структура("Р, А", "ЗаписьВидеоYandexTTSИдентификаторКаталога", "yandexttsfolderId"));
	Рез.Вставить("ЗаписьВидеоYandexTTSOauthToken", Новый Структура("Р, А", "ЗаписьВидеоYandexTTSOauthToken", "yandexttsoauthtoken"));
	...
	Рез.Вставить("ЗаписьВидеоСкоростьПроизношения", Новый Структура("Р, А", "ЗаписьВидеоСкоростьПроизношения", "speedofspeech"));
	Рез.Вставить("ЗаписьВидеоКэшироватьФайлыTTS", Новый Структура("Р, А", "ЗаписьВидеоКэшироватьФайлыTTS", "cachettsfiles"));
	Рез.Вставить("ЗаписьВидеоКэшФайловTTS", Новый Структура("Р, А", "ЗаписьВидеоКэшФайловTTS", "ttsfilescache"));
	Рез.Вставить("ЗаписьВидеоКэшироватьВидеоВставки", Новый Структура("Р, А", "ЗаписьВидеоКэшироватьВидеоВставки", "cachevideo"));
	Рез.Вставить("ЗаписьВидеоКэшВидеоВставок", Новый Структура("Р, А", "ЗаписьВидеоКэшВидеоВставок", "videocachepath"));
	Рез.Вставить("ЗаписьВидеоДобавлятьСубтитры", Новый Структура("Р, А", "ЗаписьВидеоДобавлятьСубтитры", "addsubtitles"));
	Рез.Вставить("ЗаписьВидеоПроцентУскорения", Новый Структура("Р, А", "ЗаписьВидеоПроцентУскорения", "accelerationpercentage"));
	Рез.Вставить("ЗаписьВидеоФормироватьИнструкциюТипВидео", Новый Структура("Р, А", "ЗаписьВидеоФормироватьИнструкциюТипВидео", "instructiontypevideo"));
	Рез.Вставить("ЗаписьВидеоФормироватьИнструкциюТипHTML", Новый Структура("Р, А", "ЗаписьВидеоФормироватьИнструкциюТипHTML", "instructiontypehtml"));
	Рез.Вставить("ЗаписьВидеоФормироватьИнструкциюТипMarkdown", Новый Структура("Р, А", "ЗаписьВидеоФормироватьИнструкциюТипMarkdown", "instructiontypemarkdown"));
	...
	Рез.Вставить("ДобавлятьПриНакликиванииМетаИнформацию", Новый Структура("Р, А", "ДобавлятьПриНакликиванииМетаИнформацию", "addmetainformationclicking"));
	...
	Рез.Вставить("ОбновлятьСтатистикуВДереве", Новый Структура("Р, А", "ОбновлятьСтатистикуВДереве", "updatestatistics"));
	Рез.Вставить("ОбновлятьДеревоПриНачалеВыполненияСценария", Новый Структура("Р, А", "ОбновлятьДеревоПриНачалеВыполненияСценария", "updatetreewhenscenariostarts"));
	Рез.Вставить("ПаузаПриОткрытииОкна", Новый Структура("Р, А", "ПаузаПриОткрытииОкна", "pauseonwindowopening"));
...
Процедура ЗапускВРежимеКоманднойСтроки()
	...
	Если StartFeaturePlayer = Истина Тогда
		...
		ЗнПаузаПриОткрытииОкна = ПолучитьЗначениеПереданногоПараметра(СтрутктураJSON, "ПаузаПриОткрытииОкна");
		...
		ЗнАллюрМеток = ПолучитьЗначениеПереданногоПараметра(СтрутктураJSON, "ДанныеАллюрМеток");
		...
		Если Объект.ДелатьСкриншотПриВозникновенииОшибки Тогда
			...
			Объект.КаталогвыгрузкиСкриншотов = ПреобразоватьПутьСТочкамиКНормальномуПути(ЗнКаталогOutputСкриншоты);
		КонецЕсли;	 
		...
		Объект.ЗаписьВидеоКэшироватьФайлыTTS                           = ПолучитьЗначениеПереданногоПараметра(СтрутктураJSON, "ЗаписьВидеоКэшироватьФайлыTTS");
		Объект.ЗаписьВидеоКэшФайловTTS                                 = ПолучитьЗначениеПереданногоПараметра(СтрутктураJSON, "ЗаписьВидеоКэшФайловTTS");
		Объект.ЗаписьВидеоКэшироватьВидеоВставки                       = ПолучитьЗначениеПереданногоПараметра(СтрутктураJSON, "ЗаписьВидеоКэшироватьВидеоВставки");
		Объект.ЗаписьВидеоКэшВидеоВставок                              = ПолучитьЗначениеПереданногоПараметра(СтрутктураJSON, "ЗаписьВидеоКэшВидеоВставок");
		Объект.ЗаписьВидеоДобавлятьСубтитры                            = ПолучитьЗначениеПереданногоПараметра(СтрутктураJSON, "ЗаписьВидеоДобавлятьСубтитры");
		Объект.ЗаписьВидеоФормироватьИнструкциюТипВидео                = ПолучитьЗначениеПереданногоПараметра(СтрутктураJSON, "ЗаписьВидеоФормироватьИнструкциюТипВидео");
		Объект.ЗаписьВидеоФормироватьИнструкциюТипHTML                 = ПолучитьЗначениеПереданногоПараметра(СтрутктураJSON, "ЗаписьВидеоФормироватьИнструкциюТипHTML");
		Объект.ЗаписьВидеоФормироватьИнструкциюТипMarkdown             = ПолучитьЗначениеПереданногоПараметра(СтрутктураJSON, "ЗаписьВидеоФормироватьИнструкциюТипMarkdown");
		
		Попытка
			Объект.ЗаписьВидеоПроцентУскорения = Число(ПолучитьЗначениеПереданногоПараметра(СтрутктураJSON, "ЗаписьВидеоПроцентУскорения"));
		Исключение
		...
		Попытка
			Объект.ЗаписьВидеоТипОзвучкиTTS = Число(ПолучитьЗначениеПереданногоПараметра(СтрутктураJSON, "ЗаписьВидеоТипОзвучкиTTS"));
		Исключение
			Объект.ЗаписьВидеоТипОзвучкиTTS = 0;
		КонецПопытки;
		
		Объект.ЗаписьВидеоYandexTTSЯзык                                = ПолучитьЗначениеПереданногоПараметра(СтрутктураJSON, "ЗаписьВидеоYandexTTSЯзык");
		Объект.ЗаписьВидеоYandexTTSГолос                               = ПолучитьЗначениеПереданногоПараметра(СтрутктураJSON, "ЗаписьВидеоYandexTTSГолос");
		Объект.ЗаписьВидеоYandexTTSЭмоция                              = ПолучитьЗначениеПереданногоПараметра(СтрутктураJSON, "ЗаписьВидеоYandexTTSЭмоция");
		Попытка
			Объект.ЗаписьВидеоYandexTTSСкорость = Число(ПолучитьЗначениеПереданногоПараметра(СтрутктураJSON, "ЗаписьВидеоYandexTTSСкорость"));
		Исключение
			Объект.ЗаписьВидеоYandexTTSСкорость = 1.1;
		КонецПопытки;
		Объект.ЗаписьВидеоYandexTTSИдентификаторКаталога               = ПолучитьЗначениеПереданногоПараметра(СтрутктураJSON, "ЗаписьВидеоYandexTTSИдентификаторКаталога");
		Объект.ЗаписьВидеоYandexTTSOauthToken                          = ПолучитьЗначениеПереданногоПараметра(СтрутктураJSON, "ЗаписьВидеоYandexTTSOauthToken");
		...
		Попытка
			Объект.ЗаписьВидеоСкоростьПроизношения                     = Число(ПолучитьЗначениеПереданногоПараметра(СтрутктураJSON, "ЗаписьВидеоСкоростьПроизношения"));
		Исключение
		КонецПопытки;
		...
		ЗнЗакрытьTestClientПослеЗапускаСценариев =
		    ПолучитьЗначениеПереданногоПараметра(СтрутктураJSON, "ЗакрытьTestClientПослеЗапускаСценариев");
		...
		Если Объект.СоздаватьИнструкциюHTML Тогда
			...
			Объект.КаталогВыгрузкиИнструкцийHTML = ПреобразоватьПутьСТочкамиКНормальномуПути(ЗнКаталогOutputИнструкцияHTML);
		КонецЕсли;	 
		
		Если Объект.СоздаватьИнструкциюMarkdown Тогда
			ЗнКаталогOutputИнструкцияMarkdown = ПолучитьЗначениеПереданногоПараметра(СтрутктураJSON, "КаталогOutputИнструкцияMarkdown");
			Объект.КаталогВыгрузкиИнструкцийMarkdown = ПреобразоватьПутьСТочкамиКНормальномуПути(ЗнКаталогOutputИнструкцияMarkdown);
		КонецЕсли;	 
		
		Если Объект.СоздаватьИнструкциюВидео Тогда
			ЗнКаталогOutputИнструкцияВидео = ПолучитьЗначениеПереданногоПараметра(СтрутктураJSON, "КаталогOutputИнструкцияВидео");
			Объект.КаталогВыгрузкиИнструкцийВидео = ПреобразоватьПутьСТочкамиКНормальномуПути(ЗнКаталогOutputИнструкцияВидео);
		КонецЕсли;
		...
		Объект.ДобавлятьПриНакликиванииМетаИнформацию = ПолучитьЗначениеПереданногоПараметра(СтрутктураJSON, "ДобавлятьПриНакликиванииМетаИнформацию");
		...
		Объект.ОбновлятьСтатистикуВДереве = ПолучитьЗначениеПереданногоПараметра(СтрутктураJSON, "ОбновлятьСтатистикуВДереве");
		Объект.ОбновлятьДеревоПриНачалеВыполненияСценария = ПолучитьЗначениеПереданногоПараметра(СтрутктураJSON, "ОбновлятьДеревоПриНачалеВыполненияСценария");
		...
		Если ЗнДелатьОтчетВФорматеjUnit = Истина Тогда
			...
			Если ЗначениеЗаполнено(ЗнКаталогOutputjUnit) Тогда
				...
				КонецЕсли;	 
				Объект.КаталогВыгрузкиJUnit       = ПреобразоватьПутьСТочкамиКНормальномуПути(ЗнКаталогOutputjUnit);
		...
		Если ЗнДелатьОтчетВФорматеCucumberJson = Истина Тогда
			...
			Если ЗначениеЗаполнено(ЗнКаталогOutputCucumberJson) Тогда
				...
				КонецЕсли;	 
				Объект.КаталогВыгрузкиCucumberJson       = ПреобразоватьПутьСТочкамиКНормальномуПути(ЗнКаталогOutputCucumberJson);
		...
		Если ЗначениеЗаполнено(ЗнКаталогOutputAllure) Тогда
			...
			Если Не ФайлСуществуетКомандаСистемы(Файл.ПолноеИмя, "КаталогOutputAllure") Тогда
				СоздатьКаталогКомандаСистемы(Файл.ПолноеИмя);
			КонецЕсли;	 
			Объект.КаталогВыгрузкиAllure      = ЗнКаталогOutputAllure;
		...
		Если ЗначениеЗаполнено(ЗнКаталогOutputAllureБазовый) Тогда
			...
			Если ПолучитьЗначениеПереданногоПараметра(СтрутктураJSON, "СоздаватьПодкаталогВКаталогеAllureДляЭтойСборки") = Истина Тогда
				ЗнКаталогOutputAllureБазовый = 
				    ДополнитьСлешВПуть(ПреобразоватьПутьСТочкамиКНормальномуПути(ЗнКаталогOutputAllureБазовый))
					+ Лев(ПолучитьЗначениеПереданногоПараметра(СтрутктураJSON, "ИмяСборки"),40);
			...
			Объект.КаталогВыгрузкиAllure      = ЗнКаталогOutputAllureБазовый;
			ОпределилиКаталогAllure         = Истина;
		КонецЕсли;	 
...
Процедура ДобавитьВЛогИнструкцииHTMLВыполненияШага(СтруткураШага = Неопределено)
	...
	КаталогOutputИнструкцияHTML = ПреобразоватьПутьСТочкамиКНормальномуПути(Объект.КаталогВыгрузкиИнструкцийHTML);
...
Функция ПолучитьПараметрыЗаписиВидео()
	...
	ПараметрыВидео.Вставить("КаталогOutputИнструкцияВидео", Объект.КаталогВыгрузкиИнструкцийВидео);
...
Процедура ПодготовитьСозданиеИнструкцииMarkdown()
	...
	КаталогOutputИнструкцияMarkdown = ПреобразоватьПутьСТочкамиКНормальномуПути(Объект.КаталогВыгрузкиИнструкцийMarkdown);
...
Процедура ВыполнинтьСценарийАссинхронноТаймер()
	...
	Если ПрекратитьВыполнениеВсехСценариев ИЛИ ((МассивСценариевДляВыполнения.Количество() - 1) < ТекИД_СценарияВМассиве) Тогда
		...
		Если Объект.ДелатьОтчетВФорматеjUnit Тогда
			...
			Иначе	
				ИмяФайлаXML = ДополнитьСлешВПуть(ПреобразоватьПутьСТочкамиКНормальномуПути(Объект.КаталогOutputjUnit))
				    + "junit.xml";
			КонецЕсли;	 
