...
Процедура ДобавитьМассивСостоянийФайлов(Массив)
	...
	ДобавитьДействиеВМассивАсинхроныхСобытий(Массив, ПреобразоватьПутьСТочкамиКНормальномуПути(Объект.КаталогВыгрузкиAllure), "КаталогOutputAllure", "РаботаСФайлом");
	ДобавитьДействиеВМассивАсинхроныхСобытий(Массив, ПреобразоватьПутьСТочкамиКНормальномуПути(Объект.КаталогВыгрузкиJUnit), "КаталогOutputjUnit", "РаботаСФайлом");
	ДобавитьДействиеВМассивАсинхроныхСобытий(Массив, ПреобразоватьПутьСТочкамиКНормальномуПути(Объект.КаталогВыгрузкиCucumberJson), "КаталогOutputCucumberJson", "РаботаСФайлом");
	ДобавитьДействиеВМассивАсинхроныхСобытий(Массив, ПреобразоватьПутьСТочкамиКНормальномуПути(Объект.КаталогВыгрузкиИнструкцийHTML), "КаталогOutputИнструкцияHTML", "РаботаСФайлом");
...
Процедура ЗапускВРежимеКоманднойСтроки()
	...
	Если StartFeaturePlayer = Истина Тогда
		...
		ПромСтр = ПреобразоватьПутьСТочкамиКНормальномуПути(ПолучитьЗначениеПараметра(СтрутктураJSON, "КаталогФич"));
		Если ПромСтр = Неопределено Тогда
		...
		ЗначКаталогиБиблиотек = ПолучитьЗначениеПараметра(СтрутктураJSON, "КаталогиБиблиотек");
		...
		ЗнВыгрузитьPIDTestManager = ПолучитьЗначениеПараметра(СтрутктураJSON, "ВыгрузитьPIDTestManager");
		Если ЗнВыгрузитьPIDTestManager = Истина Тогда
			ВычислитьPIDЭтогоСеанса("");
			ИмяФайлаPIDTestManager = ПолучитьЗначениеПараметра(СтрутктураJSON, "ИмяФайлаPIDTestManager");
		...
		ЗнИмяФайлаВнешнихКомандФреймворка = ПолучитьЗначениеПараметра(СтрутктураJSON, "ИмяФайлаВнешнихКомандФреймворка");
		...
		ЗнПриравниватьPendingКFailed = ПолучитьЗначениеПараметра(СтрутктураJSON, "ПриравниватьPendingКFailed");
		Если ЗначениеЗаполнено(ЗнПриравниватьPendingКFailed) Тогда			
			Объект.ПриравниватьPendingКFailed = ЗнПриравниватьPendingКFailed;
		КонецЕсли;  
		
		ЗнКоличествоСекундПоискаОкна = ПолучитьЗначениеПараметра(СтрутктураJSON, "КоличествоСекундПоискаОкна");
		...
		ЗнПаузаПриОткрытииОкна = ПолучитьЗначениеПараметра(СтрутктураJSON, "ПаузаПриОткрытииОкна");
		...
		ЗнКоличествоПопытокВыполненияДействия = ПолучитьЗначениеПараметра(СтрутктураJSON, "КоличествоПопытокВыполненияДействия");
		...
		ЗнОстановкаПриВозникновенииОшибки = ПолучитьЗначениеПараметра(СтрутктураJSON, "ОстановкаПриВозникновенииОшибки");
		...
		ЗнПоказыватьНомерСтрокиДереваПриВозникновенииОшибки = ПолучитьЗначениеПараметра(СтрутктураJSON, "ПоказыватьНомерСтрокиДереваПриВозникновенииОшибки");
		...
		ЗнКаталогИнструментов = ПолучитьЗначениеПараметра(СтрутктураJSON, "КаталогИнструментов");
		Если ЗначениеЗаполнено(ЗнКаталогИнструментов) Тогда			
			Объект.КаталогИнструментов = ЗнКаталогИнструментов;
		КонецЕсли;  
		
		ЗнКаталогПроекта = ПолучитьЗначениеПараметра(СтрутктураJSON, "КаталогПроекта");
		...
		ЗначСписокТеговИсключение = ПолучитьЗначениеПараметра(СтрутктураJSON, "СписокТеговИсключение");
		...
		ЗначСписокТеговОтбор = ПолучитьЗначениеПараметра(СтрутктураJSON, "СписокТеговОтбор");
		Если ТипЗнч(ЗначСписокТеговОтбор) = Тип("Массив") Тогда
			Объект.СписокТеговОтбор.ЗагрузитьЗначения(ЗначСписокТеговОтбор);
		КонецЕсли;  
		
		ЗнДелатьСообщенияТранслитом = ПолучитьЗначениеПараметра(СтрутктураJSON, "ДелатьСообщенияТранслитом");
		Если ЗнДелатьСообщенияТранслитом = Истина Тогда
			Объект.ДелатьСообщенияТранслитом = Истина;
		КонецЕсли;	 
		
		ЗнСоздаватьИнструкциюHTML = ПолучитьЗначениеПараметра(СтрутктураJSON, "СоздаватьИнструкциюHTML");
		Если ЗнСоздаватьИнструкциюHTML = Истина Тогда
			Объект.СоздаватьИнструкциюHTML = Истина;
		КонецЕсли;	 
		
		ЗнСоздаватьИнструкциюMarkdown = ПолучитьЗначениеПараметра(СтрутктураJSON, "СоздаватьИнструкциюMarkdown");
		Если ЗнСоздаватьИнструкциюMarkdown = Истина Тогда
			Объект.СоздаватьИнструкциюMarkdown = Истина;
		КонецЕсли;	 
		
		ЗнСоздаватьИнструкциюВидео = ПолучитьЗначениеПараметра(СтрутктураJSON, "СоздаватьИнструкциюВидео");
		Если ЗнСоздаватьИнструкциюВидео = Истина Тогда
			Объект.СоздаватьИнструкциюВидео = Истина;
		КонецЕсли;	 
		
		ЗнДелатьЛогВыполненияСценариевВЖР = ПолучитьЗначениеПараметра(СтрутктураJSON, "ДелатьЛогВыполненияСценариевВЖР");
		Если ЗнДелатьЛогВыполненияСценариевВЖР = Истина Тогда
			Объект.ДелатьЛогВыполненияСценариевВЖР = Истина;
		КонецЕсли;	  		
		
		ЗнДелатьЛогВыполненияСценариевВТекстовыйФайл = ПолучитьЗначениеПараметра(СтрутктураJSON, "ДелатьЛогВыполненияСценариевВТекстовыйФайл");
		Если ЗнДелатьЛогВыполненияСценариевВТекстовыйФайл = Истина Тогда
			Объект.ДелатьЛогВыполненияСценариевВТекстовыйФайл = Истина;
			Объект.ИмяФайлаЛогВыполненияСценариев = ПреобразоватьПутьСТочкамиКНормальномуПути(ПолучитьЗначениеПараметра(СтрутктураJSON, "ИмяФайлаЛогВыполненияСценариев"));
		КонецЕсли;	  		
		
		ЗнВыводитьВЛогВыполнениеШагов = ПолучитьЗначениеПараметра(СтрутктураJSON, "ВыводитьВЛогВыполнениеШагов");
		Если ЗнВыводитьВЛогВыполнениеШагов = Истина Тогда
			Объект.ВыводитьВЛогВыполнениеШагов = Истина;
		КонецЕсли;	  		
		
		ЗнДелатьЛогОшибокВТекстовыйФайл = ПолучитьЗначениеПараметра(СтрутктураJSON, "ДелатьЛогОшибокВТекстовыйФайл");
		Если ЗнДелатьЛогОшибокВТекстовыйФайл = Истина Тогда
			Объект.ДелатьЛогОшибокВТекстовыйФайл = Истина;
			Объект.ИмяКаталогаЛогОшибок             = ПреобразоватьПутьСТочкамиКНормальномуПути(ПолучитьЗначениеПараметра(СтрутктураJSON, "ИмяКаталогаЛогОшибок"));
		КонецЕсли;	  		
		
		ЗнВерсияПлатформыДляГенерацииEPF = ПолучитьЗначениеПараметра(СтрутктураJSON, "ВерсияПлатформыДляГенерацииEPF");
		...
		ЗнКлиентыТестирования = ПолучитьЗначениеПараметра(СтрутктураJSON, "КлиентыТестирования");
		...
		ЗнАллюрМеток = ПолучитьЗначениеПараметра(СтрутктураJSON, "ДанныеАллюрМеток");
		...
		ЗнДополнительныеПараметры = ПолучитьЗначениеПараметра(СтрутктураJSON, "ДополнительныеПараметры");
		...
		ЗнЗапускатьТестКлиентВРежимеОтладки = ПолучитьЗначениеПараметра(СтрутктураJSON, "ЗапускатьТестКлиентВРежимеОтладки");
		Если ЗнЗапускатьТестКлиентВРежимеОтладки = Истина Тогда
			Объект.ЗапускатьТестКлиентВРежимеОтладки = Истина;
		КонецЕсли;
		
		ЗнДиапазонПортовTestclient = ПолучитьЗначениеПараметра(СтрутктураJSON, "ДиапазонПортовTestclient");
		Если ЗначениеЗаполнено(ЗнДиапазонПортовTestclient) Тогда
			Объект.ДиапазонПортовTestclient = ЗнДиапазонПортовTestclient;
		КонецЕсли;	 
		
		ЗнЯзыкГенератораGherkin = ПолучитьЗначениеПараметра(СтрутктураJSON, "ЯзыкГенератораGherkin");
		Если ЗначениеЗаполнено(ЗнЯзыкГенератораGherkin) Тогда
			Объект.ЯзыкГенератораGherkin = ЗнЯзыкГенератораGherkin;
		КонецЕсли;	 
		
		ЗнКомандаОткрытияФичиВТекстовомРедакторе = ПолучитьЗначениеПараметра(СтрутктураJSON, "КомандаОткрытияФичиВТекстовомРедакторе");
		...
		Попытка
			ЗнТаймаутЗапуска1С = ПолучитьЗначениеПараметра(СтрутктураJSON, "ТаймаутЗапуска1С");
		...
		Попытка
			ЗнТаймаутДляАсинхронныхШагов = ПолучитьЗначениеПараметра(СтрутктураJSON, "ТаймаутДляАсинхронныхШагов");
		...
		ЗнБезопасноеВыполнениеШагов = ПолучитьЗначениеПараметра(СтрутктураJSON, "БезопасноеВыполнениеШагов");
		...
		ЗнДелатьСкриншотПриВозникновенииОшибки = ПолучитьЗначениеПараметра(СтрутктураJSON, "ДелатьСкриншотПриВозникновенииОшибки");
		...
		ЗнСниматьСкриншотКаждогоОкна1С = ПолучитьЗначениеПараметра(СтрутктураJSON, "СниматьСкриншотКаждогоОкна1С");
		...
		ЗнКомандаСделатьСкриншот = ПолучитьЗначениеПараметра(СтрутктураJSON, "КомандаСделатьСкриншот");
		Если ЗначениеЗаполнено(ЗнКомандаСделатьСкриншот) Тогда
			Объект.КомандаСделатьСкриншот = ЗнКомандаСделатьСкриншот;
		КонецЕсли;	 
		
		Если Объект.ДелатьСкриншотПриВозникновенииОшибки Тогда
			ЗнКаталогВыгрузкиСкриншотов = ПолучитьЗначениеПараметра(СтрутктураJSON, "КаталогВыгрузкиСкриншотов");
		...
		Объект.ЗаписьВидеоКомандаНачатьЗаписьВидео                     = ПолучитьЗначениеПараметра(СтрутктураJSON, "ЗаписьВидеоКомандаНачатьЗаписьВидео");
		Объект.ЗаписьВидеоФайлКурсораМышки                             = ПреобразоватьПутьСТочкамиКНормальномуПути(ПолучитьЗначениеПараметра(СтрутктураJSON, "ЗаписьВидеоФайлКурсораМышки"));
		Объект.ЗаписьВидеоКаталогДляВременныхФайлов                    = ПреобразоватьПутьСТочкамиКНормальномуПути(ПолучитьЗначениеПараметра(СтрутктураJSON, "ЗаписьВидеоКаталогДляВременныхФайлов"));
		Объект.ЗаписьВидеоФайлВодянойЗнак                              = ПреобразоватьПутьСТочкамиКНормальномуПути(ПолучитьЗначениеПараметра(СтрутктураJSON, "ЗаписьВидеоФайлВодянойЗнак"));
		Объект.ЗаписьВидеоКомандаFfmpeg                                = ПолучитьЗначениеПараметра(СтрутктураJSON, "ЗаписьВидеоКомандаFfmpeg");
		Объект.ЗаписьВидеоКомандаConvert                               = ПолучитьЗначениеПараметра(СтрутктураJSON, "ЗаписьВидеоКомандаConvert");
		Объект.ЗаписьВидеоКаталогМузыки                                = ПреобразоватьПутьСТочкамиКНормальномуПути(ПолучитьЗначениеПараметра(СтрутктураJSON, "ЗаписьВидеоКаталогМузыки"));
		Объект.ЗаписьВидеоДелатьНаложениеTTS                           = ПолучитьЗначениеПараметра(СтрутктураJSON, "ЗаписьВидеоДелатьНаложениеTTS");
		Объект.ЗаписьВидеоПутьКДвижкуTTS                               = ПолучитьЗначениеПараметра(СтрутктураJSON, "ЗаписьВидеоПутьКДвижкуTTS");
		Объект.ЗаписьВидеоИмяTTS                                       = ПолучитьЗначениеПараметра(СтрутктураJSON, "ЗаписьВидеоИмяTTS");
		Объект.ЗаписьВидеоКэшироватьФайлыTTS                           = ПолучитьЗначениеПараметра(СтрутктураJSON, "ЗаписьВидеоКэшироватьФайлыTTS");
		Объект.ЗаписьВидеоКэшФайловTTS                                 = ПолучитьЗначениеПараметра(СтрутктураJSON, "ЗаписьВидеоКэшФайловTTS");
		Объект.ЗаписьВидеоКэшироватьВидеоВставки                       = ПолучитьЗначениеПараметра(СтрутктураJSON, "ЗаписьВидеоКэшироватьВидеоВставки");
		Объект.ЗаписьВидеоКэшВидеоВставок                              = ПолучитьЗначениеПараметра(СтрутктураJSON, "ЗаписьВидеоКэшВидеоВставок");
		Объект.ЗаписьВидеоДобавлятьСубтитры                            = ПолучитьЗначениеПараметра(СтрутктураJSON, "ЗаписьВидеоДобавлятьСубтитры");
		Объект.ЗаписьВидеоФормироватьИнструкциюТипВидео                = ПолучитьЗначениеПараметра(СтрутктураJSON, "ЗаписьВидеоФормироватьИнструкциюТипВидео");
		Объект.ЗаписьВидеоФормироватьИнструкциюТипHTML                 = ПолучитьЗначениеПараметра(СтрутктураJSON, "ЗаписьВидеоФормироватьИнструкциюТипHTML");
		Объект.ЗаписьВидеоФормироватьИнструкциюТипMarkdown             = ПолучитьЗначениеПараметра(СтрутктураJSON, "ЗаписьВидеоФормироватьИнструкциюТипMarkdown");
		
		Попытка
			Объект.ЗаписьВидеоПроцентУскорения = Число(ПолучитьЗначениеПараметра(СтрутктураJSON, "ЗаписьВидеоПроцентУскорения"));
		Исключение
			Объект.ЗаписьВидеоПроцентУскорения = 25;
		КонецПопытки;
		
		Попытка
			Объект.ЗаписьВидеоГромкостьМузыки = Число(ПолучитьЗначениеПараметра(СтрутктураJSON, "ЗаписьВидеоГромкостьМузыки"));
		Исключение
			Объект.ЗаписьВидеоГромкостьМузыки = 0.10;
		КонецПопытки;
		
		Попытка
			Объект.ЗаписьВидеоТипОзвучкиTTS = Число(ПолучитьЗначениеПараметра(СтрутктураJSON, "ЗаписьВидеоТипОзвучкиTTS"));
		Исключение
			Объект.ЗаписьВидеоТипОзвучкиTTS = 0;
		КонецПопытки;
		
		Объект.ЗаписьВидеоYandexTTSЯзык                                = ПолучитьЗначениеПараметра(СтрутктураJSON, "ЗаписьВидеоYandexTTSЯзык");
		Объект.ЗаписьВидеоYandexTTSГолос                               = ПолучитьЗначениеПараметра(СтрутктураJSON, "ЗаписьВидеоYandexTTSГолос");
		Объект.ЗаписьВидеоYandexTTSЭмоция                              = ПолучитьЗначениеПараметра(СтрутктураJSON, "ЗаписьВидеоYandexTTSЭмоция");
		Попытка
			Объект.ЗаписьВидеоYandexTTSСкорость = Число(ПолучитьЗначениеПараметра(СтрутктураJSON, "ЗаписьВидеоYandexTTSСкорость"));
		Исключение
			Объект.ЗаписьВидеоYandexTTSСкорость = 1.1;
		КонецПопытки;
		Объект.ЗаписьВидеоYandexTTSИдентификаторКаталога               = ПолучитьЗначениеПараметра(СтрутктураJSON, "ЗаписьВидеоYandexTTSИдентификаторКаталога");
		Объект.ЗаписьВидеоYandexTTSOauthToken                          = ПолучитьЗначениеПараметра(СтрутктураJSON, "ЗаписьВидеоYandexTTSOauthToken");
		
		
		ЗнЗаписьВидеоСловарьЗамен = ПолучитьЗначениеПараметра(СтрутктураJSON, "ЗаписьВидеоСловарьЗамен");
		...
		ЗнЗаписьВидеоСловарьЗаменСписок = ПолучитьЗначениеПараметра(СтрутктураJSON, "ЗаписьВидеоСловарьЗаменСписок");
		...
		Объект.ЗаписьВидеоЭкранШирина                                  = ПолучитьЗначениеПараметра(СтрутктураJSON, "ЗаписьВидеоЭкранШирина");
		Объект.ЗаписьВидеоЭкранВысота                                  = ПолучитьЗначениеПараметра(СтрутктураJSON, "ЗаписьВидеоЭкранВысота");
		Объект.ЗаписьВидеоКоличествоКадров                             = ПолучитьЗначениеПараметра(СтрутктураJSON, "ЗаписьВидеоКоличествоКадров");
		Объект.ЗаписьВидеоПодсвечиватьАктивныеЭлементыФорм             = ПолучитьЗначениеПараметра(СтрутктураJSON, "ЗаписьВидеоПодсвечиватьАктивныеЭлементыФорм");
		Объект.ЗаписьВидеоПеремещатьКурсорМышкиКАктивномуЭлементуФормы = ПолучитьЗначениеПараметра(СтрутктураJSON, "ЗаписьВидеоПеремещатьКурсорМышкиКАктивномуЭлементуФормы");
		Объект.ЗаписьВидеоГруппаШаговКакШаг                            = ПолучитьЗначениеПараметра(СтрутктураJSON, "ЗаписьВидеоГруппаШаговКакШаг");
		Объект.ЗаписьВидеоОтключитьМасштабированиеШаговПоВремени       = ПолучитьЗначениеПараметра(СтрутктураJSON, "ЗаписьВидеоОтключитьМасштабированиеШаговПоВремени");
		Объект.ЗаписьВидеоПодсвечиватьНажатияМышки                     = ПолучитьЗначениеПараметра(СтрутктураJSON, "ЗаписьВидеоПодсвечиватьНажатияМышки");
		Объект.ЗаписьВидеоОтключитьСлайдСЗаголовкомФичи                = ПолучитьЗначениеПараметра(СтрутктураJSON, "ЗаписьВидеоОтключитьСлайдСЗаголовкомФичи");
		Объект.ЗаписьВидеоОтключитьСлайдСценария                       = ПолучитьЗначениеПараметра(СтрутктураJSON, "ЗаписьВидеоОтключитьСлайдСценария");
		Объект.ЗаписьВидеоЭмулироватьВводСКлавиатуры                   = ПолучитьЗначениеПараметра(СтрутктураJSON, "ЗаписьВидеоЭмулироватьВводСКлавиатуры");
		Объект.ЗаписьВидеоСкрытьСлужебныеОкна                          = ПолучитьЗначениеПараметра(СтрутктураJSON, "ЗаписьВидеоСкрытьСлужебныеОкна");
		Попытка
			Объект.ЗаписьВидеоСкоростьПроизношения                     = Число(ПолучитьЗначениеПараметра(СтрутктураJSON, "ЗаписьВидеоСкоростьПроизношения"));
		Исключение
		КонецПопытки;
		//по записи видео - окончание
		Объект.ИмяТекущейСборки = ПолучитьЗначениеПараметра(СтрутктураJSON, "ИмяСборки");
		ЗнЗакрытьTestClientПослеЗапускаСценариев =
		    ПолучитьЗначениеПараметра(СтрутктураJSON, "ЗакрытьTestClientПослеЗапускаСценариев");
		Если ЗнЗакрытьTestClientПослеЗапускаСценариев = Истина Тогда
			Объект.ЗакрытьTestClientПослеЗапускаСценариев = Истина;
		КонецЕсли;	 
		
		Если Объект.СоздаватьИнструкциюHTML Тогда
			ЗнКаталогВыгрузкиИнструкцийHTML = ПолучитьЗначениеПараметра(СтрутктураJSON, "КаталогВыгрузкиИнструкцийHTML");
			Объект.КаталогВыгрузкиИнструкцийHTML = ПреобразоватьПутьСТочкамиКНормальномуПути(ЗнКаталогВыгрузкиИнструкцийHTML);
		КонецЕсли;	 
		
		Если Объект.СоздаватьИнструкциюMarkdown Тогда
			ЗнКаталогВыгрузкиИнструкцийMarkdown = ПолучитьЗначениеПараметра(СтрутктураJSON, "КаталогВыгрузкиИнструкцийMarkdown");
			Объект.КаталогВыгрузкиИнструкцийMarkdown = ПреобразоватьПутьСТочкамиКНормальномуПути(ЗнКаталогВыгрузкиИнструкцийMarkdown);
		КонецЕсли;	 
		
		Если Объект.СоздаватьИнструкциюВидео Тогда
			ЗнКаталогВыгрузкиИнструкцийВидео = ПолучитьЗначениеПараметра(СтрутктураJSON, "КаталогВыгрузкиИнструкцийВидео");
		...
		Если Объект.ЗапускатьТестКлиентВРежимеОтладки Тогда
			Объект.КлючиОтладки 	= ПолучитьЗначениеПараметра(СтрутктураJSON, "КлючиОтладки");
			Объект.АдресОтладчика 	= ПолучитьЗначениеПараметра(СтрутктураJSON, "АдресОтладчика");
		КонецЕсли;
		
		
		//для отчетов о прохождении сценариев
		ЗнКаталогОтносительноКоторогоНадоСтроитьИерархию = ПолучитьЗначениеПараметра(СтрутктураJSON, "КаталогОтносительноКоторогоНадоСтроитьИерархию");
		...
		ЗнУровеньОтчета1 = ПолучитьЗначениеПараметра(СтрутктураJSON, "УровеньОтчета1");
		Если ЗначениеЗаполнено(ЗнУровеньОтчета1) Тогда
			Объект.УровеньОтчета1 = ЗнУровеньОтчета1;
		КонецЕсли;	 
		
		ЗнУровеньОтчета2 = ПолучитьЗначениеПараметра(СтрутктураJSON, "УровеньОтчета2");
		Если ЗначениеЗаполнено(ЗнУровеньОтчета2) Тогда
			Объект.УровеньОтчета2 = ЗнУровеньОтчета2;
		КонецЕсли;	 
		
		ЗнУровеньОтчета3 = ПолучитьЗначениеПараметра(СтрутктураJSON, "УровеньОтчета3");
		Если ЗначениеЗаполнено(ЗнУровеньОтчета3) Тогда
			Объект.УровеньОтчета3 = ЗнУровеньОтчета3;
		КонецЕсли;	 
		
		ЗнДобавлятьКИмениСценарияУсловияВыгрузки = ПолучитьЗначениеПараметра(СтрутктураJSON, "ДобавлятьКИмениСценарияУсловияВыгрузки");
		Если ЗнДобавлятьКИмениСценарияУсловияВыгрузки = Истина Тогда
			Объект.ДобавлятьКИмениСценарияУсловияВыгрузки = Истина;
		КонецЕсли;	 
		
		
		ЗнВыгружатьСтатусВыполненияСценариевВФайл = ПолучитьЗначениеПараметра(СтрутктураJSON, "ВыгружатьСтатусВыполненияСценариевВФайл");
		Если ЗнВыгружатьСтатусВыполненияСценариевВФайл = Истина Тогда
			Объект.ВыгружатьСтатусВыполненияСценариевВФайл = Истина;
		КонецЕсли;	 
		
		ЗнПутьКФайлуДляВыгрузкиСтатусаВыполненияСценариев = ПолучитьЗначениеПараметра(СтрутктураJSON, "ПутьКФайлуДляВыгрузкиСтатусаВыполненияСценариев");
		...
		ЗнИспользоватьSikuliXСервер = ПолучитьЗначениеПараметра(СтрутктураJSON, "ИспользоватьSikuliXСервер");
		Если ЗнИспользоватьSikuliXСервер = Истина Тогда
			Объект.ИспользоватьSikuliXСервер = Истина;
		КонецЕсли;	 
		
		ЗнКаталогиСкриптовSikuliX = ПолучитьЗначениеПараметра(СтрутктураJSON, "КаталогиСкриптовSikuliX");
		Если ЗначениеЗаполнено(ЗнКаталогиСкриптовSikuliX) Тогда
			Объект.КаталогиСкриптовSikuliX = ЗнКаталогиСкриптовSikuliX;
		КонецЕсли;	 
		
		Объект.ИскатьЭлементыФормыПоИмени = ПолучитьЗначениеПараметра(СтрутктураJSON, "ИскатьЭлементыФормыПоИмени");
		
		Объект.ДобавлятьПриНакликиванииМетаИнформацию = ПолучитьЗначениеПараметра(СтрутктураJSON, "ДобавлятьПриНакликиванииМетаИнформацию");
		Объект.ЗапускатьКлиентТестированияСМаксимизированнымОкном = ПолучитьЗначениеПараметра(СтрутктураJSON, "ЗапускатьКлиентТестированияСМаксимизированнымОкном");
		Объект.ОбновлятьСтатистикуВДереве = ПолучитьЗначениеПараметра(СтрутктураJSON, "ОбновлятьСтатистикуВДереве");
		Объект.ОбновлятьДеревоПриНачалеВыполненияСценария = ПолучитьЗначениеПараметра(СтрутктураJSON, "ОбновлятьДеревоПриНачалеВыполненияСценария");
		
		Объект.ТегTreeВключенПоУмолчанию = ПолучитьЗначениеПараметра(СтрутктураJSON, "ТегTreeВключенПоУмолчанию");
		
		//для отчета jUnit
		ЗнДелатьОтчетВФорматеjUnit = ПолучитьЗначениеПараметра(СтрутктураJSON, "ДелатьОтчетВФорматеjUnit");
		Если ЗнДелатьОтчетВФорматеjUnit = Истина Тогда
			
			ОпределилиКаталогjUnit = Ложь;
			ЗнКаталогВыгрузкиjUnit   = ПолучитьЗначениеПараметра(СтрутктураJSON, "КаталогВыгрузкиjUnit");
		...
		ЗнДелатьОтчетВФорматеCucumberJson = ПолучитьЗначениеПараметра(СтрутктураJSON, "ДелатьОтчетВФорматеCucumberJson");
		Если ЗнДелатьОтчетВФорматеCucumberJson = Истина Тогда
			
			ОпределилиКаталогCucumberJson = Ложь;
			ЗнКаталогВыгрузкиtCucumberJson   = ПолучитьЗначениеПараметра(СтрутктураJSON, "КаталогВыгрузкиCucumberJson");
		...
		//для отчета Allure
		ЗнДелатьОтчетВФорматеАллюр = ПолучитьЗначениеПараметра(СтрутктураJSON, "ДелатьОтчетВФорматеАллюр");
		Если ЗнДелатьОтчетВФорматеАллюр = Истина Тогда
			Объект.ДелатьОтчетВФорматеАллюр = Истина;
		КонецЕсли;	
				
		ОпределилиКаталогAllure = Ложь;
		ЗнКаталогВыгрузкиAllure = ПолучитьЗначениеПараметра(СтрутктураJSON, "КаталогВыгрузкиAllure");
		...
		ЗнКаталогВыгрузкиAllureБазовый = ПолучитьЗначениеПараметра(СтрутктураJSON, "КаталогВыгрузкиAllureБазовый");
		Если ЗначениеЗаполнено(ЗнКаталогВыгрузкиAllureБазовый) Тогда
			...
			Если ПолучитьЗначениеПараметра(СтрутктураJSON, "СоздаватьПодкаталогВКаталогеAllureДляЭтойСборки") = Истина Тогда
				ЗнКаталогВыгрузкиAllureБазовый = 
				    ДополнитьСлешВПуть(ПреобразоватьПутьСТочкамиКНормальномуПути(ЗнКаталогВыгрузкиAllureБазовый))
					+ Лев(ПолучитьЗначениеПараметра(СтрутктураJSON, "ИмяСборки"),40);
		...
		ПриоритетНастроекПользователя = ПолучитьЗначениеПараметра(СтрутктураJSON, "ПриоритетНастроекПользователя");
		
		ВыполнятьШагиАссинхронноЗн = ПолучитьЗначениеПараметра(СтрутктураJSON, "ВыполнятьШагиАссинхронно");
		...
		ЗнКаталогИсполняемогоФайла = ПолучитьЗначениеПараметра(СтрутктураJSON, "КаталогИсполняемогоФайла");
		...
		ВыполнитьСценарии = ПолучитьЗначениеПараметра(СтрутктураJSON, "ВыполнитьСценарии");
		ВыполнитьСценарииСТекущегоШага = ПолучитьЗначениеПараметра(СтрутктураJSON, "ВыполнитьСценарииСТекущегоШага");
		Если ВыполнитьСценарии = Истина Тогда
			ЗнЗавершитьРаботуСистемы = ПолучитьЗначениеПараметра(СтрутктураJSON, "ЗавершитьРаботуСистемы");
		...
		ИначеЕсли ВыполнитьСценарииСТекущегоШага = Истина Тогда	
			НадоВыполнитьСценарийСоСтрокиПереданнойИзвне = Истина;
			НомерСтрокиСценарияПереданныйИзвне           = Число(ПолучитьЗначениеПараметра(СтрутктураJSON, "НомерСтрокиДляЗапускаСТекущегоШагаСценария"));
			ЗагрузитьФичи();
			ПодключитьОбработчикОжидания("ЗапуститьСценарийСоСтрокиПрисланнойИзвне",0.1,Истина);
		Иначе	
			ЗагрузитьСценарии = ПолучитьЗначениеПараметра(СтрутктураJSON, "ЗагрузитьСценарии");
...
Процедура ОбновитьЗначенияВТаблоПеременных()
	...
	Для Каждого Элем Из СписокЗначенийКонтекст Цикл
		...
		СтрокаПеремнной = СтрокиКонтекст.Добавить();
		СтрокаПеремнной.Имя = Элем.Значение;
		СтрокаПеремнной.Значение = ОбъектКонтекст[СтрокаПеремнной.Имя];
		СтрокаПеремнной.Тип = ТипЗнч(ОбъектКонтекст[СтрокаПеремнной.Имя]);
		СтрокаПеремнной.ИсточникДанных = "Контекст";
	КонецЦикла;	 
	...
	Для Каждого Элем Из СписокЗначенийКонтекст Цикл
		...
		СтрокаПеремнной = СтрокиКонтекстСохраняемый.Добавить();
		СтрокаПеремнной.Имя = Элем.Значение;
		СтрокаПеремнной.Значение = ОбъектКонтекстСохраняемый[СтрокаПеремнной.Имя];
		СтрокаПеремнной.Тип = ТипЗнч(ОбъектКонтекстСохраняемый[СтрокаПеремнной.Имя]);
		СтрокаПеремнной.ИсточникДанных = "КонтекстСохраняемый";
	КонецЦикла;	 
