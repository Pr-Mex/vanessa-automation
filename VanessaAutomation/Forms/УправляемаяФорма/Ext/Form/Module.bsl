...
//		ОсновныеНастройки = ПолучитьОбщиеНастройки(, Истина);
		...
		Объект.ЗаписьВидеоКомандаНачатьЗаписьВидео         = ПолучитьЗначениеПараметра(СтруктураJSON, "ЗаписьВидеоКомандаНачатьЗаписьВидео");
		Объект.ЗаписьВидеоФайлКурсораМышки                 = ПреобразоватьПутьСТочкамиКНормальномуПути(ПолучитьЗначениеПараметра(СтруктураJSON, "ЗаписьВидеоФайлКурсораМышки"));
		Объект.ЗаписьВидеоКаталогДляВременныхФайлов        = ПреобразоватьПутьСТочкамиКНормальномуПути(ПолучитьЗначениеПараметра(СтруктураJSON, "ЗаписьВидеоКаталогДляВременныхФайлов"));
		Объект.ЗаписьВидеоФайлВодянойЗнак                  = ПреобразоватьПутьСТочкамиКНормальномуПути(ПолучитьЗначениеПараметра(СтруктураJSON, "ЗаписьВидеоФайлВодянойЗнак"));
		Объект.ЗаписьВидеоКомандаFfmpeg                    = ПолучитьЗначениеПараметра(СтруктураJSON, "ЗаписьВидеоКомандаFfmpeg");
		Объект.ЗаписьВидеоКомандаConvert                   = ПолучитьЗначениеПараметра(СтруктураJSON, "ЗаписьВидеоКомандаConvert");
		Объект.ЗаписьВидеоКаталогМузыки                    = ПреобразоватьПутьСТочкамиКНормальномуПути(ПолучитьЗначениеПараметра(СтруктураJSON, "ЗаписьВидеоКаталогМузыки"));
		Объект.ЗаписьВидеоДелатьНаложениеTTS               = ПолучитьЗначениеПараметра(СтруктураJSON, "ЗаписьВидеоДелатьНаложениеTTS");
		Объект.ЗаписьВидеоПутьКДвижкуTTS                   = ПолучитьЗначениеПараметра(СтруктураJSON, "ЗаписьВидеоПутьКДвижкуTTS");
		Объект.ЗаписьВидеоИмяTTS                           = ПолучитьЗначениеПараметра(СтруктураJSON, "ЗаписьВидеоИмяTTS");
		Объект.ЗаписьВидеоКэшироватьФайлыTTS               = ПолучитьЗначениеПараметра(СтруктураJSON, "ЗаписьВидеоКэшироватьФайлыTTS");
		Объект.ЗаписьВидеоКэшФайловTTS                     = ПолучитьЗначениеПараметра(СтруктураJSON, "ЗаписьВидеоКэшФайловTTS");
		Объект.ЗаписьВидеоКэшироватьВидеоВставки           = ПолучитьЗначениеПараметра(СтруктураJSON, "ЗаписьВидеоКэшироватьВидеоВставки");
		Объект.ЗаписьВидеоКэшВидеоВставок                  = ПолучитьЗначениеПараметра(СтруктураJSON, "ЗаписьВидеоКэшВидеоВставок");
		Объект.ЗаписьВидеоДобавлятьСубтитры                = ПолучитьЗначениеПараметра(СтруктураJSON, "ЗаписьВидеоДобавлятьСубтитры");
		Объект.ЗаписьВидеоФормироватьИнструкциюТипВидео    = ПолучитьЗначениеПараметра(СтруктураJSON, "ЗаписьВидеоФормироватьИнструкциюТипВидео");
		Объект.ЗаписьВидеоФормироватьИнструкциюТипHTML     = ПолучитьЗначениеПараметра(СтруктураJSON, "ЗаписьВидеоФормироватьИнструкциюТипHTML");
		Объект.ЗаписьВидеоФормироватьИнструкциюТипMarkdown = ПолучитьЗначениеПараметра(СтруктураJSON, "ЗаписьВидеоФормироватьИнструкциюТипMarkdown");
		...
		Объект.ЗаписьВидеоYandexTTSЯзык = ПолучитьЗначениеПараметра(СтруктураJSON, "ЗаписьВидеоYandexTTSЯзык");
		Объект.ЗаписьВидеоYandexTTSГолос = ПолучитьЗначениеПараметра(СтруктураJSON, "ЗаписьВидеоYandexTTSГолос");
		Объект.ЗаписьВидеоYandexTTSЭмоция = ПолучитьЗначениеПараметра(СтруктураJSON, "ЗаписьВидеоYandexTTSЭмоция");
		Попытка
			Объект.ЗаписьВидеоYandexTTSСкорость = Число(ПолучитьЗначениеПараметра(СтруктураJSON, "ЗаписьВидеоYandexTTSСкорость"));
		Исключение
			Объект.ЗаписьВидеоYandexTTSСкорость = 1.1;
		КонецПопытки;
		Объект.ЗаписьВидеоYandexTTSИдентификаторКаталога = ПолучитьЗначениеПараметра(СтруктураJSON, "ЗаписьВидеоYandexTTSИдентификаторКаталога");
		Объект.ЗаписьВидеоYandexTTSOauthToken = ПолучитьЗначениеПараметра(СтруктураJSON, "ЗаписьВидеоYandexTTSOauthToken");
		...
		Объект.ЗаписьВидеоЭкранШирина                                  = ПолучитьЗначениеПараметра(СтруктураJSON, "ЗаписьВидеоЭкранШирина");
		Объект.ЗаписьВидеоЭкранВысота                                  = ПолучитьЗначениеПараметра(СтруктураJSON, "ЗаписьВидеоЭкранВысота");
		Объект.ЗаписьВидеоКоличествоКадров                             = ПолучитьЗначениеПараметра(СтруктураJSON, "ЗаписьВидеоКоличествоКадров");
		Объект.ЗаписьВидеоПодсвечиватьАктивныеЭлементыФорм             = ПолучитьЗначениеПараметра(СтруктураJSON, "ЗаписьВидеоПодсвечиватьАктивныеЭлементыФорм");
		Объект.ЗаписьВидеоПеремещатьКурсорМышкиКАктивномуЭлементуФормы = ПолучитьЗначениеПараметра(СтруктураJSON, "ЗаписьВидеоПеремещатьКурсорМышкиКАктивномуЭлементуФормы");
		Объект.ЗаписьВидеоГруппаШаговКакШаг                            = ПолучитьЗначениеПараметра(СтруктураJSON, "ЗаписьВидеоГруппаШаговКакШаг");
		Объект.ЗаписьВидеоОтключитьМасштабированиеШаговПоВремени       = ПолучитьЗначениеПараметра(СтруктураJSON, "ЗаписьВидеоОтключитьМасштабированиеШаговПоВремени");
		Объект.ЗаписьВидеоПодсвечиватьНажатияМышки                     = ПолучитьЗначениеПараметра(СтруктураJSON, "ЗаписьВидеоПодсвечиватьНажатияМышки");
		Объект.ЗаписьВидеоОтключитьСлайдСЗаголовкомФичи                = ПолучитьЗначениеПараметра(СтруктураJSON, "ЗаписьВидеоОтключитьСлайдСЗаголовкомФичи");
		Объект.ЗаписьВидеоОтключитьСлайдСценария                       = ПолучитьЗначениеПараметра(СтруктураJSON, "ЗаписьВидеоОтключитьСлайдСценария");
		Объект.ЗаписьВидеоЭмулироватьВводСКлавиатуры                   = ПолучитьЗначениеПараметра(СтруктураJSON, "ЗаписьВидеоЭмулироватьВводСКлавиатуры");
		Объект.ЗаписьВидеоСкрытьСлужебныеОкна                          = ПолучитьЗначениеПараметра(СтруктураJSON, "ЗаписьВидеоСкрытьСлужебныеОкна");
		Попытка
		...
		Объект.ИскатьЭлементыФормыПоИмени = ПолучитьЗначениеПараметра(СтруктураJSON, "ИскатьЭлементыФормыПоИмени");
		
		Объект.ДобавлятьПриНакликиванииМетаИнформацию = ПолучитьЗначениеПараметра(СтруктураJSON, "ДобавлятьПриНакликиванииМетаИнформацию");
		Объект.ЗапускатьКлиентТестированияСМаксимизированнымОкном = ПолучитьЗначениеПараметра(СтруктураJSON, "ЗапускатьКлиентТестированияСМаксимизированнымОкном");
		Объект.ОбновлятьСтатистикуВДереве = ПолучитьЗначениеПараметра(СтруктураJSON, "ОбновлятьСтатистикуВДереве");
		Объект.ОбновлятьДеревоПриНачалеВыполненияСценария = ПолучитьЗначениеПараметра(СтруктураJSON, "ОбновлятьДеревоПриНачалеВыполненияСценария");
		
		ЗначениеТегTreeВключенПоУмолчанию = ПолучитьЗначениеПараметра(СтруктураJSON, "ТегTreeВключенПоУмолчанию");
		Если ЗначениеЗаполнено(ЗначениеТегTreeВключенПоУмолчанию) Тогда
