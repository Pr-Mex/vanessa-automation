...
Процедура ЗапускВРежимеКоманднойСтроки()
	...
	// СтрокаЗапуска = "StartFeaturePlayer;VBParams=\\co-trade01\retail_base\RetailКлен\VAParams.json";
	...
	Если StartFeaturePlayer = Истина Тогда
		...
		Если Объект.ДелатьСкриншотПриВозникновенииОшибки Тогда
			...
			Если СтруктураJSON.Свойство("КаталогOutputСкриншоты") Тогда
				...
				СделатьСообщение(НСтр("ru = 'Использование устаревшего параметра ""КаталогOutputСкриншоты"". Новый параметр - ""КаталогВыгрузкиСкриншотов""'"));
			Иначе 	
			// Конец Удалить
		...
		Если Объект.СоздаватьИнструкциюHTML Тогда
			...
			Если СтруктураJSON.Свойство("КаталогOutputИнструкцияHTML") Тогда
				...
				СделатьСообщение(НСтр("ru = 'Использование устаревшего параметра ""КаталогOutputИнструкцияHTML"". Новый параметр - ""КаталогВыгрузкиИнструкцийHTML""'"));
			Иначе 	
			// Конец Удалить
		...
		Если Объект.СоздаватьИнструкциюMarkdown Тогда
			...
			Если СтруктураJSON.Свойство("КаталогOutputИнструкцияMarkdown") Тогда
				...
				СделатьСообщение(НСтр("ru = 'Использование устаревшего параметра ""КаталогOutputИнструкцияMarkdown"". Новый параметр - ""КаталогВыгрузкиИнструкцийMarkdown""'"));
			Иначе 	
			// Конец Удалить
		...
		Если Объект.СоздаватьИнструкциюВидео Тогда
			...
			Если СтруктураJSON.Свойство("КаталогOutputИнструкцияВидео") Тогда
				...
				СделатьСообщение(НСтр("ru = 'Использование устаревшего параметра ""КаталогOutputИнструкцияВидео"". Новый параметр - ""КаталогВыгрузкиИнструкцийВидео""'"));
			Иначе 	
			// Конец Удалить
		...
		Если ЗнДелатьОтчетВФорматеjUnit = Истина Тогда
			...
			Если СтруктураJSON.Свойство("КаталогOutputjUnit") Тогда
				...
				СделатьСообщение(НСтр("ru = 'Внимание. Использование устаревшего параметра ""КаталогOutputjUnit"". Новый параметр - ""КаталогВыгрузкиjUnit""'"));					
			Иначе 
			// Конец Удалить	
			...
			Если НЕ ОпределилиКаталогjUnit Тогда
				СделатьСообщение("В параметрах запуска JSON не определен каталог отчета jUnit.");
				Возврат;
			КонецЕсли;	 
		КонецЕсли;
		...
		Если ЗнДелатьОтчетВФорматеCucumberJson = Истина Тогда
			...
			Если СтруктураJSON.Свойство("КаталогOutputCucumberJson") Тогда
				...
				СделатьСообщение(НСтр("ru = 'Использование устаревшего параметра ""КаталогOutputCucumberJson"". Новый параметр - ""КаталогВыгрузкиCucumberJson""'"));
			Иначе
			// Конец Удалить	
			...
			Если НЕ ОпределилиКаталогCucumberJson Тогда
				СделатьСообщение("В параметрах запуска JSON не определен отчета CucumberJson.");
				Возврат;
			КонецЕсли;	 
		КонецЕсли;
		...
		Если СтруктураJSON.Свойство("КаталогOutputAllure") Тогда
			...
			СделатьСообщение(НСтр("ru = 'Использование устаревшего параметра ""КаталогOutputAllure"". Новый параметр - ""КаталогВыгрузкиAllure""'"));
		Иначе
		// Конец Удалить
		...
		Если СтруктураJSON.Свойство("КаталогOutputAllureБазовый") Тогда
			...
			СделатьСообщение(НСтр("ru = 'Использование устаревшего параметра ""КаталогOutputAllureБазовый"". Новый параметр - ""КаталогВыгрузкиAllureБазовый""'"));
		Иначе
		// Конец Удалить	
		...
		Если Объект.ДелатьОтчетВФорматеАллюр Тогда
			Если НЕ ОпределилиКаталогAllure Тогда
				СделатьСообщение("В параметрах запуска JSON не определен каталог отчета Allure.");
				Возврат;
			КонецЕсли;	 
		КонецЕсли;	 
