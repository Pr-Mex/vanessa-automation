...
&НаКлиенте
Процедура УстановитьФлагМодифицированностиVanessaEditor(Значение) Экспорт
	Ванесса.БылиИзмененияДанныхVanessaEditor = Значение;
	//Ванесса.Модифицированность = Значение;
КонецПроцедуры 
...
Процедура ПриСменеЗакладкиРедактора(Вкладка) Экспорт
	...
	Если ИмяФайлаСоответствуетПустойНовойРедактора(Ванесса.Объект.КаталогФич) Тогда
		...
		Ванесса.Объект.КаталогФич = "";
	КонецЕсли;	 
	УстановитьФлагМодифицированностиVanessaEditor(Вкладка.modified);
