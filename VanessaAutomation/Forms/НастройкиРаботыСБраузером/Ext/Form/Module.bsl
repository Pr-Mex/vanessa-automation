...
Процедура НайтиБраузер(ПараметрыПоиска)
	...
	Если ПараметрыПоиска.АсинхронныйПоискСуществованияФайлов Тогда
		ОписаниеОповещения = Новый ОписаниеОповещения("ПроверкаСуществованияФайла", ЭтотОбъект, ПараметрыПоиска);
		Файл.НачатьПроверкуСуществования(ОписаниеОповещения);
	Иначе
		ПроверкаСуществованияФайла(Файл.Существует(), ПараметрыПоиска)
	КонецЕсли;
...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	//ПостфиксыЭлемента = Новый Массив;
	//ПостфиксыЭлемента.Добавить("для элемента с ID ""ID""");
	//ПостфиксыЭлемента.Добавить("для элемента с именем ""Name""");
	//ПостфиксыЭлемента.Добавить("для элемента с именем класса ""className""");
	//
	//Сообщить("И страница браузера содержит текст ""Привет мир!""");
	//
	//Для каждого ПостфиксЭлемента Из ПостфиксыЭлемента Цикл
	//	Сообщить("И в странице браузера "+ПостфиксЭлемента+" я получаю текст в переменную ""ИмяПеременной""");
	//	Сообщить("И в странице браузера "+ПостфиксЭлемента+" я получаю ссылку в переменную ""ИмяПеременной""");
	//	Сообщить("И в странице браузера "+ПостфиксЭлемента+" я получаю текст кнопки в переменную ""ИмяПеременной""");
	//	Сообщить("И в странице браузера "+ПостфиксЭлемента+" я устанавливаю текст поля ""ТекстПоля""");
	//	Сообщить("И в странице браузера "+ПостфиксЭлемента+" я получаю список значений в переменную ""ИмяПеременной""");
	//	Сообщить("И в странице браузера "+ПостфиксЭлемента+" я выбираю значение ""ЗначениеЭлемента"" в списке выбора");
	//	Сообщить("И в странице браузера "+ПостфиксЭлемента+" я делаю клик");
	//	Сообщить("И в странице браузера "+ПостфиксЭлемента+" я делаю правый клик");
	//КонецЦикла;
...
//	КонецЕсли;
//	
//	Если НЕ Параметры.ЗакрытьФорму Тогда
//		Отказ = Истина;
...
//	
//	Если Результат = КодВозвратаДиалога.Да И Параметры.Свойство("ЗакрытьФорму") Тогда
//		Параметры.ЗакрытьФорму = Истина;
//		Закрыть();
