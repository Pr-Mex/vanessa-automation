...
Процедура ОткрытьURL(Команда) Экспорт
	...
	ОписаниеОповещения = Новый ОписаниеОповещения("ВызовОткрытьВебСокет", ЭтаФорма);
...
Процедура ВыполнитьJavaSctipt(Команда) Экспорт
	...
	ОписаниеОповещения = Новый ОписаниеОповещения("ВызовJavaSctipt", ЭтаФорма, ДанныеШага);
