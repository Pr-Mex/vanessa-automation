...
Функция КоллекцияКомандЗапуска() Экспорт
	...
	// Настройки выполнения сценария в Docker  
	КоллекцияКоманд.Вставить("DockerКаталогМонтирования", Новый Структура("Р, А", "DockerКаталогМонтирования", "DockerTestingContainerMountDirectory"));
	КоллекцияКоманд.Вставить("DockerСоздаватьБазуДляМенеджераТестирования", 
		Новый Структура("Р, А", "DockerСоздаватьБазуДляМенеджераТестирования", "DockerCreateDatabaseForTestingMManager"));
	КоллекцияКоманд.Вставить("DockerИмяОбразаТестирования", Новый Структура("Р, А", "DockerИмяОбразаТестирования", "DockerTestingImageName"));
	КоллекцияКоманд.Вставить("DockerПортКонтейнераТестированияДляПросмотра", Новый Структура("Р, А", "DockerПортКонтейнераТестированияДляПросмотра", "DockerContainerPortForViewing"));
	КоллекцияКоманд.Вставить("DockerИмяОбразаПросмотрщика", Новый Структура("Р, А", "DockerИмяОбразаПросмотрщика", "DockerViewerImageName"));
	КоллекцияКоманд.Вставить("DockerПортКонтейнераПросмотрщика", Новый Структура("Р, А", "DockerПортКонтейнераПросмотрщика", "DockerViewerContainerPort"));
	КоллекцияКоманд.Вставить("DockerСтрокаСоединенияСБазойТестированияДляКонтейнера", 
		Новый Структура("Р, А", "DockerСтрокаСоединенияСБазойТестированияДляКонтейнера", "DockerTestingDatabaseConnectionStringForContainer"));
	КоллекцияКоманд.Вставить("DockerИспользоватьПросмотрщик", Новый Структура("Р, А", "DockerИспользоватьПросмотрщик", "DockerUseViewer"));
	КоллекцияКоманд.Вставить("DockerКаталогПлатформыВнутриКонтейнераТестирования", 
		Новый Структура("Р, А", "DockerКаталогПлатформыВнутриКонтейнераТестирования", "DockerPlatformDirectoryInsideTestingContainer"));
	КоллекцияКоманд.Вставить("DockerРасширениеЭкранаДляПросмотра", Новый Структура("Р, А", "DockerРасширениеЭкранаДляПросмотра", "DockerScreenExtensionForViewing"));
	КоллекцияКоманд.Вставить("DockerКаталогЛицензийВнутриКонтейнераТестирования", 
		Новый Структура("Р, А", "DockerКаталогЛицензийВнутриКонтейнераТестирования", "DockerLicensesDirectoryInsideTestingContainer"));
	КоллекцияКоманд.Вставить("DockerИспользоватьВыполнениеВКонтейнере", Новый Структура("Р, А", "DockerИспользоватьВыполнениеВКонтейнере", "DockerUseExecutionInContainer"));
	КоллекцияКоманд.Вставить("DockerЗаменятьСтрокуПодключенияИзКонтейнера", 
		Новый Структура("Р, А", "DockerЗаменятьСтрокуПодключенияИзКонтейнера", "DockerReplaceConnectionStringFromContainer"));
	КоллекцияКоманд.Вставить("DockerСтрокаСоединенияСБазойМенеджераТестирования", 
		Новый Структура("Р, А", "DockerСтрокаСоединенияСБазойМенеджераТестирования", "DockerTestingManagerDatabaseConnectionString"));
	КоллекцияКоманд.Вставить("DockerЛогинБазыМенеджераТестирования", Новый Структура("Р, А", "DockerЛогинБазыМенеджераТестирования", "DockerTestingManagerDatabaseLogin"));
	КоллекцияКоманд.Вставить("DockerПарольБазыМенеджераТестирования", Новый Структура("Р, А", "DockerПарольБазыМенеджераТестирования", "DockerTestingManagerDatabasePassword"));
