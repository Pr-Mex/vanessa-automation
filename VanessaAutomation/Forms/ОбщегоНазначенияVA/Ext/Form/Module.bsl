...
Функция КоллекцияКомандЗапуска() Экспорт
	...
	КоллекцияКоманд.Вставить("ГруппировкаTestParentSuites", Новый Структура("Р, А", "ГруппировкаTestParentSuites", "testparentsuites"));
	КоллекцияКоманд.Вставить("ГруппировкаTestSuites", Новый Структура("Р, А", "ГруппировкаTestSuites", "testsuites"));
	КоллекцияКоманд.Вставить("ГруппировкаTestSubSuites", Новый Структура("Р, А", "ГруппировкаTestSubSuites", "testsubsuites"));
...
Функция СтруктураПараметровЗапуска() Экспорт
	...
	ПараметрыЗапуска.Вставить("ВключитьОзвучкуHTML", Ложь);
	ПараметрыЗапуска.Вставить("ТемпОзвучкиHTML", 1);
	ПараметрыЗапуска.Вставить("ДиапазонОзвучкиHTML", 1);
	ПараметрыЗапуска.Вставить("ГолосОзвучкиHTML", 0);
	...
	ПараметрыЗапуска.Вставить("ИспользоватьДляОстановкиВыполненияСценарияФайл", Истина);
	ПараметрыЗапуска.Вставить("РазрешеноЗапускатьТолькоОдинКлиентТестирования", Ложь);
	ПараметрыЗапуска.Вставить("ПроверкаСерверныхВызововВОбработчикахСобытий", Ложь);
	...
	ПараметрыЗапуска.Вставить("СниматьСкриншотыБраузера", Истина);
	...
	ПараметрыЗапуска.Вставить("ЗавершатьРаботуЕслиНеПолучилосьВыполнитьТихуюУстановкуКомпоненты", Ложь);
	...
	ПараметрыЗапуска.Вставить("ГруппировкаTestParentSuites", "");
	ПараметрыЗапуска.Вставить("ГруппировкаTestSuites", "");
	ПараметрыЗапуска.Вставить("ГруппировкаTestSubSuites", "");
