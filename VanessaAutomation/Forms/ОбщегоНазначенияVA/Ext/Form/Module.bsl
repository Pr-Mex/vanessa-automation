...
Функция КоллекцияКомандЗапуска() Экспорт
	...
	КоллекцияКоманд.Вставить("КаталогГенерированияДымовыхТестов", Новый Структура("Р, А", "КаталогГенерированияДымовыхТестов", "SmokeTestGenerationPath"));
	КоллекцияКоманд.Вставить("КаталогФайловИсключаемыхОбъектовИзДымовогоТестирования", Новый Структура("Р, А", "КаталогФайловИсключаемыхОбъектовИзДымовогоТестирования", "CatalogOfFilesOfExcludedObjectsFromTheSmokeTest"));
	КоллекцияКоманд.Вставить("ТолькоИзмененныеОтносительноКонфигурацииПоставщикаДляДымовогоТестирования", Новый Структура("Р, А", "ТолькоИзмененныеОтносительноКонфигурацииПоставщикаДляДымовогоТестирования", "OnlyChangedRelativelyProviderConfiguration"));
	КоллекцияКоманд.Вставить("ТолькоВведенныеОбъектыДляДымовогоТестирования", Новый Структура("Р, А", "ТолькоВведенныеОбъектыДляДымовогоТестирования", "OnlyEnteredObjects"));
	КоллекцияКоманд.Вставить("ИмяКонфигурацииПоставщика", Новый Структура("Р, А", "ИмяКонфигурацииПоставщика", "NameOfTheVendorConfiguration"));
	КоллекцияКоманд.Вставить("ПутьНастройкиСценариеДымовыхТестов", Новый Структура("Р, А", "ПутьНастройкиСценариеДымовыхТестов", "TheSetupPathOfTheSmokeTestScenario"));
	КоллекцияКоманд.Вставить("ЯзыкШаговДымовыхТестов", Новый Структура("Р, А", "ЯзыкШаговДымовыхТестов", "LanguageOfSmokeTestSteps"));
