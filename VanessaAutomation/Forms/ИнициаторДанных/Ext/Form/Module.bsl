...
//
&НаКлиенте
Функция РезультатЗаписиДокументаПоНавигационнойСсылке(НавигационнаяСсылка, Режим, ВызыватьИсключение = Ложь) Экспорт

	Ссылка = ПолучитьСсылкуПоНавигационнойСсылке(НавигационнаяСсылка); 
	...
	Иначе
		...
		Результат.Описание = "Не удалось получить актуальную ссылку";
...
Функция ПолучитьСсылкуПоНавигационнойСсылке(НавигационнаяСсылка)
