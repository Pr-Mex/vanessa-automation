...
// 	
&НаКлиенте
Функция ПроверкаЗаполненияПройдена(СсылкаИлиИмяПеременной) Экспорт
	ОписаниеСсылки = ОписаниеСсылкиПеременной(СсылкаИлиИмяПеременной);
	Возврат ПроверкаЗаполненияПройденаНаСервере(ОписаниеСсылки);
КонецФункции
...
Процедура СоздатьЗаписиРегистраСведенийПоТаблицеГеркина(ИмяРегистра, Источник) Экспорт
	...
	ЗначениеБДПоОписанию(ОписаниеОбъекта);
КонецПроцедуры
...
Функция ПроверкаЗаполненияПройденаНаСервере(Знач ОписаниеСсылки)
	...
	Возврат ОбъектПриемника.ПроверитьЗаполнение();
